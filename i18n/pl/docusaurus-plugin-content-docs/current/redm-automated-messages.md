...
title: "RedM: Zautomatyzowane wiadomości na serwerze - Informuj swoich graczy o nowościach, linkach społecznościowych i nie tylko!"
...
Dzięki **Zadaniom Zaplanowanym** wiadomości na serwerze mogą być automatycznie wysyłane na czat w grze **RedM** poprzez wykonywanie zdefiniowanych komend według ustalonego harmonogramu.
...
Aby stworzyć zautomatyzowane wiadomości na serwerze, otwórz panel główny swojego serwera gier i przejdź do sekcji **Zadania Zaplanowane**. Utwórz nowe zadanie zaplanowane i wybierz opcję wykonania **komendy**. W polu komendy wpisz komendę do wiadomości obsługiwaną przez Twój serwer gier.
...
- Ogłaszanie nadchodzących eventów o ustalonych godzinach
