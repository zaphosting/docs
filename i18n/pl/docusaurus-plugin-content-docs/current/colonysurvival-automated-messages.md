...
title: "Colony Survival: Zautomatyzowane wiadomości na serwerze - Informuj swoich graczy o nowościach, linkach społecznościowych i nie tylko!"
...
Dzięki **Zadaniom zaplanowanym** wiadomości na serwerze mogą być automatycznie wysyłane na czat w grze **Colony Survival** poprzez wykonywanie zdefiniowanych komend w ustalonym harmonogramie.
...
Zamień komendę na komendę gry lub komendę z rozszerzenia, której chcesz użyć do wywołania wiadomości, a `<tekst Twojej wiadomości>` na treść, którą mają zobaczyć gracze.
