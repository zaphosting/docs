...
title: "Deadlock: Połącz się z serwerem"
description: "Dowiedz się, jak bezproblemowo połączyć się z serwerem Deadlock i rozwiązać typowe problemy, aby cieszyć się płynną rozgrywką → Sprawdź teraz"
...
Aby połączyć się z serwerem przez konsolę, otwórz ją klawiszem `F7`. Gdy konsola się otworzy, wpisz następujące polecenie:
