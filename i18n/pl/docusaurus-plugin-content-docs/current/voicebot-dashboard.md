...
Interesujesz się **botem głosowym** lub już go posiadasz, ale brakuje Ci pełnego przeglądu administracji i łatwego dostępu do wszystkich potrzebnych opcji? Zwłaszcza na początku może to być wyzwanie. Spokojnie, poniżej dostarczymy Ci szczegółowe wprowadzenie do zarządzania Twoim serwisem, dzięki czemu zyskasz najlepszy możliwy przegląd.

Po przejściu przez ten poradnik, bez problemu będziesz mógł efektywnie zarządzać swoim botem głosowym i szybko oraz łatwo znajdować wszystkie potrzebne opcje i funkcje. Otrzymasz tu uporządkowany przegląd, który krok po kroku pomoże Ci zapoznać się z administracją Voicebota i celowo poszerzać swoją wiedzę. Dzięki temu zapewnisz, że Twój **bot głosowy** będzie optymalnie skonfigurowany pod Twoje potrzeby i wyciągniesz maksimum z dostępnych opcji.

<InlineVoucher />

## Administracja produktu

W sekcji **Administracja produktu** znajdziesz wszystkie niezbędne strony do zarządzania swoim botem głosowym. Poniżej szczegółowo wymienione są opcje zarządzania Twoim botem.

### Panel główny

**Panel główny** Voicebota służy jako centralny przegląd zarządzania. Dostarcza wszystkie podstawowe i kluczowe informacje o Voicebocie w przejrzystym formacie, w tym status online, dane do logowania, link do zewnętrznego interfejsu webowego oraz wykorzystanie dysku.

![img](https://screensaver01.zap-hosting.com/index.php/s/YnXaQDPywcoxFPP/preview)

### Interfejs webowy

Większość funkcji Voicebota jest dostępna przez zewnętrzny interfejs webowy. Ten interfejs pozwala wybrać źródło muzyki oraz przesyłać sugestie dotyczące ulepszeń bota. Możliwe jest także zmienienie hasła do dostępu do interfejsu webowego oraz reinstalacja Voicebota.

![img](https://screensaver01.zap-hosting.com/index.php/s/cmKrJ2YpzmZcm2L/preview)

### Serwer

Przed użyciem bota należy określić, na którym serwerze TeamSpeak ma działać. Trzeba podać adres IP i port serwera oraz dowolnie wybraną nazwę dla bota. Jeśli serwer jest chroniony hasłem, należy je podać, aby bot mógł się połączyć.
