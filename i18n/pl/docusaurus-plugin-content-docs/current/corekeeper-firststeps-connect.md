...
description: "Dowiedz się, jak bezproblemowo połączyć się z serwerem Core Keeper i rozwiązać typowe problemy, aby cieszyć się płynną rozgrywką → Sprawdź teraz"
...
Dzięki powyższym danym powinieneś bez problemu zlokalizować swój serwer i upewnić się, że łączysz się z właściwym serwerem.
...
<Tabs>
    <TabItem value="connect_solution_server_joine" label="Dołącz do gry" default>

Kliknij **Dołącz do gry** w grze i wklej skopiowane **ID gry** z pliku konfiguracyjnego `Game ID` w odpowiednie pole. 
