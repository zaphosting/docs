...
title: "Valheim: Połącz się z serwerem"
description: "Dowiedz się, jak bezproblemowo połączyć się z serwerem Valheim i zdobądź wszystkie niezbędne informacje, aby cieszyć się grą bez stresu → Sprawdź teraz"
...
Do standardowego korzystania z vanilla serwera Valheim nie jest potrzebne dodatkowe oprogramowanie. Jednak jeśli wybrałeś wariant Valheim Plus lub BepInEx, aby korzystać z pluginów, musisz również zainstalować tę rozszerzenie lokalnie. Sprawdź tutaj, jak zainstalować te rozszerzenia lokalnie dla swojej gry: 

| Rozszerzenie   | Pobierz                                                     |
| -------------- | ------------------------------------------------------------ |
...
Aby połączyć się z serwerem przez wbudowaną przeglądarkę serwerów w grze, uruchom grę. Kliknij **Start game**. Jeśli jeszcze nie stworzyłeś postaci, najpierw ją stwórz i zacznij grać. Teraz kliknij **Add server** na liście serwerów. W nowym oknie wpisz adres IP:Port swojego serwera. Po dodaniu serwera możesz połączyć się, klikając przycisk **Connect**.
...
Valheim Plus/BepInEx: Połączenie może się nie powieść, jeśli nie masz zainstalowanego wymaganego rozszerzenia na kliencie lub działa ono w innej wersji. Upewnij się, że rozszerzenie/modyfikacja jest zainstalowana i działa poprawnie. Zazwyczaj widać to w menu głównym pod nagłówkiem "Valheim Plus" wraz z wersją.



#### Brak rozwiązania lub brak pomocy

Wciąż masz problemy po próbach naprawy? W takim wypadku nasz zespół wsparcia jest dostępny codziennie, aby Ci pomóc. Po prostu stwórz **[Ticket](https://zap-hosting.com/en/customer/support/)** na naszej stronie i opisz problem jak najdokładniej. Sprawdzimy to najszybciej, jak się da, i pomożemy rozwiązać problem!
