...
title: "Astro Colony: Połącz się z serwerem"
description: "Dowiedz się, jak bezproblemowo połączyć się z serwerem Astro Colony i zacząć grać bez stresu → Sprawdź teraz"
...
Uruchom grę i przejdź do **Multiplayer**, aby otworzyć listę serwerów. Skorzystaj z pola wyszukiwania, aby znaleźć swój serwer po nazwie. Połącz się, klikając przycisk **Dołącz**.
...
Wyszukaj lub dodaj swój serwer w przeglądarce Steam, używając `adresu IP` i `portu` serwera gier. W tym celu wybierz zakładkę `Ulubione` na liście serwerów i kliknij plusik na dole. Pojawi się okienko, w którym wpiszesz dane swojego serwera. 
