...
title: "Icarus: Połącz się z serwerem"
description: "Dowiedz się, jak bezproblemowo połączyć się z serwerem Icarus i zapewnić sobie płynną rozgrywkę → Sprawdź teraz"
...
Aby połączyć się z serwerem przez wbudowaną przeglądarkę serwerów, otwórz **Przeglądarkę serwerów**. Kliknij **Graj**, stwórz postać, jeśli jeszcze tego nie zrobiłeś. Gdy znajdziesz się w przeglądarce serwerów, możesz wyszukać swój serwer po nazwie w polu wyszukiwania u góry. Wybierz swój serwer i połącz się.

![img](https://screensaver01.zap-hosting.com/index.php/s/43JboZPQY756SYi/download)

</TabItem>

<TabItem value="connect_solution_server_browser_direct" label="Bezpośrednie połączenie (w grze)" default>

Zamiast szukać serwera na liście, możesz też dodać go ręcznie, wpisując adres IP i port serwera, aby nawiązać połączenie. W tym celu kliknij **Bezpośrednie połączenie** na liście serwerów i wpisz dane.
