...
title: "Afterinfection: Połącz się z serwerem"
description: "Dowiedz się, jak łatwo i bezpiecznie połączyć się z serwerem Afterinfection dzięki niezbędnym wskazówkom i poradom → Sprawdź teraz"
...
Aby połączyć się z serwerem przez wbudowaną przeglądarkę serwerów w grze, uruchom grę i przejdź do **Multiplayer**. Teraz możesz wyszukać swój serwer na liście, wpisując nazwę serwera. 

![img](https://screensaver01.zap-hosting.com/index.php/s/yJpWzbfzD8jTSpc/download)

</TabItem>

<TabItem value="connect_solution_direct" label="Połączenie bezpośrednie (w grze)">

Zamiast szukać serwera na liście, możesz też skorzystać z połączenia bezpośredniego w zakładce **Multiplayer** w lewym dolnym rogu. Wpisz po prostu adres IP i port serwera, a następnie kliknij **Dołącz**.
