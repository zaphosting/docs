...
Aby połączyć się z serwerem, uruchom grę i przejdź do **Graj Online**. Tam wyszukaj swój serwer po nazwie na liście serwerów. Kliknij Dołącz, aby nawiązać połączenie.
...
Aby połączyć się z serwerem, uruchom grę i przejdź do **Graj Online**. Następnie kliknij **Bezpośrednie połączenie**. Wpisz adres IP i port serwera, a potem kliknij **Połącz**.
...
Gratulacje! Jeśli wykonałeś wszystkie kroki, powinieneś już być połączony z serwerem. W razie dalszych pytań lub potrzeby pomocy, nie wahaj się skontaktować z naszym supportem, który jest dostępny codziennie i chętnie pomoże! 🙂
