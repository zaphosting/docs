...
title: "Broke Protocol: Połącz się z serwerem"
description: "Dowiedz się, jak bezproblemowo połączyć się z serwerem Broke Protocol i zacznij grać bez stresu → Sprawdź teraz"
...
Aby połączyć się z serwerem, uruchom grę i przejdź do **Play Online**. Tam wyszukaj swój serwer po nazwie na liście serwerów. Kliknij Dołącz, aby nawiązać połączenie.
...
Aby połączyć się z serwerem, uruchom grę i przejdź do **Play Online**. Następnie kliknij **Direct**. Wpisz adres IP serwera i port, a potem kliknij **Connect**.
