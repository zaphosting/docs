...
Aby połączyć się z serwerem przez przeglądarkę serwerów w grze, otwórz ją w menu głównym, klikając **Znajdź serwery**. Następnie kliknij **Dodaj serwer** i wpisz adres IP:Port swojego serwera w polu. Kliknij **Dodaj ten adres do ulubionych**, aby dodać serwer do ulubionych.
...
W Counter-Strike: Source konsola jest domyślnie wyłączona. Aby ją włączyć, **przejdź do Opcje → Klawiatura i wybierz Zaawansowane**. Aby połączyć się z serwerem przez konsolę, otwórz ją klawiszem `~`. Gdy konsola się otworzy, wpisz następującą komendę:
