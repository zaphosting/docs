...
title: "Sons of the Forest: Połącz się z serwerem"
description: "Dowiedz się, jak bezproblemowo połączyć się z serwerem Sons of the Forest i rozwiązać typowe problemy, aby gra była nieprzerwana → Sprawdź teraz"
...
Aby połączyć się z serwerem, uruchom grę. Po wejściu do gry kliknij **Multiplayer**, a następnie wybierz **Join**. Kliknij na **Direct** na liście serwerów i wpisz adres IP oraz port swojego serwera w odpowiednie pole. Potwierdź wpis, aby nawiązać połączenie.
