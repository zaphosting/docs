---
id: gmod-gslt
title: "Garry’s Mod: Jak stworzyć GSLT (Steam Game Server Login Token)"
...
Po zalogowaniu możesz utworzyć nowy token, korzystając z formularza na stronie. W polu **App ID** wpisz ID aplikacji `4000`, które należy do **Garry’s Mod**. Upewnij się, że wpisałeś poprawne ID, ponieważ token nie zadziała z błędną wartością.
...
:::info Obsługa wielu serwerów Garry’s Mod
Jeśli prowadzisz kilka serwerów **Garry’s Mod**, potrzebujesz osobnego GSLT dla każdego z nich. <u>**Nie**</u> da się obsługiwać wielu serwerów gier za pomocą jednego tokena GSLT.
:::
...
Token GSLT został utworzony i zastosowany w konfiguracji Twojego serwera. W razie pytań lub potrzeby pomocy, śmiało kontaktuj się z naszym zespołem wsparcia, który jest dostępny codziennie, by Ci pomóc! 🙂
