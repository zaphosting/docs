...
Otwórz grę, aby połączyć się z serwerem. Wywołaj **listę serwerów** w grze i wpisz adres IP oraz port serwera w polu **Bezpośredni IP i port**. Następnie kliknij przycisk **Połącz**, aby nawiązać połączenie.
