...
title: "Voyagers of Nera: Zautomatyzowane wiadomości na serwerze - Informuj swoich graczy o nowościach, linkach społecznościowych i nie tylko!"
...
Dzięki **Zadaniom Zaplanowanym** wiadomości na serwerze mogą być automatycznie wysyłane na czat w grze **Voyagers of Nera** poprzez wykonywanie zdefiniowanych komend według ustalonego harmonogramu.
...
Zautomatyzowane wiadomości tworzy się przez zaplanowanie zadania, które wykonuje komendę serwera o określonym czasie lub w określonych odstępach. Komenda może służyć do wysłania wiadomości na czat, broadcastu lub powiadomienia serwerowego.
