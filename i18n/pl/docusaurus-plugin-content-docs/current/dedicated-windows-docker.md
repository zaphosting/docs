...
Podczas instalacji system zostanie zrestartowany i powinien kontynuować proces automatycznie. Po restarcie zaloguj się i jeśli skrypt o to poprosi, uruchom go ponownie, aby usługa zakończyła inicjalizację. Po zakończeniu skryptu wyświetli się taki komunikat:
...
Sprawdź status kontenera poleceniami:
...
Gratulacje! Udało Ci się zainstalować i skonfigurować Dockera na Twoim serwerze dedykowanym. Polecamy też zapoznać się z poniższymi materiałami, które mogą pomóc i wesprzeć Cię podczas konfiguracji serwera:
