...
Następnie pobierz plik. Będzie to archiwum **steamcmd.zip**, które należy rozpakować. Zalecamy utworzenie osobnego folderu, gdzie wypakujesz pliki. Po rozpakowaniu powinieneś zobaczyć plik **steamcmd.exe**. Uruchom go i poczekaj, aż proces instalacji się zakończy.
...
Kolejnym krokiem jest instalacja serwera. Wykonaj polecenie `app_update 90`. ID aplikacji **90** oznacza **serwer dedykowany Counter-Strike: Condition Zero**.
