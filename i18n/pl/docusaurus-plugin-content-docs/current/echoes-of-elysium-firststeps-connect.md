...
title: "Echoes of Elysium: Połącz się z serwerem"
description: "Dowiedz się, jak bezproblemowo połączyć się z serwerem Echoes of Elysium i rozwiązać typowe problemy, aby cieszyć się płynną rozgrywką → Sprawdź teraz"
...
![img](https://screensaver01.zap-hosting.com/index.php/s/ddyK8e4zzYNwZZ24/preview)

## Nawiąż połączenie z serwerem

Połączenie z serwerem nawiązuje się za pomocą **adresu IP** i **portu** serwera. Opcjonalnie może być wymagane hasło. W tym celu kliknij **Dołącz** w głównym menu, a następnie na dole listy serwerów wybierz **Dołącz przez adres IP**. Wprowadź adres IP, port oraz opcjonalnie hasło do swojego serwera. 
