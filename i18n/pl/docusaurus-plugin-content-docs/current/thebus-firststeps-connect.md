...
title: "The Bus: Połącz się z serwerem"
description: "Dowiedz się, jak bezproblemowo połączyć się z serwerem The Bus i rozwiązać typowe problemy, aby cieszyć się płynną rozgrywką → Sprawdź teraz"
...
Aby połączyć się z serwerem, otwórz menu **Multiplayer** w grze. Następnie naciśnij klawisz `Alt`, aby dodać nowy serwer do swojej listy. Wprowadź adres IP i port serwera, a następnie połącz się.
