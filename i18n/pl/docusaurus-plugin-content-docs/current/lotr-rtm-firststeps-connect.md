...
title: "The Lord of the Rings: Return to Moria: Połącz się z serwerem"
description: "Dowiedz się, jak bezproblemowo połączyć się z serwerem The Lord of the Rings: Return to Moria i ciesz się nieprzerwanym gameplayem → Sprawdź teraz"
...
Aby połączyć się z serwerem przez wbudowaną przeglądarkę serwerów w grze, uruchom grę. Po wejściu do gry kliknij **Graj** i stwórz Krasnala (postać), jeśli jeszcze go nie masz. Następnie kliknij **Dołącz do innego świata**, a potem **Połączenie bezpośrednie**. Wpisz adres IP i port swojego serwera w polu **Bezpośrednie dołączenie** i kliknij **Dołącz do serwera**.
