...
**Synchronizacja**
Joplin obsługuje wiele celów synchronizacji, takich jak Nextcloud, Dropbox, OneDrive czy WebDAV. Wybierz swojego ulubionego dostawcę w sekcji „Synchronizacja” i wpisz swoje dane logowania. Dzięki temu Twoje notatki będą aktualne na wszystkich urządzeniach.
...
Gratulacje! Właśnie pomyślnie zainstalowałeś i skonfigurowałeś Joplin na swoim serwerze dedykowanym. Polecamy też rzucić okiem na poniższe zasoby, które mogą dostarczyć Ci dodatkowej pomocy i wskazówek podczas konfiguracji serwera.
