...
title: "Foundry: Połącz się z serwerem"
description: "Dowiedz się, jak płynnie połączyć się z serwerem Foundry i rozwiązać typowe problemy, aby cieszyć się bezproblemową rozgrywką → Sprawdź teraz"
...
Otwórz grę i przejdź do trybu multiplayer. Kliknij **IP Połączenie bezpośrednie** i wpisz adres IP oraz port swojego serwera. 
...
Wciąż masz problemy po próbie rozwiązania? W takim wypadku nasz zespół wsparcia jest dostępny codziennie, by Ci pomóc. Po prostu stwórz **[Ticket](https://zap-hosting.com/en/customer/support/)** na naszej stronie i opisz swój problem jak najdokładniej. Sprawdzimy to najszybciej, jak się da, i pomożemy rozwiązać problem!



## Podsumowanie

Gratulacje! Jeśli wykonałeś wszystkie kroki, powinieneś już być połączony z serwerem. W razie dalszych pytań lub potrzeby pomocy, śmiało kontaktuj się z naszym zespołem wsparcia, który jest dostępny codziennie, by Ci pomóc! 🙂
