...
Tebex obsługuje następujące gry, które również oferujemy w naszym produkcie serwera gier. Po więcej informacji i innych dostępnych grach polecamy zajrzeć na oficjalną [stronę](https://www.tebex.io/game-servers). 
...
Konfiguracja Tebex z ZAP jest bardzo prosta. Instalacja i konfiguracja wymagają tylko kilku kroków, które opisujemy poniżej.
...
Tebex wyśle zaproszenie na adres e-mail powiązany z Twoim kontem klienta ZAP-Hosting. Postępuj zgodnie z instrukcjami w mailu, aby aktywować konto Tebex. Przejdziesz przez podstawową konfigurację swojego sklepu.
...
## Weryfikacja połączenia z Tebex
...
W niektórych przypadkach może być konieczne podanie klucza API wtyczki sklepu Tebex, aby nawiązać połączenie między ZAP a Twoim sklepem Tebex. Po poprawnym połączeniu zobaczysz potwierdzenie:
![](https://screensaver01.zap-hosting.com/index.php/s/4YS2SwHfSTgn4DE/preview)

## Podsumowanie

Pomyślnie połączyłeś Tebex ze swoim serwerem gier. W razie pytań lub potrzeby pomocy, śmiało kontaktuj się z naszym zespołem wsparcia, który jest dostępny codziennie, by Ci pomóc! 🙂
