...
title: "DDraceNetwork: Połącz się z serwerem"
description: "Dowiedz się, jak bezproblemowo połączyć się z serwerem DDraceNetwork i rozwiązać typowe problemy, aby cieszyć się płynną rozgrywką → Sprawdź teraz"
...
- adres IP i port
- nazwa serwera (fraza do wyszukiwania)
...
Aby połączyć się z serwerem przez przeglądarkę serwerów w grze, otwórz ją klikając **Graj** w głównym menu. Połączenie możesz nawiązać na liście serwerów, wyszukując po nazwie serwera (fraza) lub wpisując adres IP i port serwera.
