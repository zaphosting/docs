...
Admini na serwerze Hytale otrzymują status operatora, który daje im rozszerzone uprawnienia do komend. Można to zrobić przez **konsolę serwera** lub **komendy w grze** przez istniejącego operatora. Aby nadać uprawnienia operatora graczowi, wpisz w konsoli serwera lub w grze (mając odpowiednie uprawnienia):
...
Po usunięciu gracz wraca do standardowych uprawnień i nie będzie mógł korzystać z komend admina.
