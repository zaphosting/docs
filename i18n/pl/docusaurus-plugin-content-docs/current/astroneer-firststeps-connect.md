...
title: "ASTRONEER: Połącz się z serwerem"
description: "Dowiedz się, jak bezproblemowo połączyć się z serwerem ASTRONEER i rozwiązać typowe problemy, aby gra była nieprzerwana → Sprawdź teraz"
...
Aby połączyć się z serwerem przez wbudowaną przeglądarkę serwerów w grze, otwórz **przeglądarkę serwerów** w menu głównym. Kliknij **Dodaj serwer dedykowany** na liście serwerów, aby dodać swój serwer. Wprowadź adres IP i port serwera oraz nazwę. Następnie kliknij **Dodaj serwer**, wybierz dodany serwer i nawiąż połączenie.
