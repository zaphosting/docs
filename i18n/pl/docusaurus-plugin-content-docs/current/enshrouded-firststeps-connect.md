...
## Wprowadzenie
Nie wiesz, jak połączyć się ze swoim serwerem **Enshrouded** lub czego potrzebujesz, żeby zacząć? Spoko, mamy to ogarnięte! Przeprowadzimy Cię przez wszystko, co potrzebne. Od niezbędnych narzędzi i informacji, po sam proces łączenia, wraz z ważnymi wskazówkami, które zapewnią płynne i bezproblemowe połączenie. Skorzystaj z naszego poradnika i połączysz się w mgnieniu oka!
...
Aby połączyć się z serwerem przez przeglądarkę serwerów w grze, uruchom grę. Następnie kliknij **Graj**, wybierz **Dołącz** w opcji gry, a potem kliknij **Szukaj nazwy serwera** po prawej stronie. Otworzy się okienko, w którym wpisujesz nazwę swojego serwera i klikasz szukaj. Twój serwer powinien się wtedy pojawić.
...
Wyszukaj lub dodaj swój serwer przez przeglądarkę Steam, używając `adresu IP` i `portu` swojego serwera gier. W tym celu wybierz zakładkę `Ulubione` na liście serwerów i kliknij plusik na dole. Otworzy się okienko, w którym wpisujesz dane swojego serwera.
