...
title: "SCP: Containment Breach: Połącz się z serwerem"
description: "Dowiedz się, jak bezproblemowo połączyć się z serwerem SCP: Containment Breach i zapewnić sobie płynną rozgrywkę → Sprawdź teraz"
...
Uruchom grę i przejdź do opcji **Multiplayer**. Wybierz opcję **Direct connect** na liście serwerów i wpisz adres IP oraz port swojego serwera. Następnie nawiąż połączenie, klikając przycisk **Connect**.
...
Wciąż masz problemy po próbach rozwiązania? W takim wypadku nasz zespół wsparcia jest dostępny codziennie, aby Ci pomóc. Po prostu utwórz **[Ticket](https://zap-hosting.com/en/customer/support/)** na naszej stronie i opisz swój problem jak najdokładniej. Sprawdzimy to najszybciej, jak się da, i pomożemy rozwiązać problem!
