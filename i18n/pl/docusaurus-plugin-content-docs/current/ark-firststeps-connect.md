...
Aby połączyć się z serwerem przez przeglądarkę serwerów w grze, otwórz ją w menu głównym. Kliknij **Dołącz do Ark** i wpisz nazwę swojego serwera gier w polu **Filtr nazwy** u góry. Następnie wybierz serwer i kliknij przycisk **Dołącz**.
...
Wyszukaj lub dodaj swój serwer przez przeglądarkę Steam, korzystając z `adresu IP` i `portu` swojego serwera gier. W tym celu wybierz zakładkę `Ulubione` na liście serwerów i kliknij symbol plusa na dole. Otworzy się okno, w którym wpiszesz dane swojego serwera.
...
Obecnie nie jest możliwe połączenie się z serwerami ARK przez EPIC Launcher, jeśli są zabezpieczone hasłem serwera. 
:::
</TabItem>
</Tabs>
