...
title: "Avorion: Połącz się z serwerem"
description: "Dowiedz się, jak płynnie i bezpiecznie połączyć się z serwerem Avorion, aby cieszyć się nieprzerwanym gameplayem → Sprawdź teraz"
...
Aby połączyć się z serwerem przez przeglądarkę serwerów w grze, otwórz ją w menu głównym. Kliknij **Multiplayer**, a następnie wybierz **Browse Servers**. Możesz użyć **pola wyszukiwania**, aby znaleźć swój serwer na liście po nazwie, a następnie połącz się klikając **Join**.
...
<TabItem value="connect_solution_direct" label="Połączenie bezpośrednie (w grze)" default>

Zamiast szukać serwera na liście, możesz połączyć się bezpośrednio podając adres IP i port. Kliknij **Multiplayer**, a następnie wybierz **Join via IP**. Otworzy się okno, w którym wpisujesz dane serwera w polu IP/Port. Dodatkowo musisz podać nazwę serwera. Na koniec kliknij **Add server**, aby dodać serwer i nawiązać połączenie.
...
Wciąż masz problemy mimo prób naprawy? W takim wypadku nasz support jest dostępny codziennie, by Ci pomóc. Po prostu załóż **[Ticket](https://zap-hosting.com/en/customer/support/)** na naszej stronie i opisz problem jak najdokładniej. Sprawdzimy to najszybciej jak się da i pomożemy rozwiązać problem!
