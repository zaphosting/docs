...
description: "Dowiedz się, jak płynnie i bezpiecznie połączyć się z serwerem Avorion, aby grać bez przerw → Sprawdź teraz"
...
Zamiast szukać serwera na liście, możesz połączyć się bezpośrednio, wpisując adres IP i port. Kliknij **Multiplayer**, a potem wybierz **Join via IP**. Otworzy się okno, w którym wpisujesz dane serwera w polu IP/Port. Dodatkowo musisz podać nazwę serwera. Następnie kliknij **Add server**, aby dodać serwer i nawiązać połączenie. 
