...
title: "Killing Floor 2: Zautomatyzowane wiadomości na serwerze – Informuj swoich graczy o nowościach, linkach społecznościowych i nie tylko!"
...
Dzięki **zaplanowanym zadaniom** wiadomości na serwerze mogą być wysyłane automatycznie do czatu w grze **Killing Floor 2** poprzez wykonywanie zdefiniowanych komend według ustalonego harmonogramu.
...
Aby stworzyć zautomatyzowane wiadomości na serwerze, otwórz panel główny swojego serwera gier i przejdź do sekcji **Zaplanowane zadania**. Utwórz nowe zaplanowane zadanie i wybierz opcję wykonania **komendy**. W polu komendy wpisz komendę do wysłania wiadomości obsługiwaną przez Twój serwer gier.
...
Funkcjonalność zautomatyzowanych wiadomości na serwerze zależy od możliwości gry i dostępnych komend. Podstawowe wiadomości zaplanowane można wdrożyć za pomocą standardowych komend serwera, ale takie rozwiązanie może mieć ograniczenia w zakresie formatowania, warunków czy zaawansowanej personalizacji.
