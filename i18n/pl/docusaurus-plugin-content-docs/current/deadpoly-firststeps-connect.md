...
title: "DeadPoly: Połącz się z serwerem"
description: "Dowiedz się, jak bezproblemowo połączyć się z serwerem DeadPoly i ciesz się płynną rozgrywką → Sprawdź teraz"
...
Uruchom grę, aby połączyć się z serwerem. Kliknij **Graj** w grze, a następnie przejdź do **Znajdź grę**. Zobaczysz teraz listę serwerów, gdzie możesz wyszukać swój serwer po nazwie. Wybierz swój serwer i kliknij **Połącz**, aby nawiązać połączenie.
...
Uruchom grę, aby połączyć się z serwerem. Kliknij **Graj** w grze, a następnie przejdź do pola **IP:Port**. Wpisz tam adres IP i port swojego serwera, a następnie kliknij przycisk **Połącz**.
