...
title: "Serwer dedykowany: Rozwiązywanie problemów sieciowych - Brak ICMPv4 Echo – Serwer widoczny jako offline"
...
Systemy monitorujące polegają na tych odpowiedziach, aby określić dostępność serwera, dlatego serwer może być widoczny jako offline, mimo że usługi na nim działają normalnie.



## Rozwiązanie

Aby rozwiązać ten problem, trzeba utworzyć regułę zapory, która zezwoli na żądania ICMPv4 Echo. Zacznij od połączenia się przez konsolę HTML5 w panelu iLO. Kliknij **HTML5** w panelu głównym i zaloguj się swoimi standardowymi danymi logowania.
...
Podczas tworzenia reguły wybierz **Niestandardowa** jako typ reguły. W kolejnym kroku wybierz typ protokołu **ICMPv4**. Po wybraniu protokołu otwórz ustawienia **Dostosuj** i włącz opcję **Żądanie Echo**, która pozwala serwerowi odpowiadać na żądania ping.
...
Na koniec nadaj regule jasną nazwę, np. `Zezwól na żądania ICMPv4 Echo`. Po zakończeniu kreatora nowa reguła od razu pozwoli na przychodzące żądania ICMP Echo.
...
Gratulacje! Tworząc regułę ICMPv4 Echo w zaporze Windows, zapewniłeś, że Twój Windowsowy serwer dedykowany może ponownie odpowiadać na żądania ping.

Dzięki temu systemy monitorujące poprawnie wykrywają dostępność Twojego serwera i zapobiegasz sytuacji, w której serwer widoczny jest jako offline w panelu administracyjnym.
