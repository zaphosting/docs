...
title: "Abiotic Factor: Połącz się z serwerem"
description: "Dowiedz się, jak bezproblemowo połączyć się z serwerem Abiotic Factor i ciesz się nieprzerwanym gameplayem → Sprawdź teraz"
...
Aby połączyć się z serwerem, uruchom grę i z głównego menu wybierz **Enter the Facility**. Następnie kliknij **Join a Server**, aby otworzyć listę serwerów. W polu wyszukiwania wpisz nazwę swojego serwera, a gdy się pojawi, kliknij **Join**, aby nawiązać połączenie.

![img](https://screensaver01.zap-hosting.com/index.php/s/AScDLr65YwcAwBn/download)

</TabItem>

<TabItem value="connect_solution_server_direct" label="Połączenie bezpośrednie (w grze)">

Aby połączyć się z serwerem, uruchom grę i z głównego menu wybierz **Enter the Facility**. Następnie kliknij **Join a Server**, aby otworzyć listę serwerów. Wybierz **Direct Connect**, wpisz adres IP i port serwera, a następnie kliknij **Join**, aby nawiązać połączenie.
