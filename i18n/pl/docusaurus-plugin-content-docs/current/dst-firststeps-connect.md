...
description: "Dowiedz się, jak bezproblemowo połączyć się z serwerem Don't Starve Together i ciesz się nieprzerwanym gameplayem → Sprawdź teraz"
...
Aby połączyć się z serwerem przez przeglądarkę serwerów w grze, otwórz ją w menu głównym. Kliknij **Przeglądaj gry**. Następnie wyszukaj swój serwer w **polu wyszukiwania** wpisując nazwę serwera i kliknij **Dołącz**.
