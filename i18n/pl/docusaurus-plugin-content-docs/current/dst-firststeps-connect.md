...
title: "Don't Starve Together: Połącz się z serwerem"
description: "Dowiedz się, jak bezproblemowo połączyć się z serwerem Don't Starve Together i cieszyć się nieprzerwanym gameplayem → Sprawdź teraz"
...
Aby połączyć się z serwerem przez wbudowaną przeglądarkę serwerów w grze, otwórz przeglądarkę serwerów w menu głównym. Kliknij **Przeglądaj gry**. Następnie wyszukaj swój serwer, wpisując jego nazwę w **pole wyszukiwania**, a potem kliknij **Dołącz**.
