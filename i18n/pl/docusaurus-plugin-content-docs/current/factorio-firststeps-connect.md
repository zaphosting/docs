...
title: "Factorio: Połącz się z serwerem"
description: "Dowiedz się, jak bezproblemowo połączyć się z serwerem Factorio i rozwiązać typowe problemy, aby cieszyć się płynną rozgrywką → Sprawdź teraz"
...
<Tabs>
    <TabItem value="connect_solution_server_direct" label="Połączenie bezpośrednie (w grze)" default>

Otwórz grę, aby połączyć się z serwerem. W grze przejdź do **Multiplayer**, a następnie do **Połącz z adresem**. Tam wpisz adres IP i port swojego serwera w odpowiednie pole. Potwierdź dane i nawiąż połączenie, klikając przycisk **Połącz**.  
