...
title: "BeamMP: Zautomatyzowane wiadomości na serwerze - Informuj swoich graczy o nowościach, linkach społecznościowych i nie tylko!"
...
Dzięki **Zadaniom zaplanowanym** wiadomości na serwerze mogą być automatycznie wysyłane na czat w grze **BeamMP** poprzez wykonywanie zdefiniowanych komend według ustalonego harmonogramu.
...
Zamień komendę na komendę gry lub rozszerzenia, której chcesz użyć do wywoływania wiadomości, a `<tekst Twojej wiadomości>` na treść, którą mają zobaczyć gracze.
