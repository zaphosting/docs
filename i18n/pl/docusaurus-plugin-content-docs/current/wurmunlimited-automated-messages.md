...
title: "Wurm Unlimited: Zautomatyzowane wiadomości na serwerze - Informuj swoich graczy o nowościach, linkach społecznościowych i nie tylko!"
...
Dzięki **Zaplanowanym Zadaniom** wiadomości na serwerze mogą być automatycznie wysyłane na czat w grze **Wurm Unlimited** poprzez wykonywanie zdefiniowanych komend według ustalonego harmonogramu.
...
Zautomatyzowane wiadomości tworzy się, planując zadanie, które wykonuje komendę serwera o określonym czasie lub w określonych odstępach. Komenda może służyć do wysłania wiadomości na czat, ogłoszenia lub powiadomienia serwerowego.
...
Następnie możesz określić, jak często wiadomość ma być wysyłana, np. co kilka minut, co godzinę lub o określonych godzinach w ciągu dnia. Szczegółowe instrukcje dotyczące tworzenia zaplanowanych zadań znajdziesz w [poradniku Zaplanowane zadania](gameserver-scheduled-tasks.md).
...
Odstęp między wiadomościami można zmieniać w dowolnym momencie bez konieczności restartu serwera, co pozwala na elastyczne dostosowywanie w miarę rozwoju serwera.



## Ważne uwagi

Funkcjonalność zautomatyzowanych wiadomości na serwerze zależy od możliwości gry i dostępnych komend. Podstawowe zaplanowane wiadomości można wdrożyć za pomocą standardowych komend serwera, ale takie podejście może mieć ograniczenia w zakresie formatowania, warunków czy zaawansowanej personalizacji.
