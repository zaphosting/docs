...
title: "Minecraft: Zautomatyzowane wiadomości na serwerze - Informuj swoich graczy o nowościach, linkach społecznościowych i nie tylko!"
...
Dzięki **Zadaniom Zaplanowanym** wiadomości na serwerze mogą być automatycznie wysyłane na czat w grze **Minecraft** poprzez wykonywanie zdefiniowanych komend według ustalonego harmonogramu.
...
Zamień komendę na komendę gry lub komendę z rozszerzenia, której chcesz użyć do wywoływania wiadomości, a `<tekst Twojej wiadomości>` na treść, którą chcesz, aby zobaczyli gracze.
