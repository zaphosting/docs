...
Aby połączyć się z serwerem, musisz uruchomić grę. Po wejściu do gry wybierz opcję **Multi Play**. Kliknij w pole **IP:Port** w lewym dolnym rogu i wpisz dane swojego serwera gier. Potwierdź wpis klawiszem `Enter`.
