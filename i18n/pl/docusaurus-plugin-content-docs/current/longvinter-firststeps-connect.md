...
title: "Longvinter: Połącz się z serwerem"
description: "Dowiedz się, jak bezproblemowo połączyć się z serwerem Longvinter i rozwiązać typowe problemy, aby cieszyć się płynną rozgrywką → Sprawdź teraz"
...
Aby połączyć się z serwerem przez wbudowaną przeglądarkę serwerów w grze, otwórz ją w menu głównym. Kliknij na **Połącz przez IP** w prawym górnym rogu listy serwerów i wpisz adres IP oraz port swojego serwera. Potwierdź wpis klawiszem `Enter`, aby nawiązać połączenie.
