...
Postępuj zgodnie z wyświetlanymi krokami, aby zakończyć instalację. Gdy Homebrew zostanie poprawnie zainstalowany, możesz użyć go do instalacji MTR, wpisując w terminalu:
