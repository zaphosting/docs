...
title: "HumanitZ: Zautomatyzowane wiadomości serwera - Informuj swoich graczy o nowościach, linkach społecznościowych i nie tylko!"
...
Dzięki **Zadaniom Zaplanowanym** wiadomości serwera mogą być automatycznie wysyłane na czacie w grze **HumanitZ** poprzez wykonywanie zdefiniowanych komend według ustalonego harmonogramu.
...
Funkcjonalność zautomatyzowanych wiadomości serwera zależy od możliwości gry i dostępnych w niej komend. Podstawowe wiadomości zaplanowane można wdrożyć za pomocą standardowych komend serwera, jednak takie podejście może mieć ograniczenia w zakresie formatowania, warunków czy zaawansowanej personalizacji.
