...
Aby usunąć dostęp dla użytkownika, usuń go z whitelisty za pomocą dedykowanej komendy.
...
Jeśli wszystkie powyższe kroki zostały wykonane poprawnie, whitelist jest aktywna i masz pełną kontrolę nad tym, kto może dołączyć do serwera. Jeśli dostęp nadal nie działa jak należy, zrestartuj serwer jeszcze raz i sprawdź plik lub wyjście komend, aby potwierdzić, że zmiana została zastosowana.
