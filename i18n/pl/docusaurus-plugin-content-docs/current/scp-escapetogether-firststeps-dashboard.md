...
Po przejściu przez ten poradnik, z łatwością będziesz mógł efektywnie zarządzać swoim serwerem i szybko oraz łatwo znaleźć wszystkie potrzebne opcje i funkcje. Otrzymasz tu uporządkowany przegląd, który krok po kroku pomoże Ci zapoznać się z administracją serwera i celowo poszerzać swoją wiedzę. Dzięki temu zapewnisz, że Twój **serwer gier SCP: Escape Together** będzie optymalnie dopasowany do Twoich potrzeb i wykorzystasz dostępne możliwości w 100%.
...
W panelu głównym masz też opcję uruchomienia, zatrzymania lub restartu usługi, co daje Ci pełną kontrolę nad jej działaniem. Ponadto możesz uzyskać dostęp do konsoli na żywo, aby otrzymywać informacje o stanie serwera w czasie rzeczywistym i w razie potrzeby podjąć natychmiastowe działania.
...
Twój serwer był chwilowo offline i nie wiesz dlaczego? Sprawdzenie dziennika zdarzeń i plików logów nic nie wyjaśniło? Możliwe, że przyczyna problemu nie leży bezpośrednio po stronie Twojego serwera, lecz systemu hostującego, na którym działa.
...
Chcesz zaplanować restarty serwera na konkretne godziny? Planer restartów pozwala ustawić automatyczne restarty serwera gier o wybranych porach lub w regularnych odstępach.
...
Oprócz serwerów gier oferujemy też 10 wliczonych w cenę baz danych. Bazy te są potrzebne np. wtedy, gdy dane muszą być przechowywane w bazie. W zakładce **Bazy danych** możesz utworzyć bazę i zobaczyć dane dostępowe. Masz też opcję włączenia backupu i importu istniejących kopii zapasowych bazy.
...
Domyślnie dla naszych serwerów gier zapewniamy 10 GB miejsca na serwerze do przechowywania kopii zapasowych. Jeśli potrzebujesz więcej przestrzeni, możesz ją dokupić. Dzięki temu masz pewność, że zawsze masz wystarczająco miejsca na backupy i w razie potrzeby dostęp do starszych kopii.
