---
id: killingfloor2-automated-messages
title: "Killing Floor 2: Mensajes Automáticos en el Servidor - ¡Mantén a tus jugadores informados sobre noticias, enlaces sociales y más!"
...
Usando **Tareas Programadas**, los mensajes del servidor pueden enviarse automáticamente al chat dentro del juego de **Killing Floor 2** ejecutando comandos predefinidos en un horario recurrente.
...
Si el juego soporta plugins, mods o extensiones que ofrecen más flexibilidad y opciones de personalización, puede valer la pena usar esas soluciones. En esos casos, los sistemas de mensajería especializados pueden ofrecer funciones más completas que los comandos por defecto del juego y ser más adecuados para configuraciones de servidor complejas o altamente personalizadas.
