...
title: "Sons of the Forest: Vista general del panel"
description: "Descubre cómo gestionar eficientemente tu servidor de Sons of the Forest con una visión clara de funciones y opciones → Aprende más ahora"
sidebar_label: Panel
services:
...
En la sección de **Herramientas** de tu panel de navegación encontrarás varios subapartados que te ayudarán a gestionar tu servidor. Incluyen **Explorador FTP**, **Bases de datos** y **Copias de seguridad**. A continuación te damos una introducción detallada a estas áreas.
