...
title: "Palworld: Vista General del Panel"
description: "Descubre cómo gestionar y optimizar eficientemente tu servidor de Palworld para el mejor rendimiento y experiencia de usuario → Aprende más ahora"
sidebar_label: Panel
services:
  - gameserver-palworld
---
...
**FileZilla:** FileZilla es el cliente FTP más fácil y conocido. Solo instala, abre y escribe tus datos de acceso en la barra superior, que encontrarás un poco más arriba en esta página. Tras un clic rápido en "Conectar", entras directamente al servidor y puedes gestionar los archivos.
...
En la configuración puedes especificar si las copias se crean automáticamente y si debe ser diario o semanal. Además, puedes decidir si se eliminan las copias más antiguas cuando el espacio de almacenamiento disponible se limite.
