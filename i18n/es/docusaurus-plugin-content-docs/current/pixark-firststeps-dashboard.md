...
title: "PixARK: Vista general del panel"
description: "Descubre cómo gestionar y optimizar tu servidor de PixARK de forma eficiente con una visión clara de todas las funciones clave → Aprende más ahora"
sidebar_label: Panel
services:
  - gameserver-pixark
---
...
En el panel también tienes la opción de arrancar, parar o reiniciar tu servicio para tener control total sobre su funcionamiento. Además, puedes acceder a la consola en vivo para obtener información en tiempo real sobre el estado del servidor y actuar directamente si es necesario.
...
:::warning
El uso del Gestor DDoS solo es posible si tienes una IP propia o la opción "Vista general del Gestor DDoS" contratada como extra. Si te faltan estos componentes en tu paquete actual, puedes añadirlos en cualquier momento con una actualización.
:::
...
El **Registro de eventos** te ofrece una visión completa de todas las actividades relacionadas con la administración del servidor. Aquí puedes ver en cualquier momento cuándo un servidor arrancó, se paró o se cayó, así como cuándo se hicieron actualizaciones, copias de seguridad o nuevas instalaciones.
...
En configuraciones tienes una visión general de las opciones más comunes para tu servidor, con una breve explicación. Esta página es especialmente recomendada para quienes están empezando en la administración de servidores.
