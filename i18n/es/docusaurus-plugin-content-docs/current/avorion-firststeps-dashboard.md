...
title: "Avorion: Vista general del panel"
description: "Descubre cómo gestionar y optimizar eficientemente tu servidor de juegos Avorion con una vista clara de todas las funciones esenciales → Aprende más ahora"
sidebar_label: Panel
services:
...
En **Copias de seguridad** puedes crear copias manuales y automáticas para tu servidor y su base de datos asociada. Esto facilita la recuperación de datos en caso de problemas o pérdida de información.
