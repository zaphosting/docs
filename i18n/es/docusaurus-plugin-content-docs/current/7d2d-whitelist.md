...
## Gestionando jugadores en lista blanca
...
Si prefieres usar comandos, abre la Consola en vivo en la gestión del servidor de juegos ZAP-Hosting y usa los comandos integrados de lista blanca para añadir o eliminar jugadores. Los cambios hechos por comandos se reflejarán en los mismos datos de lista blanca que usa el servidor al reiniciarse.
...
Si el servidor aún permite jugadores no listados, revisa que tus entradas de lista blanca no estén comentadas y que hayas editado el `serveradmin.xml` correcto para la partida activa.
