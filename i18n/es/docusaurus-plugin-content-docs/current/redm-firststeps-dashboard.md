...
¿Tu servidor estuvo offline temporalmente y no sabes por qué? ¿Miraste el registro de eventos y archivos de registro y no encontraste nada? Puede que la causa no esté directamente en tu servidor, sino en el sistema anfitrión donde se ejecuta.
...
El editor de archivos de configuración te permite editar los archivos directamente desde la web en la forma clásica, sin la vista simplificada. Esta opción te permite personalizar las configuraciones de tu servidor según tus preferencias.
...
**FileZilla:** FileZilla es el cliente FTP más fácil y conocido. Solo instálalo, ábrelo e ingresa tus datos de acceso en la barra superior, que encontrarás un poco más arriba en esta página. Tras un clic rápido en "Conectar", estarás conectado directamente al servidor y podrás gestionar los archivos.
...
Además de nuestros productos de servidor de juegos, ofrecemos 10 bases de datos incluidas. Estas bases de datos son necesarias, por ejemplo, cuando se deben almacenar datos en una base. En **Bases de datos** puedes crear una base y ver las credenciales de acceso. También puedes activar la opción de copia de seguridad e importar copias existentes.
