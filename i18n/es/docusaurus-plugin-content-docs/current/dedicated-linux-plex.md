...
Después de la configuración, también puedes acceder a tu Plex Media Server externamente abriendo la interfaz web en un navegador vía `http://<dirección-ip>:32400`. Sustituye `<dirección-ip>` por la IP pública de tu servidor.
