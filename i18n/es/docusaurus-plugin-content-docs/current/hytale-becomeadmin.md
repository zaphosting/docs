...
Si un jugador ya no necesita acceso de admin o no debería tener permisos elevados, su estatus de operador puede ser removido en cualquier momento:

```
/op remove <nombrejugador>
```

Una vez removido, el jugador volverá a los niveles de permiso estándar y ya no podrá usar comandos de admin.
