...
title: "VPS: Configuración de Servidor Dedicado Counter-Strike 2 en Windows"
...
Cuando aparezca el mensaje **Loading Steam API.... OK**, el proceso se completó con éxito y puedes comenzar con la instalación del servidor de Counter-Strike 2.
...
El siguiente paso es la instalación. Esto se hace con el comando `app_update 730`. El ID de la app **730** corresponde a la aplicación del **Servidor Dedicado de Counter-Strike 2**.
...
¡Felicidades, has instalado y configurado con éxito el servidor de Counter-Strike 2 en tu VPS! Para cualquier duda o ayuda, no dudes en contactar a nuestro equipo de soporte, que está disponible todos los días para ayudarte 🙂.
