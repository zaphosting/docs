...
title: "Contagion: Problemas comunes"
description: "Descubre cómo solucionar y resolver problemas comunes en servidores de Contagion para mantener tu juego funcionando sin interrupciones → Aprende más ahora"
...
Las copias de seguridad regulares pueden evitar mucho estrés y preocupaciones. Crea copias de seguridad periódicas para asegurarte de que, en caso de cualquier problema, aún tengas una versión anterior donde todo funcionaba bien. Ofrecemos una [solución de backup](  - gameserver-corekeeper-backups.md) para nuestros servidores de juegos de Contagion, que puedes usar para crear copias manuales o automáticas programadas.
