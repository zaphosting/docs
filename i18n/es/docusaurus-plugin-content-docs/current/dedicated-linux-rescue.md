...
Si estás trabajando en una red de confianza, la solución más fácil y rápida es detener el servicio del firewall en SystemRescue con el siguiente comando:
...
Cuando te conectas a un servidor vía **SFTP** por primera vez, WinSCP muestra esta alerta de seguridad. La advertencia aparece porque la **clave del host** del servidor aún no está almacenada en tu caché local.
...
Ahora que estás conectado, navega al **directorio de rescate** que creaste antes. Desde ahí tendrás acceso a tus archivos y podrás empezar a descargarlos a tu máquina local. Simplemente explora las carpetas, selecciona los datos que quieres respaldar y transfiérelos de forma segura vía SFTP.
