...
title: "Contagion: Vista general del panel"
description: "Descubre cómo gestionar y optimizar tu servidor de Contagion de forma eficiente con una visión clara de todas las funciones y opciones clave → Aprende más ahora"
sidebar_label: Panel
services:
...
En esta sección encontrarás un historial de interrupciones del sistema host donde corre tu servidor de juegos. Más información y la versión más actual de nuestro estado de servicio la tienes en nuestra nueva [página de estado](https://status.zap-hosting.com/).
