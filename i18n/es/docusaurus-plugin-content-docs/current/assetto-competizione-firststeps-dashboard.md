...
title: "Assetto Corsa Competizione: Vista General del Panel"
description: "Descubre cómo gestionar eficientemente tu Servidor de Assetto Corsa Competizione con una vista clara de funciones y opciones → Aprende más ahora"
sidebar_label: Panel
services:
...
En esta sección encontrarás un historial de interrupciones del sistema anfitrión donde corre tu servidor de juegos. Más información y la versión más actualizada del estado de nuestros servicios la puedes consultar en nuestra nueva [página de estado](https://status.zap-hosting.com/).
...
Con la configuración DNS de ZAP puedes crear direcciones fáciles de recordar para tu servicio. Puedes usar un subdominio de uno de nuestros dominios o crear una entrada DNS en tus propios dominios para tener una dirección que se asocie mejor contigo.
