...
title: "SCP 5K: Vista General del Panel"
description: "Descubre cómo gestionar eficientemente tu servidor SCP: 5K con una visión clara de funciones y opciones → Aprende más ahora"
sidebar_label: Panel
services:
  - gameserver-scp5k
---
...
:::warning
El uso del Gestor DDoS solo es posible si tienes una IP propia o la opción "Vista General Gestor DDoS" contratada como extra. Si estos componentes faltan en tu paquete actual, puedes añadirlos en cualquier momento con una actualización.
:::
...
La **Consola en Vivo** te muestra en tiempo real todos los eventos actuales en tu servidor. Aquí puedes ver información sobre las actividades de los jugadores, así como posibles mensajes de error y mensajes del sistema. Esta vista te permite tener un panorama completo de lo que está pasando en tu servidor y detectar problemas a tiempo.
...
El editor de archivos de configuración te permite editar directamente los archivos desde la web, sin la vista simplificada. Esta opción te da control total para personalizar las configuraciones de tu servidor según tus preferencias.

Con el editor tienes acceso directo a todas las opciones disponibles y puedes ajustarlas con precisión. Esto es ideal para usuarios avanzados que quieren control total y saben exactamente qué cambiar.
...
Con el **Explorador FTP** obtendrás toda la información necesaria para conectarte al acceso FTP. El acceso FTP te permite acceder directamente a los archivos de tu servidor de juegos. Recomendamos usar un programa FTP externo como **Filezilla** o **WinSCP** para un uso óptimo. Si no estás familiarizado con FTP, puede ayudarte la guía de [Acceso vía FTP](gameserver-ftpaccess.md).

![](https://screensaver01.zap-hosting.com/index.php/s/sX85i9HyzR9wmAM/preview)

**FileZilla:** FileZilla es probablemente el cliente FTP más sencillo y conocido. Solo instálalo, ábrelo y en la barra superior introduce tus datos de acceso que encontrarás un poco más arriba en esta página. Con un clic en "Conectar" estarás dentro del servidor y podrás gestionar los archivos.

**WinSCP:** WinSCP está pensado para SCP y SFTP (las versiones cifradas del protocolo FTP), pero también funciona perfectamente con FTP normal. Es un programa un poco más completo que FileZilla y más adecuado para usuarios avanzados.
...
En la sección **Enlaces Útiles** encontrarás más enlaces relevantes para tu producto.
