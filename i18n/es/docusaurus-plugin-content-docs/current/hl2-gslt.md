---
id: hl2-gslt
title: "Half-Life 2: Crear un GSLT (Steam Game Server Login Token)"
description: "Entiende cómo autenticar tu servidor de juegos con un Steam Game Server Login Token para un listado correcto y protección VAC → Aprende más ahora"
...
Una vez dentro, tienes la opción de crear un nuevo token usando el formulario que aparece en la página. En el campo **App ID**, introduce el ID de la app `320`, que corresponde a **Half-Life 2**. Asegúrate de ingresar el ID correcto, ya que el token no funcionará con un valor incorrecto.
...
:::info Operar múltiples servidores de Half-Life 2
Si operas múltiples servidores de **Half-Life 2**, necesitarás un GSLT para cada servidor. <u>**No**</u> es posible operar varios servidores de juegos con un solo GSLT.
:::
