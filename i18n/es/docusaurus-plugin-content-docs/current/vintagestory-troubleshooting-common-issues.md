...
title: "Vintage Story: Problemas comunes"
description: "Descubre cómo solucionar problemas comunes en servidores de Vintage Story y mantener una experiencia de juego fluida para tu comunidad → Aprende más ahora"
...
Los crashes a menudo son causados por extensiones defectuosas o desactualizadas. Ya sea un framework, plugin, mod o recurso, pueden surgir problemas si la extensión no es compatible con la última versión del juego o tiene bugs en su código.
...
Las copias de seguridad regulares evitan mucho estrés y preocupaciones. Haz backups frecuentes para asegurarte de que, en caso de cualquier problema, tengas una copia de una versión anterior cuando todo funcionaba bien. Ofrecemos una [solución de backup](gameserver-backups.md) para nuestros servidores de juegos Vintage Story, que puedes usar para crear copias manuales o automáticas programadas.
