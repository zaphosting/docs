...
En esta sección encontrarás un historial de interrupciones del sistema anfitrión donde corre tu servidor de juegos. Más información y la versión más actualizada de nuestro estado de servicio la tienes en nuestra nueva [página de estado](https://status.zap-hosting.com/).
...
Además, puedes activar la función de notificación por correo electrónico para actualizaciones automáticas y así estar siempre informado y al día.
