...
title: "Echoes of Elysium: Vista General del Panel"
description: "Descubre cómo gestionar y optimizar eficientemente tu servidor de Echoes of Elysium para la mejor experiencia de juego → Aprende más ahora"
sidebar_label: Panel
services:
...
¿Tu servidor estuvo offline temporalmente y no sabes por qué? ¿Miraste en el registro de eventos y archivos de registro y no encontraste nada? Puede que la causa no esté directamente en tu servidor, sino en el sistema host donde se ejecuta.
...
En esta sección encontrarás un historial de interrupciones del sistema host donde corre tu servidor de juegos. Más información y la versión más reciente del estado de nuestros servicios la tienes en nuestra nueva [página de estado](https://status.zap-hosting.com/).
...
En **Juegos** siempre tienes la posibilidad de cambiar la variante del juego de tu servidor actual o instalar otro juego en general. Los juegos con el mismo precio por slot se pueden seleccionar directamente en **Juegos Disponibles**. Para todos los demás juegos, primero se debe ajustar el precio por slot. Más información sobre esto la encuentras en la guía de [Cambio de Juego](gameserver-gameswitch.md).
...
La sección de **Preguntas frecuentes** ofrece un resumen de las preguntas más comunes de nuestros clientes. Aquí encontrarás respuestas útiles e información detallada sobre varios temas para ayudarte rápido y eficientemente.
