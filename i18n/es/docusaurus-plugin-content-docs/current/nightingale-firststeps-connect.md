...
title: "Nightingale: Conéctate al servidor"
description: "Descubre cómo conectarte sin problemas a tu servidor Nightingale y soluciona problemas comunes para una experiencia de juego fluida → Aprende más ahora"
...
## Introducción
¿No sabes cómo conectarte a tu servidor **Nightingale** o qué necesitas para empezar? ¡No te preocupes, aquí te ayudamos! Te guiaremos por todo lo que necesitas. Desde las herramientas e información necesarias hasta el proceso real de conexión, junto con consideraciones clave para asegurar una conexión fluida y sin problemas. Sigue nuestra guía y estarás conectado en un abrir y cerrar de ojos.
...
<Tabs>
    <TabItem value="connect_solution_server_browser_ingame" label="En el juego" default>

Para conectarte a tu servidor, debes abrir la interfaz de usuario. Para hacerlo, presiona `F2` o `RCtrl` y navega a **Conectar**. Una vez allí, usa la IP:Puerto de tu servidor para establecer la conexión. 
