...
title: "Teeworlds: Vista general del panel"
description: "Descubre cómo gestionar y optimizar tu servidor de Teeworlds de forma eficiente con una guía clara y paso a paso → Aprende más ahora"
sidebar_label: Panel
services:
...
:::warning
El uso del Gestor DDoS solo es posible si tienes una IP propia o la opción "Visión general del Gestor DDoS" contratada como extra. Si estos componentes faltan en tu paquete actual, puedes añadirlos en cualquier momento con una actualización.
:::
...
En configuraciones tienes un resumen de las opciones más comunes para tu servidor. También incluyen una breve explicación. Esta página es especialmente recomendada para quienes están empezando en la administración de servidores.
...
Además, puedes activar las notificaciones por email para las actualizaciones automáticas y así estar siempre informado.
...
Además de nuestros productos de servidor de juegos, ofrecemos 10 bases de datos incluidas. Estas bases de datos son necesarias, por ejemplo, cuando se deben almacenar datos en una base de datos. En **Bases de datos** puedes crear una base de datos y ver las credenciales de acceso. También puedes activar la opción de copia de seguridad e importar copias de seguridad existentes.

![img](https://screensaver01.zap-hosting.com/index.php/s/WFLwCbZSQfYjrmD/preview)

### Copias de seguridad

En **Copias de seguridad** puedes crear copias manuales y automáticas para tu servidor y su base de datos asociada. Esto facilita recuperar tus datos en caso de problemas o pérdida de datos.
