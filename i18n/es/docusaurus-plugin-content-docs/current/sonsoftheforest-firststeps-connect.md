...
title: "Sons of the Forest: Conéctate al servidor"
description: "Descubre cómo conectarte a tu servidor de Sons of the Forest sin problemas y soluciona problemas comunes para un juego sin interrupciones → Aprende más ahora"
...
Para conectarte a tu servidor, abre el juego. Una vez dentro, haz clic en **Multijugador** y selecciona **Unirse**. Haz clic en **Directo** en la lista de servidores e ingresa la dirección IP y el puerto de tu servidor en el campo. Confirma la entrada para establecer la conexión.
