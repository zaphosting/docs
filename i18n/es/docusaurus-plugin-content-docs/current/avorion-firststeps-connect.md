...
title: "Avorion: Conéctate al servidor"
description: "Descubre cómo conectarte a tu servidor de Avorion de forma fácil y segura para un juego sin interrupciones → Aprende más ahora"
...
## Introducción
¿No sabes cómo conectarte a tu **servidor de juegos** de Avorion o qué necesitas para empezar? No te preocupes, ¡aquí te ayudamos! Te guiaremos por todo lo que necesitas: desde las herramientas e información necesarias hasta el proceso real de conexión, junto con puntos clave para asegurar una experiencia fluida y sin problemas. Sigue nuestra guía y estarás conectado en un abrir y cerrar de ojos.
...
Para conectarte a tu servidor a través del navegador de servidores dentro del juego, abre el navegador en el menú principal. Para ello, haz clic en **Multijugador** y luego selecciona **Buscar servidores**. Puedes usar el **campo de búsqueda** para encontrar tu servidor en la lista usando el nombre del servidor y luego establecer la conexión con el botón **Unirse**.
...
<TabItem value="connect_solution_direct" label="Conexión directa (En el juego)" default>

En lugar de buscar el servidor en la lista, también puedes conectarte directamente usando la dirección IP y el puerto. Para hacerlo, haz clic en **Multijugador** y luego selecciona **Unirse por IP**. Se abrirá una ventana donde debes ingresar la información de tu servidor en el campo IP/Puerto. Además, tienes que poner un nombre para el servidor. Después, haz clic en **Agregar servidor** para añadirlo y establecer la conexión.
...
¡Felicidades! Si seguiste todos los pasos, deberías haber establecido la conexión con el servidor exitosamente. Para cualquier duda o ayuda adicional, no dudes en contactar a nuestro equipo de soporte, que está disponible todos los días para asistirte 🙂
