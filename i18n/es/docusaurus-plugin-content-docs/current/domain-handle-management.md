...
Todos los cambios pueden introducirse y guardarse directamente desde la interfaz de Gestión de Handles. Los handles recién creados estarán disponibles para futuras registraciones o actualizaciones de dominios. Los handles existentes pueden actualizarse en dominios activos cuando el registro lo permita.
