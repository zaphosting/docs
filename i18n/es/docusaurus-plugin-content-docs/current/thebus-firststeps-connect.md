...
title: "The Bus: Conéctate al servidor"
description: "Descubre cómo conectarte a tu servidor de The Bus sin problemas y soluciona los problemas comunes para una experiencia de juego fluida → Aprende más ahora"
...
## Introducción
¿No sabes cómo conectarte a tu servidor de **The Bus** o qué necesitas para empezar? ¡No te preocupes, aquí te ayudamos! Te guiaremos por todo lo que necesitas: desde las herramientas e información necesarias hasta el proceso de conexión, junto con puntos clave para asegurar una conexión fluida y sin problemas. Sigue nuestra guía y estarás conectado en un abrir y cerrar de ojos.
...
Para conectarte a tu servidor, abre el menú **Multijugador** en el juego. Luego presiona la tecla `Alt` para añadir un nuevo servidor a tu lista. Introduce la dirección IP y el puerto de tu servidor, y conéctate.
