...
description: "Aprende cómo configurar un servidor dedicado de Half-Life 2 en tu VPS o servidor dedicado de forma rápida y eficiente → Descubre más ahora"
...
Cuando aparezca el mensaje **Loading Steam API.... OK**, el proceso se ha completado con éxito y puedes comenzar con la instalación del servidor de Half-Life 2.
...
El siguiente paso será la instalación. Esto se hace con el comando `app_update 232370`. El App ID **232370** corresponde a la aplicación **Half-Life 2 Dedicated Server**.
...
En esta etapa, ya has terminado la configuración básica de tu servidor de Half-Life 2. Puedes hacer configuraciones adicionales editando directamente el archivo de lanzamiento. Ve a tu directorio raíz. Dentro de este directorio navega a la carpeta cfg y abre el archivo `server.cfg`. Ahí puedes modificar las opciones del servidor.
