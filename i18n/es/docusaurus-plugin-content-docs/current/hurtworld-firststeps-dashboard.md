...
title: "Hurtworld: Vista general del panel"
description: "Descubre cómo gestionar eficientemente tu servidor de juegos Hurtworld con una visión clara de funciones y opciones → Aprende más ahora"
sidebar_label: Panel
services:
...
Por defecto, ofrecemos 10 GB de espacio en el servidor de almacenamiento para backups en nuestros productos de servidor de juegos. Si necesitas más espacio, puedes ampliarlo pagando un extra. Así te aseguras de tener siempre espacio suficiente para tus copias y acceso a backups antiguos si hace falta.
