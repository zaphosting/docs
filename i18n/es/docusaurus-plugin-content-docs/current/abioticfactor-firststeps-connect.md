...
title: "Abiotic Factor: Conéctate al servidor"
description: "Descubre cómo conectarte sin problemas a tu servidor de Abiotic Factor y disfruta de una experiencia de juego ininterrumpida → Aprende más ahora"
...
<TabItem value="connect_solution_server_direct" label="Conexión directa (En el juego)">

Para conectarte a tu servidor, inicia el juego y navega a **Enter the Facility** desde el menú principal. Luego haz clic en **Join a Server** para abrir la lista de servidores. Selecciona **Direct Connect**, ingresa la dirección IP y el puerto de tu servidor, y haz clic en **Join** para establecer la conexión.
