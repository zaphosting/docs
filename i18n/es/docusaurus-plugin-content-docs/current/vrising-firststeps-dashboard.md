...
description: "Descubre cómo gestionar eficientemente tu servidor de V Rising con una vista clara de todas las funciones y opciones → Aprende más ahora"
sidebar_label: Panel
services:
  - gameserver-vrising
---
...
Además de monitorizar eventos, también puedes enviar comandos directamente al servidor desde la **Consola en Vivo**. Esto es útil para ajustar configuraciones, realizar acciones específicas o responder rápido a problemas que surjan.
