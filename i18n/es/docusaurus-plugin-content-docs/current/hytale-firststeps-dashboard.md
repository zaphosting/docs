...
:::warning
El uso del Gestor de DDoS solo es posible si se ha contratado una IP propia o la opción "Vista General del Gestor de DDoS" como adicional. Si estos componentes faltan en tu paquete actual, puedes añadirlos en cualquier momento mediante una actualización.
:::
...
¿Tu servidor estuvo temporalmente offline y no sabes por qué? ¿Mirar el registro de eventos y los archivos de registro no dio información? Podría ser que la causa del problema no esté directamente en tu servidor, sino en el sistema anfitrión donde se ejecuta tu servidor.
...
En configuraciones encontrarás un resumen de las opciones de configuración más comunes para tu servidor. Estas incluyen también una breve explicación. El uso de la página de configuraciones es especialmente recomendado para quienes están empezando en la administración de servidores.
