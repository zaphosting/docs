...
title: "Nienix: Vista general del panel"
description: "Descubre cómo gestionar y optimizar tu servidor Nienix de forma eficiente con una visión clara de funciones y opciones → Aprende más ahora"
sidebar_label: Panel
services:
  - gameserver-nienix
---
...
En la configuración puedes especificar si las copias se crean automáticamente y si esto debe hacerse diariamente o semanalmente. Además, puedes decidir si se deben eliminar las copias más antiguas cuando sea necesario, por ejemplo, si el espacio de almacenamiento disponible se vuelve limitado.
