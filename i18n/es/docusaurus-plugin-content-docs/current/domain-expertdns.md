...
description: "Descubre cómo personalizar los servidores de nombres de tu dominio con ExpertDNS para tener mayor control y flexibilidad → Aprende más ahora"
...
La **opción ExpertDNS** ofrece la posibilidad de usar servidores de nombres externos en lugar de los proporcionados por ZAP-Hosting. Con solo unos clics puedes cambiar los servidores de nombres.
...
La opción **EasyDNS** debería estar seleccionada por defecto. Por lo tanto, primero debes seleccionar y activar la opción **ExpertDNS**.

![2022-05-07_21-58](https://screensaver01.zap-hosting.com/index.php/s/zrKagEpZx7coebe/preview)

Tan pronto como la opción esté activa, puedes cambiar los servidores de nombres predeterminados o añadir servidores de nombres adicionales (opcionales). Guarda el cambio después haciendo clic en el botón verde **Guardar**.
