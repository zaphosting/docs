...
El siguiente paso será la instalación. Esto se hace con el comando `app_update 232330`. El ID de la app **232330** corresponde a la aplicación **Counter-Strike: Source Dedicated Server**.
...
¡Felicidades, has instalado y configurado con éxito el servidor de Counter-Strike: Source en tu VPS! Para cualquier duda o ayuda, no dudes en contactar con nuestro equipo de soporte, que está disponible todos los días para ayudarte 🙂.
