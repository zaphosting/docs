...
title: "DeadPoly: Conéctate al servidor"
description: "Descubre cómo conectarte a tu servidor de DeadPoly sin complicaciones y asegura una experiencia de juego sin líos → Aprende más ahora"
...
## Introducción
¿No sabes cómo conectarte a tu **servidor de juegos DeadPoly** o qué necesitas para empezar? ¡No te preocupes, aquí te ayudamos! Te guiaremos por todo lo que necesitas: desde las herramientas e información necesarias hasta el proceso de conexión, junto con puntos clave para asegurar una conexión fluida y sin problemas. Sigue nuestra guía y estarás conectado en un abrir y cerrar de ojos.
...
Inicia el juego para conectarte a tu servidor. Haz clic en **Jugar** dentro del juego y luego navega a **Buscar partida**. Ahora verás la lista de servidores donde puedes buscar tu servidor por su nombre. Selecciona tu servidor y haz clic en **Conectar** para establecer la conexión.
...
<TabItem value="connect_solution_direct" label="Conexión directa (En el juego)">

Inicia el juego para conectarte a tu servidor. Haz clic en **Jugar** dentro del juego y luego ve al campo **IP:Puerto**. Introduce la dirección IP y el puerto de tu servidor ahí y luego haz clic en el botón **Conectar**.
