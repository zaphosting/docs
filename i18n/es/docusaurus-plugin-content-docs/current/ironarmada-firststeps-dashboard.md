...
title: "Iron Armada: Vista general del panel"
description: "Descubre cómo gestionar eficientemente tu servidor Iron Armada y optimizar sus funciones según tus necesidades → Aprende más ahora"
sidebar_label: Panel
services:
...
Si ya tienes más experiencia y quieres hacer cambios más precisos, te recomendamos usar el Editor de Configs. Más información sobre esto la tienes en la categoría **Configs**.
