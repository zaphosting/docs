---
id: tf2-gslt
title: "Team Fortress 2: Crear un GSLT (Steam Game Server Login Token)"
description: "Descubre cómo autenticar tu servidor dedicado de juegos con un Steam Game Server Login Token válido para un listado correcto y protección VAC → Aprende más ahora"
...
Una vez dentro, tienes la opción de crear un nuevo token usando el formulario que aparece en la página. En el campo **App ID**, introduce el ID de la app `440`, que corresponde a **Team Fortress 2**. Asegúrate de ingresar el ID correcto, ya que el token no funcionará con un valor incorrecto.
...
:::info Operar múltiples servidores de Team Fortress 2
Si operas varios servidores de **Team Fortress 2**, necesitarás un GSLT para cada servidor. <u>**No**</u> es posible operar varios servidores de juegos con un solo GSLT.
:::
...
El GSLT ha sido creado y aplicado a la configuración de tu servidor. Para cualquier duda o ayuda, no dudes en contactar con nuestro equipo de soporte, ¡disponible todos los días para ayudarte! 🙂
