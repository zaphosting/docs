...
title: "Servidor Dedicado: Configuración de Servidor Dedicado Day of Defeat: Source en Windows"
description: "Descubre cómo configurar un servidor dedicado de Day of Defeat: Source en tu VPS o servidor de forma rápida y eficiente → Aprende más ahora"
...
El siguiente paso será la instalación. Esto se hace con el comando `app_update 232290`. El App ID **232290** corresponde a la aplicación **Day of Defeat: Source Dedicated Server**.
...
¡Felicidades, has instalado y configurado con éxito el servidor de Day of Defeat: Source en tu VPS! Para cualquier duda o ayuda, no dudes en contactar con nuestro equipo de soporte, disponible a diario para asistirte 🙂
