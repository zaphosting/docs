...
El siguiente paso será la instalación. Esto se hace con el comando `app_update 232290`. El ID de la app **232290** corresponde a la aplicación **Servidor Dedicado de Day of Defeat: Source**.
...
¡Felicidades, has instalado y configurado con éxito el servidor de Day of Defeat: Source en tu VPS! Para cualquier duda o ayuda, no dudes en contactar a nuestro equipo de soporte, disponible todos los días para asistirte 🙂.
