...
La salida debería mostrar ahora la edición licenciada, como `ServerStandard` o `ServerDatacenter`, confirmando que la edición de evaluación se convirtió correctamente.
