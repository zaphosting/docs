...
title: "Leap: Vista general del panel"
description: "Descubre cómo gestionar eficientemente tu servidor Leap con una vista clara de funciones y opciones para un rendimiento óptimo → Aprende más ahora"
sidebar_label: Panel
services:
  - gameserver-leap
---
...
¿Tu servidor estuvo offline temporalmente y no sabes por qué? ¿Miraste el registro de eventos y los archivos de registro y no encontraste información? Puede que la causa no esté directamente en tu servidor, sino en el sistema anfitrión donde se ejecuta tu servidor de juegos.
