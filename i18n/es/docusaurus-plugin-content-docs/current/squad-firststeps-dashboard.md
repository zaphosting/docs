...
title: "Squad: Vista general del panel"
description: "Descubre cómo gestionar y optimizar tu servidor de Squad de forma eficiente con una visión clara de la administración y funciones clave → Aprende más ahora"
sidebar_label: Panel
services:
  - gameserver-squad
---
...
Si ya tienes más confianza y quieres hacer cambios más precisos, te recomendamos usar el Editor de Configs. Más información sobre esto la tienes en la categoría **Configs**.
