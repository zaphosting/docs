...
## Introducción
¿No sabes cómo conectarte a tu servidor de **Craftopia** o qué necesitas para empezar? ¡No te preocupes, aquí te ayudamos! Te guiaremos por todo lo que necesitas: desde las herramientas e información necesarias hasta el proceso de conexión, junto con puntos clave para asegurar una conexión fluida y sin problemas. Sigue nuestra guía y estarás conectado en un abrir y cerrar de ojos.
...
Para conectarte a tu servidor, abre el juego y ve a **Multijugador** en el menú principal. Una vez ahí, haz clic en **Unirse vía IP**. Introduce la dirección IP y el puerto de tu servidor y haz clic en **Iniciar**.
