...
## Introducción
¿No sabes cómo conectarte a tu **servidor de juegos SCP: Containment Breach** o qué necesitas para empezar? ¡No te preocupes, aquí te ayudamos! Te guiaremos por todo lo que necesitas: desde las herramientas e información necesarias hasta el proceso real de conexión, junto con consideraciones clave para asegurar una conexión fluida y sin problemas. Sigue nuestra guía y estarás conectado en un abrir y cerrar de ojos.
...
Inicia el juego y navega a la opción de menú **Multijugador**. Selecciona la opción **Conexión directa** en la lista de servidores e ingresa la dirección IP y el puerto de tu servidor. Luego, establece la conexión haciendo clic en el botón **Conectar**.
