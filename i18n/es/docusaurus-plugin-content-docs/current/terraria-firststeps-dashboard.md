...
title: "Terraria: Vista General del Panel"
description: "Descubre cómo gestionar y optimizar tu servidor de Terraria de forma eficiente con una guía clara y paso a paso → Aprende más ahora"
sidebar_label: Panel
services:
  - gameserver-terraria
---
...
- Configuraciones básicas: Protección adicional contra trampas, Título del Mundo, Tamaño del nuevo mundo, ¿Crear nuevo mundo?, Contraseña del servidor

Si te sientes más seguro y quieres hacer cambios más precisos, te recomendamos usar el Editor de Configs. Más info sobre esto en la categoría **Configs**.
...
Ofrecemos documentación extensa para nuestros productos, que sirve como base de conocimiento para las preguntas y dudas más frecuentes. Allí encontrarás diversas guías y ayudas sobre distintos temas que te asistirán en el uso y gestión de tu producto.
