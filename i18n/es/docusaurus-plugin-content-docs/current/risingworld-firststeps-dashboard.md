...
title: "Rising World: Vista General del Panel"
description: "Descubre cómo gestionar eficientemente tu servidor de Rising World y optimizar sus ajustes para el mejor rendimiento → Aprende más ahora"
sidebar_label: Panel
services:
  - gameserver
---
...
El editor de archivos de configuración te permite editar los archivos directamente desde la web en la forma clásica, sin la vista simplificada. Esta opción te permite personalizar los ajustes de tu servidor y configurarlos según tus preferencias personales.
...
:::warning
¿Has notado que algunos de tus cambios se sobrescriben parcialmente? Ten en cuenta que ciertos valores de opciones se toman de la página de ajustes. Si quieres hacer estos cambios directamente en la config, primero debes desactivar las opciones correspondientes en la página de ajustes.
:::
...
En los ajustes puedes especificar si las copias de seguridad deben crearse automáticamente y si esto debe hacerse diariamente o semanalmente. Además, puedes decidir si se deben eliminar las copias más antiguas cuando sea necesario, por ejemplo, cuando el espacio de almacenamiento disponible sea limitado.
