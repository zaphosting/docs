...
title: "Servidor Dedicado: Configuración de Servidor Dedicado Counter-Strike 1.6 en Windows"
...
Tan pronto como aparezca el mensaje **Loading Steam API.... OK**, el proceso se ha completado con éxito y puedes comenzar con la instalación del servidor de Counter-Strike 1.6.
...
El siguiente paso será la instalación. Esto se hace con el comando `app_update 90`. El ID de la aplicación **90** corresponde a la aplicación del **Servidor Dedicado de Counter-Strike 1.6**.
...
Debes añadir reglas adicionales en la configuración. Para ello, haz clic en las reglas de entrada y salida como se indica a continuación y añádelas para los siguientes puertos: 27015-27020 para los protocolos TCP/UDP.



## Configuración

En este punto, ya has terminado la configuración básica de tu servidor de Counter-Strike 1.6. Puedes realizar configuraciones adicionales editando directamente el archivo de lanzamiento. Ve a tu directorio raíz. Dentro de este directorio navega a la carpeta cfg y abre el archivo `server.cfg`. Ahí puedes editar las opciones del servidor.
...
¡Felicidades, has instalado y configurado con éxito el servidor de Counter-Strike 1.6 en tu VPS! Para más preguntas o ayuda, no dudes en contactar con nuestro equipo de soporte, que está disponible todos los días para asistirte! 🙂
