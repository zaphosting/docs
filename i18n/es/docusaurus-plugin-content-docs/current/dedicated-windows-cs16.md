...
Cuando aparezca el mensaje **Loading Steam API.... OK**, el proceso se ha completado con éxito y puedes comenzar con la instalación del servidor de Counter-Strike 1.6.
...
El siguiente paso será la instalación. Esto se hace con el comando `app_update 90`. El ID de la app **90** corresponde a la aplicación del **Servidor Dedicado de Counter-Strike 1.6**.
...
¡Felicidades, has instalado y configurado con éxito el servidor de Counter-Strike 1.6 en tu VPS! Para cualquier duda o ayuda, no dudes en contactar con nuestro equipo de soporte, disponible todos los días para ayudarte 🙂.
