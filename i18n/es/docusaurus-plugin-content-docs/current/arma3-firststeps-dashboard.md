...
En configuración encontrarás un resumen de las opciones más comunes para tu servidor. También incluyen una breve explicación. El uso de la página de configuración es especialmente recomendado para quienes son nuevos en la administración de servidores.
