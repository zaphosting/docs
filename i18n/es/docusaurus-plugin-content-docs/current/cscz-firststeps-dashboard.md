...
:::warning
El uso del Gestor DDoS solo es posible si se ha contratado una IP propia o la opción adicional "Vista General del Gestor DDoS". Si estos componentes faltan en tu paquete actual, puedes añadirlos en cualquier momento actualizando.
:::
...
:::warning
¿La información encontrada no ayuda o no la entiendes? ¡No te preocupes! En ese caso, nuestro soporte está disponible todos los días. Solo crea un **[Ticket](https://zap-hosting.com/en/customer/support/)** y explícanos tu problema. Lo revisaremos lo antes posible y te ayudaremos a solucionarlo :) 
:::
...
¿Tu servidor estuvo offline temporalmente y no sabes por qué? ¿Mirar el registro de eventos y los archivos de registro no dio información? Puede que la causa del problema no esté directamente en tu servidor, sino en el sistema anfitrión donde se ejecuta tu servidor.
