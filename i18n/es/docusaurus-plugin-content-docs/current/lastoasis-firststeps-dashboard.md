...
title: "Last Oasis: Vista General del Panel"
description: "Descubre cómo gestionar eficientemente tu servidor de Last Oasis y optimizar sus ajustes para el mejor rendimiento → Aprende más ahora"
sidebar_label: Panel
services:
...
En ajustes encontrarás un resumen de las opciones más comunes para configurar tu servidor. También incluye una breve explicación. El uso de esta página es especialmente recomendado para quienes son nuevos en la administración de servidores.
...
- Ajustes básicos: nombre del juego, nombre del servidor, descripción del servidor, contraseña de admin
...
**FileZilla:** FileZilla es el cliente FTP más fácil y conocido. Solo instala, inicia y pon tus datos de acceso en la barra superior, que encuentras un poco más arriba en esta página. Tras un clic rápido en "Conectar", entras directamente al servidor y puedes gestionar los archivos.

**WinSCP:** WinSCP está pensado para SCP y SFTP (los descendientes cifrados del protocolo FTP), pero también maneja FTP. El programa es más completo que FileZilla y es ideal para usuarios avanzados.
...
En los ajustes puedes especificar si las copias se crean automáticamente y si debe ser diario o semanal. Además, puedes decidir si se eliminan las copias más antiguas cuando el espacio de almacenamiento se limite.
