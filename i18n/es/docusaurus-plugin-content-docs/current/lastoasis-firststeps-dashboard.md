...
En esta sección encontrarás un historial de interrupciones del sistema anfitrión donde corre tu servicio de servidor de juegos. Más información y la versión más actual de nuestro estado de servicio la puedes encontrar en nuestra nueva [página de estado](https://status.zap-hosting.com/).
...
En ajustes encontrarás un resumen de las opciones más comunes para configurar tu servidor. También incluyen una breve explicación. El uso de esta página de ajustes es especialmente recomendado para quienes son nuevos en la administración de servidores.
...
- Ajustes básicos: nombre del juego, nombre del servidor, descripción del servidor, contraseña de administrador
...
Con los ajustes DNS de ZAP puedes crear direcciones fáciles de recordar para tu servicio. Puedes usar un subdominio de uno de nuestros dominios o crear una entrada DNS en tus propios dominios y así tener una dirección que se asocie mejor contigo como persona.
...
En los ajustes puedes especificar si las copias de seguridad deben crearse automáticamente y si esto debe hacerse diariamente o semanalmente. Además, puedes decidir si las copias de seguridad más antiguas deben eliminarse si es necesario, por ejemplo, cuando el espacio de almacenamiento disponible se vuelve limitado.
