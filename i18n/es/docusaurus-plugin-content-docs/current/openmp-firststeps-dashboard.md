...
description: "Descubre cómo gestionar y optimizar tu servidor Open.mp de forma eficiente con una vista clara de las funciones y controles clave → Aprende más ahora"
sidebar_label: Panel
services:
  - gameserver-openmp
---
...
El editor de archivos de configuración te permite editar los archivos directamente desde la web, sin la vista simplificada. Esta opción te permite personalizar las configuraciones de tu servidor según tus preferencias.
