...
Una vez dentro, tienes la opción de crear un nuevo token usando el formulario que aparece en la página. En el campo **App ID**, introduce el ID de la app `4000`, que corresponde a **Garry’s Mod**. Asegúrate de ingresar el ID correcto, ya que el token no funcionará con un valor incorrecto.
...
:::info Operar varios servidores de Garry’s Mod
Si gestionas varios servidores de **Garry’s Mod**, necesitarás un GSLT para cada servidor. <u>**No**</u> es posible operar varios servidores de juegos con un solo GSLT.
:::
...
El GSLT ha sido creado y aplicado a la configuración de tu servidor. Para cualquier duda o ayuda, no dudes en contactar con nuestro equipo de soporte, ¡estamos disponibles todos los días para ayudarte! 🙂
