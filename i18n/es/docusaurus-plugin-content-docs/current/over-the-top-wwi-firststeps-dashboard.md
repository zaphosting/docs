...
title: "Over The Top: WWI: Vista general del panel"
description: "Descubre cómo gestionar y optimizar eficientemente tu servidor de Over The Top: WWI con una vista clara de todas las funciones y opciones → Aprende más ahora"
sidebar_label: Panel
services:
...
En esta sección encontrarás un historial de interrupciones del sistema host donde corre tu servicio de servidor de juegos. Más información y la versión más reciente del estado de nuestro servicio la encuentras en nuestra nueva [página de estado](https://status.zap-hosting.com/).
...
En configuraciones encontrarás un resumen de las opciones de configuración más comunes para tu servidor. También incluyen una breve explicación. El uso de la página de configuraciones es especialmente recomendable para quienes son nuevos en la administración de servidores.
...
En **Juegos** siempre tienes la posibilidad de cambiar la variante del juego de tu partida existente o instalar otro juego en general. Juegos con el mismo precio por slot pueden seleccionarse directamente bajo **Juegos disponibles**. Para todos los demás juegos es necesario primero ajustar el precio por slot. Más información sobre esto la encuentras en la guía de [Cambio de juego](gameserver-gameswitch.md).
...
En la sección de **Herramientas** de tu panel de navegación encontrarás varios subítems que te ayudarán a gestionar tu servidor. Estos incluyen **Navegador FTP**, **Bases de datos** y **Copias de seguridad**. A continuación, recibirás una introducción detallada a estas áreas.
...
**WinSCP:** WinSCP está pensado originalmente para SCP y SFTP (las versiones cifradas del protocolo FTP), pero también funciona perfectamente con FTP normal. El programa es un poco más completo que FileZilla y es más adecuado para usuarios avanzados.
