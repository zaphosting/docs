...
title: "Night of the Dead: Vista general del panel"
description: "Descubre cómo gestionar y optimizar eficientemente tu servidor de Night of the Dead para un rendimiento y control sin interrupciones → Aprende más ahora"
sidebar_label: Panel
services:
  - gameserver
---
...
:::warning
El uso del Gestor DDoS solo es posible si tienes una IP propia o la opción "Visión general del Gestor DDoS" contratada como extra. Si estos componentes faltan en tu paquete actual, puedes añadirlos en cualquier momento actualizando.
:::
...
En esta sección encontrarás un historial de interrupciones del sistema anfitrión donde corre tu servidor de juegos. Más información y la versión más reciente de nuestro estado de servicio la tienes en nuestra nueva [página de estado](https://status.zap-hosting.com/).
...
Por defecto, ofrecemos 10 GB de espacio en el servidor de almacenamiento para copias en nuestros productos de servidor de juegos. Si necesitas más espacio, puedes ampliarlo pagando un extra. Así te aseguras de tener siempre espacio suficiente para tus copias y acceso a las antiguas si es necesario.
