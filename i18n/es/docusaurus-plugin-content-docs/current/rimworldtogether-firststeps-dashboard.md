...
title: "RimWorld Together: Vista General del Panel"
description: "Descubre cómo gestionar y optimizar eficientemente tu servidor de RimWorld Together para el mejor rendimiento y experiencia de usuario → Aprende más ahora"
sidebar_label: Panel
services:
  - gameserver
---
...
:::info
¿La información encontrada no te ayuda o no la entiendes? ¡No te preocupes! En ese caso, también estamos disponibles diariamente en soporte. Solo crea un **[Ticket](https://zap-hosting.com/en/customer/support/)** y explícanos tu problema. Lo revisaremos lo antes posible y te ayudaremos a solucionarlo. :)
:::
...
¿Tu servidor estuvo offline temporalmente y no sabes por qué? ¿Miraste el registro de eventos y los archivos de registro y no encontraste información? Puede que la causa del problema no esté directamente en tu servidor, sino en el sistema host donde se ejecuta tu servidor.
...
En la sección de **Configuraciones** encontrarás todas las páginas necesarias para configurar tu servidor. Las opciones disponibles para configurar tu servidor se listan detalladamente a continuación.
...
- Configuraciones básicas: Nombre del juego guardado, Nombre del servidor, Descripción del servidor, Contraseña de administrador
...
**WinSCP:** WinSCP está pensado principalmente para SCP y SFTP (los descendientes cifrados del protocolo FTP), pero también puede manejar FTP. El programa es más completo que FileZilla y es adecuado para usuarios avanzados.
