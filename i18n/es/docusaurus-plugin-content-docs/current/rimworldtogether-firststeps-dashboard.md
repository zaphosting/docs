...
- Configuraciones básicas: nombre del juego guardado, nombre del servidor, descripción del servidor, contraseña de admin
...
**FileZilla:** FileZilla es el cliente FTP más fácil y conocido. Solo instálalo, ábrelo e introduce tus datos de acceso en la barra superior, que encontrarás un poco más arriba en esta página. Tras un clic rápido en "Conectar", entrarás directamente al servidor y podrás gestionar los archivos.
