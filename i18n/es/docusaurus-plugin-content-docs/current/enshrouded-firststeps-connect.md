...
title: "Enshrouded: Conéctate al servidor"
description: "Descubre cómo conectarte sin problemas a tu servidor de Enshrouded y asegura una experiencia de juego fluida → Aprende más ahora"
...
## Introducción
¿No sabes cómo conectarte a tu servidor de **Enshrouded** o qué necesitas para empezar? ¡No te preocupes, aquí te ayudamos! Te guiaremos por todo lo que necesitas: desde las herramientas e información necesarias hasta el proceso de conexión en sí, junto con consideraciones clave para asegurar una conexión fluida y sin problemas. Sigue nuestra guía y estarás conectado en un abrir y cerrar de ojos.
...
Para conectarte a tu servidor mediante el navegador de servidores dentro del juego, abre el juego. Desde ahí, haz clic en **Jugar**, selecciona **Unirse** en la selección de juego y luego haz clic en **Buscar nombre del servidor** a la derecha. Se abrirá una ventana emergente donde debes escribir el nombre de tu servidor y luego hacer clic en buscar. Tu servidor debería aparecer después.
