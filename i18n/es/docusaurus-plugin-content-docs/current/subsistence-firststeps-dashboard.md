...
title: "Subsistence: Vista general del panel"
description: "Descubre cómo gestionar y optimizar eficientemente tu servidor de Subsistence con una vista clara de todas las funciones y opciones → Aprende más ahora"
sidebar_label: Panel
services:
...
En **Copias de seguridad** puedes crear copias tanto manuales como automáticas para tu servidor y su base de datos asociada. Esto facilita la recuperación de datos en caso de problemas o pérdida de información.
