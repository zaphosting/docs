...
title: "Craftopia: Vista general del panel"
description: "Descubre cómo gestionar y optimizar tu servidor de Craftopia de forma eficiente con una vista clara de las funciones y controles esenciales → Aprende más ahora"
sidebar_label: Panel
services:
...
En esta sección encontrarás un historial de interrupciones del sistema host donde corre tu servicio de servidor de juegos. Más información y la versión más actualizada del estado de nuestros servicios la tienes en nuestra nueva [página de estado](https://status.zap-hosting.com/).
