...
title: "Veloren: Mensajes Automáticos en el Servidor - ¡Mantén a tus jugadores informados sobre noticias, enlaces sociales y más!"
...
Usando **Tareas Programadas**, los mensajes del servidor pueden enviarse automáticamente al chat dentro del juego **Veloren** ejecutando comandos predefinidos en un horario recurrente.
...
Reemplaza el comando con el comando del juego o de una extensión que quieras usar para disparar los mensajes y `<tu texto de mensaje>` con el mensaje que quieres que los jugadores vean.
...
Las tareas programadas permiten control total sobre cuándo y con qué frecuencia aparecen los mensajes. Algunos casos comunes incluyen:
