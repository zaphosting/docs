...
En esta sección encontrarás un resumen de las opciones de configuración más comunes para tu servidor. También incluye una breve explicación. El uso de esta página es especialmente recomendado para quienes son nuevos en la administración de servidores.
...
En **Copias de seguridad** tienes la opción de crear copias de seguridad manuales y automáticas para tu servidor y su base de datos asociada. Esto facilita la recuperación de tus datos en caso de problemas o pérdida de información.

En la configuración puedes especificar si las copias de seguridad deben crearse automáticamente y si esto debe hacerse diariamente o semanalmente. Además, puedes decidir si las copias más antiguas deben eliminarse cuando sea necesario, por ejemplo, cuando el espacio de almacenamiento disponible sea limitado.
