...
title: "Unfortunate Spacemen: Vista general del panel"
description: "Descubre cómo gestionar eficientemente tu servidor de Unfortunate Spacemen con una vista clara de funciones y opciones → Aprende más ahora"
sidebar_label: Panel
services:
...
Si ya tienes más confianza y quieres hacer cambios más precisos, te recomendamos usar el Editor de Configs. Más información sobre esto está en la categoría **Configs**.
