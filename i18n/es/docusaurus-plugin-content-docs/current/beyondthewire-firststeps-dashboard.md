...
title: "Beyond the Wire: Vista general del panel"
description: "Descubre cómo gestionar y optimizar tu servidor de Beyond the Wire de forma eficiente con una vista clara de todas las funciones clave → Aprende más ahora"
sidebar_label: Panel
services:
...
¿Tu servidor estuvo offline temporalmente y no sabes por qué? ¿Miraste el registro de eventos y los archivos de registro y no encontraste nada? Puede que la causa no esté directamente en tu servidor, sino en el sistema host donde se ejecuta tu servidor de juegos.
...
Además de nuestros productos de servidor de juegos, ofrecemos 10 bases de datos incluidas. Estas bases de datos son necesarias, por ejemplo, cuando hay que almacenar datos en una base. En **Bases de datos** puedes crear una base y ver las credenciales de acceso. También puedes activar la opción de copia de seguridad e importar copias de bases de datos existentes.
