...
title: "Empyrion: Vista general del panel"
description: "Descubre cómo gestionar eficientemente tu servidor de juegos Empyrion y optimizar sus ajustes para el mejor rendimiento → Aprende más ahora"
sidebar_label: Panel
services:
  - gameserver-empyrion
---
...
:::warning
¿La información que encuentras no te ayuda o no la entiendes? ¡No te preocupes! En ese caso, nuestro soporte está disponible todos los días. Solo crea un **[Ticket](https://zap-hosting.com/en/customer/support/)** y explícanos tu problema. Lo revisaremos lo antes posible y te ayudaremos a solucionarlo. :)
:::
...
En esta sección encontrarás un historial de interrupciones del sistema host donde corre tu servidor de juegos. Más info y la versión más reciente del estado de nuestros servicios la tienes en nuestra nueva [página de estado](https://status.zap-hosting.com/).
...
En ajustes encontrarás un resumen de las opciones más comunes para configurar tu servidor. También incluyen una breve explicación. Esta página es especialmente recomendada para quienes están empezando en la administración de servidores.
...
El editor de archivos de configuración te permite editar los archivos directamente desde la web, al estilo clásico, sin la vista simplificada. Esta opción te permite personalizar los ajustes de tu servidor según tus preferencias.
...
Con los ajustes DNS de ZAP puedes crear direcciones fáciles de recordar para tu servicio. Puedes usar un subdominio de uno de nuestros dominios o crear una entrada DNS en tus propios dominios para tener una dirección que se asocie mejor contigo.
