...
## Introducción
¿Tienes un VPS Windows y quieres alojar tu propio servidor de juegos Hytale en él? En esta guía, te explicamos paso a paso cómo instalar y ejecutar el servidor dedicado de Hytale en un sistema Windows.
