...
El uso del Gestor DDoS requiere una dirección IP dedicada o la opción adicional "Vista General del Gestor DDoS". Si tu paquete actual no incluye estos componentes, puedes añadirlos en cualquier momento mejorando tu servicio.
:::
...
Si te sientes más seguro y quieres hacer cambios más precisos, te recomendamos usar el Editor de Configs. Más info sobre esto la tienes en la categoría **Configs**.
...
En **Versiones** puedes ver y gestionar la versión actual de tu servidor de juegos. Aquí puedes actualizar a la última versión en cualquier momento o activar las actualizaciones automáticas para mantener tu servidor siempre actualizado.
...
Con el **Explorador FTP** obtendrás toda la información necesaria para establecer una conexión FTP. El acceso FTP te permite acceso directo a los archivos de tu servidor de juegos. Recomendamos usar un programa FTP externo como **Filezilla** o **WinSCP** para un uso óptimo. Si no sabes cómo usar FTP, te puede ayudar la guía de [Acceso vía FTP](gameserver-ftpaccess.md).

![](https://screensaver01.zap-hosting.com/index.php/s/fZSYpSi4KwPos5P/preview)

**FileZilla:** FileZilla es el cliente FTP más fácil y conocido. Solo instálalo, ábrelo e ingresa tus datos de acceso en la barra superior, que encontrarás un poco más arriba en esta página. Con un clic en "Conectar" accedes directamente al servidor y puedes gestionar los archivos.
