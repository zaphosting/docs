---
id: dods-gslt
title: "Day of Defeat: Source：创建 GSLT（Steam 游戏服务器登录令牌）"
description: "了解如何使用 Steam 的游戏服务器登录令牌（GSLT）来认证并保护你的专用游戏服务器，实现更好的可见性和安全 → 立即了解"
...
## 创建 GSLT
要创建游戏服务器登录令牌，请使用你的 Steam 账号登录并访问 [Steam 游戏服务器账号管理](https://steamcommunity.com/dev/managegameservers)。


![img](https://screensaver01.zap-hosting.com/index.php/s/WaMsyscboqCtNHA/preview)

登录后，你可以通过页面上的表单创建新令牌。在 **App ID** 字段中输入 App ID `300`，它对应的是 **Day of Defeat: Source**。务必输入正确的 ID，否则令牌无法生效。
...
:::info 多台 Day of Defeat: Source 服务器运营
如果你运营多台 **Day of Defeat: Source** 服务器，每台服务器都需要单独的 GSLT。<u>**不支持**</u>用一个 GSLT 运营多台服务器。
:::
