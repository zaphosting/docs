---
id: hl2-gslt
title: "Half-Life 2：创建 GSLT（Steam 游戏服务器登录令牌）"
description: "了解如何使用 Steam 游戏服务器登录令牌认证你的游戏服务器，实现正确的服务器列表显示和 VAC 保护 → 立即了解更多"
...
登录后，你可以通过页面上的表单创建新令牌。在 **App ID** 字段中输入 App ID `320`，它对应的是 **Half-Life 2**。务必输入正确的 ID，否则令牌无法生效。
...
接下来需要将登录令牌添加到你的服务器配置中。打开游戏服务器管理界面，进入 **设置** 部分。在标有 **GSL Token** 的字段中输入令牌，然后保存。

![img](https://screensaver01.zap-hosting.com/index.php/s/tzJiT4nTZo2nWMz/preview)

:::info 多台 Half-Life 2 服务器运营
如果你运营多台 **Half-Life 2** 服务器，每台服务器都需要单独的 GSLT。<u>**不支持**</u>用一个 GSLT 运营多台游戏服务器。
:::
