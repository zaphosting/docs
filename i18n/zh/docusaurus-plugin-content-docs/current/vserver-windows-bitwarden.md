...
title: "VPS：在 Windows 上安装 Bitwarden"
description: "了解如何安全自托管 Bitwarden，管理密码，支持端到端加密和强大凭证功能 → 立即了解更多"
...
我们在 [Docker](vserver-windows-docker.md) 指南中提供了完整的安装流程和使用教程，强烈推荐查看。
...
输入你的安装 ID 和安装密钥，这两个信息可在 [Bitwarden](https://bitwarden.com/host) 获取。然后选择区域 US 或 EU，仅在将自托管实例连接到付费订阅时生效。
