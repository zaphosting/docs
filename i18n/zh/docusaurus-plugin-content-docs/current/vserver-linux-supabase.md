...
title: "在 Linux 服务器上安装 Supabase - 启动你的开源后端平台"
description: "了解如何托管和配置 Supabase，打造一个可靠的开源 Postgres 平台，支持身份验证和实时功能 → 立即了解更多"
...
:::warning 默认凭据
你的应用目前使用的是默认凭据。请尽快按照下面的说明保护你的服务。
:::
...
恭喜你！现在已经成功在你的 VPS/独服上安装并配置了 Supabase。我们还推荐你查看以下资源，能为你的服务器配置提供更多帮助和指导：
