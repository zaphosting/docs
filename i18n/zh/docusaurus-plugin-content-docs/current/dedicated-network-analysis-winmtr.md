...
title: "独立服务器：使用 WinMTR/MTR 识别网络问题"
description: "了解如何通过分析出站和回程路径来有效识别延迟和丢包，从而诊断网络问题 → 立即了解更多"
sidebar_label: 网络问题
services:
  - dedicated
---
...
通过 **[远程桌面连接](vserver-windows-userdp.md)** 连接服务器。要在服务器上安装 WinMTR，先从 ZAP-Hosting 网站下载应用。下载后解压，得到可执行文件 `WinMTR.exe`。
...
:::info
不知道你的 IP 地址或不确定如何查找？有多种方法可以确定你的 IP，最快的方式是使用在线服务 **[WhatIsMyIPAddress](https://whatismyipaddress.com/)**。
:::
