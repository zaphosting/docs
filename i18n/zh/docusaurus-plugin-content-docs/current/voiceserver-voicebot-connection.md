...
现在你可以在 **服务器** 下选择一个 TeamSpeak，如果你账号里也有预订的话。如果服务器是外部托管的，也可以选择 **自定义 TeamSpeak 服务器**。

接着在下面输入相关数据，保存后，语音机器人就会连接到你的 TeamSpeak 3 服务器，示例如下：
...
要把语音机器人连接到 Discord，先进入 **服务器**，然后选择 **Discord**。

![](https://screensaver01.zap-hosting.com/index.php/s/g73fPeqbesHiXSm/preview)

接着输入 **Discord 机器人令牌** 和 **Discord 机器人客户端 ID**，语音机器人就会连接到你的 Discord 服务器。
...
点击 **新建应用** 创建一个新应用，然后给它取个名字，如下图：

![](https://screensaver01.zap-hosting.com/index.php/s/YPbPtRaPEHZ7pB4/preview)

点击 **创建** 完成应用创建。接下来请记下应用 ID：
...
创建应用时会自动生成一个机器人。点击 **重置令牌** 就能拿到令牌，记得保存好这个用户令牌：

![](https://screensaver01.zap-hosting.com/index.php/s/5ypmywwPJxRAFax/preview)

:::caution
千万别把机器人令牌泄露给别人，这样你的机器人才能正常运行，避免安全风险。令牌就像秘密钥匙，绝不能分享。
:::

同一页面往下滑，开启 **Presence Intent**、**Server Members Intent** 和 **Message Content Intent**，然后保存更改：
...
把之前记下的客户端 ID 填入下面链接的对应位置，在浏览器打开这个链接，然后把机器人添加到你的 Discord 服务器。示例链接如下：
```
...
语音机器人是个超实用又好玩的产品，适合用在 TeamSpeak 或 Discord 服务器上。如果你有任何问题或需要帮助，随时联系在线客服，我们每天都在线为你服务！🙂
