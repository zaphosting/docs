...
description: "了解如何通过 Tebex 变现你的游戏服务器，提升游戏内销售和等级收入 → 立即了解更多"
...
以下游戏是我们自家游戏服务器产品也支持的，且兼容 Tebex。想了解更多游戏和支持情况，建议查看官方 [网站](https://www.tebex.io/game-servers)。
...
如果你选的游戏支持 Tebex，侧边栏会出现一个叫 “Tebex Shop” 的标签。点击加载页面时出现的图片。

![](https://screensaver01.zap-hosting.com/index.php/s/SztAWeeNX8fx5kF/preview)

Tebex 会把邀请发送到你 ZAP-Hosting 账户绑定的邮箱。按照邮件里的指示激活你的 Tebex 账户。系统会引导你完成店铺的基础配置。

### 安装 Tebex 插件

这个过程通常是自动的。如果我们服务器上没有自动安装的插件，或者没收到 Tebex 的 pingback，你就得手动安装。

### 配置 Tebex 插件

手动安装适合你游戏的服务器插件。不同游戏的安装流程不一样。插件安装的基础说明可以在这里找到：[官方文档](https://docs.tebex.io/store/integrating-with-your-game-server-or-website/minecraft-java-edition)。
...
有时候你需要输入 Tebex 网店插件的 API 密钥，才能让 ZAP 和你的 Tebex 店铺建立连接。成功连接后你会看到这个界面：
![](https://screensaver01.zap-hosting.com/index.php/s/4YS2SwHfSTgn4DE/preview)

## 总结

你已经成功把 Tebex 和你的游戏服务器服务连接起来了。还有问题或者需要帮助，随时联系在线客服，我们每天都在线帮你！🙂
