...
title: "独立服务器：在 Linux 上安装 Supabase"
description: "了解如何设置和配置 Supabase 自托管，打造强大的开源 Postgres 平台 → 立即了解更多"
...
在搭建 **Supabase** 之前，需要先准备好系统环境，包括更新操作系统到最新版本并安装所有必需依赖。这些准备工作能保证环境稳定，避免安装过程中或之后出现问题。
...
#### Git
Supabase 的数据将通过 GitHub 下载，因此需要先安装 Git。运行：
...
## 安装
满足所有要求并完成准备后，就可以开始安装 Supabase 应用。

克隆 Supabase 仓库，创建专用项目目录，并复制 Docker 资源和示例环境文件到该目录。
...
恭喜！你已成功在独立服务器上安装并配置了 Supabase。我们还推荐你查看以下资源，能为你的服务器配置提供更多帮助和指导：
...
有具体问题没覆盖到？欢迎随时联系在线客服，我们每天都在线为你提供帮助！🙂