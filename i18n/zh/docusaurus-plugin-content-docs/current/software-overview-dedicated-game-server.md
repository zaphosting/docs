...
想在你的VPS或专用服务器上托管专用游戏服务器？这里有一整套针对Linux和Windows热门游戏的详细分步安装指南。

## Linux

使用我们的详细指南，在你的Linux服务器上搭建专用游戏服务器。你会找到SteamCMD、Wine兼容层、Linux服务配置等通用设置资源，以及包括生存游戏、Source引擎经典FPS和多人热门游戏如FiveM、Rust、Palworld的分步安装教程。

### 通用

<Cards columns={2} layout="horizontal">
    <Card title="txAdmin的Cloudflare隧道" description="" link="https://zap-hosting.com/guides/docs/dedicated-linux-fivem-txAdmin-cloudflare-tunnel" image="https://screensaver01.zap-hosting.com/index.php/s/XmJGtYkc7d9rBai/preview" type="product-categories"/>
    <Card title="SteamCMD设置" description="" link="https://zap-hosting.com/guides/docs/dedicated-linux-steamcmd" image="https://screensaver01.zap-hosting.com/index.php/s/XmJGtYkc7d9rBai/preview" type="product-categories"/>
    <Card title="Wine兼容层设置" description="" link="https://zap-hosting.com/guides/docs/dedicated-linux-wine" image="https://screensaver01.zap-hosting.com/index.php/s/XmJGtYkc7d9rBai/preview" type="product-categories"/>
    <Card title="Linux服务设置" description="" link="https://zap-hosting.com/guides/docs/dedicated-linux-create-gameservice" image="https://screensaver01.zap-hosting.com/index.php/s/XmJGtYkc7d9rBai/preview" type="product-categories"/>
</Cards>
...
<Cards columns={2} layout="horizontal">
    ...
    <Card title="Arma 3" description="" link="https://zap-hosting.com/guides/docs/server-linux-arma3" image="https://screensaver01.zap-hosting.com/index.php/s/XmJGtYkc7d9rBai/preview"/>
    ...
    <Card title="反恐精英 1.6" description="" link="https://zap-hosting.com/guides/docs/dedicated-linux-cs16" image="https://screensaver01.zap-hosting.com/index.php/s/q5enKNatKZMpXPf/preview"/>
    <Card title="反恐精英：Condition Zero" description="" link="https://zap-hosting.com/guides/docs/dedicated-linux-cscz" image="https://screensaver01.zap-hosting.com/index.php/s/XmJGtYkc7d9rBai/preview"/>
    <Card title="反恐精英：全球攻势" description="" link="https://zap-hosting.com/guides/docs/server-linux-csgo" image="https://screensaver01.zap-hosting.com/index.php/s/XmJGtYkc7d9rBai/preview"/>
    <Card title="反恐精英：起源" description="" link="https://zap-hosting.com/guides/docs/dedicated-linux-css" image="https://screensaver01.zap-hosting.com/index.php/s/PqQqSqgin9BjJtw/preview"/>
    <Card title="反恐精英 2" description="" link="https://zap-hosting.com/guides/docs/dedicated-linux-cs2" image="https://screensaver01.zap-hosting.com/index.php/s/cSkWS3sQb22s5f8/preview"/>
    ...
    <Card title="半条命 2" description="" link="https://zap-hosting.com/guides/docs/dedicated-linux-hl2" image="https://screensaver01.zap-hosting.com/index.php/s/XmJGtYkc7d9rBai/preview"/>
    ...
    <Card title="求生之路 2" description="" link="https://zap-hosting.com/guides/docs/dedicated-linux-l4d2" image="https://screensaver01.zap-hosting.com/index.php/s/NSeDwKGWMY4fBEH/preview"/>
...
用我们的全套指南，在你的Windows服务器上托管专用游戏服务器。涵盖了包括ARK、Conan Exiles、Enshrouded、Valheim、完整的反恐精英和Source引擎系列，以及所有Farming Simulator版本。你还会找到如txAdmin的Cloudflare隧道配置等通用设置资源。

### 通用

<Cards columns={2} layout="horizontal">
    <Card title="txAdmin的Cloudflare隧道" description="" link="https://zap-hosting.com/guides/docs/dedicated-windows-fivem-txAdmin-cloudflare-tunnel" image="https://screensaver01.zap-hosting.com/index.php/s/XmJGtYkc7d9rBai/preview" type="product-categories"/>
</Cards>
...
<Cards columns={2} layout="horizontal">
    ...
    <Card title="反恐精英 1.6" description="" link="https://zap-hosting.com/guides/docs/dedicated-windows-cs16" image="https://screensaver01.zap-hosting.com/index.php/s/q5enKNatKZMpXPf/preview"/>
    <Card title="反恐精英：Condition Zero" description="" link="https://zap-hosting.com/guides/docs/dedicated-windows-cscz" image="https://screensaver01.zap-hosting.com/index.php/s/XmJGtYkc7d9rBai/preview"/>
    <Card title="反恐精英：起源" description="" link="https://zap-hosting.com/guides/docs/dedicated-windows-css" image="https://screensaver01.zap-hosting.com/index.php/s/PqQqSqgin9BjJtw/preview"/>
    <Card title="反恐精英 2" description="" link="https://zap-hosting.com/guides/docs/dedicated-windows-cs2" image="https://screensaver01.zap-hosting.com/index.php/s/cSkWS3sQb22s5f8/preview"/>
    ...
    <Card title="半条命 2" description="" link="https://zap-hosting.com/guides/docs/dedicated-windows-hl2" image="https://screensaver01.zap-hosting.com/index.php/s/XmJGtYkc7d9rBai/preview"/>
    ...
    <Card title="求生之路 2" description="" link="https://zap-hosting.com/guides/docs/dedicated-windows-l4d2" image="https://screensaver01.zap-hosting.com/index.php/s/NSeDwKGWMY4fBEH/preview"/>
