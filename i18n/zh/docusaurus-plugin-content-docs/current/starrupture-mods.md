...
description: "了解如何在你的 StarRupture 服务器和客户端上安装 Mods，提升游戏体验 → 立即了解更多"
...
要在你的 StarRupture 服务器上安装 Mods，首先从可信来源（例如 **NexusMods**）下载你想要的 Mod 文件。
...
部分 StarRupture Mods 也需要在客户端本地安装。大多数本地安装的 Mods 在连接服务器时都会保持激活状态。首先，从可信来源如 NexusMods 下载你想要的 Mod。

然后，打开你的 **Steam 库**，右键点击 **StarRupture**，悬停到 **管理**，选择 **浏览本地文件**。在游戏安装目录中，找到以下路径：
...
恭喜你！你已经成功在 StarRupture 的服务器和客户端上安装了 Mods。安装 Mods 后，你可以通过社区制作的新功能、机制和改进，极大地丰富你的游戏体验。
