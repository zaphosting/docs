...
title: "Miscreated: Conecte-se ao servidor"
description: "Descubra como se conectar ao seu servidor Miscreated de forma fácil e resolva problemas comuns para uma experiência de jogo sem interrupções → Saiba mais agora"
...
Para se conectar ao seu servidor via o navegador de servidores dentro do jogo, abra o navegador no menu principal. Para isso, clique em **Entrar no Servidor**. Quando estiver lá, busque seu servidor pelo nome e então clique em **Entrar no Servidor**.
