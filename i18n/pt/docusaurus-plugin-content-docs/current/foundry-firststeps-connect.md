...
title: "Foundry: Conecte-se ao servidor"
description: "Descubra como se conectar ao seu servidor Foundry de forma fácil e resolva problemas comuns para uma experiência de jogo sem interrupções → Saiba mais agora"
...
Abra o jogo e vá para multiplayer. Clique em **Conexão direta por IP** e insira o endereço IP e a porta do seu servidor. 
