...
title: "Assetto Corsa: Conecte-se ao servidor"
description: "Descubra como se conectar facilmente ao seu servidor de jogos Assetto Corsa e garantir uma experiência de jogo tranquila → Saiba mais agora"
...
Para se conectar ao seu servidor via o navegador de servidores dentro do jogo, abra o navegador no menu principal. Vá em **Drive** e selecione **Online**. A lista de servidores vai abrir, onde você pode buscar o servidor usando o nome dele no **campo de busca**. 
...
Parabéns, se você seguiu tudo direitinho, já deve ter conseguido se conectar ao servidor. Para dúvidas ou ajuda extra, não hesite em contatar nosso time de suporte, que está disponível todos os dias para te dar uma força! 🙂
