...
title: "Unturned: Visão Geral do Dashboard"
description: "Descubra como gerenciar seu servidor de jogos Unturned de forma eficiente com uma visão clara dos recursos e opções → Saiba mais agora"
...
:::warning
Notou que algumas mudanças suas são parcialmente sobrescritas? Fique ligado que certos valores de opções são puxados da página de configurações. Se quiser fazer essas mudanças direto no config, primeiro desative as opções correspondentes na página de configurações.
:::
...
Se você busca conteúdo novo para turbinar sua experiência, o Steam Workshop oferece uma seleção enorme de mods e mapas para vários jogos. Para usar uma coleção de mods ou mapas no seu jogo, basta inserir o ID da Coleção do Steam Workshop. Depois, reinicie seu servidor para garantir que o conteúdo novo seja carregado. Pronto! Agora você pode usar o conteúdo novo no seu servidor e deixar o jogo ainda mais divertido.
