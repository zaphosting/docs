...
title: "Minetest: Visão geral do Dashboard"
description: "Descubra como gerenciar e otimizar seu servidor de Minetest de forma eficiente com uma visão clara dos recursos essenciais e ferramentas de administração → Saiba mais agora"
...
Visualize ataques DDoS passados para avaliar melhor possíveis ameaças e padrões. Ative notificações para ataques DDoS em andamento no seu servidor e reaja rápido quando um incidente ocorrer.
...
Está ocorrendo um problema técnico e você não sabe a causa? Uma primeira estratégia para solução é verificar os **Arquivos de Log**. Esses arquivos contêm muitas informações sobre o servidor, como eventos atuais, dicas ou mensagens de erro.
...
Além disso, você pode ativar notificações por e-mail para atualizações automáticas, mantendo-se informado sobre as novidades e garantindo que seu servidor esteja sempre na última versão.
...
Oferecemos 10 GB de espaço para backups nos servidores de armazenamento para nossos servidores de jogos por padrão. Se precisar de mais espaço, pode fazer upgrade pagando uma taxa. Assim, você garante espaço suficiente para seus backups e ainda pode acessar backups antigos quando precisar.
...
Oferecemos documentação completa dos nossos produtos, que serve como base de conhecimento para as dúvidas e questões mais frequentes. Lá você encontra vários guias e ajudas sobre diferentes assuntos para facilitar o uso e a administração do seu produto.

![](https://screensaver01.zap-hosting.com/index.php/s/n48ct6aZBrNq7eT/preview)

### Notícias

A seção **Notícias** oferece uma visão completa de todos os anúncios e novidades relacionadas ao seu serviço. Aqui você encontra informações importantes sobre:
