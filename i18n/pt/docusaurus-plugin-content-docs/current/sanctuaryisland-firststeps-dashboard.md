...
title: "Sanctuary Island: Visão geral do Dashboard"
description: "Descubra como gerenciar e otimizar seu servidor Sanctuary Island para desempenho máximo e controle → Saiba mais agora"
...
Quer agendar reinícios do servidor em horários específicos? O Planejador de Reinício permite configurar reinícios automáticos agendados do seu servidor de jogos. Com essa função, você pode programar reinícios em horários fixos ou em intervalos regulares.
...
**FileZilla:** FileZilla é provavelmente o cliente FTP mais simples e conhecido. É só instalar, abrir e na barra superior inserir seus dados de acesso, que você encontra um pouco acima nesta página. Com um clique rápido em "Conectar", você já está logado no servidor e pode gerenciar os arquivos.
