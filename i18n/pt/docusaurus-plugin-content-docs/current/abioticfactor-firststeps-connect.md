...
Para se conectar ao seu servidor, inicie o jogo e vá para **Enter the Facility** no menu principal. Depois clique em **Join a Server** para abrir a lista de servidores. Use o campo de busca para digitar o nome do seu servidor e, quando ele aparecer, clique em **Join** para estabelecer a conexão.
...
Para se conectar ao seu servidor, inicie o jogo e vá para **Enter the Facility** no menu principal. Depois clique em **Join a Server** para abrir a lista de servidores. Selecione **Direct Connect**, digite o endereço IP e a porta do seu servidor, e clique em **Join** para estabelecer a conexão.
...
Parabéns, se você seguiu tudo direitinho, já deve ter conseguido se conectar ao servidor. Para dúvidas ou ajuda, não hesite em contatar nosso suporte, que está disponível todos os dias para te ajudar! 🙂
