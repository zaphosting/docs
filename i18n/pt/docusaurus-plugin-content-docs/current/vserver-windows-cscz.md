...
title: "VPS: Configuração de Servidor Dedicado Counter-Strike: Condition Zero no Windows"
...
O próximo passo é a instalação. Isso é feito com o comando `app_update 90`. O App ID **90** representa a aplicação do **Servidor Dedicado de Counter-Strike: Condition Zero**.
