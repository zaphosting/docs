...
title: "Barotrauma: Conecte-se ao servidor"
description: "Descubra como se conectar ao seu servidor de jogos Barotrauma de forma fácil e garanta uma experiência de jogo sem problemas → Saiba mais agora"
...
Para se conectar ao seu servidor via o navegador de servidores dentro do jogo, abra o navegador no menu principal. Quando estiver lá, procure seu servidor na **lista de servidores** usando o nome do servidor. Selecione seu servidor e clique em **Entrar**.
...
Para se conectar ao seu servidor via o navegador de servidores dentro do jogo, abra o navegador no menu principal. Quando estiver lá, clique em **Entrada Direta** na parte inferior e insira o endereço IP e a porta do seu servidor. Confirme e estabeleça a conexão usando o botão **Entrar**.
...
A falta de visibilidade do servidor pode acontecer se a inicialização não foi concluída com sucesso. Isso pode ser, por exemplo, devido a uma configuração incorreta ou arquivos corrompidos. Informações adicionais geralmente podem ser encontradas no console do servidor ou nos arquivos de log.
