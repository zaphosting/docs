...
O próximo passo será a instalação. Isso é feito com o comando `app_update 222840`. O App ID **222840** representa a aplicação do **Servidor Dedicado de Left 4 Dead 2**.
