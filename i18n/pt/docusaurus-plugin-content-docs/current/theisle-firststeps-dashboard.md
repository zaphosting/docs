...
title: "The Isle: Visão geral do dashboard"
description: "Descubra como gerenciar e otimizar seu servidor The Isle de forma eficiente com uma visão clara de todos os recursos e opções principais → Saiba mais agora"
...
Com essas informações, você tem uma boa noção do uso do seu servidor. Além disso, essas estatísticas são úteis para identificar possíveis problemas de desempenho e restringir suas causas. Por exemplo, você pode rastrear quando a utilização aumentou e se isso está relacionado a eventos ou mudanças específicas. Isso é especialmente importante quando surgem problemas repentinos, pois permite tomar medidas direcionadas para solucionar e analisar sistematicamente as causas possíveis.
...
Está acontecendo um problema técnico e você não sabe a causa? Uma primeira estratégia possível é verificar os **Arquivos de Log**. Esses arquivos contêm muitas informações sobre o servidor, como eventos atuais, dicas ou mensagens de erro.
...
**FileZilla:** FileZilla é provavelmente o cliente FTP mais simples e conhecido. É só instalar, abrir e inserir seus dados de acesso na barra superior, que você encontra um pouco acima nesta página. Com um clique rápido em "Conectar", você já estará logado no servidor e pode gerenciar os arquivos.
...
Oferecemos 10 GB de espaço para backups no servidor de armazenamento para nossos produtos de servidor de jogos por padrão. Se precisar de mais espaço, pode fazer upgrade pagando uma taxa. Assim, você garante sempre espaço suficiente para seus backups e ainda consegue acessar backups antigos quando precisar.
