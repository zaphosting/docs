...
title: "One Hour One Life: Visão geral do Dashboard"
description: "Descubra como gerenciar e otimizar seu servidor One Hour One Life de forma eficiente para o melhor desempenho e experiência do usuário → Saiba mais agora"
...
Nesta seção, você encontra um histórico das interrupções do sistema host onde seu servidor de jogos está rodando. Para mais informações e a versão mais atual do status do nosso serviço, confira nossa nova [página de status](https://status.zap-hosting.com/).
...
Em **Jogos**, você pode sempre mudar a variante do jogo atual ou instalar outro jogo. Jogos com o mesmo preço por slot podem ser selecionados diretamente em **Jogos Disponíveis**. Para outros jogos, é preciso ajustar o preço por slot antes. Mais informações estão no guia [Mudança de Jogo](gameserver-gameswitch.md).
...
Além disso, pode ativar notificações por e-mail para atualizações automáticas, assim você fica sempre informado e atualizado.
...
**FileZilla:** FileZilla é provavelmente o cliente FTP mais simples e conhecido. É só instalar, abrir e digitar seus dados de acesso na barra superior, que você encontra aqui nesta página um pouco acima. Com um clique rápido em "Conectar", você já está logado no servidor e pode gerenciar os arquivos.
