...
title: "Foundry: Visão Geral do Dashboard"
description: "Descubra como gerenciar e otimizar seu servidor Foundry de forma eficiente com uma visão completa da administração → Saiba mais agora"
...
:::info
Não entendeu as informações encontradas ou elas não ajudaram? Relaxa! Nesse caso, nosso suporte está disponível diariamente. É só abrir um **[Ticket](https://zap-hosting.com/en/customer/support/)** e explicar seu problema pra gente. Vamos analisar o quanto antes e ajudar você a resolver! :)
:::
...
Aqui você encontra um histórico das interrupções do sistema host onde seu servidor de jogos está rodando. Para mais informações e a versão mais atual do status dos nossos serviços, confira nossa nova [página de status](https://status.zap-hosting.com/).
...
Em **Jogos**, você pode mudar a variante do jogo atual ou instalar outro jogo. Jogos com o mesmo preço de slot podem ser selecionados diretamente em **Jogos Disponíveis**. Para outros jogos, é preciso ajustar o preço do slot antes. Mais detalhes no guia [Mudança de Jogo](gameserver-gameswitch.md).
...
Com as configurações de DNS da ZAP, você cria endereços fáceis de lembrar para seu serviço. Pode usar um subdomínio de um dos nossos domínios ou criar uma entrada DNS no seu próprio domínio, tendo assim um endereço que te representa melhor.
...
Em **Backups**, você pode criar backups manuais e automáticos do seu servidor e banco de dados associado. Isso facilita recuperar dados em caso de problemas ou perdas.
