...
title: "Garry's Mod: Visão Geral do Dashboard"
description: "Descubra como gerenciar e otimizar seu servidor de jogos Garry's Mod de forma eficiente com uma visão clara e estruturada → Saiba mais agora"
...
Clicando na imagem, você pode criar sua própria loja para servidor de jogos com o Tebex. A configuração é rápida e fácil, assim você estará pronto para vender seus itens virtuais rapidinho.
...
> ⚠️ As informações encontradas não ajudam ou você não entende? Relaxa! Nesse caso, nosso suporte está disponível diariamente. É só abrir um **[Ticket](https://zap-hosting.com/en/customer/support/)** e explicar seu problema pra gente. Vamos analisar rapidinho e ajudar você a resolver! :)
...
Nesta seção, você encontra um histórico das interrupções do sistema host onde seu serviço de servidor de jogos está rodando. Para mais informações e a versão mais atual do status dos nossos serviços, visite nossa nova [página de status](https://status.zap-hosting.com/).
...
Além dos nossos produtos de servidor de jogos, oferecemos também 10 bancos de dados incluídos. Esses bancos são necessários, por exemplo, quando dados precisam ser armazenados em banco de dados. Em **Bancos de Dados**, você pode criar um banco e ver as credenciais de acesso. Também pode ativar a opção de backup e importar backups existentes.
...
Nas configurações, você define se os backups devem ser criados automaticamente e se isso deve ser diário ou semanal. Também pode decidir se os backups mais antigos devem ser deletados quando o espaço de armazenamento ficar limitado.
