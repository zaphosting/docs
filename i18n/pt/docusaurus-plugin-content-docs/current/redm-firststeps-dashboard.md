...
title: "RedM: Visão Geral do Dashboard"
description: "Descubra como gerenciar e otimizar seu servidor RedM de forma eficiente com uma visão clara dos recursos essenciais de administração → Saiba mais agora"
...
Com essas informações, você tem uma boa noção do uso do seu servidor. Além disso, essas estatísticas são úteis para identificar possíveis problemas de desempenho e restringir suas causas. Por exemplo, você pode rastrear quando a utilização aumentou e se isso está relacionado a certos eventos ou mudanças. Isso é especialmente importante quando surgem problemas repentinos, pois permite tomar medidas direcionadas para solucionar e analisar sistematicamente as causas possíveis.
...
Clicando na imagem, você pode criar sua própria loja para servidor de jogos com o Tebex. A configuração é rápida e fácil, então você estará pronto para vender seus itens virtuais rapidinho.
...
O **Registro de Eventos** oferece uma visão completa de todas as atividades relacionadas à administração do servidor. Aqui você pode acompanhar quando um servidor foi iniciado, parado ou caiu, além de quando atualizações, backups ou novas instalações foram feitas.
...
Além de monitorar os eventos, você pode enviar comandos direto para o servidor pelo **Console ao Vivo**. Isso é útil para ajustar configurações, executar ações ou responder rápido a problemas que surgirem.
...
Nesta seção, você encontra um histórico das interrupções do sistema host onde seu serviço de servidor de jogos está rodando. Para mais informações e a versão mais atual do status do serviço, acesse nossa nova [página de status](https://status.zap-hosting.com/).
...
- Configurações básicas (Nome do servidor, nome do projeto, descrição do projeto e mais)
- EasyAdmin (Idioma, botão de menu, webhook do Discord, comandos de relatório e admin)
- Configurações RedM (Exibição de coordenadas, PVP)
- Tela de carregamento (ID do vídeo do YouTube)
...
Além disso, pode ativar notificações por e-mail para atualizações automáticas, para ficar sempre informado.

### Recursos

Para este jogo, oferecemos a possibilidade de instalar recursos/plugins populares com um clique em **Recursos**. Na visão geral, você encontra uma seleção do conteúdo disponível que pode adicionar clicando no botão de instalação. Após reiniciar o servidor, esses recursos serão instalados, ativados e estarão disponíveis para você.

![](https://screensaver01.zap-hosting.com/index.php/s/bP48gnjNPdSkA9q/preview)

Usando essa função, você expande o conteúdo do seu servidor de jogos rápido e fácil, sem precisar fazer ajustes manuais. Isso economiza tempo e reduz o risco de erros ou problemas de compatibilidade.
...
Com as configurações DNS da ZAP, você cria endereços fáceis de lembrar para seu serviço. Pode usar um subdomínio de um dos nossos domínios ou criar um registro DNS no seu próprio domínio, tendo assim um endereço que se conecta melhor com você.
...
**FileZilla:** FileZilla é o cliente FTP mais fácil e conhecido. É só instalar, abrir e inserir seus dados de acesso na barra superior, que você encontra um pouco acima nesta página. Depois de clicar em "Conectar", você já está logado no servidor e pode gerenciar os arquivos.
...
Nas configurações, você define se os backups são automáticos e se são diários ou semanais. Também pode escolher se os backups mais antigos devem ser deletados quando o espaço de armazenamento estiver limitado.
...
Oferecemos documentação extensa para nossos produtos, que serve como base de conhecimento para as dúvidas mais frequentes. Lá você encontra vários guias e ajuda sobre diferentes assuntos para usar e gerenciar seu produto.

![](https://screensaver01.zap-hosting.com/index.php/s/n48ct6aZBrNq7eT/preview)

### Notícias

A seção **Notícias** te mantém por dentro de todos os anúncios e novidades sobre seu serviço. Aqui você encontra informações importantes sobre:
...
Acompanhar as **Notícias** regularmente te ajuda a ficar informado e ajustar seu serviço para tirar o máximo do seu servidor.
