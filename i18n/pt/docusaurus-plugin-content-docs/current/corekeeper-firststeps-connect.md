...
title: "Core Keeper: Conecte-se ao servidor"
description: "Descubra como se conectar ao seu servidor de jogos Core Keeper de forma fácil e resolva problemas comuns para uma experiência de jogo sem interrupções → Saiba mais agora"
...
<Tabs>
    <TabItem value="connect_solution_server_joine" label="Entrar no Jogo" default>

Clique em **Entrar no Jogo** dentro do jogo e insira o **ID do Jogo** copiado do arquivo de configuração `Game ID` no campo indicado.
...
Parabéns, se você seguiu tudo certinho, já deve ter conseguido se conectar ao servidor. Para dúvidas ou ajuda, não hesite em contatar nosso suporte, que está disponível diariamente para te dar aquela força! 🙂
