...
title: "Ground Branch: Visão geral do Dashboard"
description: "Descubra como gerenciar seu servidor de jogos Ground Branch de forma eficiente com uma visão clara dos recursos e opções → Saiba mais agora"
...
:::warning
As informações encontradas não ajudam ou você não entende? Relaxa! Nesse caso, nosso suporte está disponível diariamente. Basta criar um **[Ticket](https://zap-hosting.com/en/customer/support/)** e explicar seu problema para a gente. Vamos analisar o quanto antes e ajudar você a resolver! :)
:::
...
**FileZilla:** FileZilla é provavelmente o cliente FTP mais simples e conhecido. É só instalar, abrir e na barra superior colocar seus dados de acesso, que você encontra um pouco acima nesta página. Depois de clicar em "Conectar", você já estará conectado ao servidor e pode gerenciar os arquivos.
