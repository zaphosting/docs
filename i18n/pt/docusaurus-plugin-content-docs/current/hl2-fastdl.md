---
id: hl2-fastdl
title: "Half-Life 2: Configurando o FastDL"
...
FastDL (Fast Download) é um método para entregar conteúdo customizado como mapas, sons ou modelos via um servidor web externo em vez do próprio servidor de jogos. Isso melhora a velocidade de download para os jogadores e reduz a carga no servidor.
...
Você vai precisar de um servidor de jogos Half-Life 2 ativo hospedado pela ZAP-Hosting e um pacote adicional de hospedagem de sites. O acesso FTP ou acesso ao Gerenciador de Arquivos deve estar disponível tanto para o servidor de jogos quanto para a hospedagem de sites.
...
No diretório raiz da sua hospedagem de sites, crie uma pasta chamada `fastdl`. Dentro dessa pasta, crie subdiretórios como `maps`, `sound` ou `models` dependendo do conteúdo que você pretende servir. A estrutura de pastas deve espelhar exatamente a usada pelo seu servidor de jogos Half-Life 2.
...
Garanta que a URL do FastDL corresponda exatamente à estrutura usada na sua hospedagem de sites. Depois de salvar o arquivo, reinicie seu servidor de jogos para aplicar a configuração.

## Conclusão

O FastDL pode ser configurado de forma rápida e confiável usando sua própria hospedagem de sites da ZAP. Isso permite uma entrega rápida e eficiente de conteúdo customizado e melhora a experiência de todos os jogadores do seu servidor Half-Life 2.
