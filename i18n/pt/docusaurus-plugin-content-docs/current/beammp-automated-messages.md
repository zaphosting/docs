...
title: "BeamMP: Mensagens Automáticas no Servidor - Mantenha seus jogadores informados sobre novidades, links sociais e muito mais!"
...
Usando **Tarefas Agendadas**, mensagens podem ser enviadas automaticamente no chat do **BeamMP** executando comandos pré-definidos em uma programação recorrente.
