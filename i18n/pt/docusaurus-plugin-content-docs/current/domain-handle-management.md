...
Todas as alterações podem ser inseridas e salvas diretamente na interface de Gerenciamento de Handles. Handles recém-criados ficam disponíveis para futuras registros ou atualizações de domínio. Handles existentes podem ser atualizados em domínios ativos onde o registro permitir.
