...
title: "Left 4 Dead 2: Falha de Segmentação"
...
Esse passo pode descartar se os problemas são causados pelo conteúdo adicional. Após atualizações, por exemplo, é comum ter problemas com esse tipo de conteúdo porque ele não é mais ou ainda não é compatível com a nova versão do servidor.
