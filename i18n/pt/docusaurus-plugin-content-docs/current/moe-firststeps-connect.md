...
title: "Myth of Empires: Conecte-se ao servidor"
description: "Descubra como se conectar facilmente ao seu servidor de jogos Myth of Empires e curtir o gameplay sem interrupções → Saiba mais agora"
...
Para se conectar ao seu servidor via o navegador de servidores dentro do jogo, abra o navegador no menu principal. Clique em **Servidor Personalizado** para isso. Procure seu servidor usando o nome do servidor no campo de busca. Depois selecione seu servidor e clique em **Conectar** para estabelecer a conexão.
