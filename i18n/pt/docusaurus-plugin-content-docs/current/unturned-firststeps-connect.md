...
title: "Unturned: Conecte-se ao servidor"
description: "Descubra como se conectar ao seu servidor de jogos Unturned de forma fácil e curta uma jogabilidade sem interrupções com nosso guia completo → Saiba mais agora"
...
Abra o jogo para se conectar ao seu servidor via o navegador de servidores dentro do jogo. Quando estiver no jogo, clique em **Jogar** e vá para **Multiplayer**. Depois clique nas opções de filtro na lista de servidores e use o campo de nome para buscar seu servidor pelo nome. ![img](https://screensaver01.zap-hosting.com/index.php/s/6cbF7Gp3kyfMc4E/download)

</TabItem>

<TabItem value="connect_solutiion_direct" label="Conexão direta (No jogo)">

Abra o jogo para se conectar via conexão direta. Quando estiver no jogo, clique em **Jogar** e vá para **Conectar diretamente**. Digite o endereço IP e a porta do servidor e clique em **Conectar**.
...
Para se conectar ao seu servidor via navegador de servidores do Steam, abra o navegador de servidores pelo Steam. Clique em `Exibir` no topo da navegação do Steam e depois na seção `Servidor de Jogos` para abrir.
...
Parabéns, se você seguiu tudo direitinho, já deve ter se conectado com sucesso ao servidor. Para dúvidas ou ajuda, não hesite em contatar nosso time de suporte, que está disponível diariamente para te ajudar! 🙂
