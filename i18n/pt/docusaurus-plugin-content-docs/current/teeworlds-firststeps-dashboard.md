...
title: "Teeworlds: Visão geral do dashboard"
description: "Descubra como gerenciar e otimizar seu servidor de jogos Teeworlds de forma eficiente com um guia claro e passo a passo → Saiba mais agora"
...
Aqui você encontra uma visão geral das opções de configuração mais comuns para seu servidor, com uma explicação rápida. O uso desta página é especialmente recomendado para quem está começando na administração de servidores.
...
**FileZilla:** FileZilla é provavelmente o cliente FTP mais simples e conhecido. É só instalar, abrir e colocar seus dados de acesso na barra superior, que você encontra aqui nesta página um pouco acima. Com um clique rápido em "Conectar", você já está no servidor e pode gerenciar os arquivos.
