...
title: "SCP: Containment Breach: Conecte-se ao servidor"
description: "Descubra como se conectar facilmente ao seu servidor de jogos SCP: Containment Breach e garantir uma experiência de jogo tranquila → Saiba mais agora"
...
<Tabs>
    <TabItem value="connect_solution_server_browser_ingame" label="Navegador de Servidores Conexão Direta (No jogo)" default>

Inicie o jogo e vá até a opção de menu **Multiplayer**. Selecione a opção **Conexão direta** na lista de servidores e preencha o endereço IP e a porta do seu servidor. Depois, estabeleça a conexão clicando no botão **Conectar**.
...
Parabéns, se você seguiu tudo certinho, já deve ter conseguido se conectar ao servidor. Para mais dúvidas ou ajuda, não hesite em contatar nosso time de suporte, que está disponível todos os dias para te dar uma força! 🙂
