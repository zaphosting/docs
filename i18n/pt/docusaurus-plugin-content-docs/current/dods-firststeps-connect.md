...
Para se conectar ao seu servidor via o navegador de servidores do Steam, abra o navegador pelo Steam. Clique em `Exibir` no topo da navegação do Steam e depois na seção `Servidor de Jogos` para abrir.
