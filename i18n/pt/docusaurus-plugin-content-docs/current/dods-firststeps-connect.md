...
title: "Day of Defeat Source: Conecte-se ao servidor"
description: "Descubra como se conectar facilmente ao seu servidor de jogos Day of Defeat: Source e aproveite uma jogabilidade suave → Saiba mais agora"
...
Procure ou adicione seu servidor usando o `endereço IP` e a `porta` do seu servidor de jogos. Para isso, selecione a aba `Favoritos` na lista de servidores e clique no símbolo de mais na parte inferior. Uma janela pop-up vai abrir para você especificar as informações do seu servidor.
...
No Counter-Strike: Source, o console vem desativado por padrão. Para ativar, **vá em Opções → Teclado e escolha Avançado**. Para se conectar ao seu servidor via console, abra o console com a tecla `~`. Com o console aberto, execute o comando:
