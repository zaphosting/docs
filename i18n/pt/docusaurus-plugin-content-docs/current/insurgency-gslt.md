---
id: insurgency-gslt
title: "Insurgency: Crie um GSLT (Steam Game Server Login Token)"
description: "Descubra como proteger e autenticar seu servidor dedicado de jogos com um Steam Game Server Login Token para melhor visibilidade e proteção → Saiba mais agora"
...
Após o login, você poderá criar um novo token usando o formulário exibido na página. No campo **App ID**, insira o App ID `17700`, que pertence ao **Insurgency**. Certifique-se de inserir o ID correto, pois o token não funcionará com um valor incorreto.
...
Agora o token de login precisa ser adicionado à configuração do seu servidor. Para isso, abra a interface de gerenciamento do seu servidor de jogos e vá até a seção **Settings**. Insira o token no campo chamado **GSL Token** e salve.

![img](https://screensaver01.zap-hosting.com/index.php/s/tzJiT4nTZo2nWMz/preview)

:::info Operando múltiplos servidores Insurgency
Ao operar múltiplos servidores **Insurgency**, você precisará de um GSLT para cada servidor. <u>**Não**</u> é possível rodar vários servidores de jogos com um único GSLT.
:::
