---
id: cs2-gslt
title: "Counter-Strike 2: Crie um GSLT (Steam Game Server Login Token)"
...
Após o login, você poderá criar um novo token usando o formulário exibido na página. No campo **App ID**, insira o App ID `730`, que pertence ao **Counter-Strike 2**. Certifique-se de inserir o ID correto, pois o token não funcionará com um valor incorreto.
...
:::info Operando múltiplos servidores Counter-Strike 2
Ao operar múltiplos servidores de **Counter-Strike 2**, você precisará de um GSLT para cada servidor. <u>**Não**</u> é possível operar vários servidores de jogos com um único GSLT.
:::
