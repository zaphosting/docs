...
title: "Banana Shooter: Crie um GSLT (Steam Game Server Login Token)"
...
Após o login, você pode criar um novo token usando o formulário exibido na página. No campo **App ID**, insira o App ID `1949740`, que pertence ao **Banana Shooter**. Certifique-se de inserir o ID correto, pois o token não funcionará com um valor incorreto.

No campo **Memo**, você pode adicionar uma descrição à sua escolha. Isso ajuda a identificar o propósito do token depois, como o nome ou função do servidor. Após preencher ambos os campos, clique em **Create** para gerar o token. O token será exibido e pode ser usado na configuração de inicialização do seu servidor.
...
Agora o token de login precisa ser adicionado à configuração do seu servidor. Para isso, abra a interface de gerenciamento do seu servidor de jogos e navegue até a seção **Settings**. Insira o token no campo chamado **GSL Token** e salve.

![img](https://screensaver01.zap-hosting.com/index.php/s/tzJiT4nTZo2nWMz/preview)

:::info Operando múltiplos servidores Banana Shooter
Ao operar múltiplos servidores **Banana Shooter**, você precisará de um GSLT para cada servidor. <u>**Não**</u> é possível rodar vários servidores de jogos com um único GSLT.
:::
