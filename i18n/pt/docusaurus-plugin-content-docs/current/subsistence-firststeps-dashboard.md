...
title: "Subsistence: Visão geral do Dashboard"
description: "Descubra como gerenciar e otimizar seu servidor Subsistence de forma eficiente com uma visão clara de todos os recursos e opções → Saiba mais agora"
...
Em **Jogos**, você sempre pode mudar a variante do jogo existente ou instalar outro jogo em geral. Jogos com o mesmo preço por slot podem ser selecionados diretamente em **Jogos Disponíveis**. Para todos os outros jogos, é necessário ajustar o preço por slot antes. Mais informações estão no guia [Mudança de Jogo](gameserver-gameswitch.md).
...
Com o **Navegador FTP**, você obtém todas as informações necessárias para estabelecer uma conexão via acesso FTP. O acesso FTP permite acesso direto aos arquivos do seu servidor de jogos. Recomendamos usar um programa FTP externo como **Filezilla** ou **WinSCP** para melhor experiência. Se não estiver familiarizado com FTP, dê uma olhada no nosso guia [Acesso FTP](gameserver-ftpaccess.md), que pode ajudar.
...
Oferecemos 10 GB de espaço para backups no servidor de armazenamento para nossos produtos de servidor de jogos por padrão. Se precisar de mais espaço, pode fazer upgrade pagando uma taxa. Assim, você garante sempre espaço suficiente para seus backups e ainda pode acessar backups antigos se precisar.
