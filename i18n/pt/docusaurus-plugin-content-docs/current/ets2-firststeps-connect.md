...
title: "Euro Truck Simulator 2: Conecte-se ao servidor"
description: "Descubra como se conectar facilmente ao seu servidor de jogos Euro Truck Simulator 2 e garantir uma experiência de jogo tranquila → Saiba mais agora"
...
Para se conectar a um servidor, você deve iniciar ou continuar sua **Carreira** no jogo. Depois clique em **Convoy** e abra o **Convoy Lobby**. A lista de servidores vai abrir, onde você pode buscar seu servidor usando o nome do servidor. 

:::warning Servidor não aparece?
Se você não conseguir encontrar seu servidor pelo nome, pode buscar pelo Session ID no console ao vivo e usar esse ID para procurar e encontrar seu servidor. Copie o Session ID sem a parte “/101”. 
:::
