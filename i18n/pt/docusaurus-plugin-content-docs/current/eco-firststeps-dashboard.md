...
description: "Descubra como gerenciar seu servidor Eco - Global Survival de forma eficiente e otimizar suas configurações para a melhor experiência de jogo → Saiba mais agora"
...
:::warning
Percebeu que algumas alterações são parcialmente sobrescritas? Fique ligado que certos valores são puxados da página de configurações. Se quiser alterar diretamente no config, primeiro desative as opções correspondentes na página de configurações.
:::
...
Nas configurações, você define se os backups serão criados automaticamente e se será diário ou semanal. Também pode decidir se os backups mais antigos devem ser deletados quando o espaço de armazenamento estiver acabando.
