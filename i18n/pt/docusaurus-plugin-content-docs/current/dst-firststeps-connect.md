...
title: "Don't Starve Together: Conecte-se ao servidor"
description: "Descubra como se conectar facilmente ao seu servidor de jogos Don't Starve Together e aproveite o gameplay sem interrupções → Saiba mais agora"
...
Para se conectar ao seu servidor via navegador de servidores dentro do jogo, abra o navegador no menu principal. Para isso, clique em **Browse Games**. Quando estiver lá, busque seu servidor usando o **campo de busca** e o nome do seu servidor, depois clique em **Join**.
...
Ainda com problemas depois de tentar resolver? Nesse caso, nosso time de suporte está disponível todos os dias para te ajudar. É só criar um **[Ticket](https://zap-hosting.com/en/customer/support/)** no nosso site e explicar seu problema com o máximo de detalhes possível. Vamos analisar rapidinho e te ajudar a resolver o problema!



## Conclusão

Parabéns, se você seguiu tudo certinho, já deve ter conseguido se conectar ao servidor. Para dúvidas ou ajuda extra, não hesite em contatar nosso time de suporte, que está disponível diariamente para te dar aquela força! 🙂
