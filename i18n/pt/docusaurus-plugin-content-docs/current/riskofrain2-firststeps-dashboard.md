...
title: "Risk of Rain 2: Visão geral do dashboard"
description: "Descubra como gerenciar e otimizar seu servidor de Risk of Rain 2 de forma eficiente com uma visão clara dos principais recursos e controles → Saiba mais agora"
...
Seu servidor ficou offline temporariamente e você não sabe o motivo? O registro de eventos e os arquivos de log não deram nenhuma pista? Pode ser que a causa do problema não esteja diretamente no seu servidor, mas no sistema host onde ele roda.
...
Oferecemos 10 GB de espaço para backups no servidor de armazenamento para nossos produtos de servidor de jogos por padrão. Se precisar de mais espaço, é possível fazer upgrade pagando uma taxa. Assim, você garante sempre espaço suficiente para seus backups e ainda pode acessar backups antigos se precisar.
