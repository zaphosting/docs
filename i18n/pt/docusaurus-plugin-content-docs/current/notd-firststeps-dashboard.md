...
title: "Night of the Dead: Visão geral do Dashboard"
description: "Descubra como gerenciar e otimizar seu servidor Night of the Dead de forma eficiente para um desempenho e controle sem falhas → Saiba mais agora"
...
Nas configurações, você pode definir se os backups devem ser criados automaticamente e se isso deve ser diário ou semanal. Também pode decidir se os backups mais antigos devem ser deletados quando o espaço disponível estiver acabando.
...
Oferecemos uma documentação completa dos nossos produtos, que serve como base de conhecimento para as dúvidas e questões mais frequentes. Lá você encontra vários guias e ajuda sobre diferentes assuntos que vão te ajudar a usar e administrar seu produto.
