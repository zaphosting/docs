...
title: "SCP 5K: Visão Geral do Dashboard"
description: "Descubra como gerenciar seu servidor SCP: 5K de forma eficiente com uma visão clara dos recursos e opções → Saiba mais agora"
...
Além disso, você pode ativar notificações por e-mail para atualizações automáticas, mantendo-se informado sobre as novidades e garantindo que está sempre na última versão.
...
Nas configurações, você define se os backups serão criados automaticamente e se isso deve ser diário ou semanal. Também pode decidir se os backups mais antigos devem ser deletados quando o espaço disponível estiver acabando.
