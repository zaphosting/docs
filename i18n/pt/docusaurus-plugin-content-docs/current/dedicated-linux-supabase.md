...
title: "Servidor Dedicado: Configure Supabase no Linux"
description: "Descubra como configurar e ajustar o Supabase para auto-hospedagem e crie uma poderosa plataforma Postgres open-source → Saiba mais agora"
...
Pensando em hospedar esse serviço por conta própria? Vamos te guiar em cada passo para configurar e ajustar tudo, além de te mostrar tudo que você precisa saber.
...
#### Git
Os dados do Supabase serão baixados via GitHub. Por isso, o Git precisa estar instalado primeiro. Execute o comando:
...
O Supabase será implantado e executado na sua máquina usando um container Docker. Por isso, o Docker precisa estar instalado primeiro. Execute o comando:
...
- `POSTGRES_PASSWORD`: senha para o papel `postgres`
...
Aplique as mudanças na configuração reiniciando a stack:
...
Parabéns! Você instalou e configurou com sucesso o Supabase no seu Servidor Dedicado. Também recomendamos dar uma olhada nos seguintes recursos, que podem te ajudar ainda mais durante a configuração do seu servidor:
