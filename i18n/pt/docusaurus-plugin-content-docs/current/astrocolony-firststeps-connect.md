...
Inicie o jogo e vá para **Multiplayer** para abrir a lista de servidores. Use o campo de busca para procurar seu servidor pelo nome. Estabeleça a conexão clicando no botão **Entrar**.
