...
title: "Project Zomboid: Conecte-se ao servidor"
description: "Descubra como se conectar ao seu servidor de jogos Project Zomboid de forma fácil e segura com dicas e passos essenciais → Saiba mais agora"
...
Para se conectar ao seu servidor via o navegador de servidores dentro do jogo, abra o jogo e vá em **Entrar**. Quando estiver na lista de servidores, insira as informações do seu servidor nos campos Nome Favorito, Endereço IP e Porta. Você também deve fornecer seu nome de usuário e senha da conta. Clique em **Adicionar** para incluir o servidor. 
...
Para se conectar ao seu servidor via o navegador de servidores do Steam, abra o navegador de servidores pelo Steam. Clique em `Visualizar` no topo da navegação do Steam e depois na seção `Servidor de Jogos` para abrir.
...
Parabéns, se você seguiu tudo direitinho, já deve ter conseguido se conectar ao servidor. Para dúvidas ou ajuda extra, não hesite em contatar nosso suporte, que está disponível todos os dias para te dar aquela força! 🙂
