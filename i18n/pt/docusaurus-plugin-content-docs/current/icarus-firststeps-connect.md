...
title: "Icarus: Conecte-se ao servidor"
description: "Descubra como se conectar facilmente ao seu servidor de jogos Icarus e garantir uma experiência de jogo tranquila → Saiba mais agora"
...
Para se conectar ao seu servidor via o navegador de servidores dentro do jogo, abra o **Navegador de Servidores**. Clique em **Jogar**, crie um personagem caso ainda não tenha criado um. Uma vez no navegador de servidores, você pode buscar seu servidor pelo nome usando o campo de busca no topo. Selecione seu servidor e conecte-se.
