...
title: "Afterinfection: Visão geral do Dashboard"
description: "Descubra como gerenciar e otimizar seu servidor Afterinfection de forma eficiente com uma visão clara de todos os recursos e opções → Saiba mais agora"
...
Oferecemos 10 GB de espaço de armazenamento para backups nos nossos produtos de servidor de jogos por padrão. Se precisar de mais espaço, pode fazer upgrade pagando uma taxa. Assim, você garante que sempre terá espaço suficiente para seus backups e ainda pode acessar backups antigos quando precisar.
...
Oferecemos uma documentação extensa para nossos produtos, que serve como base de conhecimento para as dúvidas e questões mais frequentes. Lá você encontra vários guias e ajudas sobre diferentes assuntos que vão te ajudar a usar e gerenciar seu produto.
...
Ficando de olho nas **Notícias** regularmente, você fica sempre informado e pode ajustar seu serviço para tirar o máximo do seu servidor.
