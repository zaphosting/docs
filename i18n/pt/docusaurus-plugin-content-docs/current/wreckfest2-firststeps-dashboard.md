...
title: "Wreckfest 2: Visão Geral do Dashboard"
description: "Descubra como gerenciar e otimizar seu Servidor de Jogos Wreckfest 2 de forma eficiente com uma visão clara de todos os recursos e opções → Saiba mais agora"
...
:::warning
Percebeu que algumas mudanças são parcialmente sobrescritas? Fique ligado que certos valores são puxados da página de configurações. Se quiser fazer essas mudanças direto no config, primeiro desative as opções correspondentes na página de configurações.
:::
