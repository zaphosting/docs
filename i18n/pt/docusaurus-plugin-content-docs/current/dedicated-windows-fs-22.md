...
Além disso, é necessária uma GameLicense própria (não pode ser a versão Steam), assim como um endereço IPv4 público. GPU ou placa de som não são necessárias para o Servidor Dedicado.  
...
:::info
Importante: No e-mail você encontrará a GameKey necessária para o download e para a ativação da instalação posteriormente.  
:::
