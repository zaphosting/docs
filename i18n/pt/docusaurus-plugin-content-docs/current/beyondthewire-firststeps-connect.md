...
title: "Beyond the Wire: Conecte-se ao servidor"
description: "Descubra como se conectar facilmente ao seu servidor Beyond the Wire e resolver problemas comuns para uma experiência de jogo tranquila → Saiba mais agora"
...
Para se conectar ao seu servidor, abra o jogo e vá para **Multiplayer**. Quando estiver lá, clique em **Navegador Personalizado** e procure seu servidor usando o nome do servidor na lista.
