...
title: "DDraceNetwork: Conecte-se ao servidor"
description: "Descubra como se conectar facilmente ao seu servidor DDraceNetwork e resolver problemas comuns para uma experiência de jogo tranquila → Saiba mais agora"
...
- Endereço IP e porta
- Nome do servidor (termo de busca)
...
Para se conectar ao seu servidor via o navegador de servidores dentro do jogo, abra o navegador clicando em **Jogar** no menu principal. Você pode se conectar na lista de servidores usando o nome do servidor (termo de busca) ou o endereço IP e porta do seu servidor.
