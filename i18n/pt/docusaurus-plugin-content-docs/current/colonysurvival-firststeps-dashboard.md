...
title: "Colony Survival: Visão geral do Dashboard"
description: "Descubra como gerenciar e otimizar seu servidor de Colony Survival de forma eficiente com uma visão clara de todos os recursos e opções principais → Saiba mais agora"
...
Está rolando um problema técnico e você não sabe a causa? Uma primeira estratégia possível é checar os **Arquivos de Log**. Esses arquivos contêm muita informação sobre o servidor, como eventos atuais, dicas ou mensagens de erro.

Mensagens de erro, em especial, ajudam a identificar e entender melhor a causa do problema. Muitas vezes, dificuldades podem ser descobertas e resolvidas ao olhar com foco nos arquivos de log.
...
Na seção **Configurações**, você encontra todas as páginas necessárias para configurar seu servidor. As opções disponíveis para configuração estão listadas detalhadamente a seguir.
...
**WinSCP:** WinSCP é feito para SCP e SFTP (versões criptografadas do protocolo FTP), mas também funciona bem com FTP normal. O programa é um pouco mais completo que o FileZilla e é mais indicado para usuários avançados.
