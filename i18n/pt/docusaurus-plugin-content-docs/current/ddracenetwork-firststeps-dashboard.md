...
title: "DDraceNetwork: Visão geral do Dashboard"
description: "Descubra como gerenciar seu servidor DDraceNetwork de forma eficiente com uma visão clara dos recursos e opções → Saiba mais agora"
...
Em **Jogos**, você sempre pode mudar a variante do jogo atual ou instalar outro jogo. Jogos com o mesmo preço por slot podem ser selecionados direto em **Jogos Disponíveis**. Para outros jogos, é preciso ajustar o preço por slot antes. Mais informações estão no guia [Mudança de Jogo](gameserver-gameswitch.md).
...
**FileZilla:** FileZilla é provavelmente o cliente FTP mais simples e conhecido. É só instalar, abrir e colocar seus dados de acesso na barra superior, que você encontra um pouco acima nesta página. Com um clique rápido em "Conectar", você já está no servidor e pode gerenciar os arquivos.
...
Nas configurações, você define se os backups são criados automaticamente e se isso acontece diariamente ou semanalmente. Também pode decidir se os backups mais antigos devem ser deletados quando o espaço disponível ficar limitado.
