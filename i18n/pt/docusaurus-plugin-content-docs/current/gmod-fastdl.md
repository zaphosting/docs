---
id: gmod-fastdl
title: "Garry's Mod: Configurando o FastDL"
...
Você vai precisar de um servidor de jogos Garry's Mod ativo hospedado pela ZAP-Hosting e um pacote adicional de hospedagem de sites. O acesso FTP ou acesso ao Gerenciador de Arquivos deve estar disponível tanto para o servidor de jogos quanto para a hospedagem de sites.
...
No diretório raiz da sua hospedagem de sites, crie uma pasta chamada `fastdl`. Dentro dessa pasta, crie subdiretórios como `maps`, `sound` ou `models` dependendo do conteúdo que você pretende servir. A estrutura de pastas deve espelhar exatamente a usada pelo seu servidor de jogos Garry's Mod.
...
O FastDL pode ser configurado de forma rápida e confiável usando sua própria hospedagem de sites da ZAP. Isso permite uma entrega rápida e eficiente de conteúdo customizado e melhora a experiência de todos os jogadores do seu servidor de jogos Garry's Mod.
