...
title: "Contagion: Visão geral do Dashboard"
description: "Descubra como gerenciar e otimizar seu servidor Contagion de forma eficiente com uma visão clara de todos os recursos e opções principais → Saiba mais agora"
...
Nesta seção, você encontra um histórico das interrupções do sistema host onde seu serviço de servidor de jogos está hospedado. Para mais informações e a versão mais atual do status dos nossos serviços, acesse nossa nova [página de status](https://status.zap-hosting.com/).
...
Além dos nossos produtos de servidor de jogos, oferecemos também 10 bancos de dados incluídos. Esses bancos são necessários, por exemplo, quando dados precisam ser armazenados em um banco de dados. Em **Bancos de Dados**, você pode criar um banco e visualizar as credenciais de acesso. Também pode ativar a opção de backup e importar backups existentes do banco.
