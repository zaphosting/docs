...
title: "Voyagers of Nera: Conecte-se ao servidor"
description: "Descubra como se conectar facilmente ao seu servidor Voyagers of Nera e resolva problemas comuns para uma experiência de jogo sem interrupções → Saiba mais agora"
...
Para se conectar ao seu servidor, abra o jogo. Uma vez dentro, acesse o menu **Browse Game**. Na lista de servidores, use o campo de busca para procurar seu servidor pelo nome.
...
Parabéns, se você seguiu tudo certinho, já deve estar conectado ao servidor. Para dúvidas ou ajuda extra, não hesite em contatar nosso suporte, que está disponível todos os dias para te dar uma força! 🙂
