...
title: "Killing Floor 2: Mensagens Automáticas no Servidor - Mantenha seus jogadores informados sobre novidades, links sociais e muito mais!"
...
Usando **Tarefas Agendadas**, mensagens podem ser enviadas automaticamente no chat do **Killing Floor 2** executando comandos pré-definidos em uma programação recorrente.
