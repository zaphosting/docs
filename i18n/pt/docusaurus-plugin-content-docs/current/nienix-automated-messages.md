...
title: "Nienix: Mensagens Automáticas no Servidor - Mantenha seus jogadores informados sobre novidades, links sociais e muito mais!"
...
Usando **Tarefas Agendadas**, as mensagens do servidor podem ser enviadas automaticamente no chat do **Nienix** dentro do jogo, executando comandos pré-definidos em uma programação recorrente.
...
Depois de configurada, a tarefa roda automaticamente em segundo plano e exibe a mensagem para todos os jogadores conectados. Isso garante uma comunicação constante sem precisar que a equipe esteja online.
...
Tarefas agendadas dão controle total sobre quando e com que frequência as mensagens aparecem. Usos comuns incluem:
