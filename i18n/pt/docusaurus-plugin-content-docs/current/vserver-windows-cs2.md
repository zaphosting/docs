...
title: "VPS: Configuração de Servidor Dedicado Counter-Strike 2 no Windows"
...
Tenha paciência enquanto o download é concluído, pode levar um tempo para jogos maiores. Quando for concluído com sucesso, uma mensagem de confirmação aparecerá.
...
Neste ponto, você já terminou a configuração do seu servidor de Counter-Strike 2. Você pode fazer configurações adicionais editando diretamente o arquivo de inicialização. Vá até o diretório raiz. Dentro dele, navegue até a pasta cfg e abra o arquivo `server.cfg`. Lá você pode editar as opções do servidor.
