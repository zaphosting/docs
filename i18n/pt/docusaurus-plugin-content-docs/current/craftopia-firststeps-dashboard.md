...
title: "Craftopia: Visão geral do Dashboard"
description: "Descubra como gerenciar e otimizar seu servidor de jogos Craftopia de forma eficiente com uma visão clara dos recursos e controles essenciais → Saiba mais agora"
...
Em **Versões**, você pode ver e gerenciar a versão atual do seu servidor de jogos. Aqui, pode atualizar para a versão mais recente a qualquer momento ou ativar atualizações automáticas para manter seu servidor sempre atualizado.
...
**FileZilla:** FileZilla é provavelmente o cliente FTP mais simples e conhecido. É só instalar, abrir e digitar seus dados de acesso na barra superior, que você encontra nesta página um pouco acima. Com um clique rápido em "Conectar", você já está logado no servidor e pode gerenciar os arquivos.
...
Nas configurações, você define se os backups são criados automaticamente e se isso deve ser diário ou semanal. Também pode escolher se os backups mais antigos devem ser deletados quando o espaço disponível ficar limitado.
