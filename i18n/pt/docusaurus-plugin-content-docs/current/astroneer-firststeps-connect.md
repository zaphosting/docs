...
title: "ASTRONEER: Conecte-se ao servidor"
description: "Descubra como se conectar ao seu servidor de jogos ASTRONEER de forma fácil e resolva problemas comuns para um gameplay sem interrupções → Saiba mais agora"
...
Para se conectar ao seu servidor via o navegador de servidores dentro do jogo, abra o **navegador de servidores** no menu principal. Clique em **Adicionar Servidor Dedicado** na lista de servidores para adicionar o seu. Insira o endereço IP e a porta do seu servidor e dê um nome para ele. Depois clique em **Adicionar servidor**, selecione o servidor adicionado e estabeleça a conexão.
