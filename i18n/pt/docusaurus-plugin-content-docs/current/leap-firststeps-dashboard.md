...
title: "Leap: Visão geral do Dashboard"
description: "Descubra como gerenciar seu servidor Leap de forma eficiente com uma visão clara dos recursos e opções para desempenho ideal → Saiba mais agora"
...
Nesta seção, você encontra um histórico das interrupções do sistema host onde seu serviço de servidor de jogos está hospedado. Para mais informações e a versão mais atual do status do nosso serviço, confira nossa nova [página de status](https://status.zap-hosting.com/).
