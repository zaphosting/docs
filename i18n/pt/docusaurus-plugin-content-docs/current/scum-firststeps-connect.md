...
title: "SCUM: Conecte-se ao servidor"
description: "Descubra como se conectar ao seu servidor de jogos SCUM de forma fácil com dicas essenciais e soluções para problemas → Saiba mais agora"
...
Para se conectar ao seu servidor, abra o jogo. Uma vez dentro, acesse o menu **Multi Play**. Clique no campo **IP:Porta** no canto inferior esquerdo e insira as informações do seu servidor de jogos. Confirme a entrada pressionando a tecla `Enter`.
...
Parabéns, se você seguiu tudo direitinho, já deve ter conseguido se conectar ao servidor. Para dúvidas ou ajuda extra, não hesite em contatar nosso suporte, que está disponível diariamente para te dar aquela força! 🙂
