...
title: "Colony Survival: Conecte-se ao servidor"
description: "Descubra como se conectar ao seu servidor de Colony Survival de forma fácil e resolva problemas comuns para uma experiência de jogo sem interrupções → Saiba mais agora"
...
Para se conectar ao seu servidor, abra o jogo e vá para **Multiplayer**. Lá, você pode buscar seu servidor pelo nome. Selecione seu servidor e clique em **Entrar**.
