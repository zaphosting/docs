...
title: "7 Days To Die: Conecte-se ao servidor"
description: "Descubra como se conectar facilmente ao seu servidor de jogos 7 Days To Die e resolva problemas comuns para uma jogabilidade sem interrupções → Saiba mais agora"
...
Para se conectar ao seu servidor, abra o jogo. Uma vez dentro, clique em **Entrar em um jogo**. Clique em **Conectar ao IP** na parte inferior e insira o endereço IP e a porta do servidor na janela.
...
Parabéns, se você seguiu tudo certinho, já deve ter estabelecido a conexão com o servidor com sucesso. Para mais dúvidas ou ajuda, não hesite em contatar nosso time de suporte, que está disponível todos os dias para te ajudar! 🙂
