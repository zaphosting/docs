...
title: "Half-Life 2: Visão Geral do Dashboard"
description: "Descubra como gerenciar e otimizar seu servidor de jogos Half-Life 2 de forma eficiente com uma visão clara de todos os recursos e opções principais → Saiba mais agora"
...
> ⚠️ Percebeu que algumas mudanças suas são parcialmente sobrescritas? Fique ligado que certos valores de opção são puxados da página de configurações. Se quiser alterar direto no config, primeiro desative as opções correspondentes na página de configurações.
...
Com as configurações de DNS da ZAP, você pode criar endereços fáceis de lembrar para seu serviço. Pode usar um subdomínio de um dos nossos domínios ou criar uma entrada DNS nos seus próprios domínios, tendo assim um endereço que se conecta melhor com você.
...
**WinSCP:** WinSCP é originalmente para SCP e SFTP (as versões criptografadas do protocolo FTP), mas também funciona bem com FTP normal. O programa é um pouco mais complexo que o FileZilla e é mais indicado para usuários avançados.
...
Nas configurações, você define se os backups devem ser criados automaticamente e se isso deve ser diário ou semanal. Também pode decidir se os backups mais antigos devem ser apagados quando o espaço de armazenamento ficar limitado.

![](https://screensaver01.zap-hosting.com/index.php/s/nm9za5LTMEcNsga/preview)

Oferecemos 10 GB de espaço para backups no servidor de armazenamento para nossos produtos de servidor de jogos por padrão. Se precisar de mais espaço, pode fazer upgrade pagando uma taxa. Assim, você garante espaço suficiente para seus backups e ainda acessa backups antigos quando precisar.
