...
title: "Counter-Strike: Source: Mensagens Automáticas no Servidor - Mantenha seus jogadores informados sobre novidades, links sociais e muito mais!"
...
Usando **Tarefas Agendadas**, as mensagens do servidor podem ser enviadas automaticamente no chat do **Counter-Strike: Source** executando comandos pré-definidos em uma programação recorrente.
