...
title: "Motor Town: Behind The Wheel: Conecte-se ao servidor"
description: "Descubra como se conectar facilmente ao seu servidor Motor Town e curtir o jogo sem interrupções → Saiba mais agora"
...
Inicie o jogo e vá até **Entrar** para abrir a lista de servidores. Use o campo de busca para procurar seu servidor pelo nome. Estabeleça a conexão clicando no botão **Conectar**.
...
Procure ou adicione seu servidor pelo navegador do Steam usando o `endereço IP` e a `porta` do seu servidor de jogos. Para isso, selecione a aba `Favoritos` na lista de servidores e clique no símbolo de mais na parte inferior. Uma janela pop-up vai abrir onde você especifica as informações do seu servidor.
