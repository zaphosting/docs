...
Para se conectar ao servidor, inicie o jogo ou abra o launcher. Navegue até o menu **Servidores** no launcher. Selecione a seção **Internet** na lista de servidores. Use o **campo de busca** para procurar seu servidor pelo nome. Depois, selecione seu servidor e clique no botão **Entrar**. 

![img](https://screensaver01.zap-hosting.com/index.php/s/ogEprRpMdWe7pFn/download)

</TabItem>

<TabItem value="connect_solution_server_browser_direct" label="Conexão Direta" default>

Para se conectar ao servidor, inicie o jogo ou abra o launcher. Navegue até o menu **Servidores** no launcher. Clique no botão **Conexão Direta** no canto inferior direito. Insira o endereço IP e a porta do seu servidor e clique no botão **Entrar**. 
...
Parabéns, se você seguiu tudo certinho, já deve estar conectado ao servidor com sucesso. Para dúvidas ou ajuda extra, não hesite em contatar nosso time de suporte, que está disponível diariamente para te dar aquela força! 🙂
