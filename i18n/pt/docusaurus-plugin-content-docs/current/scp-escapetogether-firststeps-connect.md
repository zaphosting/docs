...
title: "SCP: Escape Together: Conecte-se ao servidor"
description: "Descubra como se conectar facilmente ao seu servidor SCP: Escape Together e resolva problemas comuns para um gameplay sem interrupções → Saiba mais agora"
...
Inicie o jogo e vá até **Jogar**. Selecione a opção **Conexão direta** e preencha o endereço IP e a porta do seu servidor. Depois, estabeleça a conexão clicando no botão **Conectar**.
...
Parabéns, se você seguiu tudo certinho, já deve estar conectado ao servidor com sucesso. Para dúvidas ou ajuda extra, não hesite em contatar nosso time de suporte, que está disponível todos os dias para te dar aquela força! 🙂
