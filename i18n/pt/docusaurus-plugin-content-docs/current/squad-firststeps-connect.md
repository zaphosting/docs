...
Para se conectar ao seu servidor via o navegador de servidores dentro do jogo, abra o navegador no menu principal. Uma vez na lista de servidores, clique em **Navegador Personalizado**. Use o **campo de busca** para procurar seu servidor pelo nome. Selecione-o e clique em **Entrar no Servidor**.
