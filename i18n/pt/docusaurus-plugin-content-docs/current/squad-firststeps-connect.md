...
title: "Squad: Conecte-se ao servidor"
description: "Descubra como se conectar ao seu servidor de jogos Squad de forma fácil e resolva problemas comuns para uma experiência de jogo sem interrupções → Saiba mais agora"
...
Para se conectar ao seu servidor via navegador de servidores dentro do jogo, abra o navegador no menu principal. Uma vez na lista de servidores, clique em **Navegador Personalizado**. Use o **campo de busca** para procurar seu servidor pelo nome. Selecione-o e clique em **Entrar no Servidor**.
