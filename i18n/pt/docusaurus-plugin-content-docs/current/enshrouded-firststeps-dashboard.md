...
description: "Descubra como gerenciar seu servidor Enshrouded de forma eficiente com uma visão clara dos recursos e opções → Saiba mais agora"
...
No dashboard, você também pode iniciar, parar ou reiniciar seu serviço, tendo controle total sobre seu funcionamento. Além disso, é possível acessar o console ao vivo para obter informações em tempo real sobre o estado do servidor e agir diretamente se necessário.
...
Está rolando um problema técnico e você não sabe o motivo? Uma primeira estratégia é conferir os **Arquivos de Log**. Esses arquivos contêm muita informação sobre o servidor, como eventos atuais, dicas ou mensagens de erro.

Mensagens de erro, em especial, ajudam a identificar e entender melhor a causa do problema. Muitas vezes, dificuldades podem ser descobertas e resolvidas com uma olhada direcionada nos arquivos de log.
...
Além de monitorar os eventos, você pode enviar comandos diretamente para o servidor pelo **Console ao Vivo**. Isso é útil para ajustar configurações, executar ações específicas ou responder rápido a problemas.
...
Aqui você encontra uma visão geral das opções de configuração mais comuns para seu servidor, com explicações rápidas. O uso da página de configurações é especialmente recomendado para quem está começando na administração de servidores.

![](https://screensaver01.zap-hosting.com/index.php/s/Y3e6G2io6KaPBZe/preview)

Você pode fazer ajustes como:
...
Em **Jogos**, você pode trocar a variante do jogo atual ou instalar outro jogo. Jogos com o mesmo preço de slot podem ser selecionados direto em **Jogos Disponíveis**. Para outros jogos, é preciso ajustar o preço do slot antes. Mais detalhes no guia [Troca de Jogo](gameserver-gameswitch.md).
...
Também dá para ativar notificações por e-mail para atualizações automáticas, assim você fica sempre por dentro das novidades.
...
Quer agendar reinícios do servidor em horários específicos? O Planejador de Reinício permite configurar reinícios automáticos agendados do seu servidor de jogos. Você pode definir reinícios em horários fixos ou em intervalos regulares.

![](https://screensaver01.zap-hosting.com/index.php/s/Y6WciDS7YP98P4m/preview)

### Configurações de DNS

Com as configurações de DNS da ZAP, você cria endereços fáceis de lembrar para seu serviço. Pode usar um subdomínio de um dos nossos domínios ou criar um registro DNS no seu próprio domínio, assim o endereço fica mais personalizado e fácil de associar a você.
...
**FileZilla:** O FileZilla é o cliente FTP mais fácil e conhecido. É só instalar, abrir e inserir seus dados de acesso na barra superior, que você encontra nesta página um pouco acima. Depois, clique em "Conectar" e você já estará logado no servidor para gerenciar os arquivos.

**WinSCP:** O WinSCP é feito para SCP e SFTP (versões criptografadas do FTP), mas também funciona com FTP. É mais completo que o FileZilla e indicado para usuários avançados.
...
Oferecemos 10 GB de espaço para backups nos servidores de armazenamento para nossos servidores de jogos por padrão. Se precisar de mais espaço, pode fazer upgrade pagando uma taxa. Assim, você garante espaço suficiente para seus backups e acesso a versões antigas quando precisar.
...
Oferecemos documentação completa dos nossos produtos, que funciona como base de conhecimento para as dúvidas mais frequentes. Lá você encontra vários guias e ajuda sobre diferentes assuntos para usar e administrar seu produto.
