...
title: "Animalia Survival: Conecte-se ao servidor"
description: "Descubra como se conectar facilmente ao seu servidor de jogos Animalia Survival e aproveite o gameplay sem interrupções → Saiba mais agora"
...
Para se conectar ao seu servidor via o navegador de servidores dentro do jogo, abra o navegador no menu principal. Para isso, clique em **Multiplayer**, busque seu servidor usando o nome dele na lista. Selecione o servidor e clique em **Conectar**. Depois escolha um slot e selecione um animal para começar.
