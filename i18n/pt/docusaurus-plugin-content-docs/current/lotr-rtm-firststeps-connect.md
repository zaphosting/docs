...
title: "O Senhor dos Anéis: Retorno a Moria: Conecte-se ao servidor"
description: "Descubra como se conectar facilmente ao seu servidor de jogos O Senhor dos Anéis: Retorno a Moria e aproveite o gameplay sem interrupções → Saiba mais agora"
...
Para se conectar ao seu servidor via navegador de servidores dentro do jogo, abra seu jogo. Uma vez dentro, clique em **Jogar** e crie um Anão (personagem) se ainda não tiver um. Depois, clique em **Entrar em Outro Mundo** e então em **Conexão Direta**. Digite o endereço IP e a porta do seu servidor em **Entrada Direta** e clique em **Entrar no servidor**.
