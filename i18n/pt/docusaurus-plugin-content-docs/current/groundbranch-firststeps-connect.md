...
title: "Ground Branch: Conecte-se ao servidor"
description: "Descubra como se conectar ao seu servidor Ground Branch de forma fácil e resolva problemas comuns para uma experiência de jogo sem interrupções → Saiba mais agora"
...
Para se conectar ao seu servidor via navegador de servidores dentro do jogo, abra o navegador no menu principal. Quando estiver lá, busque seu servidor usando o **campo de busca** e o nome do seu servidor, depois clique em **Conectar**.
