...
description: "Descubra como se conectar ao seu servidor de jogos Ground Branch de forma tranquila e resolva problemas comuns para uma experiência de jogo sem interrupções → Saiba mais agora"
...
Para se conectar ao seu servidor via navegador de servidores dentro do jogo, abra o navegador no menu principal. Quando estiver lá, procure seu servidor usando o **campo de busca** e o nome do seu servidor, depois clique em **Conectar**.
