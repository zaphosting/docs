---
id: tf2-plugins
title: "Team Fortress 2: Instale plugins no seu próprio servidor"
description: "Descubra como personalizar e melhorar seu servidor de jogos com plugins Sourcemod e Metamod para melhor gerenciamento e recursos → Saiba mais agora"
...
Saiba como instalar Sourcemod e Metamod e como usar plugins no seu servidor. Ambas as extensões permitem personalizar jogos como CS:S, CS:GO, DoD:S ou TF2 e expandir significativamente as opções de gerenciamento do servidor.

Com Sourcemod e Metamod, você pode adicionar plugins, ativar recursos especiais e ajustar seu servidor exatamente do jeito que você quer.
...
Depois de concluir os passos acima, você pode prosseguir com a instalação. Faça o upload dos arquivos para seu servidor via FTP usando um cliente FTP. Se você não está familiarizado com FTP e como ele funciona, confira o seguinte guia: [Acesso via FTP](gameserver-ftpaccess.md)
