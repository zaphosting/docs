...
title: "Iron Armada: Conecte-se ao servidor"
description: "Descubra como se conectar ao seu servidor Iron Armada de forma fácil e resolva problemas comuns para uma experiência de jogo sem interrupções → Saiba mais agora"
...
Com essas informações, você consegue localizar seu servidor e garantir que está se conectando ao servidor correto.
...
<Tabs>
    <TabItem value="connect_solution_server_browser_ingame" label="Navegador de Servidores (In game)" default>

Para se conectar ao seu servidor via o navegador de servidores dentro do jogo, abra o navegador clicando em **Multiplayer** no menu principal. Você pode se conectar na lista de servidores pelo nome do servidor ou via **conexão direta** usando o endereço IP e a porta do seu servidor.
...
Parabéns, se você seguiu tudo certinho, já deve ter conseguido se conectar ao servidor. Para dúvidas ou ajuda extra, não hesite em contatar nosso suporte, que está disponível diariamente para te ajudar! 🙂
