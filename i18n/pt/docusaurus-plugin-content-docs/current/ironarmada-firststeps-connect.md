...
Para se conectar ao seu servidor via o navegador de servidores dentro do jogo, abra o navegador clicando em **Multiplayer** no menu principal. Você pode se conectar na lista de servidores pelo nome do servidor ou através da opção **conexão direta** usando o endereço IP e a porta do seu servidor.
...
Parabéns, se você seguiu tudo direitinho, já deve ter conseguido se conectar ao servidor. Para mais dúvidas ou ajuda, não hesite em contatar nosso time de suporte, que está disponível todos os dias para te ajudar! 🙂
