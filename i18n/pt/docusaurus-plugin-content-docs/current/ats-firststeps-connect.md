...
title: "American Truck Simulator: Conecte-se ao servidor"
description: "Descubra como se conectar facilmente ao seu servidor de American Truck Simulator e curtir o jogo sem interrupções → Saiba mais agora"
...
- Nome do servidor
- ID da Sessão de Busca (Live Console)
...
Para se conectar a um servidor, você deve iniciar ou continuar sua **Carreira** no jogo. Depois, clique em **Convoy** e abra o **Convoy Lobby**. A lista de servidores vai aparecer, onde você pode buscar seu servidor pelo nome.

:::warning Servidor não aparece?
Se você não conseguir encontrar seu servidor pelo nome, pode buscar pelo ID da sessão de busca no live console e usar esse ID para localizar seu servidor. Copie o ID da sessão de busca sem a parte “/101”. 
:::
...
A falta de visibilidade do servidor pode acontecer se a inicialização não foi concluída com sucesso. Isso pode ser causado por uma configuração errada ou arquivos corrompidos, por exemplo. Mais informações geralmente podem ser encontradas no console do servidor ou nos arquivos de log.
