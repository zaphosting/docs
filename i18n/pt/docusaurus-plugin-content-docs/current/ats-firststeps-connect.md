...
- Nome do servidor
- Buscar Session ID (Console ao vivo)
...
Para se conectar a um servidor, você deve iniciar ou continuar sua **Carreira** no jogo. Depois clique em **Convoy** e abra o **Convoy Lobby**. A lista de servidores vai abrir, onde você pode buscar seu servidor pelo nome.

:::warning Servidor não aparece?
Se você não conseguir encontrar seu servidor pelo nome, pode buscar pelo Session ID no console ao vivo e usar esse ID para localizar seu servidor. Copie o Session ID sem a parte “/101”. 
:::
