---
id: ats-gslt
title: "American Truck Simulator: Crie um GSLT (Steam Game Server Login Token)"
description: "Descubra como proteger e autenticar seus servidores dedicados com o Game Server Login Token da Steam para listagem pública confiável e proteção → Saiba mais"
...
Para usar um Game Server Login Token (GSLT), sua conta Steam não pode estar limitada, banida ou excluída da comunidade. Ela deve estar vinculada a um smartphone verificado, e você precisa possuir o jogo que deseja hospedar. É possível criar até 1000 tokens por conta.
...
Após o login, você poderá criar um novo token usando o formulário exibido na página. No campo **App ID**, insira o App ID `270880`, que pertence ao **American Truck Simulator**. Certifique-se de inserir o ID correto, pois o token não funcionará com um valor incorreto.
...
:::info Operando múltiplos servidores American Truck Simulator
Ao operar múltiplos servidores de **American Truck Simulator**, você precisará de um GSLT para cada servidor. <u>**Não**</u> é possível operar vários servidores de jogos com um único GSLT.
:::
