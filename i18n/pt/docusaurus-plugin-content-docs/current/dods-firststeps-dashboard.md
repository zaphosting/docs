...
title: "Day of Defeat Source: Visão Geral do Dashboard"
description: "Descubra como gerenciar seu servidor de jogos Day of Defeat: Source de forma eficiente e otimize suas configurações para o melhor desempenho → Saiba mais agora"
...
:::warning
As informações encontradas não ajudam ou você não entende? Relaxa! Nesse caso, nosso suporte está disponível diariamente. Basta criar um **[Ticket](https://zap-hosting.com/en/customer/support/)** e explicar seu problema. Vamos analisar o mais rápido possível e ajudar você a resolver! :)
:::
...
**FileZilla:** FileZilla é provavelmente o cliente FTP mais simples e conhecido. Basta instalar, abrir e inserir seus dados de acesso na barra superior, que você encontra nesta página um pouco acima. Com um clique rápido em "Conectar", você já está conectado ao servidor e pode gerenciar os arquivos.
