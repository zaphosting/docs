...
Nas configurações, você define se os backups serão criados automaticamente e se isso será diário ou semanal. Também pode decidir se os backups mais antigos devem ser deletados quando o espaço disponível ficar limitado.
...
Oferecemos documentação extensa para nossos produtos, que serve como base de conhecimento para as dúvidas e questões mais frequentes. Lá você encontra vários guias e ajuda sobre diferentes assuntos para facilitar o uso e gerenciamento do seu produto.
