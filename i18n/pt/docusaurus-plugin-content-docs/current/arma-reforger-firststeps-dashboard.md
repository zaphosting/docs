...
title: "Arma Reforger: Visão Geral do Dashboard"
description: "Descubra como gerenciar e otimizar seu Servidor de Jogos Arma Reforger de forma eficiente com uma visão clara dos recursos e opções principais → Saiba mais agora"
...
:::warning
As informações encontradas não ajudam ou você não entende? Relaxa! Nesse caso, nosso suporte está disponível diariamente. É só abrir um **[Ticket](https://zap-hosting.com/en/customer/support/)** e explicar seu problema. Vamos analisar o quanto antes e ajudar você a resolver! :)
:::
...
Seu servidor ficou offline temporariamente e você não sabe o motivo? Consultar o registro de eventos e os arquivos de log não ajudou? Pode ser que a causa do problema não esteja diretamente no seu servidor, mas no sistema host onde ele roda.
...
Em configurações, você encontra uma visão geral das opções mais comuns para ajustar seu servidor. Também há uma explicação rápida para cada uma. O uso da página de configurações é especialmente recomendado para quem está começando na administração de servidores.
...
Em **Jogos**, você pode trocar a variante do jogo atual ou instalar outro jogo no geral. Jogos com o mesmo preço de slot podem ser selecionados direto em **Jogos Disponíveis**. Para outros jogos, é necessário ajustar o preço do slot antes. Mais detalhes estão no guia [Troca de Jogo](gameserver-gameswitch.md).
...
Oferecemos 10 GB de espaço para backups no servidor de armazenamento para nossos servidores de jogos por padrão. Se precisar de mais espaço, pode fazer upgrade pagando uma taxa. Assim, você garante espaço suficiente para seus backups e acesso a versões antigas quando precisar.
