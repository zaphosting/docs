...
title: "Cryofall: Conecte-se ao servidor"
description: "Descubra como se conectar ao seu servidor de Cryofall de forma fácil e resolva problemas comuns para uma experiência de jogo sem interrupções → Saiba mais agora"
...
Para se conectar ao seu servidor via o navegador de servidores dentro do jogo, abra o jogo. Uma vez dentro, clique em **Jogar** e depois em **Multiplayer** para abrir a lista de servidores. Escolha a aba comunidade e busque seu servidor pelo nome.
