...
title: "Garry's Mod: Conecte-se ao servidor"
description: "Descubra como se conectar ao seu servidor de jogos Garry's Mod de forma tranquila e aproveite o gameplay sem interrupções → Saiba mais agora"
...
Para se conectar ao seu servidor via o navegador de servidores dentro do jogo, abra o navegador no menu principal. Para isso, clique em **Find Multiplayer Game** e depois abra o **Legacy Browser**. Quando estiver lá, busque seu servidor usando o **campo de busca** e o nome do seu servidor, então clique em **Connect**.
...
Busque ou adicione seu servidor pelo navegador do Steam usando o `endereço IP` e a `porta` do seu servidor de jogos. Para isso, selecione a aba `Favorites` na lista de servidores e clique no símbolo de mais na parte inferior. Uma janela pop-up vai abrir onde você especifica as informações do seu servidor.
