...
Este guia traz os passos para a instalação do Node.js, Deno e Bun. Esses comandos devem ser executados via SSH, se você não sabe como se conectar ao seu servidor via SSH, dê uma olhada no nosso [Acesso inicial (SSH)](vserver-linux-ssh.md).
