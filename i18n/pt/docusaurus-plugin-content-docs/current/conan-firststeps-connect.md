...
title: "Conan Exiles: Conecte-se ao servidor"
description: "Descubra como se conectar ao seu servidor de jogos Conan Exiles de forma fácil e curta a jogatina sem interrupções → Saiba mais agora"
...
Para se conectar ao seu servidor, vá em **Jogar Online** no jogo. Isso abrirá a lista de servidores. Na lista, você pode buscar pelo nome do seu servidor usando o **campo de nome**. Selecione seu servidor e clique em **Entrar**.
...
Para se conectar ao seu servidor, vá em **Jogar Online** no jogo. A lista de servidores será aberta. Em vez de buscar seu servidor, você pode clicar em **Conexão Direta** no canto inferior esquerdo e se conectar usando o endereço IP e a porta do seu servidor.
...
Parabéns, se você seguiu tudo certinho, já deve ter conseguido se conectar ao servidor. Para dúvidas ou ajuda, não hesite em contatar nosso suporte, que está disponível todos os dias para te ajudar! 🙂
