...
## Introdução
Não sabe como se conectar ao seu **servidor de jogos Longvinter** ou o que precisa para começar? Relaxa, a gente te ajuda! Vamos te guiar por tudo que você precisa – desde as ferramentas e informações necessárias até o processo real de conexão, junto com dicas importantes para garantir uma conexão suave e sem estresse. Siga nosso guia e você estará conectado rapidinho!
...
Para se conectar ao seu servidor via navegador de servidores dentro do jogo, abra o navegador no menu principal. Clique em **Conectar por IP** no canto superior direito da lista de servidores e insira o endereço IP e a porta do seu servidor. Confirme a entrada com a tecla `Enter` para estabelecer a conexão.
