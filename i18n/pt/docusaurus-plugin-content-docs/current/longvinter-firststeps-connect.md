...
title: "Longvinter: Conecte-se ao servidor"
description: "Descubra como se conectar facilmente ao seu servidor Longvinter e resolva problemas comuns para uma experiência de jogo tranquila → Saiba mais agora"
...
Para se conectar ao seu servidor via o navegador de servidores dentro do jogo, abra o navegador no menu principal. Clique em **Conectar por IP** no canto superior direito da lista de servidores e insira o endereço IP e a porta do seu servidor. Confirme a entrada com a tecla `Enter` para estabelecer a conexão.
...
Parabéns, se você seguiu tudo direitinho, já deve estar conectado ao servidor. Para dúvidas ou ajuda extra, não hesite em contatar nosso suporte, que está disponível diariamente para te dar aquela força! 🙂
