...
title: "Nienix: Visão geral do Dashboard"
description: "Descubra como gerenciar e otimizar seu servidor Nienix de forma eficiente com uma visão clara dos recursos e opções → Saiba mais agora"
...
:::warning
As informações encontradas não ajudam ou você não entende? Relaxa! Nesse caso, nosso suporte está disponível diariamente. Basta abrir um **[Ticket](https://zap-hosting.com/en/customer/support/)** e explicar seu problema para a gente. Vamos analisar o mais rápido possível e ajudar você a resolver! :)
:::
...
Oferecemos 10 GB de espaço para backups no servidor de armazenamento para nossos produtos de servidor de jogos por padrão. Se precisar de mais espaço, é possível fazer upgrade pagando uma taxa. Assim, você garante espaço suficiente para seus backups e ainda pode acessar backups antigos se precisar.
