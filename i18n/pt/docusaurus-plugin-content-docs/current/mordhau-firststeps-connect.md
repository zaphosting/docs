...
title: "Mordhau: Conecte-se ao servidor"
description: "Descubra como se conectar facilmente ao seu servidor de jogos Mordhau e garantir uma experiência de jogo tranquila → Saiba mais agora"
...
Inicie seu jogo e selecione **Fight** no menu principal. Abra o navegador de servidores e digite o nome do seu servidor no campo de busca à direita para encontrá-lo rapidamente.
