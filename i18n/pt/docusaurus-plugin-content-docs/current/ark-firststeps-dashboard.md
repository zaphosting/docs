...
title: "ARK: Visão Geral do Dashboard"
description: "Descubra como gerenciar seu servidor ARK de forma eficiente com uma visão clara dos recursos e opções → Saiba mais agora"
...
Com essas informações, você tem uma boa noção do uso do seu servidor. Além disso, essas estatísticas são úteis para identificar possíveis problemas de desempenho e entender suas causas. Por exemplo, você pode verificar quando a utilização aumentou e se isso está relacionado a eventos ou mudanças específicas. Isso é especialmente importante quando surgem problemas repentinos, pois permite que você tome medidas direcionadas para solucionar e analisar sistematicamente as causas.
...
Em configurações, você encontra uma visão geral das opções mais comuns para seu servidor, com explicações rápidas. O uso dessa página é especialmente recomendado para quem está começando na administração de servidores.

![](https://screensaver01.zap-hosting.com/index.php/s/bHK6BMKK8m25xyg/preview)

Aqui você pode fazer ajustes como:

- Configurações básicas: nome do servidor, senha, mapa do servidor de jogos e mais
- Configurações do jogo: Cuddle baby
- Dificuldade: Multiplicador de dano do jogador, multiplicador de dano dos dinos, multiplicador de dano das estruturas e mais.
...
Com as configurações de DNS da ZAP, você cria endereços fáceis de lembrar para seu serviço. Pode usar um subdomínio de um dos nossos domínios ou criar um registro DNS no seu próprio domínio, assim tendo um endereço que te representa melhor.
...
**FileZilla:** O FileZilla é o cliente FTP mais fácil e conhecido. Basta instalar, abrir e inserir seus dados de acesso na barra superior, que você encontra nesta página um pouco acima. Com um clique em "Conectar", você já está logado no servidor e pode gerenciar os arquivos.

**WinSCP:** O WinSCP é feito para SCP e SFTP (versões criptografadas do FTP), mas também suporta FTP. O programa é mais completo que o FileZilla e indicado para usuários avançados.
...
Nas configurações, você define se os backups são automáticos e se rodam diariamente ou semanalmente. Também pode escolher se os backups mais antigos devem ser deletados quando o espaço de armazenamento estiver acabando.
...
Ficando de olho nas **Notícias**, você fica sempre informado e pode ajustar seu serviço para aproveitar ao máximo seu servidor.
