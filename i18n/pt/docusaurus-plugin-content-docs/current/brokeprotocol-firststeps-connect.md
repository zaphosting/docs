...
description: "Descubra como se conectar ao seu servidor de jogos Broke Protocol de forma fácil e prepare-se para jogar sem complicações → Saiba mais agora"
...
## Introdução
Não sabe como se conectar ao seu servidor de jogos **Broke Protocol** ou o que precisa para começar? Relaxa, a gente te ajuda! Vamos te guiar por tudo que você precisa. Desde as ferramentas e informações necessárias até o processo real de conexão, junto com pontos importantes para garantir uma experiência tranquila e sem estresse. Siga nosso guia e você estará conectado rapidinho!
...
Para se conectar ao seu servidor, abra o jogo e vá para **Jogar Online**. Quando estiver lá, procure seu servidor usando o nome do servidor na lista. Clique em Entrar para estabelecer a conexão.
...
Para se conectar ao seu servidor, abra o jogo e vá para **Jogar Online**. Quando estiver lá, clique em **Direto**. Digite o endereço IP e a porta do seu servidor e clique em **Conectar**
...
Parabéns, se você seguiu tudo certinho, já deve ter conseguido se conectar ao servidor. Para dúvidas ou ajuda, não hesite em contatar nosso suporte, que está disponível todos os dias para te dar uma força! 🙂
