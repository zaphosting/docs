...
title: "Nightingale: Conecte-se ao servidor"
description: "Descubra como se conectar facilmente ao seu servidor Nightingale e resolver problemas comuns para uma experiência de jogo sem interrupções → Saiba mais agora"
...
<Tabs>
    <TabItem value="connect_solution_server_browser_ingame" label="No jogo" default>

Para se conectar ao seu servidor, você deve abrir a interface do jogo. Para isso, pressione `F2` ou `RCtrl` e navegue até **Conectar**. Uma vez lá, use o IP:Porta do seu servidor para estabelecer a conexão.
