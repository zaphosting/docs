...
title: "Project Zomboid: Visão Geral do Dashboard"
description: "Descubra como gerenciar seu servidor de jogos Project Zomboid de forma eficiente com uma visão clara dos recursos e opções → Saiba mais agora"
...
Em **Jogos**, você pode trocar a variante do jogo do seu servidor atual ou instalar outro jogo. Jogos com o mesmo preço de slot podem ser selecionados diretamente em **Jogos Disponíveis**. Para outros jogos, é preciso ajustar o preço dos slots antes. Mais detalhes no guia [Mudança de Jogo](gameserver-gameswitch.md).
...
Nas configurações, defina se os backups serão automáticos e se serão diários ou semanais. Também pode escolher se os backups mais antigos serão deletados quando o espaço de armazenamento estiver acabando.
