...
title: "SCP: Escape Together: Mensagens Automáticas no Servidor - Mantenha seus jogadores informados sobre novidades, links sociais e muito mais!"
...
Usando **Tarefas Agendadas**, as mensagens do servidor podem ser enviadas automaticamente no chat do jogo **SCP: Escape Together** executando comandos pré-definidos em uma programação recorrente.
...
Você pode definir com que frequência a mensagem deve ser enviada, como a cada poucos minutos, a cada hora ou em horários específicos do dia. Para instruções detalhadas sobre como criar tarefas agendadas, consulte o guia de [Tarefas agendadas](gameserver-scheduled-tasks.md).
...
- Enviar dicas de gameplay para jogadores novos ou que estão voltando
