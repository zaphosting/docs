...
title: "Impostor Among Us: Visão Geral do Dashboard"
description: "Descubra como gerenciar e otimizar seu Servidor Impostor - Among Us para a melhor experiência de jogo → Saiba mais agora"
...
O editor de arquivos de configuração permite editar os arquivos diretamente pelo site, no modo clássico, sem a visão simplificada. Essa opção te permite personalizar as configurações do servidor conforme suas preferências.
...
Em **Jogos**, você pode mudar a variante do jogo atual ou instalar outro jogo. Jogos com o mesmo preço de slot podem ser selecionados direto em **Jogos Disponíveis**. Para outros jogos, é preciso ajustar o preço do slot antes. Mais detalhes no guia [Mudança de Jogo](gameserver-gameswitch.md).
...
Também é possível ativar notificações por e-mail para atualizações automáticas, assim você fica sempre por dentro das novidades.
...
**FileZilla:** FileZilla é provavelmente o cliente FTP mais simples e conhecido. É só instalar, abrir e inserir seus dados de acesso na barra superior, que você encontra nesta página um pouco acima. Com um clique rápido em "Conectar", você já está conectado ao servidor e pode gerenciar os arquivos.
