...
title: "Soulmask: Visão Geral do Dashboard"
description: "Descubra como gerenciar e otimizar seu servidor Soulmask de forma eficiente com um guia claro e passo a passo → Saiba mais agora"
...
Está rolando um problema técnico e você não sabe o motivo? Uma primeira estratégia é conferir os **Arquivos de Log**. Esses arquivos contêm muitas informações sobre o servidor, como eventos atuais, dicas ou mensagens de erro.
...
O **Console ao Vivo** oferece uma visão em tempo real de todos os eventos atuais no seu servidor. Aqui você vê informações sobre as atividades dos jogadores, possíveis mensagens de erro e mensagens do sistema. Essa visão permite entender o que está rolando no seu servidor e detectar problemas cedo.
...
Aqui você encontra um histórico das interrupções do sistema host onde seu servidor de jogos está hospedado. Para mais informações e a versão mais atual do status do serviço, confira nossa nova [página de status](https://status.zap-hosting.com/).
...
Em **Jogos**, você pode mudar a variante do jogo do seu servidor atual ou instalar outro jogo. Jogos com o mesmo preço de slot podem ser selecionados diretamente em **Jogos Disponíveis**. Para outros jogos, é necessário ajustar o preço do slot antes. Mais detalhes no guia [Mudança de Jogo](gameserver-gameswitch.md).
...
**FileZilla:** FileZilla é o cliente FTP mais fácil e conhecido. É só instalar, abrir e colocar seus dados de acesso na barra superior, que você encontra nesta página um pouco acima. Depois de clicar em "Conectar", você já está logado no servidor e pode gerenciar os arquivos.
...
Nas configurações, você define se os backups são automáticos e se rodam diariamente ou semanalmente. Também pode decidir se os backups mais antigos devem ser deletados quando o espaço de armazenamento estiver acabando.
...
Oferecemos documentação completa dos nossos produtos, que funciona como base de conhecimento para as dúvidas mais frequentes. Lá você encontra vários guias e ajuda sobre diferentes assuntos para usar e gerenciar seu produto.
...
Ficar de olho nas **Notícias** te ajuda a se manter informado e ajustar seu serviço para tirar o máximo do seu servidor.
