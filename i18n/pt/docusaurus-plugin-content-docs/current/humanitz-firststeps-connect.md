...
Para se conectar ao seu servidor via navegador de servidores dentro do jogo, abra o navegador no menu principal. Para isso, clique em **Jogar**, vá para **Multiplayer** e pressione em **Encontrar Servidor**. Quando estiver lá, busque seu servidor pelo nome e clique em **Entrar no Servidor**.
