...
title: "No More Room In Hell: Mensagens Automáticas no Servidor - Mantenha seus jogadores informados sobre novidades, links sociais e muito mais!"
...
Usando **Tarefas Agendadas**, as mensagens do servidor podem ser enviadas automaticamente no chat do jogo **No More Room In Hell** executando comandos pré-definidos em uma programação recorrente.
