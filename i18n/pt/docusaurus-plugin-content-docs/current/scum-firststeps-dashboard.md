...
title: "SCUM: Visão Geral do Dashboard"
description: "Descubra como gerenciar e otimizar seu servidor SCUM de forma eficiente com uma visão clara dos recursos e controles principais → Saiba mais agora"
...
Além de monitorar os eventos, você pode enviar comandos diretamente ao servidor pelo **Console ao Vivo**. Isso é útil para ajustar configurações, executar ações específicas ou responder rápido a problemas que surgirem.
...
Em configurações, você encontra uma visão geral das opções mais comuns para seu servidor, com uma explicação rápida. O uso desta página é especialmente recomendado para quem está começando na administração de servidores.
...
Além disso, você pode ativar notificações por e-mail para atualizações automáticas, mantendo-se informado sobre as novidades.
