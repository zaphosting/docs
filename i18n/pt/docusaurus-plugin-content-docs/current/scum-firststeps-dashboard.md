...
description: "Descubra como gerenciar e otimizar seu servidor SCUM de forma eficiente com uma visão clara dos principais recursos e controles → Saiba mais agora"
...
**FileZilla:** FileZilla é provavelmente o cliente FTP mais simples e conhecido. Basta instalar, abrir e inserir seus dados de acesso na barra superior, que você encontra nesta página um pouco acima. Com um clique rápido em "Conectar", você já estará conectado ao servidor e pode gerenciar os arquivos.
...
Oferecemos uma documentação extensa dos nossos produtos, que serve como base de conhecimento para as dúvidas e questões mais frequentes. Lá você encontra vários guias e ajudas sobre diferentes temas que vão te ajudar a usar e gerenciar seu produto.
