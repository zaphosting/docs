...
title: "Necesse: Conecte-se ao servidor"
description: "Descubra como se conectar ao seu servidor Necesse de forma fácil e resolva problemas comuns para uma experiência de jogo sem interrupções → Saiba mais agora"
...
Para se conectar ao seu servidor, abra o jogo e vá até **Multiplayer** no menu principal. Depois, clique em **Adicionar Servidor** e insira um nome, o endereço IP e a porta do seu servidor. Confirme a entrada clicando no botão **Adicionar**. 
