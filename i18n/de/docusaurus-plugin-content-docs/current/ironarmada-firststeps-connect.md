...
title: "Iron Armada: Verbindung zum Server herstellen"
description: "Entdecke, wie du dich reibungslos mit deinem Iron Armada Server verbindest und häufige Probleme für ein nahtloses Gaming-Erlebnis löst → Jetzt mehr erfahren"
...
Um dich über den Ingame-Serverbrowser mit deinem Server zu verbinden, öffne den Serverbrowser, indem du im Hauptmenü auf **Multiplayer** klickst. Du kannst die Verbindung in der Serverliste entweder über den Servernamen oder über **Direktverbindung** via IP-Adresse und Port deines Servers herstellen.
