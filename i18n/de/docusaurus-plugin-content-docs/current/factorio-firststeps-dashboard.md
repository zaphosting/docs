...
description: "Entdecke, wie du deine Factorio- und Stormworks-Server effizient verwaltest – mit einer klaren Übersicht über wichtige Features und Optionen → Jetzt mehr erfahren"
...
- Grundeinstellungen: Savegame erstellen, Savegame auswählen, Rcon-Passwort
...
Mit dem Editor hast du direkten Zugriff auf alle verfügbaren Optionen und kannst sie präzise anpassen. Das ist besonders praktisch für fortgeschrittene Nutzer, die volle Kontrolle über ihre Servereinstellungen wollen und genau wissen, welche Änderungen sie vornehmen möchten.
...
Für dieses Spiel bieten wir die Möglichkeit, bekannte und beliebte Plugins mit nur einem Klick unter **Plugins** einfach zu installieren. In der Übersicht findest du eine Auswahl der verfügbaren Inhalte, die du per Installationsbutton hinzufügen kannst. Nach einem Neustart des Servers werden diese Plugins installiert, aktiviert und stehen dir zur Verfügung.

![](https://screensaver01.zap-hosting.com/index.php/s/g3f5ZkcqBgSpCzj/preview)

Mit dieser Funktion kannst du den Content deines Gameservers schnell und unkompliziert erweitern, ohne selbst Anpassungen vornehmen zu müssen. Das spart Zeit und reduziert das Risiko von Fehlern oder Kompatibilitätsproblemen.
