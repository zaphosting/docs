...
title: "DDraceNetwork: Dashboard-Übersicht"
description: "Entdecke, wie du deinen DDraceNetwork-Server effizient verwaltest mit einer klaren Übersicht über Features und Optionen → Jetzt mehr erfahren"
...
Unter Einstellungen findest du eine Übersicht der gängigsten Konfigurationsoptionen für deinen Server. Dazu gibt’s auch kurze Erklärungen. Die Nutzung der Einstellungsseite empfehlen wir besonders Einsteigern in die Serververwaltung.
...
Der Config-Datei-Editor ermöglicht dir, die Konfigurationsdateien direkt auf der Webseite klassisch zu bearbeiten, ohne vereinfachte Ansicht. So kannst du die Einstellungen deines Servers individuell anpassen und nach deinen Wünschen konfigurieren.
...
Unter **Spiele** kannst du jederzeit die Spielvariante deines bestehenden Spiels ändern oder generell ein anderes Spiel installieren. Spiele mit dem gleichen Slot-Preis kannst du direkt unter **Verfügbare Spiele** auswählen. Für alle anderen Spiele muss zuerst der Slot-Preis angepasst werden. Mehr Infos dazu findest du in der [Game Change](gameserver-gameswitch.md) Anleitung.
