---
id: nienix-firststeps-connect
title: "Nienix: Zum Server verbinden"
description: Informationen über verschiedene Möglichkeiten, wie du dich mit deinem Nienix Server von ZAP-Hosting verbinden kannst - ZAP-Hosting Dokumentation
...
Um eine Verbindung zu deinem Server herzustellen, öffne das Spiel und navigiere zu **Join Game**. Sobald du dort bist, suche deinen Server anhand des Servernamens in der Serverliste. Klicke auf **Connect**, um die Verbindung herzustellen.

![img](https://screensaver01.zap-hosting.com/index.php/s/9ipNTGpzRwcSjLq/download)

</TabItem>

<TabItem value="connect_solution_direct_ingame" label="Direktverbindung (Im Spiel)">

An Stelle von der Serverliste kannst du auch über die Direktverbindung eine Verbindung herstellen. Gebe dazu die IP-Adresse und Port deines Servers an und füge den Server hinzu. 

![img](https://screensaver01.zap-hosting.com/index.php/s/sZL8fYdNHGDC6LA/download)
