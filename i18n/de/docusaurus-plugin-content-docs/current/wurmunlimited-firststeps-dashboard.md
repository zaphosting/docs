...
title: "Wurm Unlimited: Dashboard Übersicht"
description: "Entdecke, wie du deinen Wurm Unlimited Gameserver effizient verwaltest – mit einer klaren Übersicht über Features und Optionen → Jetzt mehr erfahren"
...
In diesem Bereich findest du eine Übersicht über die Unterbrechungshistorie des Hostsystems, auf dem dein Gameserver-Service läuft. Weitere Infos und die aktuellste Version unseres Service-Status findest du auf unserer neuen [Status-Seite](https://status.zap-hosting.com/).
...
Unter den Einstellungen findest du eine Übersicht der gängigsten Konfigurationsoptionen für deinen Server. Diese sind jeweils mit einer kurzen Erklärung versehen. Die Nutzung der Einstellungsseite empfehlen wir besonders Einsteigern in die Serveradministration.
