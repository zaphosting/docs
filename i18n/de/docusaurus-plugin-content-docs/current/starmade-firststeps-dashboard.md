...
title: "Starmade: Dashboard-Übersicht"
description: "Entdecke, wie du deinen Starmade Gameserver effizient verwaltest und optimierst – mit einer klaren Übersicht aller wichtigen Features → Jetzt mehr erfahren"
...
Im Dashboard kannst du deinen Service außerdem starten, stoppen oder neu starten und hast so die volle Kontrolle über den Betrieb. Zudem hast du Zugriff auf die Live-Konsole, um Echtzeit-Infos zum Serverstatus zu bekommen und bei Bedarf direkt eingreifen zu können.
...
:::warning
Der DDoS Manager kann nur genutzt werden, wenn entweder eine eigene IP-Adresse oder die Option „DDoS Manager Übersicht“ als Zusatzoption gebucht wurde. Fehlen diese Komponenten in deinem aktuellen Paket, kannst du sie jederzeit per Upgrade hinzufügen.
:::
...
Gerade Fehlermeldungen helfen oft dabei, die Ursache eines Problems zu identifizieren und besser zu verstehen. Häufig lassen sich Schwierigkeiten durch gezieltes Prüfen der Logdateien aufdecken und beheben.
...
Unter den Einstellungen findest du eine Übersicht der gängigsten Konfigurationsoptionen für deinen Server. Diese sind mit kurzen Erklärungen versehen. Die Nutzung der Einstellungsseite empfehlen wir besonders Einsteigern in die Serververwaltung.
...
Mit dem Editor hast du direkten Zugriff auf alle verfügbaren Optionen und kannst diese genau anpassen. Das ist besonders praktisch für fortgeschrittene User, die volle Kontrolle über ihre Servereinstellungen wollen und genau wissen, welche Änderungen sie vornehmen möchten.
...
Außerdem kannst du die E-Mail-Benachrichtigung für automatische Updates aktivieren, um immer über Updates informiert zu sein und up-to-date zu bleiben.
...
Willst du Serverneustarts zu bestimmten Zeiten planen? Der Neustartplaner ermöglicht dir, automatische Neustarts deines Gameservers zeitgesteuert einzurichten. So kannst du Neustarts zu festen Zeiten oder in regelmäßigen Abständen planen.
...
Mit dem **FTP-Browser** bekommst du alle nötigen Infos, um eine Verbindung zum FTP-Zugang herzustellen. Der FTP-Zugang ermöglicht dir direkten Zugriff auf die Dateien deines Gameservers. Für die optimale Nutzung empfehlen wir ein externes FTP-Programm wie **Filezilla** oder **WinSCP**. Wenn du noch nicht mit FTP vertraut bist, schau dir gerne unsere [FTP-Zugang](gameserver-ftpaccess.md) Anleitung an, die dir weiterhelfen kann.
...
Unter **Backups** kannst du sowohl manuelle als auch automatische Backups für deinen Server und die zugehörige Datenbank erstellen. So kannst du im Problemfall oder bei Datenverlust deine Daten leichter wiederherstellen.
