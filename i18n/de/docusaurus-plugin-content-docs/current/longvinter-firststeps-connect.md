...
title: "Longvinter: Zum Server verbinden"
...
![img](https://screensaver01.zap-hosting.com/index.php/s/Srjsrg6z3qN73aZ/preview)
...
Um eine Verbindung zu deinem Server über den Server-Browser im Spiel herzustellen, öffne den Server-Browser im Hauptmenü. Klicke oben rechts in der Server Liste auf **Connect by IP** und trage die IP-Adresse und Port deines Servers ein. Bestätige die Eingabe mit der `Enter` Taste, um die Verbindung herzustellen. 
