...
description: "Entdecke, wie du deinen RedM Gameserver effizient verwaltest und optimierst – mit einer klaren Übersicht über die wichtigsten Admin-Features → Jetzt mehr erfahren"
...
Nach dem Durcharbeiten dieser Anleitung kannst du deinen Server ganz easy effizient verwalten und findest alle wichtigen Optionen und Features schnell und unkompliziert. Hier bekommst du eine strukturierte Übersicht, die dir Schritt für Schritt hilft, dich mit der Serveradministration vertraut zu machen und dein Wissen gezielt zu erweitern. So stellst du sicher, dass dein **RedM Gameserver** optimal auf deine Bedürfnisse angepasst ist und du das Maximum aus den verfügbaren Optionen rausholst.
...
Tritt ein technisches Problem auf und du bist unsicher, woran es liegt? Eine erste mögliche Lösung ist ein Blick in die **Logdateien**. Diese Dateien enthalten viele Infos über den Server, wie aktuelle Ereignisse, Hinweise oder Fehlermeldungen.
...
Mit dem Editor hast du direkten Zugriff auf alle verfügbaren Optionen und kannst sie genau einstellen. Das ist besonders praktisch für fortgeschrittene Nutzer, die volle Kontrolle über ihre Servereinstellungen wollen und genau wissen, welche Änderungen sie vornehmen möchten.

:::info
Hast du bemerkt, dass einige deiner Änderungen teilweise überschrieben werden? Bitte beachte, dass bestimmte Optionswerte von der Einstellungsseite übernommen werden. Wenn du diese Änderungen direkt in der Config vornehmen möchtest, musst du die entsprechenden Optionen zuerst auf der Einstellungsseite deaktivieren.
:::
...
Für dieses Spiel bieten wir unter **Ressourcen** die Möglichkeit, bekannte und beliebte Ressourcen/Plugins mit nur einem Klick zu installieren. In der Übersicht findest du eine Auswahl des verfügbaren Contents, den du per Installationsbutton hinzufügen kannst. Nach einem Serverneustart werden diese Ressourcen installiert, aktiviert und stehen dir zur Verfügung.
