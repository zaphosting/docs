...
Um dich über den Ingame-Serverbrowser mit deinem Server zu verbinden, öffne den Serverbrowser im Hauptmenü. Sobald du in der Serverliste bist, klicke auf **Custom Browser**. Nutze das **Suchfeld**, um deinen Server über den Servernamen zu finden. Wähle ihn aus und klicke auf **Server beitreten**.
