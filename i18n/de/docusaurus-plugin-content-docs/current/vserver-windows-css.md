...
Der nächste Schritt ist die Installation. Diese erfolgt mit dem Befehl `app_update 232330`. Die App ID **232330** steht für die Anwendung **Counter Strike 2 Dedicated Server**.
