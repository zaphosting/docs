...
Bitte lies dir unsere Anleitung [Certbot installieren](linux-certbot) durch, die den gesamten Prozess der Beantragung und automatischen Verlängerung von SSL-Zertifikaten für deine Domain(s) abdeckt.
