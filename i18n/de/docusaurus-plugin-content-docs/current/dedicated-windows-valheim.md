...
<YouTube videoId="Trs9Ysxa1gc" imageSrc="https://screensaver01.zap-hosting.com/index.php/s/D2doaAqjzdMSo9r/preview" title="Valheim Dedicated Server Setup auf Windows VPS" description="Du verstehst besser, wenn du Dinge in Aktion siehst? Kein Problem! Schau dir unser Video an, das alles für dich erklärt. Egal ob du es eilig hast oder einfach lieber auf die spannendste Art lernst!"/>
...
Danach erfolgt der Download. Dieser enthält die **steamcmd.zip** Datei, die zuerst entpackt werden muss. Es empfiehlt sich, einen eigenen Ordner zu erstellen, in den die Datei entpackt wird. Am Ende solltest du die **steamcmd.exe** sehen. Starte diese und warte, bis der Installationsprozess abgeschlossen ist.
...
Navigiere in das Verzeichnis, in dem du die Installation durchgeführt hast, und gehe in das folgende Unterverzeichnis:  **../steamapps/common/Valheim dedicated Server**/
...
REM Tipp: Erstelle eine lokale Kopie dieses Skripts, um zu vermeiden, dass es von Steam überschrieben wird.
REM HINWEIS: Minimale Passwortlänge ist 5 Zeichen & Passwort darf nicht im Servernamen vorkommen.
...
Die eigentliche Einrichtung ist damit schon abgeschlossen. Weitere Konfigurationsänderungen kannst du in der **start_headless_server.bat** Datei vornehmen. Dort hast du die Möglichkeit, den Servernamen, das Serverpasswort, das Server-Admin-Passwort und viele weitere Optionen zu ändern. Navigiere dazu in folgende Verzeichnisse:
...
Am Ende der Einrichtung kannst du den Server jetzt starten, indem du die zuvor erstellte **start_headless_server.bat** Datei ausführst. Dadurch sollte sich die Server-Konsole öffnen und der Serverstartprozess beginnen. Wenn alles wie erwartet läuft, sollte der Server nach erfolgreichem Start in der Serverliste sichtbar sein.
