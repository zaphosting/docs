...
Wenn du Crossplay benötigst, kannst du stattdessen auch die Windows-Version installieren und **Wine** als Kompatibilitätsschicht verwenden. Bitte benutze unsere Kurzanleitung [Wine Compatibility Layer Setup](dedicated-linux-wine.md), um dies einzurichten. Wenn du fertig bist, kannst du die Valheim-Windows-Serverversion über SteamCMD installieren:
```
