...
Jetzt hast du die Grundinstallation deines Team Fortress 2 Servers abgeschlossen. Weitere Servereinstellungen kannst du direkt in der Startdatei vornehmen.

Wechsle in dein Root-Verzeichnis. Dort findest du im Ordner `cfg` die Datei `server.cfg`, die du zum Anpassen der Serveroptionen öffnen kannst.
```
