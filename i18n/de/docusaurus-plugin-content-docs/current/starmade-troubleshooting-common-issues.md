...
title: "Starmade: Häufige Probleme"
description: "Entdecke, wie du häufige Starmade-Serverprobleme behebst und ein reibungsloses Gameplay für deine Community sicherst → Jetzt mehr erfahren"
...
Das kann zu hoher CPU-Auslastung, Speicherlecks, Lag oder sogar Crashes führen, besonders wenn mehrere unoptimierte Komponenten zusammenwirken. Achte immer darauf, dass Erweiterungen aktiv gepflegt, gut dokumentiert und auf Performance getestet sind. Im Zweifel hilft Feedback aus der Community oder das Monitoring der Serverperformance, um Problemquellen zu identifizieren.
...
### Netzwerk
Netzwerkprobleme können Lag, Verzögerungen oder Verbindungsabbrüche verursachen. Die Ursachen sind vielfältig, lassen sich aber meist mit den richtigen Einstellungen und Sicherheitsmaßnahmen beheben.
...
Regelmäßige Backups ersparen dir viel Stress und Sorgen. Erstelle regelmäßige Backups, damit du im Problemfall immer eine ältere Version hast, bei der noch alles lief. Wir bieten eine [Backup-Lösung](gameserver-backups.md) für unsere Starmade Gameserver an, mit der du manuelle oder automatische geplante Backups erstellen kannst.
