...
Um dich über den Ingame-Serverbrowser mit deinem Server zu verbinden, öffne das Spiel. Klicke im Spiel auf **Multiplayer**, um die Serverliste zu öffnen. Oben rechts in der Serverliste kannst du nun den Namen deines Servers in die Suchleiste eingeben, deinen Server auswählen und die Verbindung herstellen.
