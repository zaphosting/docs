...
title: "The Bus: Zum Server verbinden"
description: Informationen über verschiedene Möglichkeiten, wie du dich mit deinem The Bus Server von ZAP-Hosting verbinden kannst - ZAP-Hosting Dokumentation
...
![img](https://screensaver01.zap-hosting.com/index.php/s/CwxAzLxF8XJzLEa/preview)
...
Um dich mit deinem Server zu verbinden, öffne im Spiel das Menü **Multiplayer**. Drücke anschließend die `Alt`-Taste, um einen neuen Server zur Liste hinzuzufügen. Gib dort die IP-Adresse und den Port deines Servers ein und stelle die Verbindung her.

![img](https://screensaver01.zap-hosting.com/index.php/s/ytPkDYpx7WNBZ2D/download)
