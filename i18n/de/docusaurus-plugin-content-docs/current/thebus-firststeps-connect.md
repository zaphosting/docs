...
Um dich mit deinem Server zu verbinden, öffne im Spiel das **Multiplayer**-Menü. Drücke dann die `Alt`-Taste, um einen neuen Server zu deiner Liste hinzuzufügen. Gib die IP-Adresse und den Port deines Servers ein und verbinde dich.
