...
title: "Sons of the Forest: Automatisierte Server-Nachrichten – Halte deine Spieler über News, Social Links und mehr auf dem Laufenden!"
...
Mit **Geplanten Aufgaben** können Server-Nachrichten automatisch per vordefiniertem Befehl im **Sons of the Forest** Ingame-Chat ausgegeben werden – und das immer wieder nach deinem Zeitplan.
...
Automatisierte Nachrichten werden erstellt, indem du eine Aufgabe planst, die zu einer definierten Zeit oder in einem Intervall einen Server-Befehl ausführt. Der Befehl kann genutzt werden, um eine Chat-Nachricht, eine Broadcast- oder Server-Benachrichtigung zu senden.
...
Um automatisierte Server-Nachrichten zu erstellen, öffne dein Gameserver-Dashboard und navigiere zum Bereich **Geplante Aufgaben**. Erstelle eine neue geplante Aufgabe und wähle die Option, einen **Befehl** auszuführen. Im Befehlsfeld gibst du den Nachrichtenbefehl ein, den dein Gameserver unterstützt.
...
Geplante Aufgaben geben dir volle Kontrolle darüber, wann und wie oft Nachrichten erscheinen. Häufige Anwendungsfälle sind:
...
Automatisierte Server-Nachrichten sind eine zuverlässige Methode, um Spieler informiert und engagiert zu halten – ganz ohne manuellen Aufwand. Mit geplanten Aufgaben, die Nachrichtenbefehle ausführen, können Server-Admins eine konstante Kommunikation auf ihrem Server sicherstellen.
