...
Verbinde dich zunächst über SSH mit deinem Dedicated Server. Verwende unsere Anleitung [SSH-Erstzugang](vserver-linux-ssh.md), wenn du dabei Hilfe brauchst.
