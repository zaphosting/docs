...
title: "Banana Shooter: Automatisierte Server-Nachrichten – Halte deine Spieler über News, Social Links und mehr auf dem Laufenden!"
...
Mit **Geplanten Tasks** werden Server-Nachrichten automatisch in den **Banana Shooter** Ingame-Chat geschickt, indem vordefinierte Befehle nach einem Zeitplan ausgeführt werden.
...
Ersetze den Befehl durch den Game-Befehl oder Befehl einer Erweiterung, mit dem du Nachrichten triggern möchtest, und `<dein Nachrichtentext>` durch die Nachricht, die deine Spieler sehen sollen.

Anschließend kannst du festlegen, wie oft die Nachricht gesendet werden soll – z.B. alle paar Minuten, stündlich oder zu bestimmten Tageszeiten. Für detaillierte Anleitungen zum Erstellen von geplanten Tasks schau in die [Geplante Tasks](gameserver-scheduled-tasks.md) Anleitung.
