...
title: "Wreckfest2: Zum Server verbinden"
description: Informationen über verschiedene Möglichkeiten, wie du dich mit deinem Wreckfest2 Server von ZAP-Hosting verbinden kannst - ZAP-Hosting Dokumentation
...
![img](https://screensaver01.zap-hosting.com/index.php/s/sdWFHe7qjEkcWbx/preview)
...
Um eine Verbindung zu deinem Server über den Server-Browser im Spiel herzustellen, öffne den Server-Browser im Hauptmenü. Sobald du dort angelangt bist, klicke links auf **Connect to address**. Trage dort die IP-Adresse und Port deines Servers ein und klicke anschließend auf **Ok**, um die Verbindung herzustellen. 
