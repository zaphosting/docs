...
Um dich über den Ingame-Serverbrowser mit deinem Server zu verbinden, öffne den Serverbrowser im Hauptmenü. Klicke dort links auf **Mit Adresse verbinden**. Gib die IP-Adresse und den Port deines Servers ein und klicke dann auf **Ok**, um die Verbindung herzustellen.
