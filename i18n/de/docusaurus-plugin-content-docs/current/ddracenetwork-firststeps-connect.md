...
title: "DDraceNetwork: Zum Server verbinden"
description: Informationen über verschiedene Möglichkeiten, wie du dich mit deinem DDraceNetwork Server von ZAP-Hosting verbinden kannst - ZAP-Hosting Dokumentation
...
![img](https://screensaver01.zap-hosting.com/index.php/s/XbEGHFjNPRzAkF2/preview)
...
Um eine Verbindung zu deinem Server über den Server-Browser im Spiel herzustellen, öffne den Server-Browser über **Play** im Hauptmenü. Du kannst eine Verbindung in der Serverliste entweder über den Servernamen (Suchbegriff) oder über die IP-Adresse und den Port deines Servers herstellen. 
