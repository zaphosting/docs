...
title: "The Bus: Automatisierte Server-Nachrichten – Halte deine Spieler über News, Social Links und mehr auf dem Laufenden!"
...
Mit **Geplanten Tasks** können Server-Nachrichten automatisch in den **The Bus** Ingame-Chat geschickt werden, indem vordefinierte Befehle nach einem Zeitplan ausgeführt werden.
...
Automatisierte Server-Nachrichten sind ein zuverlässiger Weg, Spieler informiert und engagiert zu halten – ganz ohne manuellen Aufwand. Durch geplante Tasks, die Nachrichtenbefehle ausführen, können Server-Admins eine konstante Kommunikation auf ihrem Server sicherstellen.
