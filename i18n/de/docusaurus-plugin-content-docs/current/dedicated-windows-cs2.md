...
Der nächste Schritt ist die Installation. Diese erfolgt mit dem Befehl `app_update 730`. Die App ID **730** steht für die Anwendung **Counter Strike 2 Dedicated Server**.
