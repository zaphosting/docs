...
Jetzt öffnen wir per **Rechtsklick** die **Eigenschaften** des Adapters. 
...
Gehe sicher, dass du **deine** Server IP unter "IP-Adresse" eingibst. Wichtig hierbei ist, dass die Subnetzmaske immer ein Typ C Netz ist und somit immer 255.255.255.0 lautet. Das Standardgateway ist immer die IP-Adresse selber mit der 1 am Ende. Als DNS-Server nimmt man in der Regel den Google DNS, wie im obigen Screenshot.
