...
title: "Core Keeper: Mit dem Server verbinden"
description: "Entdecke, wie du dich reibungslos mit deinem Core Keeper Gameserver verbindest und häufige Probleme für ein nahtloses Spielerlebnis löst → Jetzt mehr erfahren"
...
<Tabs>
    <TabItem value="connect_solution_server_joine" label="Spiel beitreten" default>

Klicke im Spiel auf **Spiel beitreten** und gib die kopierte **Game ID** aus der `Game ID` Konfigurationsdatei in das Feld ein.
