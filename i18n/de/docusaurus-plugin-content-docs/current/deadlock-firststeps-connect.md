...
description: Informationen über verschiedene Möglichkeiten, wie du dich mit deinem Deadlock Server von ZAP-Hosting verbinden kannst - ZAP-Hosting Dokumentation
...
Um eine Verbindung zu deinem Server über die Konsole herzustellen, öffne die Konsole mit der Taste `F7`. Sobald die Konsole geöffnet ist, führe den folgenden Befehl aus: 
