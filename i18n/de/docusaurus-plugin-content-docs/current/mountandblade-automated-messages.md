...
title: "Mount & Blade: Automatisierte Server-Nachrichten – Halte deine Spieler über News, Social Links und mehr auf dem Laufenden!"
...
Automatisierte Server-Nachrichten sind eine simple, aber effektive Möglichkeit, wichtige Infos direkt im Spiel an deine Spieler zu kommunizieren. Du kannst sie nutzen, um Serverregeln anzuzeigen, Events anzukündigen, hilfreiche Tipps zu teilen oder Erinnerungen in regelmäßigen Abständen zu senden – ganz ohne manuellen Aufwand für Admins.

Mit **Geplanten Tasks** können Server-Nachrichten automatisch in den **Mount & Blade** Ingame-Chat geschickt werden, indem vordefinierte Befehle nach einem festgelegten Zeitplan ausgeführt werden.
