...
title: "Miscreated: Zum Server verbinden"
description: Informationen über verschiedene Möglichkeiten, wie du dich mit deinem Miscreated Server von ZAP-Hosting verbinden kannst - ZAP-Hosting Dokumentation
...
Um dich mit deinem Server über den Server-Browser im Spiel zu verbinden, öffne den Server-Browser im Hauptmenü. Klicke dazu auf **Join Server**. Suche dort nach deinem Server anhand deines Servernamens und klicke dann auf **Join Server**.
