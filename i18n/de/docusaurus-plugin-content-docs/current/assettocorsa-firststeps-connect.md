...
description: "Entdecke, wie du dich nahtlos mit deinem Assetto Corsa Server verbindest und ein reibungsloses Spielerlebnis sicherst → Jetzt mehr erfahren"
...
Um dich über den Ingame-Serverbrowser mit deinem Server zu verbinden, öffne den Serverbrowser im Hauptmenü. Navigiere zu **Drive** und wähle **Online**. Die Serverliste öffnet sich, in der du den Server über den Servernamen im **Suchfeld** finden kannst.
