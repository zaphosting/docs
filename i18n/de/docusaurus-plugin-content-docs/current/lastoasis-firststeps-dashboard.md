...
title: "Last Oasis: Dashboard Übersicht"
description: "Entdecke, wie du deinen Last Oasis Gameserver effizient verwaltest und seine Einstellungen für die beste Performance optimierst → Jetzt mehr erfahren"
...
Das **Dashboard** deines Servers ist das Herzstück der Administration. Hier werden alle grundlegenden und wichtigen Infos zu deinem Service übersichtlich dargestellt. Dazu gehören zum Beispiel Angaben zum Serverstandort, Status, IP: Port, genutztem Speicher, laufendem Spiel, Servername, Map und die Anzahl verfügbarer Slots. Außerdem wird die Auslastung von CPU, Speicher und RAM angezeigt.
...
Tritt ein technisches Problem auf und du bist unsicher, woran es liegt? Eine erste mögliche Lösungsstrategie ist das Prüfen der **Logdateien**. Diese Dateien enthalten viele Infos zum Server, wie aktuelle Ereignisse, Hinweise oder Fehlermeldungen.
...
Mit dem Editor hast du direkten Zugriff auf alle verfügbaren Optionen und kannst sie präzise anpassen. Das ist besonders nützlich für fortgeschrittene Nutzer, die volle Kontrolle über ihre Servereinstellungen wollen und genau wissen, welche Änderungen sie vornehmen möchten.
