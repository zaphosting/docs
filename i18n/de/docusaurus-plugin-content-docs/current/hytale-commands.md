...
Diese Seite gibt dir einen Überblick über häufig genutzte und offiziell dokumentierte Hytale Server-Befehle.
...
Diese Befehle steuern den administrativen Zugriff und die feingranulare Zuweisung von Berechtigungen für Nutzer und Gruppen.
...
| `/perm user list <uuid>`                 | Zeigt alle direkt dem Nutzer zugewiesenen Berechtigungen an. |
...
Whitelist-Befehle beschränken den Serverzugang nur auf genehmigte Spieler.
...
Diese Befehle beeinflussen direkt die Gameplay-Regeln und das Verhalten der Welt.
...
| `/status`        | Zeigt den aktuellen Serverstatus und Laufzeitinfos.  |



## Fazit

Das Hytale-Befehlssystem bietet mächtige Tools zur Verwaltung von Gameservern, Spielern und Gameplay-Verhalten. Mit dem Verständnis und der Nutzung der verfügbaren Befehle können Admins ihre Hytale Server-Umgebung effizient betreiben und anpassen.
