...
title: "Wreckfest: Zum Server verbinden"
description: Informationen über verschiedene Möglichkeiten, wie du dich mit deinem WreckfestServer von ZAP-Hosting verbinden kannst - ZAP-Hosting Dokumentation
...
Um eine Verbindung zu deinem Server herzustellen, öffne den Server-Browser im Hauptmenü. Klicke dazu auf **Multiplayer** und navigiere zu **Server-Browser**. Suche dort nach deinem Server, indem du den Servernamen deines Servers eingibst.
