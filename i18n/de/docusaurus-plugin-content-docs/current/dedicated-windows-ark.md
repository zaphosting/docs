...
Navigiere in das Verzeichnis, in dem du die Installation durchgeführt hast, und gehe in den folgenden Unterordner: **../steamapps/common/Ark Survival Evolved Dedicated Server/ShooterGame/Binaries/Win64**.

Dort musst du die Startdatei erstellen, die zum Ausführen der Server-Software benötigt wird. Erstelle eine Datei mit folgendem Namen: start-ark.bat
