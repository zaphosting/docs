...
Die Aktivierung des GOTV-Services erfolgt über die **server.cfg** Konfigurationsdatei. Die notwendigen Befehle müssen dort hinzugefügt werden:
...
Die oben genannten Befehle sind Pflicht, damit der GOTV-Masterserver aktiviert und erreichbar ist. Es gibt jedoch weitere Befehle für eine erweiterte Konfiguration:
...
|     tv_autorecord "0\|1"     | Nimmt alle Spiele automatisch als GOTV-Demos auf. Alle Spiele werden automatisch aufgenommen, das Demo-Dateiformat ist auto-YYYYYMMDD-hhmm-map.dem |
...
Wenn die Funktion auf dem Server aktiviert ist, ist der Zugriff über die IP-Adresse und den dafür zugewiesenen GOTV-Port auf dem Server möglich. Um dich zu verbinden, brauchst du die Konsole im Spiel. Dort kannst du dich mit folgendem Befehl verbinden:
