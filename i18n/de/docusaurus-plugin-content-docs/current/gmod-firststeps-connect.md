...
title: "Garry's Mod: Zum Server verbinden"
description: Informationen über verschiedene Möglichkeiten, wie du dich mit deinem Garry's Mod Server von ZAP-Hosting verbinden kannst - ZAP-Hosting Dokumentation
...
Um eine Verbindung zu deinem Server über den Server-Browser im Spiel herzustellen, öffne den Server-Browser im Hauptmenü. Klicke dazu auf **Find Multiplayer Game** und öffne dann den **Legacy Browser**. Suche dort mit dem **Suchfeld** und deinem Servernamen nach deinem Server und klicke dann auf **Connect**.
