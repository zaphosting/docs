...
title: "Battalion 1944: Zum Server verbinden"
description: Informationen über verschiedene Möglichkeiten, wie du dich mit deinem Battalion 1944 Server von ZAP-Hosting verbinden kannst - ZAP-Hosting Dokumentation
...
![img](https://screensaver01.zap-hosting.com/index.php/s/G3dKoz5AaRJTL3D/preview)
...
```
connect IP:Port
connect IP:Port; password deinPasswort // Wenn ein Server-Passwort festgelegt ist
```
