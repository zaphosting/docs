...
Verbinde dich zunächst über Remote Desktop (RDP) mit deinem VPS oder Root-Server. Benutze unseren Anleitung [RDP-Erstzugang](vserver-windows-userdp.md), wenn du dabei Hilfe brauchst.
