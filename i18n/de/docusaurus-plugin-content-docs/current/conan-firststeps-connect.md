...
title: "Conan Exiles: Zum Server verbinden"
...
![img](https://screensaver01.zap-hosting.com/index.php/s/Gbp5GNxLi98i7qz/preview)
...
Um dich mit deinem Server zu verbinden, navigiere im Spiel zu **Play Online**. Es öffnet sich die Server-Liste. In der Server-Liste kannst du über das **Namensfeld** nach dem Namen deines Servers suchen. Wähle deinen Server aus und klicke auf **Join**.
...
Um dich mit deinem Server zu verbinden, navigiere im Spiel zu **Play Online**. Es öffnet sich die Server-Liste. An Stelle nach deinem Server zu suchen kannst du unten links auf **Direct Connect** klicken und mit der IP-Adresse und Port deines Servers die Verbindung herstellen. 
