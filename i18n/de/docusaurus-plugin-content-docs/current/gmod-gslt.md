---
id: gmod-gslt
title: "Garry’s Mod:  GSLT erstellen (Steam Game Server Login Token)"
...
Nach der Anmeldung hast du die Möglichkeit, über das auf der Seite angezeigte Formular einen neuen Token zu erstellen. Gebe in das Feld **App-ID** die App-ID `4000` ein, die zu **Garry’s Mod** gehört. Achte darauf, die richtige ID einzugeben, da der Token mit einem falschen Wert nicht funktionieren wird.
...
:::info Betreiben von mehreren Garry’s Mod Servern
Wenn mehrere **Garry’s Mod** Server betrieben werden, wird für jeden Server ein GSLT benötigt. Es ist <u>**nicht**</u> möglich, mehrere Gameserver über einen einzigen GSLT zu betreiben.
:::
