...
title: "Icarus: Zum Server verbinden"
description: Informationen über verschiedene Möglichkeiten, wie du dich mit deinem Icarus Server von ZAP-Hosting verbinden kannst - ZAP-Hosting Dokumentation
...
Um eine Verbindung zu deinem Server über den Server-Browser im Spiel herzustellen, öffne den Server-Browser. Klicke dazu auf **Play**, erstelle einen Character, sofern du noch keinen erstellt hast. Im Anschluss in der Serverliste kannst du nun oben über das Suchfeld nach deinem Server anhand des Namens suchen. 
...
Alternativ kannst du anstelle nach dem Server zu suchen auch anhand der IP-Adresse und Port des Servers den Server hinzufügen und eine Verbindung herstellen. Klicke dazu in der Serverliste auf **Direct connect** und trage die Informationen ein. 
