...
title: "Necesse: Zum Server verbinden"
description: Informationen über verschiedene Möglichkeiten, wie du dich mit deinem Necesse Server von ZAP-Hosting verbinden kannst - ZAP-Hosting Dokumentation
...
![img](https://screensaver01.zap-hosting.com/index.php/s/P9jmeoYHZxDkK4T/preview)
...
Um eine Verbindung zu deinem Server herzustellen, öffne das Spiel und navigiere zu **Multiplayer** im Hauptmenü. Klicke anschließend auf **Add Server** und trage dort einen Namen und die IP-Adresse und Port deines Servers ein. Bestätige die Eingabe mit dem **Add** Button. 
