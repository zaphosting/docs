...
title: "Barotrauma: Zum Server verbinden"
description: Informationen über verschiedene Möglichkeiten, wie du dich mit deinem Barotrauma Server von ZAP-Hosting verbinden kannst - ZAP-Hosting Dokumentation
...
![img](https://screensaver01.zap-hosting.com/index.php/s/zWkmq8aQAnFZ3nJ/preview)
...
Um eine Verbindung zu deinem Server über den Server-Browser im Spiel herzustellen, öffne den Server-Browser im Hauptmenü. Suche dort in der **Serverliste** mit Hilfe des Servernamens nach deinem Server. Wähle deinen Server aus und klicke auf **Join**.
...
Um eine Verbindung zu deinem Server über den Server-Browser im Spiel herzustellen, öffne den Server-Browser im Hauptmenü. Klicke dort unten auf **Direct Join** und gebe die IP-Adresse und den Port deines Servers ein. Bestätige die Eingabe und stelle die Verbindung her, indem du auf den Button **Join** klickst.
