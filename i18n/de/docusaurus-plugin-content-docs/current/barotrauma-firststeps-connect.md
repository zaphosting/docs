...
description: "Entdecke, wie du dich reibungslos mit deinem Barotrauma Gameserver verbindest und ein störungsfreies Spielerlebnis sicherst → Jetzt mehr erfahren"
...
Um dich über den Ingame-Serverbrowser mit deinem Server zu verbinden, öffne den Serverbrowser im Hauptmenü. Suche dort in der **Serverliste** nach deinem Server anhand des Servernamens. Wähle deinen Server aus und klicke auf **Beitreten**.
...
Um dich direkt mit deinem Server zu verbinden, öffne im Hauptmenü den Serverbrowser. Klicke unten auf **Direkt beitreten** und gib die IP-Adresse und den Port deines Servers ein. Bestätige die Eingabe und stelle die Verbindung über den **Beitreten**-Button her.
