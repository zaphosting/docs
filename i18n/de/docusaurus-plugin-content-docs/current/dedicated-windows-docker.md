...
description: "Entdecke, wie du Anwendungen zuverlässig mit Docker-Containern deployen und verwalten kannst – für effizientes Skalieren und Updates → Jetzt mehr erfahren"
...
Um Docker auf deinem Windows Server einzurichten, lade das PowerShell-Skript `install-docker-ce.ps1` herunter und führe es aus. Es aktiviert die für Container benötigten Windows-Features und installiert die Docker-Laufzeit. Öffne PowerShell als Administrator und führe folgenden Befehl aus:
...
Das System wird während der Installation neu starten und sollte danach automatisch fortfahren. Nach dem Neustart melde dich an und führe den Befehl erneut aus, falls das Skript dich dazu auffordert, damit der Dienst die Initialisierung abschließen kann. Nach Abschluss sieht die Ausgabe so aus:
...
Glückwunsch! Du hast Docker erfolgreich auf deinem Dedicated Server installiert und konfiguriert. Wir empfehlen dir außerdem, einen Blick auf die folgenden Ressourcen zu werfen, die dir bei der Server-Konfiguration weiterhelfen können:
