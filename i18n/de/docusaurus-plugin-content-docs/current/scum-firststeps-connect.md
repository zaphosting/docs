...
title: "SCUM: Mit dem Server verbinden"
description: "Entdecke, wie du dich reibungslos mit deinem SCUM Gameserver verbindest – mit wichtigen Tipps und Troubleshooting-Hinweisen → Jetzt mehr erfahren"
...
## Einführung
Du bist dir nicht sicher, wie du dich mit deinem **SCUM** Gameserver verbindest oder was du dafür brauchst? Kein Stress, wir helfen dir! Wir zeigen dir alles, was du wissen musst. Von den nötigen Tools und Infos bis hin zum eigentlichen Verbindungsprozess – inklusive wichtiger Tipps, damit alles glatt läuft und du keine Probleme bekommst. Folge unserer Anleitung und du bist im Handumdrehen verbunden!
...
<Tabs>
    <TabItem value="connect_solution_server_browser_ingame" label="Server Browser Direkte Verbindung (Im Spiel)" default>

Um dich mit deinem Server zu verbinden, musst du das Spiel starten. Im Spiel rufst du dann das Menü **Multi Play** auf. Klicke unten links auf das Feld **IP:Port** und gib die Daten deines Gameservers ein. Bestätige die Eingabe mit der `Enter`-Taste.
