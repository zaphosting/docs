...
title: "SCUM: Zum Server verbinden"
description: Informationen über verschiedene Möglichkeiten, wie du dich mit deinem SCUM Server von ZAP-Hosting verbinden kannst - ZAP-Hosting Dokumentation
...
Um die Verbindung zu deinem Server herzustellen, musst du das Spiel öffnen. Im Spiel angelangt, rufst du den Menüpunkt **Multi Play** auf. Klicke unten Links auf das **IP:Port** Feld und trage dort die Informationen deines Gameservers ein. Bestätige die Eingabe mit der `Enter` Taste
