...
title: "Vintage Story: Dashboard-Übersicht"
description: "Entdecke, wie du deinen Vintage Story Gameserver effizient verwaltest und optimierst – mit einer klaren, strukturierten Übersicht → Jetzt mehr erfahren"
...
Im Bereich **Einstellungen** findest du alle notwendigen Seiten zur Konfiguration deines Servers. Die verfügbaren Optionen zur Servereinstellung sind hier detailliert aufgelistet.

### Einstellungen

Unter Einstellungen findest du eine Übersicht der gängigsten Konfigurationsoptionen für deinen Server. Diese sind jeweils mit einer kurzen Erklärung versehen. Die Nutzung der Einstellungsseite empfehlen wir besonders Einsteigern in die Serververwaltung.
...
Für unsere Gameserver-Produkte stellen wir standardmäßig 10 GB Speicherplatz auf dem Speicher-Server für Backups zur Verfügung. Wenn du mehr Speicherplatz brauchst, kannst du diesen kostenpflichtig upgraden. So stellst du sicher, dass du immer genug Platz für deine Backups hast und bei Bedarf auch ältere Backups noch zugänglich sind.
