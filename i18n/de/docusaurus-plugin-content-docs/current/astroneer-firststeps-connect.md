...
title: "ASTRONEER: Mit dem Server verbinden"
description: "Entdecke, wie du dich reibungslos mit deinem ASTRONEER Gameserver verbindest und häufige Probleme für unterbrechungsfreies Gameplay löst → Jetzt mehr erfahren"
...
Um dich über den Ingame-Serverbrowser mit deinem Server zu verbinden, öffne im Hauptmenü den **Server Browser**. Klicke in der Serverliste auf **Dedicated Server hinzufügen**, um deinen Server hinzuzufügen. Gib die IP-Adresse und den Port deines Servers ein und vergib einen Namen. Klicke dann auf **Server hinzufügen**, wähle den hinzugefügten Server aus und stelle die Verbindung her.
