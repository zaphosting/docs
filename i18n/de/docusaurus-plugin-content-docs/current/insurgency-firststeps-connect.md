---
id: insurgency-firststeps-connect
title: "Insurgency: Sandstorm: Zum Server verbinden"
description: "Informationen über verschiedene Möglichkeiten, wie du dich mit deinem Insurgency: Sandstorm Server von ZAP-Hosting verbinden kannst - ZAP-Hosting Dokumentation"
...
Starte dein Spiel, um dich mit deinem Server zu verbinden. Navigiere im Hauptmenü zu **Play** und wähle den **Server-Browser** aus. In der Serverliste kannst du mit dem Suchfeld und dem Namen deines Servers nach deinem Server suchen. 

![img](https://screensaver01.zap-hosting.com/index.php/s/pxFqH3fnkBxg7RF/download)

</TabItem>

<TabItem value="connect_solution_direct_ingame" label="Direktverbindung (Im Spiel)">

Starte dein Spiel, um dich mit deinem Server zu verbinden. Navigiere im Hauptmenü zu **Play** und wähle den **Server-Browser** aus. Klicke nun unten links auf **Connect to IP** und trage die IP-Adresse, Port und das Passwort deines Servers ein.

![img](https://screensaver01.zap-hosting.com/index.php/s/iZoJMBnpwfJFikz/download)
