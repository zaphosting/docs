...
title: "Empyrion: Zum Server verbinden"
description: Informationen über verschiedene Möglichkeiten, wie du dich mit deinem Empyrion Server von ZAP-Hosting verbinden kannst - ZAP-Hosting Dokumentation
...
![img](https://screensaver01.zap-hosting.com/index.php/s/qMG5L2mRX2ebsP3/preview)
...
<Tabs>
    <TabItem value="connect_solution_server_direct" label="Server Browser (Im Spiel)" default>

Öffne das Spiel, um dich mit deinem Server zu verbinden. Rufe die **Serverliste** im Spiel auf und gib die IP-Adresse und den Port des Servers in das Feld **Direct IP and Port** ein. Klicke anschließend auf den Button **Connect**, um die Verbindung herzustellen.
