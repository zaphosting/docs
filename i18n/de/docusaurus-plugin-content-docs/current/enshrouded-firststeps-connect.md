...
title: "Enshrouded: Zum Server verbinden"
description: Informationen über verschiedene Möglichkeiten, wie du dich mit deinem Enshrouded Server von ZAP-Hosting verbinden kannst - ZAP-Hosting Dokumentation
...
![img](https://github.com/zaphosting/docs/assets/42719082/94c5d078-fe34-42dd-b5e4-75bc9fc7776a)
...
Um eine Verbindung zu deinem Server über den Server-Browser im Spiel herzustellen, öffne das Spiel. Von dort aus klicke auf **Play**, bei der Spielauswahl wähle **Join** und klicke dann rechts auf **Search for servername**. Es öffnet sich ein Popup-Fenster in dem du den Namen deines Servers einträgst und dann auf suchen klickst. Im Anschluss sollte dir dein Server angezeigt werden. 
