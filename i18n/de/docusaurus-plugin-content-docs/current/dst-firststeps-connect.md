...
title: "Don't Starve Together: Zum Server verbinden"
description: Informationen über verschiedene Möglichkeiten, wie du dich mit deinem Don't Starve Together Server von ZAP-Hosting verbinden kannst - ZAP-Hosting Dokumentation
...
Um eine Verbindung zu deinem Server über den Server-Browser im Spiel herzustellen, öffne den Server-Browser im Hauptmenü. Klicke dazu auf **Browse Games** . Sobald du dort bist, suche nach deinem Server, indem du das **Suchfeld** und deinen Servernamen verwendest und dann auf **Join** klickst.
