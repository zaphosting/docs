...
Im Dashboard kannst du deinen Service auch starten, stoppen oder neu starten, um volle Kontrolle über den Betrieb zu haben. Außerdem hast du Zugriff auf die Live-Konsole, um Echtzeit-Infos zum Serverzustand zu bekommen und bei Bedarf direkt eingreifen zu können.
...
Unter den Einstellungen findest du eine Übersicht der gängigsten Einstellungsmöglichkeiten für deinen Server. Dazu gehören auch kurze Erklärungen. Die Nutzung der Einstellungsseite empfehlen wir besonders Einsteigern in die Serveradministration.
