...
title: "Craftopia: Mit dem Server verbinden"
description: "Entdecke, wie du dich reibungslos mit deinem Craftopia Gameserver verbindest und häufige Probleme für ein nahtloses Spielerlebnis löst → Jetzt mehr erfahren"
...
Die Verbindung zu einem Gameserver kann oft auf eine oder mehrere Arten hergestellt werden. Verfügbare Methoden werden im Folgenden beschrieben und detailliert erklärt.

<Tabs>
    <TabItem value="connect_solution_direct_ingame" label="Direkt verbinden (Im Spiel)" default>

Um dich mit deinem Server zu verbinden, öffne das Spiel und gehe im Hauptmenü auf **Multiplayer**. Klicke dort auf **Per IP beitreten**. Gib die IP-Adresse und den Port deines Servers ein und klicke auf **Starten**.
