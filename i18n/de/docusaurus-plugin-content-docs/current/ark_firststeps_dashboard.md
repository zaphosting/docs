...
description: Informationen zum Dashboard eines ARK Server von ZAP-Hosting - ZAP-Hosting.com Dokumentationen
...
| Anleitungen            | Seite                                                        |
| ---------------------- | ------------------------------------------------------------ |
| Admin werden           | [Anleitung aufrufen](https://zap-hosting.com/guides/docs/de/ark_becomeadmin) |
| Mods installieren      | [Anleitung aufrufen](https://zap-hosting.com/guides/docs/de/ark_mods) |
| Serverlisting Probleme | [Anleitung aufrufen](https://zap-hosting.com/guides/docs/de/ark_serverlisting) |
| Server Konfiguration   | [Anleitung aufrufen](https://zap-hosting.com/guides/docs/de/ark_configuration) |
...
![img](https://screensaver01.zap-hosting.com/index.php/s/xJHib4SFojFTtaX/preview)

Hier kannst du beispielsweise folgende Anpassungen vornehmen: 

- Basiseinstellungen: Servername, Server Passwort, Karte / Map, Erlaube Crossplay, ARK Events, Willkommensnachricht auf dem Server, Fadenkreuz, Hölenbau, Maximale zähmbare Dinos, usw.
- Spielereinstellungen: Baby kuscheln
- Schwierigkeiten: Player Damage Multiplier, Dino Damage Multiplier, Structure Damage Multiplier usw. 
...
![img](https://screensaver01.zap-hosting.com/index.php/s/eFHyHHx5zF2nAWz/preview)
...
![img](https://screensaver01.zap-hosting.com/index.php/s/Nt76Ym8qfcgRcBN/preview)
