...
title: "American Truck Simulator: Automatisierte Server-Nachrichten – Halte deine Spieler über News, Social Links und mehr auf dem Laufenden!"
...
Mit **Geplanten Tasks** können Server-Nachrichten automatisch in den **American Truck Simulator** Ingame-Chat geschickt werden, indem vordefinierte Befehle nach einem Zeitplan ausgeführt werden.
