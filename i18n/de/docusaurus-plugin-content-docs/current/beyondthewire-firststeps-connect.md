...
title: "Beyond the Wire: Zum Server verbinden"
description: Informationen über verschiedene Möglichkeiten, wie du dich mit deinem Beyond the Wire Server von ZAP-Hosting verbinden kannst - ZAP-Hosting Dokumentation
...
![img](https://screensaver01.zap-hosting.com/index.php/s/qcB2Jk52nmF5i3d/preview)
...
Um eine Verbindung zu deinem Server herzustellen, öffne das Spiel und navigiere zu **Multiplayer**. Sobald du dort bist, klicke auf **Custom Browser** und suche nach deinem Server, indem du den Servernamen in der Serverliste verwendest.
