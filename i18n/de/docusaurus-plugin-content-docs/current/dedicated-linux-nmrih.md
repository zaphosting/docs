...
Sobald du eingeloggt bist, kannst du die Installation mit folgendem Befehl starten, der SteamCMD nutzt, um den Server direkt im Verzeichnis des `steam` Benutzers zu installieren:
```
...
Jetzt hast du die Grundinstallation deines No More Room In Hell Servers abgeschlossen. Weitere Servereinstellungen kannst du direkt in der Startdatei vornehmen.
