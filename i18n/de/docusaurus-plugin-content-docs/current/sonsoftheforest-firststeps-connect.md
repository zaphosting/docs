...
title: "Sons of the Forest: Zum Server verbinden"
description: Informationen über verschiedene Möglichkeiten, wie du dich mit deinem Sons of the Forest Server von ZAP-Hosting verbinden kannst - ZAP-Hosting Dokumentation
...
![img](https://screensaver01.zap-hosting.com/index.php/s/Arb4bFMmZisq4dM/preview)
...
Sobald du im Spiel bist, klicke auf **Multiplayer** und wähle **Join** aus. Klicke in der Server Liste auf **Direct** und trage in dem Feld die IP-Adresse und Port deines Servers ein. Bestätige die Eingabe, um die  Verbindung herzustellen. 
