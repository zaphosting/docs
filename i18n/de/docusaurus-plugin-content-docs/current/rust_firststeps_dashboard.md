...
description: Informationen zum Dashboard eines Rust Server von ZAP-Hosting - ZAP-Hosting.com Dokumentationen
...
![img](https://screensaver01.zap-hosting.com/index.php/s/pJRNWz3KQZYxCXm/preview)
...
| Anleitungen          | Seite                                                        |
| -------------------- | ------------------------------------------------------------ |
| Admin werden         | [Anleitung aufrufen](https://zap-hosting.com/guides/docs/de/rust_becomeadmin) |
| Connect via RCON     | [Anleitung aufrufen](https://zap-hosting.com/guides/docs/de/rust_connectrcon) |
| Admin Befehle        | [Anleitung aufrufen](https://zap-hosting.com/guides/docs/de/rust_commands) |
| Plugins installieren | [Anleitung aufrufen](https://zap-hosting.com/guides/docs/de/rust_plugins) |
| Decay                | [Anleitung aufrufen](https://zap-hosting.com/guides/docs/de/rust_decay) |
...
![img](https://screensaver01.zap-hosting.com/index.php/s/6sTgNk78eWW2G2n/preview)

Hier kannst du beispielsweise folgende Anpassungen vornehmen: 

- Basiseinstellungen: Servername, Serverbeschreibung, Server URL, Headerbild, Map, Savegame Name, Savegame seed, Weltgröße, Speicher Intervall, Rcon Passwort, Server Tags, Web RCON, EAC Anticheat, Hardcore
...
![img](https://screensaver01.zap-hosting.com/index.php/s/N265gGEwSLcXmT7/preview)
