...
![img](https://screensaver01.zap-hosting.com/index.php/s/Tf9jJBExEfe2jW9/preview)
...
| Anleitungen                              | Seite                                                        |
| ---------------------------------------- | ------------------------------------------------------------ |
| Server konfigurieren                     | [Anleitung aufrufen](https://zap-hosting.com/guides/docs/de/assettocorsa_configure) |
| Server konfigurieren mit Content Manager | [Anleitung aufrufen](https://zap-hosting.com/guides/docs/de/assettocorsa_contentmanager) |
| Mods installieren                        | [Anleitung aufrufen](https://zap-hosting.com/guides/docs/de/assettocorsa_mods) |
...
![img](https://screensaver01.zap-hosting.com/index.php/s/DZsWfTN4RXxq98N/preview)

Hier kannst du beispielsweise folgende Anpassungen vornehmen: 

- Basiseinstellungen: Servername, Admin Passwort
...
![img](https://screensaver01.zap-hosting.com/index.php/s/gNBxjcT9FQwSaq5/preview)
