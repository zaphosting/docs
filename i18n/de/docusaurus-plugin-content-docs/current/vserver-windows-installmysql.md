...
Ein MySQL-Server wird für verschiedene Anwendungen benötigt und kann wichtige Daten enthalten, zum Beispiel für einen Gameserver oder eine Website. Im Folgenden erklären wir dir, wie du deinen eigenen MySQL-Datenbankserver auf deinem Windows VPS einrichtest.
<InlineVoucher />

## Installation

Zuerst verbindest du dich per Remote Desktop Verbindung mit deinem Server und lädst die neueste Version von MariaDB herunter, die für den Datenbankserver verwendet wird: [MariaDB Download](https://mariadb.org/download/?t=mariadb). Entpacke das heruntergeladene Archiv mit WinRAR oder 7Zip und starte die Installationsdatei per Doppelklick.
...
Eine Anleitung, wie du Ports in der Firewall weiterleitest, findest du hier:
