...
description: "Entdecke, wie du deinen Gameserver mit Sourcemod und Metamod anpassen und erweitern kannst – für bessere Verwaltung und coole Features → Jetzt mehr erfahren"
...
Lerne, wie du Sourcemod und Metamod installierst und Plugins auf deinem Server nutzt. Beide Erweiterungen ermöglichen es dir, Games wie CS:S, CS:GO, DoD:S oder TF2 zu individualisieren und die verfügbaren Verwaltungsoptionen für deinen Gameserver deutlich zu erweitern.
...
Wenn du die obigen Schritte erledigt hast, kannst du mit der Installation starten. Lade die Dateien per FTP mit einem FTP-Client auf deinen Server hoch. Falls du FTP noch nicht kennst oder nicht weißt, wie das funktioniert, schau dir unsere Anleitung an: [Zugriff via FTP](gameserver-ftpaccess.md)
...
Nachdem du die gewünschten Plugins heruntergeladen hast, kannst du sie installieren. Lade die Plugin-Dateien per FTP in folgendes Verzeichnis hoch:
