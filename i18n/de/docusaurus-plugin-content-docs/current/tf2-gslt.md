---
id: tf2-gslt
title: "Team Fortress 2: GSLT erstellen (Steam Game Server Login Token)"
description: "Informationen zur Erstellung und Verwendung von GSLT für Team Fortress 2 Server von ZAP-Hosting - ZAP-Hosting.com Dokumentation"
...
Nach der Anmeldung hast du die Möglichkeit, über das auf der Seite angezeigte Formular einen neuen Token zu erstellen. Gebe in das Feld **App-ID** die App-ID `440` ein, die zu **Team Fortress 2** gehört. Achte darauf, die richtige ID einzugeben, da der Token mit einem falschen Wert nicht funktionieren wird.
...
:::info Betreiben von mehreren Team Fortress 2 Servern
Wenn mehrere **Team Fortress 2** Server betrieben werden, wird für jeden Server ein GSLT benötigt. Es ist <u>**nicht**</u> möglich, mehrere Gameserver über einen einzigen GSLT zu betreiben.
:::
