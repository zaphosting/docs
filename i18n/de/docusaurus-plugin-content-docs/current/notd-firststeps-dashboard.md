...
title: "Night of the Dead: Dashboard-Übersicht"
description: "Entdecke, wie du deinen Night of the Dead Gameserver effizient verwaltest und optimierst für nahtlose Performance und volle Kontrolle → Jetzt mehr erfahren"
...
Im Dashboard kannst du deinen Service auch starten, stoppen oder neu starten, um volle Kontrolle über den Betrieb zu haben. Außerdem hast du Zugriff auf die Live-Konsole, um Echtzeit-Infos zum Serverstatus zu bekommen und bei Bedarf direkt eingreifen zu können.
...
Mit dem **FTP-Browser** bekommst du alle notwendigen Infos, um eine Verbindung zum FTP-Zugang herzustellen. Der FTP-Zugang erlaubt dir den direkten Zugriff auf die Dateien deines Gameservers. Für die optimale Nutzung empfehlen wir ein externes FTP-Programm wie **Filezilla** oder **WinSCP**. Wenn du noch nicht weißt, wie FTP funktioniert, empfehlen wir dir einen Blick in unsere [FTP-Zugang](gameserver-ftpaccess.md) Anleitung.
