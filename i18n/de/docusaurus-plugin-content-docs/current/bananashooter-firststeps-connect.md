...
title: "Banana Shooter: Zum Server verbinden"
description: Informationen über verschiedene Möglichkeiten, wie du dich mit deinem Banana Shooter Server von ZAP-Hosting verbinden kannst - ZAP-Hosting Dokumentation
...
Um eine Verbindung zu deinem Server herzustellen, öffne das Spiel und navigiere zum Menüpunkt **Multiplayer**. Wähle dort den **Community Server Browser** und suche deinen Server mithilfe des Servernamens. 
