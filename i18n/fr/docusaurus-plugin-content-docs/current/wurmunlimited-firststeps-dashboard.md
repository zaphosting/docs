...
title: "Wurm Unlimited : Aperçu du Tableau de Bord"
description: "Découvrez comment gérer efficacement votre serveur Wurm Unlimited avec un aperçu clair des fonctionnalités et options → En savoir plus maintenant"
...
> ⚠️ Les infos trouvées ne vous aident pas ou vous ne les comprenez pas ? Pas de souci ! Dans ce cas, notre support est dispo tous les jours. Créez simplement un **[ticket](https://zap-hosting.com/en/customer/support/)** et expliquez-nous votre problème. On le regardera au plus vite et vous aidera à le résoudre ! :)
...
En plus de surveiller les événements, vous pouvez aussi envoyer des commandes directement au serveur via la **Console Live**. C’est super utile pour ajuster des réglages, effectuer certaines actions ou réagir vite à des problèmes qui surgissent.
