...
title: "FiveM : Messages Automatisés sur le Serveur - Tiens tes joueurs au courant des news, liens sociaux et plus encore !"
...
Avec les **Tâches Planifiées**, les messages peuvent être envoyés automatiquement dans le chat en jeu de **FiveM** en exécutant des commandes prédéfinies selon un planning récurrent.
...
Pour créer des messages automatisés sur ton serveur, ouvre ton tableau de bord serveur de jeux et va dans la section **Tâches Planifiées**. Crée une nouvelle tâche planifiée et choisis l’option pour exécuter une **commande**. Dans le champ commande, entre la commande message supportée par ton serveur de jeux.
...
L’intervalle peut être modifié à tout moment sans redémarrer le serveur, ce qui permet de s’adapter facilement à l’évolution de ton serveur.
