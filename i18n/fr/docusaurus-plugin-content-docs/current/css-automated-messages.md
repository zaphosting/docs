...
title: "Counter-Strike: Source : Messages Automatisés sur le Serveur - Tiens tes joueurs au courant des news, liens sociaux et plus encore !"
...
Grâce aux **Tâches Planifiées**, les messages serveur peuvent être envoyés automatiquement dans le chat en jeu de **Counter-Strike: Source** en exécutant des commandes prédéfinies selon un planning récurrent.
