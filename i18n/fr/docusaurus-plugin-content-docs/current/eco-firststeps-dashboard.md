...
description: "Découvrez comment gérer efficacement votre serveur Eco - Global Survival et optimiser ses réglages pour une expérience de jeu au top → Apprenez-en plus maintenant"
...
En plus de surveiller les événements, tu peux aussi envoyer des commandes directement au serveur via la **Console Live**. C’est super pratique pour ajuster des réglages, lancer certaines actions ou réagir vite à un souci.
