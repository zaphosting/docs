...
title: "Project Zomboid : Messages Automatisés sur le Serveur - Tiens tes joueurs au courant des news, liens sociaux et plus encore !"
...
Grâce aux **Tâches Planifiées**, les messages peuvent être envoyés automatiquement dans le chat en jeu de **Project Zomboid** en exécutant des commandes prédéfinies selon un planning récurrent.
...
Pour créer des messages automatisés sur ton serveur, ouvre le tableau de bord de ton serveur de jeux et va dans la section **Tâches Planifiées**. Crée une nouvelle tâche planifiée et choisis l’option d’exécuter une **commande**. Dans le champ commande, entre la commande message supportée par ton serveur de jeux.
