...
title: "Rising World : Messages Automatisés du Serveur - Tiens tes joueurs au courant des news, liens sociaux et plus encore !"
...
Avec les **Tâches Planifiées**, les messages du serveur peuvent être envoyés automatiquement dans le chat en jeu de **Rising World** en exécutant des commandes prédéfinies selon un planning récurrent.
...
L’intervalle peut être ajusté à tout moment sans redémarrer le serveur, ce qui permet de faire évoluer la fréquence facilement au fur et à mesure que ton serveur grandit.
