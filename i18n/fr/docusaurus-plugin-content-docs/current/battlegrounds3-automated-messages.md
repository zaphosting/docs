...
title: "Battle Grounds III : Messages Automatisés du Serveur - Tiens tes joueurs au courant des news, liens sociaux et plus encore !"
...
Avec les **Tâches Planifiées**, les messages du serveur peuvent être envoyés automatiquement dans le chat en jeu de **Battle Grounds III** en exécutant des commandes prédéfinies selon un planning récurrent.
...
Pour créer des messages automatisés, ouvre le tableau de bord de ton serveur de jeux et va dans la section **Tâches Planifiées**. Crée une nouvelle tâche planifiée et choisis l’option pour exécuter une **commande**. Dans le champ commande, entre la commande de message supportée par ton serveur de jeux.
...
Une fois configurés, les messages automatisés tournent de façon autonome et peuvent être facilement réutilisés en ajustant simplement la commande et le texte spécifiques au jeu.
