...
title: "Vintage Story : Messages Automatisés du Serveur - Tiens tes joueurs au courant des news, liens sociaux et plus encore !"
...
Avec les **Tâches Planifiées**, les messages du serveur peuvent être envoyés automatiquement dans le chat en jeu de **Vintage Story** en exécutant des commandes prédéfinies selon un planning récurrent.
...
Les messages automatisés du serveur sont un moyen fiable pour garder les joueurs informés et engagés sans effort manuel. En utilisant les tâches planifiées pour exécuter des commandes message, les admins peuvent assurer une communication constante sur leur serveur.
