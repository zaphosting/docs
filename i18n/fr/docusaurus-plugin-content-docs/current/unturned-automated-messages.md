...
title: "Unturned : Messages Automatisés du Serveur - Tiens tes joueurs au courant des news, liens sociaux et plus encore !"
...
Avec les **Tâches Planifiées**, les messages du serveur peuvent être envoyés automatiquement dans le chat en jeu de **Unturned** en exécutant des commandes prédéfinies selon un planning récurrent.
