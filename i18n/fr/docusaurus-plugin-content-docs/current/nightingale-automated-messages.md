...
title: "Nightingale : Messages Automatisés du Serveur - Tiens tes joueurs au courant des news, liens sociaux et plus encore !"
...
Les messages automatisés sur serveur sont un moyen simple mais efficace de communiquer des infos importantes aux joueurs directement en jeu. Ils peuvent servir à afficher les règles du serveur, annoncer des événements, partager des astuces utiles ou envoyer des rappels à intervalles réguliers sans que les admins aient à intervenir manuellement.

Avec les **Tâches Planifiées**, les messages peuvent être envoyés automatiquement dans le chat en jeu de **Nightingale** en exécutant des commandes prédéfinies selon un planning récurrent.
...
La fonctionnalité des messages automatisés dépend des capacités du jeu et des commandes disponibles. Si les messages planifiés basiques peuvent être mis en place avec les commandes serveur standards, cette méthode peut être limitée en termes de formatage, conditions ou personnalisation avancée.
...
Les messages automatisés sur serveur sont un moyen fiable de garder les joueurs informés et engagés sans effort manuel. En utilisant les tâches planifiées pour exécuter des commandes message, les admins assurent une communication constante sur leur serveur.
