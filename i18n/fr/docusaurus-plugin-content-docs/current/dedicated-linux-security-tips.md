...
Vous avez fini la configuration par défaut. Pour surveiller le service SSH par exemple, descendez un peu plus jusqu’à la section `[sshd]`. Si vous avez modifié votre port, indiquez-le sous `port`.
