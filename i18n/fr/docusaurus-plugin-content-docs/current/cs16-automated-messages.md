...
title: "Counter-Strike 1.6 : Messages Automatisés sur le Serveur - Tiens tes joueurs au courant des news, liens sociaux et plus encore !"
description: "Configure des messages automatisés sur ton serveur avec des tâches planifiées pour afficher des annonces récurrentes"
...
Avec les **Tâches Planifiées**, les messages serveur peuvent être envoyés automatiquement dans le chat en jeu de **Counter-Strike 1.6** en exécutant des commandes prédéfinies selon un planning récurrent.
