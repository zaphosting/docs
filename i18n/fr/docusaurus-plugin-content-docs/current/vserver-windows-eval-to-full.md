...
Pour vérifier quelle édition est actuellement installée, ouvre une invite de commandes ou PowerShell en mode administrateur et exécute la commande suivante :

```powershell
DISM /Online /Get-CurrentEdition
```

Le résultat affichera l’identifiant de l’édition active. Les installations d’évaluation apparaissent généralement sous `ServerStandardEval` ou `ServerDatacenterEval`.
...
| Édition du système d’exploitation | Clé de licence générique Volume |
| --------------------------------- | -------------------------------- |
