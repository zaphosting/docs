...
title: "Operation: Harsh Doorstop : Messages Automatisés du Serveur - Tiens tes joueurs au courant des news, liens sociaux et plus encore !"
...
Les messages automatisés sur serveur sont un moyen simple mais efficace de communiquer des infos importantes directement en jeu à tes joueurs. Tu peux les utiliser pour afficher les règles du serveur, annoncer des événements, partager des astuces utiles ou envoyer des rappels à intervalles réguliers sans que les admins aient à intervenir manuellement.

Grâce aux **Tâches Planifiées**, les messages peuvent être envoyés automatiquement dans le chat en jeu de **Operation: Harsh Doorstop** en exécutant des commandes prédéfinies selon un planning récurrent.
