...
Avec Tebex, vous avez la possibilité de monétiser votre serveur de jeux en vendant des biens virtuels et des grades contre de l’argent réel. C’est un outil puissant et fiable conçu spécialement pour les administrateurs de serveurs de jeux qui souhaitent offrir une meilleure expérience de jeu à leurs joueurs.

![](https://screensaver01.zap-hosting.com/index.php/s/TbwafKd3Kmq4WrS/preview)

Tebex est facile à utiliser et offre de nombreuses fonctionnalités pour personnaliser et optimiser votre boutique. Vous pouvez personnaliser la mise en page, ajouter des options de paiement et même lancer des campagnes marketing pour toucher plus de joueurs.
...
La **Console en direct** vous propose une vue en temps réel de tous les événements actuels sur votre serveur. Vous pouvez y voir des informations sur les activités des joueurs ainsi que d’éventuels messages d’erreur et messages système. Cette vue d’ensemble vous permet d’avoir une vision complète de ce qui se passe sur votre serveur et de détecter rapidement d’éventuels problèmes.

![](https://screensaver01.zap-hosting.com/index.php/s/J9SsmSrPXnG7P9w/preview)

En plus de surveiller les événements, vous pouvez aussi envoyer des commandes directement au serveur dans la **Console en direct**. Cela peut être utile pour ajuster des paramètres, effectuer certaines actions ou réagir rapidement aux problèmes qui surviennent.
...
Dans cette section, vous trouverez un historique des interruptions du système hôte sur lequel votre service de serveur de jeux est hébergé. Vous pouvez trouver plus d’informations et la dernière version de notre statut de service sur notre nouvelle [page de statut](https://status.zap-hosting.com/).
...
Si vous êtes plus à l’aise et souhaitez effectuer des modifications plus précises, nous vous recommandons d’utiliser plutôt l’Éditeur de Config. Vous trouverez plus d’informations à ce sujet dans la catégorie **Configs**.
...
En utilisant l’éditeur, vous avez un accès direct à toutes les options disponibles et pouvez les personnaliser précisément. C’est particulièrement utile pour les utilisateurs avancés qui veulent un contrôle total sur les réglages de leur serveur et savent exactement quelles modifications ils souhaitent faire.

:::warning
Vous avez remarqué que certaines de vos modifications sont partiellement écrasées ? Sachez que certaines valeurs d’option sont prises depuis la page des paramètres. Si vous souhaitez modifier ces valeurs directement dans la config, vous devez d’abord désactiver les options correspondantes dans la page des paramètres.
:::
...
De plus, vous pouvez aussi activer la notification par e-mail pour les mises à jour automatiques afin de rester informé des mises à jour et vous assurer d’être toujours à jour.



### Plugins

Pour ce jeu, nous offrons la possibilité d’installer facilement des ressources/plugins connus et populaires en un seul clic sous **Plugins**. Dans l’aperçu, vous trouverez une sélection des contenus disponibles que vous pouvez ajouter en cliquant sur le bouton d’installation. Après le redémarrage du serveur, ces ressources/plugins seront installés, activés et disponibles pour vous.

![](https://screensaver01.zap-hosting.com/index.php/s/DoL7miMAmj83CDr/preview)

En utilisant cette fonctionnalité, vous pouvez rapidement et facilement enrichir le contenu de votre serveur de jeux sans avoir à faire des ajustements vous-même. Cela vous fait gagner du temps et réduit les risques d’erreurs ou de problèmes de compatibilité.



### Steam Workshop

Si vous cherchez du nouveau contenu pour améliorer votre expérience de jeu, le Steam Workshop propose une large sélection de mods et de maps pour de nombreux jeux. Pour utiliser une collection de mods ou de maps dans votre jeu, il vous suffit d’entrer l’ID de la collection Steam Workshop. Ensuite, vous devrez redémarrer votre serveur pour que le nouveau contenu soit chargé. Une fois cela fait, vous pourrez utiliser ce nouveau contenu sur votre serveur et ajouter plus de variété et de fun à votre jeu.
...
Vous souhaitez programmer des redémarrages du serveur à des heures spécifiques ? Le Planificateur de redémarrage vous permet de configurer des redémarrages automatiques programmés de votre serveur de jeux. Avec cette fonctionnalité, vous pouvez planifier des redémarrages à des heures précises ou à intervalles réguliers.

![](https://screensaver01.zap-hosting.com/index.php/s/Y6WciDS7YP98P4m/preview)

### Paramètres DNS
Avec les paramètres DNS ZAP, vous pouvez créer des adresses faciles à retenir pour votre service. Vous pouvez soit utiliser un sous-domaine de l’un de nos domaines, soit créer une entrée DNS sur vos propres domaines et ainsi avoir une adresse qui vous correspond mieux.
...
### Actualités
La section **Actualités** vous offre une vue complète de toutes les annonces et nouveautés liées à votre service. Vous y trouverez des informations importantes sur divers aspects tels que :
