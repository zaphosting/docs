...
title: "DeadPoly : Aperçu du Tableau de Bord"
description: "Découvrez comment gérer et optimiser efficacement votre serveur DeadPoly avec un aperçu clair des fonctionnalités clés et des contrôles → En savoir plus maintenant"
...
L’éditeur de fichiers de config vous permet de modifier les fichiers de configuration directement depuis le site web de manière classique, sans la vue simplifiée. Cette option vous permet de personnaliser les réglages de votre serveur selon vos préférences.
