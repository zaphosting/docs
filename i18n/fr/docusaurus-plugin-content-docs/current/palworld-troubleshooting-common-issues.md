...
title: "Palworld : Problèmes courants"
description: "Découvrez comment dépanner et résoudre les problèmes courants des serveurs Palworld pour une expérience de jeu fluide → En savoir plus maintenant"
...
Des réglages serveur incorrects ou mal ajustés peuvent entraîner une utilisation excessive des ressources et causer des problèmes de performance comme le lag ou les saccades. Assure-toi que tes valeurs de configuration correspondent aux paramètres recommandés pour ton jeu et la taille de ton serveur. Revois-les et ajuste-les si besoin pour que ton serveur tourne le plus efficacement possible.
...
Faire des sauvegardes régulières évite beaucoup de stress et de galères. Crée des sauvegardes régulières pour t’assurer qu’en cas de problème, tu as toujours une version plus ancienne qui fonctionnait. On propose une [solution de sauvegarde](gameserver-backups.md) pour nos serveurs de jeux Palworld, que tu peux utiliser pour faire des sauvegardes manuelles ou automatiques programmées.
