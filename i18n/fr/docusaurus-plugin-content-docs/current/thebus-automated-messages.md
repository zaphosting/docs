...
title: "The Bus : Messages Automatisés du Serveur - Tiens tes joueurs au courant des news, liens sociaux et plus encore !"
...
Avec les **Tâches Planifiées**, les messages peuvent être envoyés automatiquement dans le chat en jeu de **The Bus** en exécutant des commandes prédéfinies selon un planning récurrent.
