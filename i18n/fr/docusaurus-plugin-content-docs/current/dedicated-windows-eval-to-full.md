...
Avant de commencer la conversion, assure-toi d’avoir une clé produit valide pour l’édition Windows Server vers laquelle tu souhaites passer, comme Standard ou Datacenter. La clé produit doit correspondre exactement à l’édition cible.
...
Une fois l’édition cible connue et une clé produit valide en main, tu peux lancer la mise à niveau. La valeur `<TargetEdition>` doit correspondre à une des éditions supportées retournées par la commande DISM.
...
Après le redémarrage du serveur, ouvre une invite de commandes ou PowerShell en mode administrateur et lance :
...
Félicitations ! Tu as maintenant réussi à passer ta version Windows Server de l’Évaluation à la Version Complète. Pour toute question ou aide, n’hésite pas à contacter notre équipe support, disponible tous les jours pour t’aider ! 🙂
