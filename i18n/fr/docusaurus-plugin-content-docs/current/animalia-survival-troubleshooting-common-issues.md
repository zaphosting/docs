...
title: "Animalia Survival : Problèmes courants"
description: "Découvrez comment dépanner et résoudre les problèmes courants des serveurs Animalia Survival pour une expérience de jeu fluide → En savoir plus maintenant"
...
Une bonne performance serveur est cruciale pour une expérience de jeu fluide. Les problèmes comme le lag, les délais ou les crashs soudains arrivent souvent quand la config serveur n’est pas optimale, que le hardware ne correspond pas aux exigences du jeu ou que les extensions installées surchargent le système.
...
Faire des sauvegardes régulières évite beaucoup de stress et de galères. Crée des sauvegardes régulières pour être sûr qu’en cas de problème tu aies toujours une version antérieure fonctionnelle. On propose une [solution de sauvegarde](gameserver-backups.md) pour nos serveurs de jeux Animalia Survival, que tu peux utiliser pour faire des sauvegardes manuelles ou automatiques programmées.
