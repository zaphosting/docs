...
title: "Wreckfest 2 : Messages Automatisés du Serveur - Tiens tes joueurs au courant des news, liens sociaux et plus encore !"
...
Les messages automatisés du serveur sont un moyen simple mais efficace de communiquer des infos importantes directement aux joueurs en jeu. Tu peux les utiliser pour afficher les règles du serveur, annoncer des événements, partager des astuces utiles ou envoyer des rappels à intervalles réguliers sans que les admins aient à intervenir manuellement.

Avec les **Tâches Planifiées**, les messages peuvent être envoyés automatiquement dans le chat en jeu de **Wreckfest 2** en exécutant des commandes prédéfinies selon un planning récurrent.
...
Les tâches planifiées offrent un contrôle total sur le moment et la fréquence d’apparition des messages. Les cas d’usage courants incluent :
