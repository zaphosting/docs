...
title: "Serveur dédié : Installation d’un serveur dédié Team Fortress 2 sous Windows"
description: "Découvre comment installer rapidement et facilement un serveur dédié Team Fortress 2 sur ton VPS ou serveur dédié → En savoir plus maintenant"
...
Dès que le message **Loading Steam API.... OK** s’affiche, c’est que tout s’est bien passé et tu peux commencer l’installation du serveur Team Fortress 2.
...
L’étape suivante est l’installation du serveur. Lance la commande `app_update 232250`. L’ID d’application **232250** correspond à l’application **Team Fortress 2 Dedicated Server**.
...
Ajoute des règles entrantes et sortantes comme expliqué ci-dessous, pour les ports suivants : 27015-27020 en TCP/UDP.
