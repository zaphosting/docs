...
En plus de surveiller les événements, vous pouvez aussi envoyer des commandes directement au serveur dans la **Console live**. Cela peut être utile pour ajuster des réglages, effectuer certaines actions ou réagir rapidement à des problèmes qui surviennent.
...
:::warning
Vous avez remarqué que certains de vos changements sont partiellement écrasés ? Sachez que certaines valeurs d’option sont prises depuis la page des paramètres. Si vous voulez modifier ces réglages directement dans la config, vous devez d’abord désactiver les options concernées sur la page des paramètres.
:::
...
Les **Actualités** vous offrent une vue complète de toutes les annonces et nouveautés liées à votre service. Vous y trouverez des infos importantes sur divers aspects tels que :
