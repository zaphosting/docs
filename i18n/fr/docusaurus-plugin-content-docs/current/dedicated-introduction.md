...
| RAM                 | 32-2048 Go de RAM                                    |
| DISQUE              | De 500 Go jusqu’à 2x 8 To de stockage SSD              |
| Adresses IP         | 1-100 adresses IP |
...
Grâce à la puissance, aux permissions complètes et aux possibilités qui en découlent, les serveurs dédiés peuvent être utilisés dans plein de domaines différents. Par exemple :
