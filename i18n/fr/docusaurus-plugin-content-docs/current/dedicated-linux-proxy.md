...
Avec votre VPS Linux prêt, vous devrez vous y connecter. Utilisez notre guide [Accès SSH initial](vserver-linux-ssh.md) pour en savoir plus sur la procédure.
