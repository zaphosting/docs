...
title: "Voyagers of Nera : Aperçu du Tableau de Bord"
description: "Découvrez comment gérer et optimiser efficacement votre serveur Voyagers of Nera pour une performance et un contrôle optimaux → En savoir plus maintenant"
...
Un problème technique survient et vous ne savez pas d’où il vient ? Une première stratégie possible est de vérifier les **fichiers journaux**. Ces fichiers contiennent beaucoup d’infos sur le serveur, comme les événements en cours, des indices ou des messages d’erreur.
...
:::warning
Les infos trouvées ne vous aident pas ou vous ne les comprenez pas ? Pas de souci ! Dans ce cas, notre support est aussi disponible tous les jours. Il suffit de créer un **[Ticket](https://zap-hosting.com/en/customer/support/)** et de nous expliquer votre problème. Nous le regarderons au plus vite et vous aiderons à résoudre le souci ! :)
:::
...
De plus, vous pouvez aussi activer la fonction de notification par email pour les mises à jour automatiques afin de rester informé des mises à jour et être toujours à la page.
