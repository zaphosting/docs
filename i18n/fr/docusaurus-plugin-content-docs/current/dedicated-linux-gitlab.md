...
:::info
Pour les informations les plus précises et à jour concernant les spécifications, veuillez consulter la documentation officielle [Exigences matérielles](https://docs.gitlab.com/ee/install/requirements.html) de GitLab.
:::
...
Une fois la connexion établie, vous pouvez commencer à installer les paquets nécessaires pour l’installation proprement dite de GitLab.
...
Si vous souhaitez utiliser les notifications par email, téléchargez Postfix avec la commande suivante.
```
...
Si vous souhaitez utiliser les notifications par email, téléchargez Postfix avec les commandes suivantes.
```
