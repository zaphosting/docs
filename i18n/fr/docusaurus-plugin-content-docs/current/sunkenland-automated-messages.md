...
title: "Sunkenland : Messages Automatisés du Serveur - Tiens tes joueurs au courant des news, liens sociaux et plus encore !"
...
Grâce aux **Tâches Planifiées**, les messages peuvent être envoyés automatiquement dans le chat en jeu de **Sunkenland** en exécutant des commandes prédéfinies selon un planning récurrent.
