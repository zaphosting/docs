...
title: "Icarus : Problèmes courants"
description: "Découvrez comment dépanner et résoudre les problèmes courants des serveurs de jeux Icarus pour garantir un gameplay fluide et des performances fiables → En savoir plus maintenant"
...
Faire des sauvegardes régulières évite beaucoup de stress et de galères. Crée des sauvegardes régulières pour être sûr qu’en cas de problème, tu as toujours une version plus ancienne qui fonctionnait. On propose une [solution de sauvegarde](gameserver-backups.md) pour nos serveurs de jeux Icarus, que tu peux utiliser pour faire des backups manuels ou automatiques programmés.
