...
title: "No More Room In Hell : Messages Automatisés du Serveur - Tiens tes joueurs au courant des news, liens sociaux et plus encore !"
...
Les messages automatisés du serveur sont un moyen simple mais efficace de communiquer des infos importantes directement en jeu à tes joueurs. Tu peux les utiliser pour afficher les règles du serveur, annoncer des événements, partager des astuces utiles ou envoyer des rappels à intervalles réguliers sans que les admins aient à intervenir manuellement.

Avec les **Tâches Planifiées**, les messages peuvent être envoyés automatiquement dans le chat en jeu de **No More Room In Hell** en exécutant des commandes prédéfinies selon un planning récurrent.
