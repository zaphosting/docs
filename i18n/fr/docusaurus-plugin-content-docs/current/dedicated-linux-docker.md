...
Pour commencer, tu dois te connecter à ton serveur Linux via SSH. Si tu as besoin d’aide, jette un œil à notre [guide d’accès initial (SSH)](dedicated-linux-ssh.md). Dans ce guide, on utilise Ubuntu comme distribution Linux.
