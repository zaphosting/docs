...
title: "Banana Shooter : Crée un GSLT (Steam Game Server Login Token)"
...
Une fois connecté, tu peux créer un nouveau token via le formulaire affiché sur la page. Dans le champ **App ID**, entre l’ID `1949740` qui correspond à **Banana Shooter**. Assure-toi d’entrer le bon ID, car le token ne fonctionnera pas avec une valeur incorrecte.
...
:::info Exploiter plusieurs serveurs Banana Shooter
Si tu exploites plusieurs serveurs **Banana Shooter**, tu auras besoin d’un GSLT pour chaque serveur. Il est <u>**impossible**</u> d’exploiter plusieurs serveurs de jeux avec un seul GSLT.
:::
