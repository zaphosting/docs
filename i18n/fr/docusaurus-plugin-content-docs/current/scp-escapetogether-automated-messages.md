...
title: "SCP: Escape Together : Messages Automatisés du Serveur - Tiens tes joueurs au courant des news, liens sociaux et plus encore !"
...
Avec les **Tâches Planifiées**, les messages peuvent être envoyés automatiquement dans le chat en jeu de **SCP: Escape Together** en exécutant des commandes prédéfinies selon un planning récurrent.
...
- Annoncer les événements à des heures fixes
...
Une fois configurés, les messages automatisés tournent de façon autonome et peuvent être facilement réutilisés en ajustant simplement la commande message spécifique au jeu et le texte.
