...
description: "Découvre comment gérer et optimiser efficacement ton serveur TerraTech Worlds avec un guide d’administration clair et étape par étape → En savoir plus maintenant"
...
Dans cette section, tu trouveras un historique des interruptions du système hôte sur lequel ton serveur de jeux tourne. Pour plus d’infos et la version la plus récente de notre statut de service, consulte notre nouvelle [page de statut](https://status.zap-hosting.com/).
...
En plus, tu peux activer la notification par email pour les mises à jour automatiques, pour rester informé et toujours à la page.
