...
title: "Arma 3 : Aperçu du Tableau de Bord"
description: "Découvrez comment gérer et optimiser efficacement votre serveur de jeux Arma 3 avec un aperçu clair des fonctionnalités essentielles d’administration → En savoir plus maintenant"
...
Sous **Statistiques**, vous obtenez un aperçu complet des valeurs de charge de votre serveur. Vous y trouverez des infos sur différents aspects comme la charge des slots disponibles, le CPU et la mémoire. Vous pouvez consulter ces données pour différentes périodes, par exemple les dernières **60 minutes, 24 heures, 3 jours, 7 jours** ou **30 jours**.
...
:::warning
L’utilisation du Gestionnaire DDoS n’est possible que si une adresse IP propre ou l’option "Vue d’ensemble du Gestionnaire DDoS" a été réservée en option supplémentaire. Si ces composants manquent dans votre pack actuel, vous pouvez les ajouter à tout moment en effectuant une mise à niveau.
:::
...
:::warning
Les infos trouvées ne vous aident pas ou vous ne les comprenez pas ? Pas de stress ! Dans ce cas, notre support est dispo tous les jours. Créez simplement un **[ticket](https://zap-hosting.com/en/customer/support/)** et expliquez-nous votre problème. On le regardera au plus vite et vous aidera à résoudre ça ! :)
:::
...
Sous **Versions**, vous pouvez consulter et gérer la version actuelle de votre serveur de jeux. Vous pouvez mettre à jour à la dernière version à tout moment ou activer les mises à jour automatiques pour garantir que votre serveur soit toujours à jour.
