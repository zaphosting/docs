...
title: "Mordhau : Connexion au serveur"
...
## Introduction
Vous ne savez pas comment vous connecter à votre **serveur de jeux Mordhau** ou ce dont vous avez besoin pour commencer ? Pas de panique, on s’occupe de tout ! On va vous guider à travers tout ce qu’il faut. Des outils et infos nécessaires jusqu’au processus de connexion, en passant par les points clés pour assurer une connexion fluide et sans souci. Suivez notre guide et vous serez connecté en un rien de temps !
...
Lancez votre jeu et sélectionnez **Fight** dans le menu principal. Ouvrez le navigateur de serveurs et entrez le nom de votre serveur dans le champ de recherche à droite pour le trouver rapidement.
