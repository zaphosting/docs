...
title: "American Truck Simulator : Messages Automatisés du Serveur - Tiens tes joueurs au courant des news, liens sociaux et plus encore !"
...
Avec les **Tâches Planifiées**, les messages peuvent être envoyés automatiquement dans le chat en jeu de **American Truck Simulator** en exécutant des commandes prédéfinies selon un planning récurrent.
