...
title: "Stormworks : Problèmes courants"
description: "Découvrez comment dépanner et résoudre les problèmes courants des serveurs Stormworks pour une expérience de jeu fluide → En savoir plus maintenant"
...
Faire des sauvegardes régulières évite beaucoup de stress et de galères. Crée des sauvegardes régulières pour être sûr qu’en cas de pépin, tu as toujours une version plus ancienne où tout fonctionnait encore. On propose une [solution de sauvegarde](gameserver-backups.md) pour nos serveurs de jeux Stormworks, que tu peux utiliser pour faire des sauvegardes manuelles ou automatiques programmées.
