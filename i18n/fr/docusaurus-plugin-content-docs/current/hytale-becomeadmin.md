...
## Introduction
Attribuer les permissions d’admin sur un serveur Hytale permet aux joueurs de confiance d’aider à gérer le serveur. Les admins, aussi appelés opérateurs, peuvent exécuter des commandes serveur, gérer les joueurs et aider à la modération du serveur. Ça facilite la délégation des tâches courantes pour les propriétaires et assure une expérience de jeu fluide.

:::info Avis Early Access

Hytale est sorti le 13 janvier 2026 et est actuellement en Early Access. Comme le jeu est encore en phase de développement actif, les logiciels serveur, fichiers de configuration, support modding et processus d’installation peuvent évoluer avec le temps.
...
Une fois retiré, le joueur revient aux permissions standards et ne pourra plus utiliser les commandes admin.
