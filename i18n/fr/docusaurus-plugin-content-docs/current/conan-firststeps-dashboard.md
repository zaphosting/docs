...
<YouTube videoId="5U56EIZkAZo" imageSrc="https://screensaver01.zap-hosting.com/index.php/s/efH7Bwbpo6o4kT9/preview" title="Configurez votre serveur Conan Exiles en seulement UNE MINUTE !" description="Vous comprenez mieux en voyant les choses en action ? On a ce qu’il vous faut ! Plongez dans notre vidéo qui vous explique tout. Que vous soyez pressé ou que vous préfériez apprendre de manière plus immersive !" />
...
**WinSCP :** WinSCP est à l’origine conçu pour SCP et SFTP (les versions sécurisées du protocole FTP), mais il gère aussi très bien le FTP classique. Le programme est un peu plus complet que FileZilla et convient plutôt aux utilisateurs avancés.
