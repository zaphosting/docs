...
title: "Astro Colony : Messages Automatisés du Serveur - Tiens tes joueurs au courant des news, liens sociaux et plus encore !"
...
Avec les **Tâches Planifiées**, les messages peuvent être envoyés automatiquement dans le chat en jeu de **Astro Colony** en exécutant des commandes prédéfinies selon un planning récurrent.
...
La fonctionnalité des messages automatisés dépend des capacités du jeu et des commandes disponibles. Même si des messages planifiés basiques peuvent être mis en place avec les commandes serveur standards, cette méthode peut être limitée en termes de mise en forme, conditions ou personnalisation avancée.
