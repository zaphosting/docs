...
بعد تحميل ملف التثبيت، قم بتشغيله. اضغط على الملف الذي تم تحميله مسبقًا. يجب أن تظهر لك النافذة التالية: ![](https://screensaver01.zap-hosting.com/index.php/s/a2DEpaR5jD28X23/preview)
