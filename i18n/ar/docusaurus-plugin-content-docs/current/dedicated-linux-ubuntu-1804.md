...
الآن يتم تحديد مرآة أرشيف أوبونتو (خادم التنزيل للحزم). سيرفراتنا المخصصة موجودة في ألمانيا، لذا يُنصح باختيار المرآة الألمانية لتحقيق أفضل سرعات تحميل ممكنة.
...
​	أوبونتو تقدم بعض الحزم الافتراضية (snaps)، إذا أردت استخدام بعضها، فقط اختر ما يعجبك.
...
مبروك، لقد قمت بتثبيت نظام التشغيل أوبونتو 18.04 بنجاح على سيرفرك المخصص. لأي أسئلة أو مساعدة إضافية، لا تتردد في التواصل مع فريق الدعم لدينا، المتوفر يوميًا لمساعدتك! 🙂
