...
هل أنت مهتم بسيرفر **MTA (Multi Theft Auto)** أو تملك واحدًا بالفعل، لكنك تفتقد إلى نظرة شاملة على الإدارة وإيجاد جميع الخيارات الضرورية؟ خاصة في البداية، قد يكون هذا تحديًا. لا تقلق، سنقدم لك مقدمة مفصلة لإدارة خدمتك أدناه، لتتمكن من الحصول على أفضل نظرة ممكنة.

بعد قراءة هذا الدليل، ستتمكن بسهولة من إدارة سيرفرك بكفاءة والعثور على جميع الخيارات والميزات بسرعة وسهولة. هنا ستحصل على نظرة منظمة تساعدك خطوة بخطوة على التعرف على إدارة السيرفر وتوسيع معرفتك بشكل موجه. بهذه الطريقة، يمكنك التأكد من أن سيرفر **MTA (Multi Theft Auto)** الخاص بك مُكيف بشكل مثالي لاحتياجاتك وأنك تستفيد إلى أقصى حد من الخيارات المتاحة.
...
يقدم لك **الكونسول المباشر** عرضًا فوريًا لجميع الأحداث الجارية على سيرفرك. هنا يمكنك رؤية معلومات عن نشاطات اللاعبين بالإضافة إلى رسائل الخطأ والرسائل النظامية المحتملة. تتيح لك هذه النظرة الحصول على رؤية شاملة لما يحدث على سيرفرك واكتشاف المشاكل المحتملة في وقت مبكر.
...
> ⚠️ هل لاحظت أن بعض تغييراتك تُعاد كتابتها جزئيًا؟ يرجى العلم أن بعض قيم الخيارات تُأخذ من صفحة الإعدادات. إذا أردت إجراء هذه التغييرات مباشرة في التكوين، يجب أولاً تعطيل الخيارات ذات الصلة في صفحة الإعدادات.

### الألعاب

تحت قسم **الألعاب** يمكنك دائمًا تغيير نوع اللعبة على سيرفرك الحالي أو تثبيت لعبة أخرى بشكل عام. يمكن اختيار الألعاب التي لها نفس سعر الفتحات مباشرة تحت **الألعاب المتاحة**. بالنسبة لباقي الألعاب، يجب تعديل سعر الفتحات أولًا. يمكنك معرفة المزيد عن هذا في دليل [تغيير اللعبة](gameserver-gameswitch.md).

![](https://screensaver01.zap-hosting.com/index.php/s/xkkECw7o52fAMWk/preview)

### الإصدارات

في قسم **الإصدارات** يمكنك عرض وإدارة الإصدار الحالي لسيرفر اللعبة الخاص بك. هنا يمكنك التحديث إلى أحدث إصدار في أي وقت أو تفعيل التحديثات التلقائية لضمان أن سيرفرك دائمًا محدث.
