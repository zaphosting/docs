...
description: "اكتشف كيفية إعداد سيرفر Team Fortress 2 مخصص على VPS لينكس الخاص بك بسرعة وكفاءة → تعلّم المزيد الآن"
...
## مقدمة
هل لديك VPS لينكس وتريد تثبيت خدمة سيرفر Team Fortress 2 المخصص عليه؟ أنت في المكان الصحيح. في هذا الدليل، سنشرح خطوة بخطوة عملية تثبيت هذه الخدمة على سيرفرك اللينكس باستخدام SteamCMD. سنستخدم أوبونتو في الأمثلة، لكن العملية ستكون مشابهة جدًا للتوزيعات الأخرى.
...
لبداية، اتصل بـ VPS الخاص بك عبر SSH. استخدم دليلنا [الوصول الأولي عبر SSH](dedicated-linux-ssh.md) إذا كنت بحاجة لمساعدة في ذلك. ستحتاج أيضًا لإكمال إعداد SteamCMD لأول مرة إذا كانت هذه هي المرة الأولى التي تستخدم فيها SteamCMD على سيرفر لينكس الخاص بك. يرجى استخدام دليلنا [إعداد SteamCMD على لينكس](dedicated-linux-steamcmd.md) والتأكد من أن SteamCMD مُعد بالكامل قبل المتابعة.
...
في هذه المرحلة، تكون قد أنهيت إعداد سيرفر Team Fortress 2 الخاص بك. يمكنك إجراء المزيد من التهيئة للسيرفر عبر تعديل ملف الإطلاق مباشرة.
