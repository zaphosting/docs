...
بالإضافة لذلك، نوصي بإدخال بريدك الإلكتروني في السطر `letsencrypt['contact_emails']`. هذا سيسمح لـ Let's Encrypt بإرسال إشعارات والتواصل معك بخصوص شهادات SSL المجانية والتلقائية.
