...
description: "اكتشف كيف تتصل بسيرفر ألعاب Half-Life 2 الخاص بك بسهولة وتضمن تجربة لعب سلسة → تعلّم المزيد الآن"
...
## مقدمة
مش متأكد إزاي تتصل بسيرفر ألعاب **Half-Life 2** بتاعك أو إيه اللي محتاجه عشان تبدأ؟ ولا يهمك، إحنا معاك! هنمشي معاك خطوة بخطوة من الأدوات والمعلومات المطلوبة لحد عملية الاتصال نفسها، وكمان أهم النقاط اللي لازم تاخد بالك منها عشان تضمن اتصال سلس ومن غير مشاكل. اتبع دليلنا وهتكون متصل في وقت قصير!
...
ابحث أو أضف السيرفر بتاعك عن طريق متصفح Steam باستخدام `عنوان IP` و`المنفذ` الخاص بسيرفر ألعابك. عشان تعمل كده، اختار تبويب `Favorites` في قائمة السيرفرات واضغط على علامة الزائد في الأسفل. هيفتحلك نافذة منبثقة تحدد فيها معلومات السيرفر بتاعك.
