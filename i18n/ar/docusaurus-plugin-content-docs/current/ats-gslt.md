---
id: ats-gslt
title: "American Truck Simulator: إنشاء GSLT (رمز تسجيل دخول سيرفر ألعاب Steam)"
description: "اكتشف كيف تؤمن وتوثق سيرفرات الألعاب المخصصة الخاصة بك باستخدام رمز تسجيل دخول سيرفر ألعاب Steam لقائمة عامة موثوقة وحماية → تعرّف أكثر"
...
**GSLT (رمز تسجيل دخول سيرفر الألعاب)** هو رمز تسجيل دخول تطلبه Steam/Valve لتشغيل سيرفرات مخصصة لبعض الألعاب. يرتبط بحساب Steam ويضمن أن السيرفر موثّق بشكل صحيح.
...
بمجرد تسجيل الدخول، يمكنك إنشاء رمز جديد باستخدام النموذج المعروض في الصفحة. في حقل **App ID**، أدخل معرف التطبيق `270880` الخاص بـ **American Truck Simulator**. تأكد من إدخال المعرف الصحيح، لأن الرمز لن يعمل إذا كان المعرف خاطئًا.
...
:::info تشغيل عدة سيرفرات American Truck Simulator
عند تشغيل عدة سيرفرات **American Truck Simulator**، ستحتاج إلى GSLT لكل سيرفر. <u>**لا**</u> يمكن تشغيل عدة سيرفرات ألعاب باستخدام رمز GSLT واحد فقط.
:::
