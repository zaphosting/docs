...
لو تستخدم جهاز بنظام ماك أو إس، تحليل الشبكة يتم عبر تطبيق MTR. لكن تطبيق MTR مش مثبت مسبقًا على أجهزة ماك ولا متوفر في متجر آبل. لتثبيت MTR، لازم تثبت Homebrew كنظام إدارة الحزم على جهازك.
...
اتبع الخطوات المعروضة لإكمال التثبيت. بعد ما يثبت Homebrew بنجاح، تقدر تستخدمه لتثبيت MTR بالأمر التالي في الطرفية:
...
<TabItem value="linux" label="سيرفر يعمل على لينكس" default>
...
<TabItem value="windows" label="سيرفر يعمل على ويندوز">

اتصل بسيرفرك عبر **[اتصال سطح المكتب البعيد](vserver-windows-userdp.md)**. لتثبيت WinMTR على السيرفر، نزّل التطبيق من موقع ZAP-Hosting. بعد التنزيل، فك الضغط عن الملف. راح تحصل على ملف تنفيذي اسمه `WinMTR.exe`.
...
في خانة `Host`، اكتب عنوان IP لاتصالك. بعدين ابدأ التقرير. خل التطبيق يشتغل مرة ثانية لمدة لا تقل عن **دقيقة واحدة** لجمع بيانات كافية. لما تجمع بيانات كافية، وقف التحليل واحفظ النتيجة بالضغط على `Export TEXT`.

:::info
ما تعرف عنوان IP الخاص بك أو مش متأكد كيف تلاقيه؟ في عدة طرق لمعرفة عنوان IP. أسهل طريقة هي عبر خدمة أونلاين مثل **[WhatIsMyIPAddress](https://whatismyipaddress.com/)**.
:::
...
في هذا المثال، الحالة توضح فقدان حزم يحدث على جانب السيرفر، ومرئي في مسارات الإرسال والاستقبال.
...
التقييم يشير إلى أن فقدان الحزم يحدث على جانب السيرفر. كلا المسارين يظهران فقدان في النقاط النهائية (Hop 7 و 8)، مما يشير إلى مشكلة في جهة السيرفر.
...
في هذا المثال، الحالة توضح أوقات استجابة عالية على جانب العميل، واضحة في مسارات الإرسال والاستقبال.
...
في هذا المثال، الحالة توضح أوقات استجابة عالية على جانب السيرفر، واضحة في مسارات الإرسال والاستقبال.
...
في هذا المثال، الحالة توضح كيف مسار العميل X للسيرفر يعمل بدون مشاكل، بينما مسار العميل Y للسيرفر يعاني من مشاكل توجيه تؤدي لفقدان حزم. هذا يدل على مشكلة في التوجيه من مزود خدمة الإنترنت (ISP).
...
التقييم يوضح وجود مشكلة توجيه مع مزود الإنترنت. بينما مسار العميل X للسيرفر مستقر، مسار العميل Y يعاني من مشاكل كبيرة تؤدي لفقدان حزم وزمن استجابة عالي.
...
في هذا المثال، فقدان الحزم يحدث فقط في مسار الإرسال (من العميل للسيرفر)، بينما مسار الاستقبال (من السيرفر للعميل) ما يظهر فقدان. هذا ممكن يدل على مشكلة في جزء من الشبكة باتجاه السيرفر، ممكن بسبب راوترات معطوبة، ازدحام، أو اتصال ضعيف في الطريق.
...
التقييم يوضح أن فقدان الحزم يحدث فقط في مسار الإرسال. الفقدان واضح في النقاط 4، 5، و6، مما يشير إلى مشكلة في الطريق من العميل للسيرفر، مثل ازدحام أو أجهزة شبكة معطوبة في جزء من المسار. في مسار الاستقبال، ما في فقدان، يعني الاتصال في الاتجاه المعاكس مستقر.
...
في هذا المثال، فقدان الحزم يحدث فقط في مسار الاستقبال (من السيرفر للعميل)، بينما مسار الإرسال (من العميل للسيرفر) ما يظهر فقدان. هذا ممكن يدل على مشكلة في جزء من الشبكة في طريق العودة.
...
التقييم يوضح أن فقدان الحزم يحدث فقط في مسار الاستقبال. الفقدان واضح في النقاط 4، 5، و6 من مسار الاستقبال، مما يشير إلى مشكلة في الطريق من السيرفر للعميل.
