...
سيتم إيقاف دعم إصدارات أوبونتو القديمة عاجلاً أم آجلاً. المواعيد النهائية التالية مخصصة لإصدار 22.04:
...
إذا لم تكن معتادًا على تركيب ملف ISO بعد، فمن الأفضل الرجوع إلى [الإعداد الأولي](dedicated-setup.md) أو [ملف ISO خاص](dedicated-iso.md) دليلنا.



## التثبيت

بمجرد تركيب ملف ISO وتحميله بنجاح، يجب أن يكون السيرفر في وضع الإعداد. ستحدد اللغة التي تريد استخدامها لنظام التشغيل في بداية الإعداد. اختر إحدى اللغات المتاحة وأكد الاختيار بزر `Enter`. 

![](https://screensaver01.zap-hosting.com/index.php/s/yrHMNzstM23XZH6/preview)

بعدها، يجب اختيار وتعيين تخطيط لوحة المفاتيح المناسب للغة. اختر تخطيط لوحة المفاتيح الذي يناسبك هنا أيضًا. 

![](https://screensaver01.zap-hosting.com/index.php/s/x9kYGEWS5fy7Wjp/preview)

بعد ذلك، تتم عملية إعداد الشبكة. السيرفر مضبوط افتراضيًا عبر DHCP. المحول الشبكي الافتراضي هو `eno1`. أكد الإعدادات الافتراضية واستمر. 
...
الآن يتم تحديد مرآة أرشيف أوبونتو (خادم التحميل للحزم). سيرفراتنا المخصصة موجودة في ألمانيا، لذا يُنصح باختيار المرآة الألمانية لتحقيق أفضل سرعة تحميل ممكنة.
...
قبل بدء العملية، سيتم إعلامك بأن هذه العملية ستحذف كل البيانات الموجودة. يجب تأكيد هذه الرسالة بخيار `Continue`. 

![](https://screensaver01.zap-hosting.com/index.php/s/L3YcGNbYWpMmaDj/preview)

قم بضبط حساب المستخدم الخاص بك كما تحب، يمكنك أيضًا استخدام حساب root في النهاية بتغيير كلمة المرور.
...
يوصى بتثبيت إعداد SSH. إذا أردت إدارة السيرفر عبر SSH، اختر خيار التثبيت وأكد العملية.

![](https://screensaver01.zap-hosting.com/index.php/s/Xz3zzMdZ6C523ip/preview)

​	أوبونتو تقدم بعض الحزم الافتراضية snap، إذا أردت استخدام بعضها، فقط اختر ما يعجبك.
...
مبروك، لقد قمت بتثبيت نظام التشغيل أوبونتو 22.04 بنجاح على سيرفرك المخصص. لأي أسئلة أو مساعدة إضافية، لا تتردد في التواصل مع فريق الدعم الخاص بنا، المتوفر يوميًا لمساعدتك! 🙂
