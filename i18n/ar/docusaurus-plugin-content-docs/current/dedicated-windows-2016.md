...
اضغط "تثبيت الآن" لبدء عملية الإعداد.
...
يمكنك شراء مفاتيح منتجات Windows من متاجر إلكترونية مختلفة، تحقق من أنك تشتري مفتاحًا صالحًا لإصدار Windows الخاص بك، لأن هناك إصدارات مختلفة من Windows.
...
نقبل الشروط ونواصل بالضغط على "التالي".
...
يمكنك إنشاء عدة أقسام صغيرة أو قسم واحد كبير. إذا كنت تنشئ أقسامًا صغيرة، نوصي بأن يكون القسم الرئيسي لنظام Windows على الأقل 50 جيجابايت.
اضغط على "جديد" لإنشاء قسم.

![](https://screensaver01.zap-hosting.com/index.php/s/GtBxwdETkNeSGcT/preview)

يمكنك الضغط على تطبيق إذا كنت تريد قسمًا واحدًا كبيرًا. سيأخذ الإعداد تلقائيًا أكبر حجم ممكن.
...
## الخاتمة
مبروك، لقد قمت بتثبيت نظام تشغيل Windows Server 2016 بنجاح على سيرفرك المخصص. لأي أسئلة أو مساعدة إضافية، لا تتردد في التواصل مع فريق الدعم الخاص بنا، المتوفر يوميًا لمساعدتك! 🙂