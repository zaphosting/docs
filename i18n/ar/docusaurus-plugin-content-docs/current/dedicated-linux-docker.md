...
title: "تثبيت Docker على سيرفر Linux - تشغيل وإدارة الحاويات على البنية التحتية الخاصة بك"
...
يجب أن يكون Docker مثبتًا الآن. كخطوة أخيرة، تحتاج إلى تشغيله وتمكينه قبل أن يعمل.
```
