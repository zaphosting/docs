...
تتحكم إعدادات عقوبة الموت في كيفية تأثير موت اللاعبين على محتويات الجرد ومتانة العناصر. تتيح لك هذه الخيارات تحديد ما إذا كانت العناصر تُحتفظ بها، تُفقد جزئياً، أو تُسقط بالكامل، بالإضافة إلى مقدار التآكل الذي تتعرض له العناصر عند الموت.

خيارات التكوين المتاحة هي:

**ItemsLossMode**  
 يحدد هذا الإعداد السلوك العام لفقدان العناصر عند موت اللاعب.  
 يدعم القيم التالية:
...
**ItemsDurabilityLossPercentage**  
 ...
 تُحدد القيمة كنسبة مئوية من متانة العنصر الحالية، مما يسمح للموت بأن يكون له عواقب دون إزالة العناصر بالكامل.
...
هذا الإدخال يحدد ملف تكوين طريقة اللعب النشط. يتم وضع تكوين عقوبة الموت مباشرةً تحت هذا السطر ككتلة جديدة. بمجرد العثور عليها، أضف كتلة تكوين الموت لتعريف كيفية التعامل مع إعادة الظهور وفقدان العناصر:
...
عندما يموت اللاعب، يُزال نصف كل كومة من العناصر وتفقد العناصر 25 بالمئة من متانتها الحالية.

إذا لم يكن من المفترض حدوث فقدان للعناصر على الإطلاق، يمكن ضبط وضع الفقدان على `None`، وفي هذه الحالة يتم تجاهل قيم النسب المئوية:
