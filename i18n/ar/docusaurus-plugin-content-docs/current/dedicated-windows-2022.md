...
يمكنك إنشاء عدة أقسام صغيرة أو قسم واحد كبير. إذا أنشأت أقسام صغيرة، ننصح بأن يكون القسم الرئيسي لنظام Windows على الأقل 50 جيجابايت.
...
(ستجد ذلك في كونسول Java ضمن "لوحة المفاتيح")
