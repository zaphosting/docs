...
## مقدمة
مش متأكد كيف تتصل بسيرفر ألعاب **Empyrion** الخاص بك أو إيش تحتاج عشان تبدأ؟ لا تشيل هم، إحنا معاك! راح نرشدك خطوة بخطوة على كل اللي تحتاجه – من الأدوات والمعلومات المطلوبة لحد عملية الاتصال نفسها، مع أهم النصائح لضمان اتصال سلس وخالي من المشاكل. اتبع دليلنا وراح تكون متصل في وقت قصير!
...
راح تحتاج كل المعلومات المهمة عشان تتصل بسيرفرك. تقدر تلاقي معلومات السيرفر على لوحة المعلومات الخاصة بسيرفر ألعابك في واجهة الويب. المعلومات المهمة تشمل:
...
افتح اللعبة عشان تتصل بسيرفرك. افتح **قائمة السيرفرات** داخل اللعبة وادخل عنوان IP والمنفذ في خانة **IP والمنفذ المباشر**. بعدين اضغط على زر **اتصال** عشان تنشئ الاتصال. 
