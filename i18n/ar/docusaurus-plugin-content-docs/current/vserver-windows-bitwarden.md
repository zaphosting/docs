...
إذا لم تستخدم Let’s Encrypt، يمكنك استخدام شهادة موجودة بوضع الملفات في `C:\Bitwarden\bwdata\ssl\<your_domain>` وتحديد ما إذا كانت موثوقة. بدلاً من ذلك يمكنك توليد شهادة موقعة ذاتياً، وهو موصى به للاختبار فقط. إذا اخترت عدم استخدام شهادة، يجب وضع بروكسي HTTPS أمام التثبيت وإلا لن تعمل تطبيقات Bitwarden.
