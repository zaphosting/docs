...
description: "اكتشف كيفية إدارة سيرفر SCUM الخاص بك بكفاءة وتحسينه مع نظرة واضحة على الميزات الرئيسية وأدوات التحكم → تعلّم المزيد الآن"
...
هل أنت مهتم بسيرفر **SCUM** أو تملك واحدًا بالفعل، لكنك تفتقد إلى نظرة شاملة على الإدارة وإيجاد جميع الخيارات الضرورية؟ خاصة في البداية، قد يكون هذا تحديًا. لا تقلق، سنوفر لك مقدمة مفصلة لإدارة خدمتك أدناه، حتى تحصل على أفضل نظرة ممكنة.
...
في الإعدادات، يمكنك تحديد ما إذا كان يجب إنشاء النسخ الاحتياطية تلقائيًا وما إذا كان ذلك يوميًا أو أسبوعيًا. بالإضافة إلى ذلك، يمكنك تحديد ما إذا كان يجب حذف أقدم النسخ الاحتياطية عند الحاجة، مثلًا عند نفاد مساحة التخزين المتاحة.
...
بمتابعة قسم **الأخبار** بانتظام، ستبقى على اطلاع ويمكنك تعديل خدمتك وفقًا لذلك لتحصل على أقصى استفادة من سيرفرك.
