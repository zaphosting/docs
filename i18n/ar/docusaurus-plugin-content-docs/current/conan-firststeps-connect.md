...
## مقدمة
مش متأكد كيف تتصل بسيرفر ألعاب **Conan Exiles** الخاص بك أو إيش تحتاج عشان تبدأ؟ لا تقلق، إحنا معاك! هنمشي معاك خطوة بخطوة من الأدوات والمعلومات المطلوبة لحد عملية الاتصال نفسها، مع أهم النصائح عشان تضمن اتصال سلس وخالي من المشاكل. اتبع دليلنا وهتكون متصل في وقت قصير!
...
هتحتاج كل المعلومات المهمة عشان تتصل بالسيرفر. تقدر تلاقي معلومات السيرفر على لوحة المعلومات الخاصة بسيرفر ألعابك. المعلومات المهمة تشمل:
...
عشان تتصل بالسيرفر، ادخل على **اللعب أونلاين** داخل اللعبة. هتفتح لك قائمة السيرفرات. في القائمة، تقدر تبحث عن اسم سيرفرك باستخدام **حقل الاسم**. اختار سيرفرك واضغط على **انضمام**.
...
عشان تتصل بالسيرفر، ادخل على **اللعب أونلاين** داخل اللعبة. هتفتح قائمة السيرفرات. بدل ما تدور على سيرفرك، تقدر تضغط على **الاتصال المباشر** في أسفل اليسار وتتصل باستخدام عنوان IP والمنفذ الخاص بالسيرفر.
