...
title: "VPS: إعداد سيرفر مخصص لـ Conan Exiles على ويندوز"
description: "اكتشف كيفية إعداد سيرفر مخصص لـ Conan Exiles على VPS ويندوز بسرعة وكفاءة → تعلّم المزيد الآن"
...
هل لديك VPS بنظام ويندوز وتريد تثبيت خدمة سيرفر مخصص لـ Conan Exiles عليه؟ أنت في المكان الصحيح. في هذا الدليل، سنشرح خطوة بخطوة كيفية تثبيت هذه الخدمة على سيرفرك.
...
ننصح بقراءة [المنشور الرسمي في المنتدى](https://forums.funcom.com/t/conan-exiles-dedicated-server-launcher-official-version-1-7-9-beta/21699) إذا كنت تفضل استخدام هذه الأداة بدلاً من ذلك.
:::

بمجرد وصولك إلى السيرفر، ستحتاج إلى إعداد **SteamCMD** لتتمكن من تنزيل ملفات السيرفر المخصصة اللازمة. SteamCMD هو نسخة **سطر الأوامر (CLI)** من عميل Steam، وهو الأداة التي تتيح لك تنزيل مجموعة من ملفات ورشة Steam وسيرفرات الألعاب بسهولة. قم بتنزيل [SteamCMD من الموقع الرسمي لشركة Valve](https://developer.valvesoftware.com/wiki/SteamCMD) أو مباشرة [من هنا](https://steamcdn-a.akamaihd.net/client/installer/steamcmd.zip).

أنشئ مجلدًا جديدًا في مكان ما على سيرفرك، في هذا المثال سنسميه `steamcmd`. اذهب إلى مجلد التنزيلات الخاص بك، وابحث عن ملف **steamcmd.zip** الذي قمت بتنزيله وضعه داخل مجلد `steamcmd`. الآن قم بفك ضغط الملف بالنقر بزر الفأرة الأيمن واستخدام وظيفة فك الضغط في ويندوز مباشرة، أو باستخدام أي برنامج مثل 7zip أو Winrar. يجب أن ينتج عن ذلك ملف **steamcmd.exe** مفكوك الضغط.
...
بمجرد الانتهاء بنجاح، انتقل إلى مجلد التنزيل حيث تم تحميل جميع ملفات السيرفر. هنا، يمكنك استخدام ملف **StartServer.bat** لتشغيل السيرفر. ومع ذلك، نوصي بإعداد إعادة توجيه المنافذ وتكوين السيرفر أولاً.
...
هذه الأوامر ستنشئ تلقائيًا قواعد جدار ناري ضرورية لجعل سيرفر Conan Exiles الخاص بك متاحًا للعامة.
...
بمجرد إضافة هذه القواعد، سيكون سيرفرك متاحًا الآن، مما يعني أنه يمكنك الاتصال به عبر عنوان IP الخاص بالسيرفر. نوصي بتكوين إعدادات السيرفر أولاً من خلال القسم التالي قبل الوصول إلى السيرفر.

## التكوين

في هذه المرحلة، تكون قد أنهيت إعداد سيرفر Conan Exiles الخاص بك. يمكنك إجراء المزيد من التكوينات عبر ملف إعدادات موجود داخل مجلد السيرفر.
...
حان الوقت الآن لتشغيل سيرفرك. انتقل إلى المجلد الأساسي لسيرفر Conan Exiles وشغّل ملف **StartServer.bat** الذي أنشأته سابقًا لبدء عملية التشغيل. سيفتح هذا وحدة تحكم السيرفر في موجه الأوامر ويبدأ عملية التشغيل. يمكنك الآن الاتصال مباشرة بسيرفرك باستخدام متصفح السيرفر داخل اللعبة وإدخال عنوان IP والمنفذ الخاص بالسيرفر (الافتراضي هو 7777).

## الخاتمة

مبروك، لقد قمت بتثبيت وتكوين سيرفر Conan Exiles بنجاح على VPS الخاص بك! إذا كان لديك أي أسئلة أو مشاكل أخرى، يرجى التواصل مع فريق الدعم لدينا، المتوفر لمساعدتك يوميًا!
