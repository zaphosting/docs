...
description: "اكتشف كيف تدير كلمات المرور بأمان مع Bitwarden باستخدام التشفير من طرف إلى طرف للإعدادات السحابية أو المستضافة ذاتيًا → تعلّم المزيد الآن"
...
أدخل معرف التثبيت ومفتاح التثبيت، كلاهما تحصل عليهما من [Bitwarden](https://bitwarden.com/host). ثم اختر المنطقة US أو EU، وهذا مهم فقط إذا ربطت نسخة مستضافة ذاتيًا باشتراك مدفوع.
