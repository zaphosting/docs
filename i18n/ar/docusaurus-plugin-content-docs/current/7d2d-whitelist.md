...
احفظ الملف وأعد تشغيل السيرفر ليتم تحميل القائمة البيضاء الجديدة. إذا كان ملفك يحتوي فقط على أمثلة معطّلة بالتعليقات، تأكد أن سطر `<user ... />` الخاص بك ليس داخل تعليق XML.
