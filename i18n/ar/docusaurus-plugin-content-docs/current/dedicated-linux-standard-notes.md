...
### تثبيت التبعيات
بعد الانتهاء من التحديث، يمكنك تثبيت التبعيات. سيتم نشر Standard Notes وتشغيله على جهازك باستخدام مجموعة من حاويات Docker. لذلك يجب تثبيت Docker أولاً. نفذ الأمر التالي:
...
## التثبيت
الآن بعد أن تم استيفاء جميع المتطلبات واكتمال التحضيرات، يمكنك متابعة تثبيت تطبيق Standard Notes.
...
ألصق هذه القيم في ملف `.env`. يتطلب Standard Notes سكريبت تمهيدي لـ LocalStack. قم بتحميله إلى دليل العمل واجعله قابلًا للتنفيذ:
...
تضمن هذه التعديلات على التكوين أن يكون تثبيتك ليس فقط وظيفيًا بل أيضًا مؤمنًا ومناسبًا لبيئتك.
...
قبل إكمال العملية، افتح قسم "خيارات متقدمة". ضمن "سيرفر المزامنة"، اختر خيار "مخصص" وأدخل عنوان IP والمنفذ الخاص بسيرفرك بصيغة IP:Port. هذا يضمن أن ملاحظاتك لا تتم مزامنتها عبر خدمة Standard Notes الافتراضية، بل مع سيرفرك المستضاف ذاتيًا.

![img](https://screensaver01.zap-hosting.com/index.php/s/tpsFzSQEokP9xit/download)

## الخاتمة والمزيد من الموارد

مبروك! لقد قمت الآن بتثبيت وتكوين Standard Notes بنجاح على سيرفرك المخصص. ننصحك أيضًا بإلقاء نظرة على الموارد التالية التي قد توفر لك مساعدة إضافية وإرشادات أثناء عملية تكوين السيرفر:
