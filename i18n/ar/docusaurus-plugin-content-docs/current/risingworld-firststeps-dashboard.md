...
description: "اكتشف كيف تدير سيرفر Rising World الخاص بك بكفاءة وتحسن إعداداته لأفضل أداء → تعلّم المزيد الآن"
...
هل أنت مهتم بسيرفر ألعاب **Rising World** أو تملك واحدًا بالفعل، لكنك تفتقد إلى نظرة شاملة على الإدارة وإيجاد جميع الخيارات الضرورية؟ خاصة في البداية، قد يكون هذا تحديًا. لا تقلق، سنقدم لك أدناه مقدمة مفصلة لإدارة خدمتك، لتتمكن من الحصول على أفضل نظرة ممكنة.
...
إذا كنت أكثر خبرة وترغب في إجراء تغييرات أدق، نوصي باستخدام محرر التكوين بدلاً من ذلك. يمكنك العثور على مزيد من المعلومات حول هذا في فئة **Configs**.
...
نوفر 10 جيجابايت من مساحة التخزين على خادم التخزين للنسخ الاحتياطية لمنتجات سيرفرات الألعاب بشكل افتراضي. إذا كنت بحاجة إلى مساحة تخزين أكبر، يمكن ترقيتها مقابل رسوم. بهذه الطريقة تضمن دائمًا وجود مساحة كافية لنسخك الاحتياطية ولا تزال قادرًا على الوصول إلى النسخ القديمة إذا لزم الأمر.
