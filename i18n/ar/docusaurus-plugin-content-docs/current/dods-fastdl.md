---
id: dods-fastdl
title: "Day of Defeat: Source: إعداد FastDL"
description: "اكتشف كيف تسرّع تنزيل محتوى الألعاب وتقلل حمل السيرفر باستخدام FastDL مع استضافة مواقع ZAP-Hosting → تعلّم المزيد الآن"
...
ستحتاج إلى سيرفر Day of Defeat: Source نشط مستضاف من ZAP-Hosting وباقة استضافة مواقع إضافية. يجب أن يكون لديك وصول FTP أو وصول إلى مدير الملفات لكل من سيرفر الألعاب والاستضافة.
...
في المجلد الجذري لاستضافتك، أنشئ مجلد باسم `fastdl`. داخل هذا المجلد، أنشئ مجلدات فرعية مثل `maps`، `sound`، أو `models` حسب المحتوى الذي تخطط لتقديمه. يجب أن يكون هيكل المجلدات مطابقًا تمامًا للهيكل المستخدم في سيرفر Day of Defeat: Source الخاص بك.
...
يمكن إعداد FastDL بسرعة وبثقة باستخدام استضافة ZAP الخاصة بك. هذا يسمح بتوصيل سريع وفعّال للمحتوى المخصص ويحسّن تجربة جميع اللاعبين على سيرفر Day of Defeat: Source الخاص بك.
