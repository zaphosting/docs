...
## مقدمة
عندك سيرفر مخصص وبدك تثبت عليه سيرفرات ألعاب؟ مثلاً سيرفر Valheim مخصص؟ أنت في المكان الصح! في التالي رح نشرح خطوة بخطوة كيف تثبت هالخدمة على سيرفرك.
...
## التحضير
لتثبيت سيرفر Valheim، لازم تستخدم SteamCMD. SteamCMD هو **نسخة سطر الأوامر من عميل Steam**. هالأداة بتخليك تنزل تطبيقات السيرفر المخصصة لألعاب Steam الشهيرة بسرعة وسهولة. بتلاقي SteamCMD على موقع مطوري Valve الرسمي: https://developer.valvesoftware.com/wiki/SteamCMD.

بعدها، رح يتم التنزيل. الملف اللي بتنزله هو **steamcmd.zip** ولازم تفك ضغطه أولاً. يُنصح تعمل مجلد خاص عشان تفك الضغط فيه. لازم تشوف ملف **steamcmd.exe** بعد الفك. شغّله واستنى لين تخلص عملية التثبيت.
![](https://screensaver01.zap-hosting.com/index.php/s/Y5zygHw2DFJa4dZ/preview)

أول ما تطلع رسالة **Loading Steam API.... OK**، يعني العملية تمت بنجاح وتقدر تبدأ بتثبيت سيرفر Valheim.
...
هون لازم تنشئ ملف بدء التشغيل اللي بيشغّل برنامج السيرفر. أنشئ ملف بالاسم التالي: start_headless.bat
...
لتخلي السيرفر ظاهر وقابل للوصول من الخارج، لازم تفتح/تعيد توجيه منافذ السيرفر في الجدار الناري. افتح إعدادات جدار حماية ويندوز.

![](https://screensaver01.zap-hosting.com/index.php/s/MTHjL85zKsLtN9g/preview)

لازم تضيف قواعد جديدة بالإعدادات. اضغط على قواعد الواردة والصادرة مثل ما موضح تحت وأضفها للمنافذ التالية: 2456-2458 لبروتوكولات TCP/UDP.
...
الإعداد الأساسي صار جاهز. فيك تعدل إعدادات إضافية بملف **start_headless_server.bat**. هون فيك تغيّر اسم السيرفر، كلمة مرور السيرفر، كلمة مرور الأدمن، وغيرها من الخيارات. لتعديلها، روح للمجلد التالي:
...
بنهاية الإعداد، فيك تشغّل السيرفر بتنفيذ ملف **start_headless_server.bat** اللي أنشأته. هالشي رح يفتح كونسول السيرفر ويبدأ عملية تشغيل السيرفر. إذا كل شي مشى تمام، السيرفر رح يطلع بقائمة السيرفرات بعد ما يشتغل بنجاح.