...
description: "اكتشف كيف تتصل بسلاسة بسيرفر Motor Town الخاص بك واستمتع بلعب بدون انقطاع → تعلّم المزيد الآن"
...
## مقدمة
مش متأكد إزاي تتصل بسيرفر **Motor Town: خلف المقود** أو إيه اللي محتاجه عشان تبدأ؟ ولا يهمك، إحنا معاك! هنمشي معاك خطوة بخطوة من الأدوات والمعلومات المطلوبة لحد عملية الاتصال نفسها، وكمان أهم النقاط اللي لازم تاخد بالك منها عشان تضمن اتصال سلس ومن غير مشاكل. اتبع دليلنا وهتكون متصل في وقت قصير!
...
شغّل اللعبة وروح على **انضمام** عشان تفتح قائمة السيرفرات. استخدم خانة البحث عشان تدور على سيرفرك باسم السيرفر. اعمل الاتصال بالضغط على زر **اتصال**.
...
دور أو أضف سيرفرك عن طريق متصفح Steam باستخدام `عنوان IP` و`المنفذ` الخاص بسيرفر الألعاب بتاعك. عشان تعمل كده، اختار تبويب `المفضلات` في قائمة السيرفرات واضغط على علامة الزائد في الأسفل. هتفتح نافذة منبثقة تحدد فيها معلومات السيرفر بتاعك.
