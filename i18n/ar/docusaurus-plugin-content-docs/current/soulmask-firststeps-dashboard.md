...
description: "اكتشف كيف تدير سيرفر Soulmask الخاص بك بكفاءة وتحسّن أدائه مع دليل إدارة واضح خطوة بخطوة → تعلّم المزيد الآن"
...
هل أنت مهتم بـ **سيرفر Soulmask** أو تملكه بالفعل، لكنك تفتقد نظرة شاملة على الإدارة وإيجاد جميع الخيارات الضرورية؟ خاصة في البداية، قد يكون هذا تحديًا. لكن لا تقلق، سنوفر لك مقدمة مفصلة لإدارة خدمتك أدناه، لتتمكن من الحصول على أفضل نظرة ممكنة.
...
<YouTube videoId="I8ujVMeHMOo" imageSrc="https://screensaver01.zap-hosting.com/index.php/s/Fdg5wawsGzXg4s2/preview" title="إعداد سيرفر Soulmask في دقيقة واحدة فقط!" description="هل تفضل الفهم بشكل أفضل عندما ترى الأمور على أرض الواقع؟ لدينا ما يناسبك! غص في فيديو يشرح كل شيء لك. سواء كنت مستعجلاً أو تفضل استيعاب المعلومات بأكثر الطرق تشويقًا!"/>
...
تحت قسم **الألعاب**، يمكنك دائمًا تغيير نسخة اللعبة الموجودة أو تثبيت لعبة أخرى بشكل عام. يمكن اختيار الألعاب التي لها نفس سعر الفتحات مباشرة تحت **الألعاب المتاحة**. بالنسبة لباقي الألعاب، يجب تعديل سعر الفتحات أولاً. يمكنك معرفة المزيد عن ذلك في دليل [تغيير اللعبة](gameserver-gameswitch.md).
...
**FileZilla:** هو أسهل وأشهر عميل FTP. فقط قم بالتثبيت، التشغيل وأدخل بيانات الوصول في الشريط العلوي، والتي تجدها في هذه الصفحة أعلى قليلاً. بعد نقرة سريعة على "اتصال"، ستتمكن من الدخول مباشرة إلى السيرفر وإدارة الملفات.
...
بالإضافة إلى منتجات سيرفر الألعاب، نوفر أيضًا 10 قواعد بيانات مدمجة. هذه القواعد ضرورية، على سبيل المثال، عندما يحتاج الأمر لتخزين بيانات في قاعدة بيانات. تحت قسم **قواعد البيانات**، يمكنك إنشاء قاعدة بيانات وعرض بيانات الوصول. كما يمكنك تفعيل خيار النسخ الاحتياطي واستيراد نسخ قواعد بيانات موجودة.
