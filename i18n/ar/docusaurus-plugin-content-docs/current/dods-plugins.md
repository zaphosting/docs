---
id: dods-plugins
title: "Day of Defeat: Source: تثبيت الإضافات على سيرفرك الخاص"
...
تحتاج إلى حزم Linux الخاصة بـ **Sourcemod** و **Metamod**. قم بتحميلها من المصدر المحدد. بعد التحميل، يجب أن يكون لديك ملفان مضغوطان. فك الضغط على جهازك لتحصل على مجلد addons يحتوي على مجلدات `sourcemod` و `metamod`.
...
بعد تثبيت Sourcemod و Metamod وعملهما بشكل صحيح، يمكنك البدء بإضافة الإضافات. حمّل الإضافات التي تريد تثبيتها على سيرفرك من [Sourcemod](https://sourcemod.net/) حيث ستجد مجموعة كبيرة ومتزايدة من الإضافات المنشورة عبر السنين. لكل إضافة، تأكد من الحصول على ملف .smx الخاص بها.
