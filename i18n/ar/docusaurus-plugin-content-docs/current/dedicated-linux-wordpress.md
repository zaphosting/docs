...
لبدء التثبيت، عليك إعداد قاعدة بيانات MySQL جديدة. من المهم تذكر هذه البيانات لأنها ستُستخدم لاحقًا في معالج إعداد ووردبريس، لذا نوصي باستخدام أمثلتنا.
...
تهانينا، لقد قمت بتثبيت وتكوين ووردبريس بنجاح! كخطوة تالية، نوصي **بشدة** بإعداد نطاق و**شهادة SSL** لضمان نقل البيانات بأمان وجعل لوحة ووردبريس أسهل في الوصول. يرجى مراجعة دليلنا [Certbot](dedicated-linux-certbot.md) مع التركيز على **إضافة Apache** واتباع الإعداد التفاعلي لإعداد شهادة بسرعة وسهولة للنطاق الذي تختاره.
