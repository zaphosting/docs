...
### تثبيت التبعيات
بمجرد الانتهاء من التحديث، يمكنك الآن متابعة تثبيت التبعيات.

#### Git
سيتم تنزيل بيانات Supabase عبر GitHub. لذلك يجب تثبيت Git أولاً. للقيام بذلك، شغّل الأمر التالي:
```
...
سيتم نشر وتشغيل Supabase على جهازك باستخدام حاوية Docker. لذلك يجب تثبيت Docker أولاً. للقيام بذلك، شغّل الأمر التالي:
...
## التثبيت
الآن بعد أن تم استيفاء جميع المتطلبات واكتمال التحضيرات اللازمة، يمكنك متابعة تثبيت تطبيق Supabase.
...
تطبيقك يعمل الآن ببيانات دخول افتراضية. قم بتأمين خدماتك في أسرع وقت ممكن باستخدام التعليمات أدناه.
:::
...
- `POOLER_TENANT_ID`: معرف المستأجر المستخدم بواسطة Supavisor pooler
