...
description: "اكتشف كيف تحقق دخل من سيرفر ألعابك مع Tebex وزد أرباحك من المبيعات والترقيات داخل اللعبة → تعلّم المزيد الآن"
...
Tebex هي منصة تتيح لك تحقيق دخل من سيرفر ألعابك وكسب أموال حقيقية من العناصر داخل اللعبة، والترقيات، وأكثر من ذلك. توفر لك المنصة متجر ويب احترافي يمكنك من خلاله بيع السلع ومتابعة أداء متجرك. زوروا [tebex.io](https://affiliate.tebex.io/r/690a6731-fee1-4054-84e1-30c26729403a) لمزيد من المعلومات حول كيفية عملها.

<InlineVoucher />

## الألعاب المدعومة

الألعاب التالية التي نقدمها أيضًا ضمن منتج سيرفر ألعابنا مدعومة من Tebex. لمزيد من المعلومات والألعاب الأخرى المتاحة، ننصحك بزيارة الموقع الرسمي [هنا](https://www.tebex.io/game-servers).
...
سيقوم Tebex الآن بإرسال دعوة إلى البريد الإلكتروني المرتبط بحسابك لدى ZAP-Hosting. يرجى اتباع التعليمات داخل البريد لتفعيل حساب Tebex الخاص بك. سيتم إرشادك خلال الإعداد الأساسي لمتجرك.
...
قم بتثبيت إضافة سيرفر الألعاب المناسبة للعبتك يدويًا. تختلف عملية الإعداد من لعبة لأخرى. يمكنك العثور على تعليمات أساسية حول كيفية تثبيت الإضافات [هنا](https://docs.tebex.io/store/integrating-with-your-game-server-or-website/minecraft-java-edition).

## التحقق من الاتصال مع Tebex

أخيرًا، سيتوجب عليك تأكيد أنك قمت بتثبيت إضافة سيرفر الألعاب بنجاح.

![](https://screensaver01.zap-hosting.com/index.php/s/DkDtPMtij2QTKGS/preview)

في بعض الحالات، قد يُطلب منك إدخال مفتاح API الخاص بالإضافة لمتجر Tebex لتأسيس الاتصال بين ZAP ومتجرك على Tebex. بعدها يمكنك رؤية أن الاتصال تم بنجاح:
![](https://screensaver01.zap-hosting.com/index.php/s/4YS2SwHfSTgn4DE/preview)

## الخلاصة

لقد قمت بربط Tebex بنجاح مع خدمة سيرفر ألعابك. لأي أسئلة أو مساعدة إضافية، لا تتردد في التواصل مع فريق الدعم لدينا، المتوفر يوميًا لمساعدتك! 🙂
