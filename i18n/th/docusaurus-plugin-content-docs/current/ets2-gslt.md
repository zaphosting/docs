---
id: ets2-gslt
title: "Euro Truck Simulator 2: สร้าง GSLT (Steam Game Server Login Token)"
description: "เข้าใจวิธีการยืนยันตัวตนเซิร์ฟเวอร์เฉพาะของคุณด้วย Steam Game Server Login Token เพื่อการแสดงผลที่ถูกต้องและการป้องกัน VAC → เรียนรู้เพิ่มเติมตอนนี้"
...
เมื่อเข้าสู่ระบบแล้ว คุณจะเห็นแบบฟอร์มสำหรับสร้างโทเค็นใหม่ ในช่อง **App ID** ให้กรอก App ID `227300` ซึ่งเป็นของ **Euro Truck Simulator 2** ตรวจสอบให้แน่ใจว่ากรอก ID ถูกต้อง เพราะโทเค็นจะไม่ทำงานถ้าใส่ค่าไม่ถูกต้อง

ในช่อง **Memo** คุณสามารถใส่คำอธิบายตามที่ต้องการ เพื่อช่วยให้คุณจำวัตถุประสงค์ของโทเค็นได้ เช่น ชื่อหรือบทบาทของเซิร์ฟเวอร์ หลังจากกรอกทั้งสองช่องแล้ว กด **Create** เพื่อสร้างโทเค็น โทเค็นจะถูกแสดงขึ้นมาและสามารถนำไปใช้ในคอนฟิกการเปิดเซิร์ฟเวอร์ของคุณได้
...
:::info การใช้งานเซิร์ฟเวอร์ Euro Truck Simulator 2 หลายเครื่อง
ถ้าคุณใช้งานเซิร์ฟเวอร์ **Euro Truck Simulator 2** หลายเครื่อง คุณจะต้องมี GSLT สำหรับแต่ละเซิร์ฟเวอร์ <u>**ไม่สามารถ**</u> ใช้ GSLT เดียวกันกับหลายเซิร์ฟเวอร์ได้
:::
