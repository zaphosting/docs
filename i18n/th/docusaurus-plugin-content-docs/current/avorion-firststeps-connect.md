...
description: "ค้นพบวิธีเชื่อมต่อกับเซิร์ฟเวอร์ Avorion ของคุณอย่างราบรื่นและปลอดภัย เพื่อการเล่นเกมที่ไม่มีสะดุด → เรียนรู้เพิ่มเติมตอนนี้"
...
เพื่อเชื่อมต่อกับเซิร์ฟเวอร์ของคุณผ่านเซิร์ฟเวอร์บราวเซอร์ในเกม ให้เปิดเซิร์ฟเวอร์บราวเซอร์ในเมนูหลัก โดยคลิกที่ **Multiplayer** แล้วเลือก **Browse Servers** คุณสามารถใช้ **ช่องค้นหา** เพื่อค้นหาเซิร์ฟเวอร์ของคุณในรายชื่อเซิร์ฟเวอร์โดยใช้ชื่อเซิร์ฟเวอร์ จากนั้นเชื่อมต่อโดยกดปุ่ม **Join**
...
แทนที่จะค้นหาเซิร์ฟเวอร์ผ่านรายชื่อเซิร์ฟเวอร์ คุณยังสามารถเชื่อมต่อโดยตรงด้วยที่อยู่ IP และพอร์ตได้ โดยคลิกที่ **Multiplayer** แล้วเลือก **Join via IP** จะมีหน้าต่างเปิดขึ้นมาให้คุณกรอกข้อมูลเซิร์ฟเวอร์ในช่อง IP/Port นอกจากนี้คุณต้องตั้งชื่อสำหรับเซิร์ฟเวอร์ด้วย จากนั้นคลิกที่ **Add server** เพื่อเพิ่มเซิร์ฟเวอร์และเชื่อมต่อ
