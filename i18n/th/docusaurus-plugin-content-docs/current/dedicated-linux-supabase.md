...
description: "ค้นพบวิธีตั้งค่าและกำหนดค่า Supabase สำหรับการโฮสต์เอง เพื่อสร้างแพลตฟอร์ม Postgres แบบโอเพ่นซอร์สที่ทรงพลัง → เรียนรู้เพิ่มเติมตอนนี้"
...
คู่มือการติดตั้งและวิธีใช้ Docker แบบละเอียดมีให้ใน [คู่มือ Docker](dedicated-linux-docker.md)
