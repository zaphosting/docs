...
Nextcloud คือโซลูชันคลาวด์แบบโอเพนซอร์สและเป็นฟอร์กของ Owncloud ก่อตั้งขึ้นในปี 2016 โดย Frank Kalitschek ผู้ก่อตั้ง Owncloud เดิม

![](https://screensaver01.zap-hosting.com/index.php/s/n2PbXo94RGNdPzt/preview)

เพื่อให้ได้ประสิทธิภาพ ความเสถียร และฟังก์ชันการทำงานที่ดีที่สุด แนะนำการตั้งค่าดังต่อไปนี้สำหรับการโฮสต์เซิร์ฟเวอร์ Nextcloud เซิร์ฟเวอร์ Nextcloud ไม่รองรับ Windows และ MacOS อย่างน้อยก็ไม่ใช่โดยไม่ใช้การจำลองเสมือนหรือวิธีแก้ไขอื่นๆ<br/>
...
ต้องเชื่อมต่อผ่าน SSH client เพื่อทำการติดตั้งคลาวด์บนเซิร์ฟเวอร์ Linux หากคุณไม่แน่ใจวิธีใช้ SSH นี่คือคู่มือสำหรับเริ่มต้น: [การเข้าถึงเบื้องต้น (SSH)](vserver-linux-ssh.md)
...
ระหว่างการติดตั้งจะมีการถามรหัสผ่าน root หากไม่มีการถาม รหัสผ่านเริ่มต้นจะเป็นค่าว่าง ซึ่งไม่ปลอดภัยและควรเปลี่ยนทันทีหลังติดตั้ง!
...
เมื่อเสร็จแล้ว กด Ctrl-D เพื่อออกจากฐานข้อมูล จากนั้นสามารถแก้ไขฐานข้อมูล PostgreSQL ผ่านเว็บอินสตอลเลอร์หรือไฟล์ **config.php** ได้
...
ตอนนี้สามารถเริ่มการติดตั้ง Nextcloud ได้เลย ดาวน์โหลดและแตกไฟล์ซอฟต์แวร์:
```
cd /var/www/
...
เมื่อเสร็จแล้ว ให้รันสคริปต์ติดตั้งผ่านเบราว์เซอร์โดยเข้าผ่าน URL ดังนี้:
...
แนะนำอย่างยิ่งให้วางไดเรกทอรีข้อมูลนอกเว็บรูทไดเรกทอรี (เช่น นอก /var/www) วิธีที่ง่ายที่สุดคือทำตอนติดตั้งใหม่ โดยสามารถกำหนดไดเรกทอรีได้ในขั้นตอนตั้งค่า แต่ต้องสร้างไดเรกทอรีและตั้งสิทธิ์ให้เรียบร้อยก่อน ตัวอย่างเช่นเก็บข้อมูลในไดเรกทอรีชื่อ Cloud ในโฮมไดเรกทอรี
...
คลาวด์ที่ดีควรเข้าถึงได้เฉพาะผ่านการเชื่อมต่อ SSL เท่านั้น หากไม่มีการเข้ารหัส SSL ข้อมูลและข้อมูลต่างๆ จะถูกส่งแบบข้อความธรรมดา ซึ่งสามารถถูกดักจับและอ่านได้ง่าย
...
นอกจากนี้ ควรเปลี่ยนเส้นทางทราฟฟิก HTTP ทั้งหมดไปยัง HTTPS ด้วยการรีไดเรกต์ถาวร (status code 301) ซึ่งสามารถทำได้โดยใช้ Apache กับการตั้งค่า VirtualHosts ดังนี้:
...
ในเมนูตั้งค่าคุณสามารถปรับแต่งตัวเลือกเพิ่มเติมหลังการติดตั้ง และดูข้อมูลสำคัญ เช่น บันทึกกิจกรรม รวมถึงตั้งค่าความปลอดภัยเพิ่มเติม (ยืนยันตัวตนสองขั้นตอน, การเข้ารหัส ฯลฯ), การตั้งค่าดีไซน์ (โลโก้, สี, สโลแกน, เฮดเดอร์), การตั้งค่าการเข้าถึง และอื่นๆ อีกมากมาย

**แอป**

นอกจากนี้ยังสามารถติดตั้งแอปเพิ่มเติมนอกเหนือจากแอปพื้นฐานได้ โดยเข้าถึงผ่านเมนู **แอป**
