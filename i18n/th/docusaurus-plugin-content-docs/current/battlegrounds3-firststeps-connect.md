...
เพื่อเชื่อมต่อกับเซิร์ฟเวอร์ของคุณผ่านเบราว์เซอร์เซิร์ฟเวอร์ในเกม ให้เปิดเบราว์เซอร์เซิร์ฟเวอร์ในเมนูหลัก คลิกที่ **ค้นหาเซิร์ฟเวอร์** และค้นหาเซิร์ฟเวอร์ของคุณในรายการเซิร์ฟเวอร์โดยใช้ชื่อเซิร์ฟเวอร์ของคุณ
...
เพื่อเชื่อมต่อกับเซิร์ฟเวอร์ของคุณผ่านเบราว์เซอร์เซิร์ฟเวอร์ของ Steam ให้เปิดเบราว์เซอร์เซิร์ฟเวอร์จาก Steam คลิกที่ `View` ที่ด้านบนของเมนูนำทาง Steam แล้วเลือกส่วน `Game Server` เพื่อเปิด

ค้นหาหรือเพิ่มเซิร์ฟเวอร์ของคุณผ่านเบราว์เซอร์ Steam โดยใช้ `ที่อยู่ IP` และ `พอร์ต` ของเซิร์ฟเวอร์เกมของคุณ โดยเลือกแท็บ `Favorites` ในรายการเซิร์ฟเวอร์แล้วคลิกที่สัญลักษณ์บวกที่ด้านล่าง จะมีหน้าต่างป็อปอัปเปิดขึ้นเพื่อให้คุณระบุข้อมูลเซิร์ฟเวอร์ของคุณ
