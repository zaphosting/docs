...
เพื่อใช้ Cloudflare Tunnel บน Linux คุณต้องมี เซิร์ฟเวอร์เฉพาะ Linux, การติดตั้ง txAdmin ที่ใช้งานได้, พอร์ต txAdmin ของคุณ และโดเมนที่เชื่อมต่อกับบัญชี Cloudflare ของคุณแล้ว หากโดเมนของคุณยังไม่เชื่อมต่อกับ Cloudflare กรุณาทำตาม [คู่มือการตั้งค่า Cloudflare](domain-cloudflare-setup.md) ของเราก่อน
