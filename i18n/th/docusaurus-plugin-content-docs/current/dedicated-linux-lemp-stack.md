...
title: "ตั้งค่า LEMP Stack บนเซิร์ฟเวอร์ Linux - ปล่อยเว็บแอปประสิทธิภาพสูง"
...
เราจะใช้โดเมนทดสอบ `zapdocs.example.com` ตลอดคู่มือ เพราะในโลกจริงคุณน่าจะใช้โดเมน คุณ **ต้อง** ตั้งค่า `A` type ระเบียน DNS สำหรับโดเมนที่ชี้ไปยังที่อยู่ IP ของเซิร์ฟเวอร์ ถ้าต้องการความช่วยเหลือ ดูที่ [คู่มือระเบียนโดเมน](domain-records.md)
...
ยินดีด้วย คุณติดตั้งและตั้งค่า LEMP stack สำเร็จแล้ว! ขั้นตอนถัดไป เรา **แนะนำอย่างยิ่ง** ให้ตั้งค่าโดเมนและ **ใบรับรอง SSL** เพื่อให้ข้อมูลส่งผ่านอย่างปลอดภัยไปยังเว็บไซต์ของคุณ ดู [คู่มือ Certbot](dedicated-linux-certbot.md) โดยเน้นที่ **ปลั๊กอิน Nginx** และทำตามขั้นตอนโต้ตอบเพื่อสร้างใบรับรองสำหรับโดเมนที่เลือกได้ง่าย ๆ
