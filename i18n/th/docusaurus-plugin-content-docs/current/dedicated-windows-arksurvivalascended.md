...
ใช้ [คู่มือการส่งต่อพอร์ต (ไฟร์วอลล์)](vserver-windows-port.md) ของเรา หากคุณต้องการความช่วยเหลือเพิ่มเติม
...
ถึงเวลาสตาร์ทเซิร์ฟเวอร์ของคุณแล้ว แต่ก่อนที่เซิร์ฟเวอร์จะเริ่มทำงานได้ คุณต้องติดตั้ง [Microsoft Visual C++ 2015 Redistributable](https://learn.microsoft.com/en-us/cpp/windows/latest-supported-vc-redist?view=msvc-170#visual-studio-2015-2017-2019-and-2022) บน Windows VPS ของคุณก่อน

:::info
คุณต้องติดตั้ง [Microsoft Visual C++ 2015 Redistributable](https://learn.microsoft.com/en-us/cpp/windows/latest-supported-vc-redist?view=msvc-170#visual-studio-2015-2017-2019-and-2022) บน Windows VPS ของคุณก่อนพยายามสตาร์ทเซิร์ฟเวอร์ หากยังไม่มี เพราะเป็นไลบรารีที่เซิร์ฟเวอร์ต้องใช้ เซิร์ฟเวอร์อาจไม่เริ่มทำงานถ้าไม่มีตัวนี้
:::
