...
เมื่อเตรียมตัวครบถ้วนแล้ว คุณก็สามารถติดตั้งแอปพลิเคชัน Git ได้เลย ดาวน์โหลด Git สำหรับ Windows (x64) ได้ที่นี่: https://git-scm.com/downloads/win 
...
ยินดีด้วย! ตอนนี้คุณได้ติดตั้งและกำหนดค่า Git บน vServer ของคุณเรียบร้อยแล้ว เรายังแนะนำให้ดูแหล่งข้อมูลต่อไปนี้ ซึ่งจะช่วยให้คุณได้รับความช่วยเหลือและคำแนะนำเพิ่มเติมในกระบวนการตั้งค่าเซิร์ฟเวอร์
