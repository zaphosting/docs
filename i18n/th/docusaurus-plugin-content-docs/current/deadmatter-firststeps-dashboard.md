...
ด้วยข้อมูลนี้ คุณจะได้เห็นภาพการใช้งานเซิร์ฟเวอร์ของคุณอย่างชัดเจน นอกจากนี้ สถิติเหล่านี้ยังช่วยให้คุณระบุปัญหาด้านประสิทธิภาพและจำกัดสาเหตุได้ เช่น คุณสามารถตรวจสอบได้ว่าเมื่อใดที่การใช้งานเพิ่มขึ้น และว่ามีความเกี่ยวข้องกับเหตุการณ์หรือการเปลี่ยนแปลงใดๆ หรือไม่ ซึ่งสำคัญมากเมื่อเกิดปัญหาอย่างกะทันหัน เพราะจะช่วยให้คุณดำเนินการแก้ไขปัญหาได้อย่างตรงจุดและวิเคราะห์สาเหตุได้อย่างเป็นระบบ
...
เกิดปัญหาทางเทคนิคและคุณไม่แน่ใจสาเหตุหรือเปล่า? วิธีแก้ปัญหาเบื้องต้นคือการตรวจสอบ **ไฟล์บันทึก** ไฟล์เหล่านี้มีข้อมูลมากมายเกี่ยวกับเซิร์ฟเวอร์ เช่น เหตุการณ์ปัจจุบัน, เบาะแส หรือข้อความแสดงข้อผิดพลาด
...
:::warning
ข้อมูลที่พบไม่ช่วยหรือคุณไม่เข้าใจ? ไม่ต้องกังวล! ในกรณีนี้เรามีทีมซัพพอร์ตพร้อมให้บริการทุกวัน เพียงแค่สร้าง **[ตั๋ว](https://zap-hosting.com/en/customer/support/)** และอธิบายปัญหาของคุณให้เรา เราจะตรวจสอบและช่วยแก้ไขปัญหาให้เร็วที่สุด! :)
:::
...
ในส่วน **การตั้งค่า** คุณจะพบหน้าต่างๆ ที่จำเป็นสำหรับการปรับแต่งเซิร์ฟเวอร์ของคุณ ตัวเลือกสำหรับการตั้งค่าเซิร์ฟเวอร์จะแสดงรายละเอียดไว้ด้านล่าง
...
**FileZilla:** FileZilla เป็น FTP-Client ที่ง่ายและเป็นที่รู้จักมากที่สุด แค่ติดตั้ง เปิดโปรแกรม และกรอกข้อมูลการเข้าถึงที่คุณจะพบในหน้านี้ด้านบน คลิก "เชื่อมต่อ" เพียงครั้งเดียว คุณก็เข้าสู่เซิร์ฟเวอร์และจัดการไฟล์ได้เลย
...
ในหน้าการตั้งค่าคุณสามารถกำหนดได้ว่าจะให้สร้างสำรองข้อมูลอัตโนมัติหรือไม่ และจะทำทุกวันหรือทุกสัปดาห์ นอกจากนี้ยังสามารถตั้งค่าให้ลบสำรองข้อมูลเก่าที่สุดเมื่อพื้นที่จัดเก็บเหลือน้อย
