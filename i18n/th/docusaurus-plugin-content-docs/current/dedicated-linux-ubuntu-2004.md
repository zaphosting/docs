...
description: "ค้นพบวิธีการติดตั้งและตั้งค่า Ubuntu บนเซิร์ฟเวอร์เฉพาะของคุณเพื่อประสิทธิภาพสูงสุดและการสนับสนุนระยะยาว → เรียนรู้เพิ่มเติมตอนนี้"
...
การสนับสนุนสำหรับเวอร์ชัน Ubuntu เก่าจะถูกยุติในไม่ช้า กำหนดเวลาต่อไปนี้สำหรับเวอร์ชัน 20.04:
...
สำหรับการติดตั้งและตั้งค่าระบบปฏิบัติการ สิ่งสำคัญอันดับแรกคือการเมานต์ ISO ของระบบปฏิบัติการนั้น มีหลายวิธีที่เป็นไปได้ในการเมานต์:
...
เมื่อเมานต์ ISO สำเร็จและโหลดเสร็จ เซิร์ฟเวอร์จะเข้าสู่กระบวนการตั้งค่า ภาษาที่คุณต้องการใช้สำหรับระบบปฏิบัติการจะถูกกำหนดในตอนเริ่มต้นของการตั้งค่า เลือกภาษาที่มีให้และยืนยันด้วยปุ่ม `Enter`
...
ตั้งค่าบัญชีผู้ใช้ตามที่คุณต้องการ คุณยังสามารถใช้บัญชี root ได้โดยเปลี่ยนรหัสผ่าน คุณสามารถเลื่อนดูตัวเลือกด้วย tab หรือปุ่มลูกศร เมื่อเสร็จแล้วให้เลือก `Done`
...
​	Ubuntu มี snaps เริ่มต้นให้เลือก หากต้องการใช้ตัวไหนก็เลือกตามใจชอบ

![](https://screensaver01.zap-hosting.com/index.php/s/wcGiSwX935jXeex/preview)

เพื่อให้กระบวนการเสร็จสมบูรณ์ ต้องถอด ISO ออกเพื่อป้องกันไม่ให้โหลดซ้ำเมื่อเซิร์ฟเวอร์รีสตาร์ท รีสตาร์ทเซิร์ฟเวอร์หนึ่งครั้งเพื่อจบขั้นตอน
...
คุณสามารถเปลี่ยนรหัสผ่านของผู้ใช้ root ได้ง่ายๆ รันคำสั่ง `sudo su` แล้วใส่รหัสผ่านของคุณ จากนั้นรัน `sudo passwd` เพื่อเปลี่ยนรหัสผ่าน ใส่รหัสผ่านใหม่ที่ต้องการสำหรับผู้ใช้ root เท่านี้ก็เสร็จ คุณสามารถล็อกอินด้วยบัญชีผู้ใช้ `root` ได้เลย



## สรุป

ยินดีด้วย คุณได้ติดตั้งระบบปฏิบัติการ Ubuntu 20.04 บนเซิร์ฟเวอร์เฉพาะของคุณสำเร็จแล้ว หากมีคำถามหรือขอความช่วยเหลือเพิ่มเติม อย่าลังเลที่จะติดต่อทีมซัพพอร์ตของเรา ซึ่งพร้อมให้บริการทุกวันเพื่อช่วยเหลือคุณ! 🙂