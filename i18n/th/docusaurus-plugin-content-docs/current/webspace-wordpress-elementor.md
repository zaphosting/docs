...
:::info
Elementor มีให้เลือกใช้ทั้งเวอร์ชันฟรีและเวอร์ชันเสียเงิน โดยเวอร์ชันฟรีของ Elementor (Elementor Core) จะมีทุกอย่างที่คุณต้องการเพื่อเริ่มต้นเว็บไซต์ของคุณ ส่วน Elementor Pro จะเพิ่มฟีเจอร์และวิดเจ็ต Pro พิเศษเข้าไป คุณสามารถดูรายละเอียดความแตกต่างได้ในเอกสารทางการของ **[Elementor](https://elementor.com/help/elementor-pro-vs-free/)**.
:::
...
การใช้งานและติดตั้ง Elementor จำเป็นต้องมี WordPress ติดตั้งและใช้งานอยู่บนเว็บโฮสติ้งของคุณก่อน หากยังไม่ได้ติดตั้ง คุณต้องทำขั้นตอนนี้ก่อน หากไม่แน่ใจวิธีการ เราแนะนำให้ดู **[คู่มือติดตั้ง WordPress](webspace-wordpress.md)** ของเรา

เมื่อขั้นตอนนี้เสร็จสิ้นและ WordPress พร้อมใช้งานแล้ว คุณก็สามารถเริ่มติดตั้ง Elementor ได้เลย Elementor จะติดตั้งใน WordPress ในรูปแบบปลั๊กอิน คุณสามารถดูวิธีติดตั้งปลั๊กอินใน WordPress ได้ใน **[คู่มือปลั๊กอิน WordPress](webspace-wordpress-plugins.md)** ของเรา

ไปที่เมนู Plugins ใน WordPress แล้วคลิกปุ่ม **เพิ่มปลั๊กอินใหม่** ที่ด้านบนของหน้า ในขั้นตอนถัดไป ให้ค้นหา Elementor แล้วคลิกติดตั้งที่ตัวเลือก **Elementor Website Builder - More than just a page builder**
...
เมื่อการติดตั้งเสร็จสิ้น คุณสามารถดำเนินการตั้งค่าต่อได้ ในขั้นตอนถัดไป คุณจะเห็นหน้าต่างต้อนรับของ Elementor ที่จะนำทางคุณผ่านขั้นตอนต่าง ๆ ได้แก่ การสร้างบัญชี Elementor, การติดตั้งธีม “Hello”, การเลือกฟีเจอร์ที่ต้องการ และสุดท้ายยืนยัน “Good to go” แค่ทำตามคำแนะนำเพื่อเซ็ตอัพ Elementor ให้ครบถ้วน
...
ตอนนี้คุณสามารถเริ่มออกแบบเว็บไซต์ของคุณด้วย Elementor ได้เลย ก่อนอื่นควรทำความเข้าใจวิธีใช้ Elementor ให้ครบถ้วน รวมถึงวิดเจ็ตที่มีให้ใช้งาน วิธีแก้ไขดีไซน์และเลย์เอาต์ และวิธีสร้างเพจและเทมเพลตต่าง ๆ
...
สร้างเพจใหม่และออกแบบตามใจด้วย **Elementor** โดยเปิด **Elementor** ผ่านแถบด้านข้างแล้วเลือก **"สร้างเพจ"** ตัวแก้ไขจะมี **วิดเจ็ตและตัวเลือกการตั้งค่ามากมาย** ให้คุณปรับแต่งดีไซน์และเนื้อหาได้อย่างยืดหยุ่น

![img](https://screensaver01.zap-hosting.com/index.php/s/mdMbnXNkngXWJHt/download)

### เทมเพลต

สร้างเทมเพลตสำหรับ **คอนเทนเนอร์, เพจ หรือส่วนต่าง ๆ** ที่คุณสามารถใช้ซ้ำได้ ข้อดีคือการแก้ไขจะทำแค่ที่เดียว ทุกส่วนที่ใช้เทมเพลตนั้นจะอัปเดตอัตโนมัติ ช่วยประหยัดเวลาและทำให้ดีไซน์เว็บไซต์ของคุณเป็นมาตรฐาน

![img](https://screensaver01.zap-hosting.com/index.php/s/mdMbnXNkngXWJHt/download)

## เอกสาร Elementor

คู่มือนี้เน้นเฉพาะการติดตั้ง การตั้งค่า และพื้นฐานสำคัญสำหรับการใช้ WordPress ร่วมกับ Elementor สำหรับการแนะนำที่ลึกขึ้นในโลกของ Elementor เราแนะนำให้ดู **[เอกสารทางการของ Elementor](https://developers.elementor.com/docs/)** และ **[ศูนย์ช่วยเหลือ](https://elementor.com/help/)**



## ส่วนขยาย Elementor เพิ่มเติม

ตัวเลือกและฟีเจอร์ต่าง ๆ ไม่ว่าจะเป็นการตั้งค่า ธีม หรือวิดเจ็ต จะถูกจำกัดตามเวอร์ชันของ Elementor — ฟรีหรือ Pro แต่ก็มีส่วนขยายจากผู้พัฒนารายอื่น ๆ มากมายที่ช่วยขยายและปรับปรุงตัวเลือกการออกแบบของคุณ หรือเพิ่มฟีเจอร์ใหม่ ๆ ให้เว็บไซต์ของคุณได้อีกด้วย ส่วนขยายเหล่านี้ช่วยให้คุณมีความยืดหยุ่นมากขึ้นในการออกแบบเว็บไซต์ตามที่ต้องการ
...
ยินดีด้วย ถ้าคุณทำตามทุกขั้นตอนครบถ้วน คุณน่าจะติดตั้งและตั้งค่า Elementor ได้สำเร็จแล้ว หากมีคำถามเพิ่มเติมหรือต้องการความช่วยเหลือ อย่าลังเลที่จะติดต่อทีมซัพพอร์ตของเรา ที่พร้อมช่วยเหลือคุณทุกวัน! 🙂
