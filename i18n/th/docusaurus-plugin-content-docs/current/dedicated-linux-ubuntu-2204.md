...
ต่อไปนี้จะอธิบายขั้นตอนทีละขั้นตอนเกี่ยวกับวิธีการติดตั้งและตั้งค่าระบบปฏิบัติการ Ubuntu บนเซิร์ฟเวอร์เฉพาะของคุณ ทำตามคำแนะนำอย่างระมัดระวังเพื่อให้แน่ใจว่าคุณติดตั้งระบบปฏิบัติการได้สำเร็จและใช้งานได้อย่างเต็มประสิทธิภาพ
...
การสนับสนุนสำหรับเวอร์ชัน Ubuntu เก่าจะถูกยุติในไม่ช้า กำหนดเวลาต่อไปนี้สำหรับเวอร์ชัน 22.04:

- สิ้นสุดการสนับสนุนมาตรฐาน: 01.04.2027
- สิ้นสุดการสนับสนุน Ubuntu Pro: 01.04.2032
- สิ้นสุดการสนับสนุน Legacy: 01.04.2034
...
ถ้าคุณยังไม่คุ้นเคยกับการเมานต์ไฟล์ ISO แนะนำให้ดูคู่มือ [การตั้งค่าเริ่มต้น](dedicated-setup.md) หรือ [ISO ของตัวเอง](dedicated-iso.md) ของเรา



## การติดตั้ง

เมื่อเมานต์ ISO สำเร็จและโหลดแล้ว เซิร์ฟเวอร์จะเข้าสู่กระบวนการตั้งค่า ภาษาที่คุณต้องการใช้สำหรับระบบปฏิบัติการจะถูกกำหนดในตอนเริ่มต้นของการตั้งค่า เลือกภาษาที่ต้องการจากตัวเลือกที่มีและกดยืนยันด้วยปุ่ม `Enter`
...
ก่อนเริ่มกระบวนการ คุณจะได้รับแจ้งว่ากระบวนการนี้จะลบข้อมูลทั้งหมดที่มีอยู่ ต้องยืนยันข้อความนี้ด้วยตัวเลือก `Continue`

![](https://screensaver01.zap-hosting.com/index.php/s/L3YcGNbYWpMmaDj/preview)

ตั้งค่าบัญชีผู้ใช้ตามที่ต้องการ คุณยังสามารถใช้บัญชี root ได้ในภายหลังโดยเปลี่ยนรหัสผ่าน ใช้ปุ่ม tab หรือปุ่มลูกศรเพื่อเลื่อนดูตัวเลือก เมื่อเสร็จแล้วให้เลือก `Done`
