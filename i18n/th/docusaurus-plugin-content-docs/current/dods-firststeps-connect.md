...
description: "ค้นหาวิธีเชื่อมต่อกับเซิร์ฟเวอร์ Day of Defeat: Source ของคุณอย่างราบรื่นและสนุกกับการเล่นเกมที่ลื่นไหล → เรียนรู้เพิ่มเติมตอนนี้"
...
เพื่อเชื่อมต่อกับเซิร์ฟเวอร์ของคุณผ่านเบราว์เซอร์เซิร์ฟเวอร์ในเกม ให้เปิดเบราว์เซอร์เซิร์ฟเวอร์ในเมนูหลักโดยกดปุ่ม **ค้นหาเซิร์ฟเวอร์** คลิกที่ **เพิ่มเซิร์ฟเวอร์** แล้วกรอก IP:Port ของเซิร์ฟเวอร์ของคุณในช่อง จากนั้นคลิก **เพิ่มที่อยู่นี้ในรายการโปรด** เพื่อเพิ่มเซิร์ฟเวอร์ลงในรายการโปรดของคุณ
...
ค้นหาหรือเพิ่มเซิร์ฟเวอร์ของคุณผ่านเบราว์เซอร์ Steam โดยใช้ `ที่อยู่ IP` และ `พอร์ต` ของเซิร์ฟเวอร์เกมของคุณ โดยเลือกแท็บ `รายการโปรด` ในรายการเซิร์ฟเวอร์แล้วคลิกที่สัญลักษณ์บวกด้านล่าง จะมีหน้าต่างป๊อปอัปเปิดขึ้นเพื่อให้คุณระบุข้อมูลเซิร์ฟเวอร์ของคุณ
...
ใน Counter-Strike: Source คอนโซลจะถูกปิดใช้งานโดยค่าเริ่มต้น เพื่อเปิดใช้งาน ให้ไปที่ **ตัวเลือก → แป้นพิมพ์ แล้วเลือกขั้นสูง** เพื่อเชื่อมต่อกับเซิร์ฟเวอร์ของคุณผ่านคอนโซล ให้เปิดคอนโซลด้วยปุ่ม `~` เมื่อคอนโซลเปิดแล้ว ให้พิมพ์คำสั่งนี้:
