...
description: "ค้นพบวิธีตั้งค่า Hytale Dedicated Server บนเซิร์ฟเวอร์เฉพาะ Linux ของคุณเพื่อการจัดการเกมที่ลื่นไหล → เรียนรู้เพิ่มเติมตอนนี้"
...
ถ้ายังไม่ได้ติดตั้ง Java บนระบบของคุณ ให้ทำตามคู่มือ [ติดตั้ง Java](vserver-linux-java) สำหรับเซิร์ฟเวอร์ Linux ของเรา คู่มือนี้อธิบายวิธีติดตั้งและตั้งค่า Java อย่างถูกต้องในสภาพแวดล้อมของคุณ
...
| `./hytale-downloader -download-path game.zip` | ดาวน์โหลดไปยังไฟล์เฉพาะ             |
