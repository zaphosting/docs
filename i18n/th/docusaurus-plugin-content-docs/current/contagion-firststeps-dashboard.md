...
title: "Contagion: ภาพรวมแดชบอร์ด"
description: "ค้นพบวิธีจัดการและปรับแต่งเซิร์ฟเวอร์ Contagion ของคุณอย่างมีประสิทธิภาพด้วยภาพรวมที่ชัดเจนของฟีเจอร์และตัวเลือกทั้งหมด → เรียนรู้เพิ่มเติมตอนนี้"
...
ในส่วน **สถิติ** คุณจะได้รับภาพรวมที่ครอบคลุมของค่าการโหลดของเซิร์ฟเวอร์คุณ ที่นี่คุณจะพบข้อมูลเกี่ยวกับหลายๆ ด้าน เช่น การโหลดของช่องว่างที่ว่าง, CPU และหน่วยความจำ คุณสามารถดูข้อมูลนี้ในช่วงเวลาต่างๆ เช่น **60 นาที, 24 ชั่วโมง, 3 วัน, 7 วัน** หรือ **30 วัน**
...
ในส่วน **การตั้งค่า** คุณจะพบหน้าที่จำเป็นทั้งหมดสำหรับการกำหนดค่าเซิร์ฟเวอร์ของคุณ ตัวเลือกที่มีสำหรับการตั้งค่าเซิร์ฟเวอร์จะแสดงรายละเอียดไว้ด้านล่าง
...
ในส่วน **เกม** คุณสามารถเปลี่ยนแปลงเวอร์ชันเกมของเกมที่มีอยู่ หรือจะติดตั้งเกมใหม่ก็ได้ เกมที่มีราคาช่องว่างเท่ากันสามารถเลือกได้โดยตรงใน **เกมที่มีให้เลือก** สำหรับเกมอื่นๆ ต้องปรับราคาช่องว่างก่อน ดูข้อมูลเพิ่มเติมได้ในคู่มือ [เปลี่ยนเกม](  - gameserver-corekeeper-gameswitch.md)
...
นอกจากผลิตภัณฑ์เซิร์ฟเวอร์เกม เรายังมีฐานข้อมูลรวม 10 ตัวให้ใช้งาน ฐานข้อมูลเหล่านี้จำเป็นเมื่อข้อมูลต้องถูกเก็บไว้ในฐานข้อมูล ภายใต้ **ฐานข้อมูล** คุณสามารถสร้างฐานข้อมูลและดูข้อมูลการเข้าถึงได้ นอกจากนี้ยังสามารถเปิดใช้งานตัวเลือกสำรองข้อมูลและนำเข้าการสำรองฐานข้อมูลที่มีอยู่ได้
