...
title: "เซิร์ฟเวอร์เฉพาะ: ตั้งค่า Git บน Linux"
...
ถ้าการติดตั้งสำเร็จ Git จะโชว์หมายเลขเวอร์ชันที่ติดตั้งอยู่ หากมีข้อความแสดงข้อผิดพลาดหรือไม่มีผลลัพธ์ แปลว่า Git อาจติดตั้งไม่สมบูรณ์หรือคำสั่งไม่ได้อยู่ในเส้นทางระบบ
...
ยินดีด้วย! ตอนนี้คุณได้ติดตั้งและกำหนดค่า Git บนเซิร์ฟเวอร์เฉพาะของคุณเรียบร้อยแล้ว เรายังแนะนำให้ดูแหล่งข้อมูลต่อไปนี้ซึ่งจะช่วยให้คุณได้รับคำแนะนำและความช่วยเหลือเพิ่มเติมในกระบวนการตั้งค่าเซิร์ฟเวอร์
