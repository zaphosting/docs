...
เริ่มเกมและไปที่ **Join** เพื่อเปิดรายการเซิร์ฟเวอร์ ใช้ช่องค้นหาเพื่อค้นหาเซิร์ฟเวอร์ของคุณโดยใช้ชื่อเซิร์ฟเวอร์ จากนั้นเชื่อมต่อโดยคลิกที่ปุ่ม **Connect**
...
เพื่อเชื่อมต่อกับเซิร์ฟเวอร์ของคุณผ่านเบราว์เซอร์เซิร์ฟเวอร์ของ Steam ให้เปิดเบราว์เซอร์เซิร์ฟเวอร์จาก Steam คลิกที่ `View` บนแถบนำทางของ Steam ด้านบน แล้วเลือกส่วน `Game Server` เพื่อเปิด

ค้นหาหรือเพิ่มเซิร์ฟเวอร์ของคุณผ่านเบราว์เซอร์ Steam โดยใช้ `ที่อยู่ IP` และ `พอร์ต` ของเซิร์ฟเวอร์เกมของคุณ ในการทำเช่นนี้ ให้เลือกแท็บ `Favorites` ในรายการเซิร์ฟเวอร์แล้วคลิกที่สัญลักษณ์บวกด้านล่าง จะมีหน้าต่างป๊อปอัปเปิดขึ้นเพื่อให้คุณระบุข้อมูลเซิร์ฟเวอร์ของคุณ
...
การไม่เห็นเซิร์ฟเวอร์อาจเกิดขึ้นได้ถ้าการเริ่มต้นเซิร์ฟเวอร์ไม่สำเร็จ อาจเกิดจากการตั้งค่าที่ผิดพลาดหรือไฟล์เสียหาย ข้อมูลเพิ่มเติมมักจะตรวจสอบได้จากคอนโซลเซิร์ฟเวอร์หรือไฟล์ล็อก
