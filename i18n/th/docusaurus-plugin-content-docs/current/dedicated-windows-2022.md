...
## บทนำ
ต่อไปนี้จะอธิบายขั้นตอนทีละขั้นตอนในการติดตั้งและตั้งค่าระบบปฏิบัติการ Windows Server บนเซิร์ฟเวอร์เฉพาะของคุณ ทำตามคำแนะนำอย่างระมัดระวังเพื่อให้แน่ใจว่าคุณตั้งค่าระบบปฏิบัติการได้สำเร็จและใช้งานได้อย่างเต็มประสิทธิภาพ

:::info Windows Server 2022
ขั้นตอนการติดตั้งและตัวอย่างในคู่มือนี้อ้างอิงจากระบบปฏิบัติการ Windows Server 2022 (ดีไซน์เหมือนกับเวอร์ชัน 2019) เวอร์ชันเก่าอาจแตกต่างกันในเรื่องโครงสร้างและรูปลักษณ์ แต่กระบวนการโดยรวมจะคล้ายกัน
:::
...
การสนับสนุนสำหรับ Windows Server เวอร์ชันเก่าจะถูกยุติในไม่ช้า โดยมีวันหมดอายุสำหรับเวอร์ชัน 2022 ดังนี้:
...
## การติดตั้ง
ในการติดตั้ง Windows Server คุณจะต้องมีไฟล์ ISO ของเวอร์ชันที่ต้องการ คุณสามารถเลือกเวอร์ชัน Windows ที่ต้องการได้จากเว็บอินเทอร์เฟซของเรา หรือจะใช้ไฟล์ ISO ของตัวเองก็ได้ เรามีคู่มือ [ISO ของตัวเอง](dedicated-iso.md) สำหรับเรื่องนี้
...
กด "ติดตั้งทันที" เพื่อเริ่มกระบวนการติดตั้ง
...
ถ้าไม่แน่ใจว่าต้องการรุ่นไหน ให้กด "ไม่มีคีย์ผลิตภัณฑ์" คุณสามารถเพิ่มคีย์ทีหลังได้เสมอ

![](https://screensaver01.zap-hosting.com/index.php/s/jH5dYQBq7FtT2SL/preview)

ตอนนี้เลือกเวอร์ชันที่คุณต้องการติดตั้ง  
โปรดเลือกเวอร์ชันให้ถูกต้องเพราะไม่สามารถเปลี่ยนแปลงได้หลังจากนี้  
อย่าลืมเลือกเวอร์ชันที่มี "(Desktop Experience)" ด้วย ไม่เช่นนั้น Windows จะเป็นแบบ shell-based  
...
เลือก 'Custom' หากต้องการติดตั้ง Windows ใหม่แบบสะอาด  
ถ้าต้องการอัปเกรดจาก 2016 เป็น 2022 ก็เลือก "Upgrade"
...
ถ้าจะสร้างหลายพาร์ติชัน เราแนะนำให้พาร์ติชันหลักของ Windows มีขนาดอย่างน้อย 50GB  
...
เพื่อเข้าสู่ระบบ Windows กดปุ่มลัด `CTRL + ALT + DELETE` ซึ่งทำได้ง่ายผ่านคอนโซลระยะไกล  
...
ยอมรับข้อความไฟร์วอลล์ที่ขึ้นมาโดยกด "ตกลง" แล้วกด "Apply"

เปิดโปรแกรม Remote Desktop บนคอมพิวเตอร์ของคุณ แล้วกรอกที่อยู่ IP ของอินเทอร์เฟซ ZAP  
...
การตั้งค่าเครือข่ายจะถูกตั้งค่าอัตโนมัติผ่าน DHCP จึงไม่ต้องแก้ไขเพิ่มเติม
...
## สรุป
ยินดีด้วย คุณได้ติดตั้งระบบปฏิบัติการ Windows Server 2022 บนเซิร์ฟเวอร์เฉพาะของคุณเรียบร้อยแล้ว  
ถ้ามีคำถามหรือขอความช่วยเหลือเพิ่มเติม อย่าลังเลที่จะติดต่อทีมซัพพอร์ตของเรา ซึ่งพร้อมให้บริการทุกวัน! 🙂