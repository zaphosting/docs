...
SSH (Secure Shell) คือบริการที่ให้คุณเข้าถึงคอนโซลเซิร์ฟเวอร์จากระยะไกลเพื่อสั่งคำสั่งบนเซิร์ฟเวอร์ ดูวิธีตั้งค่า SSH บนเซิร์ฟเวอร์ของคุณได้ที่: [การเข้าถึงเบื้องต้น (SSH)](vserver-linux-ssh.md)
...
เพื่อปกป้องเซิร์ฟเวอร์ของคุณจากการเข้าถึง SSH ที่ไม่ต้องการให้ดียิ่งขึ้น คุณควรเปิดใช้งานการยืนยันตัวตนผ่าน SSH keys เท่านั้น และปิดการล็อกอินด้วยรหัสผ่าน ดูคู่มือ [SSH Key](vserver-linux-sshkey.md) ที่อธิบายวิธีสร้างและเพิ่ม SSH keys
...
- postfix
- Courier Mail Server
คุณสามารถเพิ่มบริการอื่น ๆ ได้ง่าย ๆ ด้วยการใช้ regular expression (RegEx) และระบุไฟล์ล็อกที่ต้องการ
...
สมมติว่าโดเมนของคุณถูกจัดการโดย Cloudflare แล้ว ถ้ายังไม่ใช่ คุณสามารถทำตาม [คู่มือของพวกเขา](https://developers.cloudflare.com/fundamentals/get-started/setup/add-site/) เพื่อย้ายโดเมนของคุณ ไปที่แท็บ DNS Records ในแดชบอร์ดของ Cloudflare และตรวจสอบให้แน่ใจว่าระเบียนที่ชี้ไปยังเว็บเซิร์ฟเวอร์ของคุณมีเมฆสีส้มและสถานะ "Proxied"
...
ทำได้โดยตั้งกฎไฟร์วอลล์จำกัดการเข้าถึงด้วย [รายชื่อ IPv4 สาธารณะของ Cloudflare](https://cloudflare.com/ips-v4) และ [รายชื่อ IPv6 สาธารณะของ Cloudflare](https://cloudflare.com/ips-v6)

หรือถ้าต้องการประหยัดเวลา คุณสามารถใช้เครื่องมืออย่าง [Cloudflare-ufw](https://github.com/Paul-Reed/cloudflare-ufw) เพื่อเพิ่มกฎไฟร์วอลล์เหล่านี้แบบแมส
