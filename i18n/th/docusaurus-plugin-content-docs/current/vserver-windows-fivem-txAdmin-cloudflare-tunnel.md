...
title: "VPS: ตั้งค่า Cloudflare Tunnel สำหรับ txAdmin"
description: "ค้นหาวิธีตั้งค่า Cloudflare Tunnel สำหรับ txAdmin เพื่อความปลอดภัยที่มากขึ้น → เรียนรู้เพิ่มเติมตอนนี้"
...
เพื่อใช้ Cloudflare Tunnel บน Windows คุณต้องมี Windows VPS, การติดตั้ง txAdmin ที่ใช้งานได้, พอร์ต txAdmin ของคุณ และโดเมนที่เชื่อมต่อกับบัญชี Cloudflare ของคุณแล้ว หากโดเมนของคุณยังไม่ได้เชื่อมต่อกับ Cloudflare กรุณาทำตาม [คู่มือการตั้งค่า Cloudflare](domain-cloudflare-setup.md) ของเราก่อน
