...
ขั้นตอนการตั้งค่าและตัวอย่างในคู่มือนี้อ้างอิงจากระบบปฏิบัติการ Windows Server 2019 เวอร์ชันเก่าอาจแตกต่างกันในเรื่องโครงสร้างและรูปลักษณ์ แต่กระบวนการโดยรวมจะคล้ายกัน
:::
...
การสนับสนุนสำหรับ Windows Server เวอร์ชันเก่าจะถูกยกเลิกในไม่ช้า กำหนดเวลาสำหรับเวอร์ชัน 2019 มีดังนี้:
...
ถ้าคุณยังไม่คุ้นเคยกับการเมานต์ไฟล์ ISO แนะนำให้ดูที่ [คู่มือการตั้งค่าเริ่มต้น](dedicated-setup.md) หรือ [คู่มือการใช้ ISO ของตัวเอง](dedicated-iso.md)



## การติดตั้ง
ในการติดตั้ง Windows Server คุณจะต้องมีไฟล์ ISO ของเวอร์ชันที่ต้องการ คุณสามารถเลือกเวอร์ชัน Windows ที่ต้องการได้ในเว็บอินเทอร์เฟซของเรา หรือจะใช้ไฟล์ ISO ของตัวเองก็ได้ เรามี [คู่มือการใช้ ISO ของตัวเอง](dedicated-iso.md) สำหรับเรื่องนี้

![](https://screensaver01.zap-hosting.com/index.php/s/DDNsa9zjbXng9Z6/preview)

ถ้าหน้านี้ปรากฏในคอนโซลระยะไกลที่คุณใช้งาน หมายความว่าไฟล์ ISO ถูกโหลดเรียบร้อยแล้ว เราสามารถเริ่มต้นการตั้งค่าได้เลย  
...
:::note
เราไม่ได้ขายไลเซนส์ Windows นะ คุณต้องซื้อคีย์เอง
:::
...
ถ้าไม่แน่ใจว่าต้องการอะไร กด "ฉันไม่มีคีย์ผลิตภัณฑ์" ได้เลย คุณสามารถเพิ่มคีย์ทีหลังได้เสมอ

![](https://screensaver01.zap-hosting.com/index.php/s/jH5dYQBq7FtT2SL/preview)

ตอนนี้เลือกเวอร์ชันที่คุณต้องการติดตั้ง  
ต้องเลือกเวอร์ชันให้ถูกต้องเพราะไม่สามารถเปลี่ยนแปลงได้หลังจากนี้  
อย่าลืมเลือกเวอร์ชันที่มี "(Desktop Experience)" ด้วย ไม่งั้น Windows จะเป็นแบบเชลล์เท่านั้น  
เมื่อเลือกได้แล้ว ให้ทำเครื่องหมายที่เวอร์ชันนั้นแล้วกด "ถัดไป"
...
เลือก 'Custom' ถ้าคุณต้องการติดตั้ง Windows ใหม่แบบสะอาดๆ  
ถ้าต้องการอัปเกรดจาก 2016 เป็น 2019 ก็เลือก "Upgrade"

![](https://screensaver01.zap-hosting.com/index.php/s/8zkx8grPTCSgprQ/preview)

ขั้นตอนถัดไป คุณต้องสร้างพาร์ติชันบนเซิร์ฟเวอร์เฉพาะของคุณ ปกติจะยังไม่มีพาร์ติชันใดๆ ถ้ามีให้เลือกแล้วกดลบออก

คุณสามารถสร้างพาร์ติชันหลายอันขนาดเล็ก หรือพาร์ติชันใหญ่พาร์ติชันเดียว  
ถ้าสร้างหลายพาร์ติชัน เราแนะนำให้พาร์ติชันหลักของ Windows มีขนาดอย่างน้อย 50GB  
...
ถ้าพอใจกับพาร์ติชันที่สร้างแล้ว ให้เลือกพาร์ติชันที่จะติดตั้ง Windows แล้วกด "ถัดไป"  
Windows Setup จะทำงานเองทั้งหมด อาจใช้เวลาหลายนาที  
ไม่มีอะไรต้องทำจนกว่าการติดตั้งจะเสร็จ
...
หลังตั้งรหัสผ่านแล้ว เราจะอยู่ที่ Windows Lockscreen

![](https://screensaver01.zap-hosting.com/index.php/s/ddxASYsjNgwHX5i/preview)

เพื่อเข้าสู่ระบบ Windows ให้กดคีย์ผสม `CTRL + ALT + DELETE` คุณสามารถกดผ่านคอนโซลระยะไกลได้ง่ายๆ  
(ในคอนโซล Java จะมีเมนู "Keyboard")  
...
ตอนนี้เปิด Remote Desktop บนคอมพิวเตอร์ของคุณแล้วกรอกที่อยู่ IP ของอินเทอร์เฟซ ZAP  
ชื่อผู้ใช้คือ Administrator เสมอ และรหัสผ่านคือรหัสที่คุณตั้งไว้ก่อนหน้า

![](https://screensaver01.zap-hosting.com/index.php/s/w97g9aDrpM8EjpA/preview)

คุณสามารถข้ามคำเตือนใบรับรองได้ โดยติ๊กที่ "อย่าถามฉันอีกสำหรับการเชื่อมต่อกับคอมพิวเตอร์นี้"  
กดยืนยันด้วย "ใช่"

![](https://screensaver01.zap-hosting.com/index.php/s/SqqCdBZRYysz8yj/preview)

Remote Desktop Connection จะเชื่อมต่อกับเซิร์ฟเวอร์เฉพาะของคุณ และคุณก็พร้อมใช้งาน  
...
## สรุป
ยินดีด้วย คุณติดตั้งระบบปฏิบัติการ Windows Server 2019 บนเซิร์ฟเวอร์เฉพาะของคุณสำเร็จแล้ว  
ถ้ามีคำถามหรืออยากได้ความช่วยเหลือเพิ่มเติม ติดต่อทีมซัพพอร์ตของเราได้เลย พร้อมให้บริการทุกวัน! 🙂