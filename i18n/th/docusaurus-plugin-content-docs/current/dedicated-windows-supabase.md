...
description: "ค้นพบวิธีตั้งค่าและกำหนดค่า Supabase สำหรับแพลตฟอร์ม Postgres แบบโอเพนซอร์สที่เชื่อถือได้ พร้อมฟีเจอร์การยืนยันตัวตนและเรียลไทม์ → เรียนรู้เพิ่มเติมตอนนี้"
...
คู่มือการติดตั้งและวิธีใช้ Docker แบบเต็มมีให้ใน [คู่มือ Docker](dedicated-windows-docker.md) ของเรา
