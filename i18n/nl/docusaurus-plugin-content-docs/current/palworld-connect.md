---
id: palworld-connect
title: "Palworld: Verbinden met je Palworld Server"
description: "Ontdek hoe je eenvoudig verbinding maakt met je Palworld server en naadloos meedoet aan multiplayer games → Leer het nu"
...
In deze gids laten we je zien hoe je verbinding maakt met je Palworld server. We raden aan om je server eerst naar wens in te stellen, check daarvoor onze [Server Configuratie](palworld-configuration.md) gids.

:::tip
We hebben nu ook een aparte **Palworld (Xbox)** gameversie beschikbaar op onze Gameservers, waarmee je kunt spelen op Xbox/Microsoft Store versies. Bekijk onze [Game Switch](gameserver-gameswitch.md) gids om te leren hoe je makkelijk van game wisselt. Vergeet niet altijd een backup van je saves te maken.
:::

<YouTube videoId="SDZC4-FEdNM" imageSrc="https://screensaver01.zap-hosting.com/index.php/s/eA3xonLFkB4x3G6/preview" title="Palworld server opzetten in slechts ÉÉN MINUUT!" description="Snap je het beter als je het in actie ziet? Wij fixen dat! Duik in onze video die alles voor je uitlegt. Of je nu haast hebt of gewoon liever info op de meest toffe manier opneemt!"/>
