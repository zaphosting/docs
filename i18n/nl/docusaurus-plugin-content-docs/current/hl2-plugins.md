---
id: hl2-plugins
title: "Half-Life 2: Installeer plugins op je eigen server"
...
Je hebt de Linux pakketten **Sourcemod** en **Metamod** nodig. Download ze vanaf de genoemde bronnen. Na het downloaden heb je twee gecomprimeerde bestanden. Pak ze uit op je computer om een addons map te krijgen met daarin de `sourcemod` en `metamod` mappen.
...
Als je alle stappen hebt gevolgd, heb je Sourcemod/Metamod en je gewenste plugins succesvol geïnstalleerd. Heb je nog vragen of hulp nodig? Neem dan gerust contact op met onze support, die dagelijks voor je klaarstaat! 🙂
