---
id: hl2-gslt
title: "Half-Life 2: Maak een GSLT (Steam Game Server Login Token)"
description: "Leer hoe je je game server authenticieert met een Steam Game Server Login Token voor correcte vermelding en VAC-bescherming → Ontdek het nu"
...
Eenmaal ingelogd kun je een nieuwe token aanmaken via het formulier op de pagina. Vul bij **App ID** de App ID `320` in, die hoort bij **Half-Life 2**. Zorg dat je de juiste ID invult, want de token werkt niet met een verkeerde waarde.
...
:::info Meerdere Half-Life 2 servers draaien
Als je meerdere **Half-Life 2** servers draait, heb je voor elke server een aparte GSLT nodig. Het is <u>**niet**</u> mogelijk om meerdere game servers te draaien met één enkele GSLT.
:::
