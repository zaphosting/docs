...
title: "Dedicated Server: Supabase installeren op Linux"
description: "Ontdek hoe je Supabase installeert en configureert voor self-hosting om een krachtige open-source Postgres platform te bouwen → Leer het nu"
...
Een volledige uitleg van het installatieproces en het gebruik van Docker vind je in onze [Docker](dedicated-linux-docker.md) gids.
