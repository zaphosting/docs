...
title: "ASTRONEER: Verbinden met de server"
description: "Ontdek hoe je soepel verbinding maakt met je ASTRONEER-server en veelvoorkomende problemen oplost voor ononderbroken gameplay → Leer het nu"
...
## Introductie
Weet je niet zeker hoe je verbinding maakt met je **ASTRONEER**-server of wat je nodig hebt om te beginnen? Geen zorgen, wij fixen het voor je! We nemen je mee door alles wat je nodig hebt – van de benodigde tools en info tot het daadwerkelijke verbindingsproces, inclusief belangrijke tips voor een soepele en probleemloze verbinding. Volg onze gids en je bent zo verbonden!
...
Om via de in-game server browser verbinding te maken met je server, open je de **server browser** in het hoofdmenu. Klik op **Dedicated Server toevoegen** in de serverlijst om je server toe te voegen. Vul het IP-adres en de poort van je server in en geef hem een naam. Klik daarna op **Server toevoegen**, selecteer de toegevoegde server en maak verbinding. 
...
Gefeliciteerd, als je alles gevolgd hebt, zou je nu succesvol verbonden moeten zijn met de server. Voor verdere vragen of hulp, aarzel niet om contact op te nemen met ons supportteam, die dagelijks voor je klaarstaat! 🙂
