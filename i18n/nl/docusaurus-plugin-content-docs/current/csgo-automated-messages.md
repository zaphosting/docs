...
title: "CS:GO: Geautomatiseerde Serverberichten - Houd je spelers op de hoogte van nieuws, socials en meer!"
...
Met **Geplande Taken** worden serverberichten automatisch in de **CS:GO** in-game chat gestuurd door vooraf ingestelde commando’s op een terugkerend schema uit te voeren.
...
Vervang het commando door het gamecommando of commando van een extensie dat je wilt gebruiken om berichten te triggeren en `<jouw berichttekst>` door de tekst die je spelers moeten zien.
