...
title: "Dedicated Server: Teamspeak 6 Server installeren op je Linux Dedicated Server"
...
In de zomer van 2025 bracht TeamSpeak de **Beta versie** van de **TeamSpeak 6 Server** uit. Nu kun je de volgende generatie van TeamSpeak zelf ervaren!
...
## Installatie
Nu aan alle vereisten is voldaan en de voorbereidingen zijn afgerond, kun je de Teamspeak 6 Server applicatie installeren.
...
Ga naar de map waar je het bestand wilt aanmaken en maak het bestand aan. Gebruik hiervoor het commando `nano docker-compose.yml` en plak de inhoud erin.

![img](https://screensaver01.zap-hosting.com/index.php/s/yBZTKL8MYgLiJEt/download)


Om de Docker container en de TeamSpeak 6 Server te starten, voer je het volgende Docker Compose commando uit:
```
...
Wil je de TeamSpeak 6 Server op de achtergrond laten draaien? Start de container dan met dit commando:
...
Gefeliciteerd! Je hebt nu succesvol de Teamspeak 6 Server geïnstalleerd en geconfigureerd op je Dedicated Server. We raden je ook aan om deze bronnen te checken, die je extra hulp en tips kunnen geven tijdens het configureren van je server:
