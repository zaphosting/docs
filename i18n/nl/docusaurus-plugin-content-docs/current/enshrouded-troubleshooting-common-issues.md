...
title: "Enshrouded: Veelvoorkomende problemen"
description: "Ontdek hoe je veelvoorkomende Enshrouded serverproblemen oplost voor een soepele game-ervaring → Leer het nu"
...
Je server is niet zichtbaar als de initialisatie niet goed is afgerond. Dit kan bijvoorbeeld komen door een foutieve configuratie of corrupte bestanden. Meestal vind je meer info terug in de serverconsole of logbestanden. Check ook of er geen verkeerde filterinstellingen in de serverlijst staan, want die kunnen ervoor zorgen dat je server niet getoond wordt.
...
Niets verpest een game-sessie sneller dan een onverwachte crash. Crashes kunnen veroorzaakt worden door buggy serversoftware, kapotte of incompatibele extensies (zoals plugins, mods, resources of frameworks), systeemoverbelasting of misconfiguraties.
...
Heb je last van lag of hoge ping op je server? Volg dan deze simpele stappen om de performance te verbeteren. Zorg eerst dat je server voldoet aan of beter is dan de aanbevolen specs voor jouw game en project. Kies ook een serverlocatie dicht bij je spelers om latency te verminderen.
...
Game servers kunnen soms doelwit zijn van kwaadaardige netwerkactiviteiten, vooral Distributed Denial of Service (DDoS) aanvallen. Deze aanvallen overspoelen de server met verkeer, wat lag, disconnects of zelfs volledige downtime kan veroorzaken. Soms proberen aanvallers ook netwerkzwaktes te misbruiken of de serverstabiliteit te verstoren met herhaalde connectiepogingen of vreemde datapatronen.
...
Regelmatige backups besparen je veel stress en zorgen. Maak regelmatig backups zodat je bij problemen altijd een oudere werkende versie hebt om op terug te vallen. Wij bieden een [backup-oplossing](gameserver-backups.md) voor onze Enshrouded game servers, waarmee je handmatige of automatische geplande backups kunt maken.
