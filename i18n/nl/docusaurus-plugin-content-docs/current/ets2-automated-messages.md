...
title: "Euro Truck Simulator 2: Geautomatiseerde Serverberichten - Houd je spelers op de hoogte van nieuws, social links en meer!"
...
Met **Geplande Taken** kunnen serverberichten automatisch in de **Euro Truck Simulator 2** in-game chat worden gestuurd door vooraf ingestelde commando’s op een terugkerend schema uit te voeren.
...
Geautomatiseerde berichten maak je aan door een taak in te plannen die een servercommando uitvoert op een bepaald tijdstip of interval. Het commando kan gebruikt worden om een chatbericht, broadcast of servermelding te sturen.
...
Daarna kun je instellen hoe vaak het bericht gestuurd moet worden, bijvoorbeeld elke paar minuten, elk uur of op specifieke tijden van de dag. Voor een uitgebreide uitleg over het maken van geplande taken, check de [Geplande taken](gameserver-scheduled-tasks.md) handleiding.
...
De functionaliteit van geautomatiseerde serverberichten hangt af van wat het spel en de beschikbare commando’s ondersteunen. Basis geplande berichten kun je vaak met standaard servercommando’s doen, maar dit is soms beperkt qua opmaak, voorwaarden of geavanceerde aanpassingen.
