...
title: "Avorion: Verbinden met de server"
description: "Ontdek hoe je soepel en veilig verbinding maakt met je Avorion-server voor ononderbroken gameplay → Leer het nu"
...
## Introductie
Weet je niet precies hoe je verbinding maakt met je **Avorion**-server of wat je nodig hebt om te starten? Geen stress, wij fixen het voor je! We nemen je stap voor stap mee – van de benodigde tools en info tot het daadwerkelijke verbindingsproces, inclusief belangrijke tips voor een soepele en probleemloze connectie. Volg onze gids en je bent zo verbonden!
...
Om via de in-game server browser verbinding te maken met je server, open je de server browser in het hoofdmenu. Klik hiervoor op **Multiplayer** en selecteer daarna **Browse Servers**. Je kunt het **zoekveld** gebruiken om je server te vinden in de serverlijst via de servernaam en vervolgens verbinding maken met de **Join** knop.
...
<TabItem value="connect_solution_direct" label="Direct Connect (In-game)" default>

In plaats van zoeken via de serverlijst, kun je ook direct verbinden met het IP-adres en de poort. Klik hiervoor op **Multiplayer** en kies **Join via IP**. Er opent een venster waar je je servergegevens invult in het IP/Port veld. Daarnaast moet je een naam voor de server invullen. Klik daarna op **Add server** om de server toe te voegen en verbinding te maken.
