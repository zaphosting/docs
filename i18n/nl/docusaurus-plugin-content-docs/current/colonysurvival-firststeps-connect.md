...
title: "Colony Survival: Verbinden met de server"
description: "Ontdek hoe je soepel verbinding maakt met je Colony Survival-server en veelvoorkomende problemen oplost voor een vlekkeloze game-ervaring → Leer het nu"
...
Om verbinding te maken met je server, open je het spel en ga je naar **Multiplayer**. Daar kun je zoeken op je servernaam. Selecteer je server en klik op **Join**.
