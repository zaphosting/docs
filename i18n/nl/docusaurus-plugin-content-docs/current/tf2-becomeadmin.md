---
id: tf2-becomeadmin
title: "Team Fortress 2: Word admin"
...
Het toekennen van administratorrechten maakt het eenvoudig en overzichtelijk om je server te beheren met volledige controle. Als admin kun je alle beschikbare opties en functies die het spel biedt direct in-game gebruiken. Hieronder leggen we stap voor stap uit hoe je administratorrechten voor jouw server instelt.
...
Gefeliciteerd! Als je alles hebt gevolgd, heb je nu succesvol de adminrechten voor je server ingesteld. Heb je nog vragen of hulp nodig? Neem gerust contact op met onze support, die dagelijks voor je klaarstaat! 🙂
