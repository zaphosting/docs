...
title: "Astro Colony: Geautomatiseerde Serverberichten - Houd je spelers op de hoogte van nieuws, social links en meer!"
...
Met **Geplande Taken** kun je serverberichten automatisch in de **Astro Colony** in-game chat laten verschijnen door vooraf ingestelde commando’s op een terugkerend schema uit te voeren.
...
Geautomatiseerde berichten maak je door een taak in te plannen die een servercommando uitvoert op een bepaald tijdstip of interval. Dit commando kan een chatbericht, broadcast of servermelding sturen.

Zodra het ingesteld is, draait de taak automatisch op de achtergrond en toont het bericht aan alle verbonden spelers. Zo blijft je communicatie consistent, zonder dat er altijd iemand van het team online hoeft te zijn.
...
De functionaliteit van geautomatiseerde serverberichten hangt af van wat het spel en de beschikbare commando’s kunnen. Basis geplande berichten kun je vaak maken met standaard servercommando’s, maar dit kan beperkt zijn qua opmaak, voorwaarden of geavanceerde aanpassingen.

Als het spel extra plugins, mods of extensies ondersteunt die meer flexibiliteit en opties bieden, is het zeker de moeite waard om die te gebruiken. Die gespecialiseerde messaging systemen bieden vaak meer features dan de standaard gamecommando’s en zijn beter geschikt voor complexe of sterk aangepaste server setups.
