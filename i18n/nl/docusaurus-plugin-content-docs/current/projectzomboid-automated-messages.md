...
title: "Project Zomboid: Geautomatiseerde Serverberichten - Houd je spelers op de hoogte van nieuws, social links en meer!"
...
Met **Geplande Taken** kun je serverberichten automatisch in de **Project Zomboid** in-game chat laten verschijnen door vooraf ingestelde commando’s op een terugkerend schema uit te voeren.
...
Zodra je het hebt ingesteld, draait de taak automatisch op de achtergrond en verschijnt het bericht voor alle verbonden spelers. Zo zorg je voor constante communicatie zonder dat je staff altijd online hoeft te hebben.



## Een geautomatiseerd bericht maken

Open je game server dashboard en ga naar de sectie **Geplande Taken**. Maak een nieuwe taak aan en kies voor het uitvoeren van een **commando**. Vul in het commando-veld het berichtcommando in dat jouw game server ondersteunt.
...
De mogelijkheden van geautomatiseerde serverberichten hangen af van wat het spel en de beschikbare commando’s ondersteunen. Basis geplande berichten kun je vaak met standaard servercommando’s doen, maar dit kan beperkt zijn qua opmaak, voorwaarden of geavanceerde aanpassingen.
