---
id: dods-plugins
title: "Day of Defeat: Source: Plugins installeren op je eigen server"
...
Met Sourcemod en Metamod kun je plugins toevoegen, speciale features activeren en je server helemaal naar jouw smaak inrichten.
...
Je hebt de Linux pakketten **Sourcemod** en **Metamod** nodig. Download ze van de genoemde bronnen. Na het downloaden heb je twee gecomprimeerde bestanden. Pak ze uit op je computer zodat je een addons map krijgt met daarin de mappen `sourcemod` en `metamod`.

![img](https://screensaver01.zap-hosting.com/index.php/s/WbxyRK8FM7GKxqt/preview)

### Installatie

Als je bovenstaande stappen hebt afgerond, kun je verder met de installatie. Upload de bestanden via FTP naar je server met een FTP-client. Ben je niet bekend met FTP en hoe het werkt? Check dan deze handleiding: [Toegang via FTP](gameserver-ftpaccess.md)
...
Zodra Sourcemod en Metamod goed werken, kun je plugins gaan toevoegen. Download de plugins die je wilt installeren op je server van [Sourcemod](https://sourcemod.net/), waar je een grote en groeiende collectie vindt die door de jaren heen is gepubliceerd. Zorg dat je voor elke plugin het bijbehorende .smx bestand hebt.

### Installatie

Heb je de gewenste plugins gedownload? Dan kun je ze installeren door de pluginbestanden via FTP te uploaden naar de map:
...
## Populaire plugins
Ben je nog op zoek naar de perfecte plugins voor je server? Check onze zorgvuldig samengestelde lijst met de populairste en meest aanbevolen plugins om je gameplay te boosten en je server die finishing touch te geven die ‘ie verdient. Laat je inspireren en vind precies de toevoegingen die bij jouw project passen.
<SearchableItemList items={items} />


## Conclusie

Als je alle stappen hebt gevolgd, heb je Sourcemod/Metamod en je gewenste plugins succesvol geïnstalleerd. Heb je nog vragen of hulp nodig? Neem dan vooral contact op met onze support, die dagelijks voor je klaarstaat! 🙂
