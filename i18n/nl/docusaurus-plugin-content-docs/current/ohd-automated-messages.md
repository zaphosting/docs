...
title: "Operation: Harsh Doorstop: Geautomatiseerde Serverberichten - Houd je spelers op de hoogte van nieuws, social links en meer!"
...
Met **Geplande Taken** kunnen serverberichten automatisch in de **Operation: Harsh Doorstop** in-game chat worden gestuurd door vooraf ingestelde commando’s op een terugkerend schema uit te voeren.
...
Het interval kun je op elk moment aanpassen zonder de server te hoeven herstarten, wat super flexibel is naarmate je server groeit.
