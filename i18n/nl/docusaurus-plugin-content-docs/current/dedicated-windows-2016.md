...
title: "Dedicated Server: Installatie van Windows Server 2016"
...
De installatie- en demonstratiestappen in deze gids zijn gebaseerd op Windows Server 2016 (2019-look - zelfde design). Oudere OS-versies kunnen qua structuur en uiterlijk verschillen, maar de procedure is vergelijkbaar.
:::
...
De ondersteuning voor oudere Windows Server versies wordt uiteindelijk stopgezet. Voor versie 2016 gelden de volgende deadlines:

- Actieve ondersteuning: 11-01-2022
- Beveiligingsondersteuning: 12-01-2027
...
Als dit scherm verschijnt in je remote console, betekent dit dat de ISO succesvol is geladen en kunnen we starten met de installatie.
...
Bij Windows Server 2019 zijn er bijvoorbeeld twee edities: de standaard en de datacenter editie.
...
Let ook op dat je een versie met "(Desktop Experience)" kiest, anders krijg je een shell-based Windows.
...
Kies 'Aangepast' als je een schone installatie wilt doen. Kies "Upgrade" als je bijvoorbeeld van 2016 naar 2019 wilt upgraden.

![](https://screensaver01.zap-hosting.com/index.php/s/8zkx8grPTCSgprQ/preview)

In de volgende stap moet je partities aanmaken op je dedicated server. Meestal zijn er nog geen partities aanwezig. Als er wel iets staat, selecteer deze dan en klik op verwijderen.

Je kunt meerdere kleinere partities maken of één grote. Wij raden aan om minimaal 50GB toe te wijzen aan de hoofd Windows-partitie.
Klik op "Nieuw" om een partitie aan te maken.

![](https://screensaver01.zap-hosting.com/index.php/s/GtBxwdETkNeSGcT/preview)

Wil je één grote partitie? Klik dan gewoon op Toepassen. De setup kiest automatisch de maximale grootte.
...
Ben je tevreden met je partities? Kies dan de partitie waarop Windows geïnstalleerd moet worden en klik op "Volgende".
De Windows-installatie doet nu alles automatisch, dit kan enkele minuten duren.
Je hoeft verder niets te doen totdat de setup klaar is.

## Configuratie

Als de installatie klaar is, vraagt Windows je om een wachtwoord in te stellen.
...
Om in te loggen in Windows, druk je op de toetscombinatie `CTRL + ALT + DELETE`. Dit kan je makkelijk doen via je remote console.
...
De gebruikersnaam is altijd Administrator en het wachtwoord is het wachtwoord dat je zojuist hebt ingesteld.
...
De netwerkconfiguratie wordt automatisch via DHCP ingesteld, dus je hoeft verder niets aan te passen.
...
## Conclusie
Gefeliciteerd, je hebt Windows Server 2016 succesvol geïnstalleerd op je dedicated server. Voor verdere vragen of hulp kun je altijd contact opnemen met onze support, die dagelijks voor je klaarstaat! 🙂