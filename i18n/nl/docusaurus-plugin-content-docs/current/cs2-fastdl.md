---
id: cs2-fastdl
title: "Counter-Strike 2: FastDL instellen"
description: "Ontdek hoe je gamecontent levert met FastDL om downloads te versnellen en de serverbelasting voor Counter-Strike 2 spelers te verminderen → Leer het nu"
...
Je hebt een actieve Counter-Strike 2 server nodig die gehost wordt door ZAP-Hosting, plus een extra webspace pakket. FTP-toegang of toegang tot de File Manager moet beschikbaar zijn voor zowel de game server als de webspace.
...
Maak in de root directory van je webspace een map aan met de naam `fastdl`. Maak daarin submappen zoals `maps`, `sound` of `models` aan, afhankelijk van welke content je wilt aanbieden. De mappenstructuur moet exact overeenkomen met die van je Counter-Strike 2 server.
...
Als je bestanden geüpload en permissies goed staan, is je FastDL-content bereikbaar via deze publieke URL:
...
FastDL instellen gaat snel en betrouwbaar met je eigen ZAP webspace. Zo lever je custom content razendsnel en efficiënt, wat de ervaring verbetert voor alle spelers op jouw Counter-Strike 2 server.
