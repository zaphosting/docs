...
<Tabs>
    <TabItem value="connect_solution_server_direct" label="Direct verbinden (In-game)" default>

Om verbinding te maken met je server, open je de game. Klik in het spel op **Join a game**. Klik onderaan op **Connect to IP** en voer het IP-adres en de poort van de server in het venster in.
