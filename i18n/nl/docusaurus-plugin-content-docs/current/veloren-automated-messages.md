...
title: "Veloren: Geautomatiseerde Serverberichten - Houd je spelers op de hoogte van nieuws, social links en meer!"
...
Met **Geplande Taken** kunnen serverberichten automatisch in de **Veloren** in-game chat worden gestuurd door vooraf ingestelde commando’s op een terugkerend schema uit te voeren.
...
Zodra het is ingesteld, draait de taak automatisch op de achtergrond en toont het bericht aan alle verbonden spelers. Zo blijft de communicatie consistent, zonder dat er altijd iemand van het team online hoeft te zijn.
