...
Om via de in-game serverbrowser verbinding te maken met je server, open je de game. Klik in het spel op **Multiplayer** om de serverlijst te openen. Rechtsboven in de serverlijst kun je nu zoeken op de naam van je server, selecteer je server en maak verbinding.

![img](https://screensaver01.zap-hosting.com/index.php/s/NfpZo6FgFtxDP7x/download)

</TabItem>

<TabItem value="connect_solution_direct_ingame" label="Direct verbinden (In-game)">

In plaats van zoeken op naam, kun je ook direct verbinden via de `V`-knop. Open de directe verbinding en voer het IP-adres en de poort van je server in. Bevestig met `Enter` om verbinding te maken.
