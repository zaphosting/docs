...
title: "HumanitZ: Veelvoorkomende problemen"
description: "Ontdek hoe je veelvoorkomende problemen met je HumanitZ game server oplost voor een soepele en toffe game-ervaring → Leer het nu"
...
Je server is soms niet zichtbaar als de initialisatie niet goed is afgerond. Dit kan bijvoorbeeld komen door een foutieve configuratie of corrupte bestanden. Meer info vind je vaak terug in de serverconsole of logbestanden. Check ook altijd of er geen verkeerde filterinstellingen in de serverlijst staan, want die kunnen ervoor zorgen dat je server niet getoond wordt.
...
Dit kan resulteren in hoge CPU-belasting, geheugenlekken, lag of zelfs crashes, vooral als meerdere niet-geoptimaliseerde componenten samenkomen. Zorg altijd dat extensies actief onderhouden worden, goed gedocumenteerd zijn en getest op performance. Check bij twijfel de communityfeedback of monitor je serverperformance om problematische onderdelen te vinden.
...
Regelmatige backups besparen je veel stress en zorgen. Maak regelmatig backups zodat je bij problemen altijd een oudere werkende versie hebt. We bieden een [backup-oplossing](gameserver-backups.md) voor onze HumanitZ game servers, waarmee je handmatige of automatische geplande backups kunt maken.
