...
description: "Leer hoe je snel en makkelijk een Left 4 Dead 2 dedicated server op je VPS of dedicated server installeert → Lees nu meer"
...
Om andere spelers op je server te laten joinen, moet je een Game Server Login Token (GSLT) genereren en toevoegen. Dit token authenticiseert je server bij Steam. Ga naar http://steamcommunity.com/dev/managegameservers en maak een token aan met de game ID 222840, dat is voor Left 4 Dead 2.
