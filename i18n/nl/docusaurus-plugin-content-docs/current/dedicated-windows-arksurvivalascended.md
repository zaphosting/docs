...
description: "Ontdek hoe je snel en makkelijk een ARK: Survival Ascended Dedicated Server installeert op je Windows VPS of dedicated server → Leer het nu"
...
:::info
Je moet [Microsoft Visual C++ 2015 Redistributable](https://learn.microsoft.com/en-us/cpp/windows/latest-supported-vc-redist?view=msvc-170#visual-studio-2015-2017-2019-and-2022) installeren op je Windows VPS voordat je de server start als je dit nog niet hebt, want het is een vereiste. Zonder deze installatie kan je server mogelijk niet starten.
:::
