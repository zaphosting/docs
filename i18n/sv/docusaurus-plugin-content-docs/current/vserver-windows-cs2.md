...
title: "VPS: Counter-Strike 2 Dedikerad Server Windows Setup"
...
Nu är setupen för din Counter-Strike 2-server klar. Du kan göra ytterligare serverinställningar genom att redigera launch-filen direkt. Gå till din root-mapp. Inuti den, navigera till cfg-mappen och öppna filen `server.cfg`. Där kan du ändra serverinställningar.
