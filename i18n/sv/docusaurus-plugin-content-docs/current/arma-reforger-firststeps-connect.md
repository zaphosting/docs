...
title: "Arma Reforger: Anslut till servern"
description: "Upptäck hur du smidigt ansluter till din Arma Reforger-server och är redo att spela utan krångel → Lär dig mer nu"
...
Istället för att söka efter servern via namn kan du också använda direktanslutningen via `V`-knappen. Öppna direktanslutningen och skriv in IP-adressen och porten till din server. Bekräfta med `Enter` för att ansluta.
