...
title: "Left 4 Dead 2: Automatiska Servermeddelanden - Håll dina spelare uppdaterade om nyheter, sociala länkar och mer!"
...
Med **Schemalagda Uppgifter** kan servermeddelanden skickas automatiskt till **Left 4 Dead 2**-chatten genom att köra fördefinierade kommandon på ett återkommande schema.
