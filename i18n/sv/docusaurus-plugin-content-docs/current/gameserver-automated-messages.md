...
title: "[Game]: Automatiska Servermeddelanden - Håll dina spelare uppdaterade om nyheter, sociala länkar och mer!"
...
Med hjälp av **Schemalagda Uppgifter** kan servermeddelanden skickas automatiskt till **[Game]**-chatten genom att köra fördefinierade kommandon på ett återkommande schema.
...
För att skapa automatiska servermeddelanden, öppna din spelserverdashboard och gå till sektionen **Schemalagda Uppgifter**. Skapa en ny schemalagd uppgift och välj alternativet att köra ett **kommando**. I kommandofältet skriver du in meddelandekommandot som din spelserver stödjer.
