...
För detta spel erbjuder vi möjligheten att enkelt installera välkända och populära resurser/plugins med bara ett klick under **Plugins**. I översikten hittar du ett urval av tillgängligt innehåll som du kan lägga till genom att klicka på installationsknappen. Efter omstart av servern installeras, aktiveras och blir dessa plugins tillgängliga för dig.
