...
title: "Day of Defeat Source: Översikt Dashboard"
description: "Upptäck hur du effektivt hanterar din Day of Defeat: Source-server och optimerar dess inställningar för bästa prestanda → Lär dig mer nu"
...
För detta spel erbjuder vi möjligheten att enkelt installera välkända och populära resurser/plugins med bara ett klick under **Plugins**. I översikten hittar du ett urval av tillgängligt innehåll som du kan lägga till genom att klicka på installationsknappen. Efter en omstart av servern installeras, aktiveras och blir dessa plugins tillgängliga för dig.
...
I inställningarna kan du ange om backuper ska skapas automatiskt och om detta ska ske dagligen eller veckovis. Dessutom kan du bestämma om de äldsta backuperna ska tas bort vid behov, till exempel när lagringsutrymmet börjar bli fullt.
