...
title: "No More Room in Hell: Anslut till servern"
description: "Upptäck hur du smidigt ansluter till din No More Room in Hell-server och njuter av en problemfri spelupplevelse → Lär dig mer nu"
...
Du behöver all relevant information för att kunna ansluta till din server. Information om din server hittar du på kontrollpanelen i webbgränssnittet för din gameserver. Viktig info inkluderar följande:
...
I No More Room in Hell är konsolen avstängd som standard. För att aktivera den, **gå till Alternativ → Tangentbord och välj Avancerat**. För att ansluta till din server via konsolen, öppna konsolen med `~`-tangenten. När konsolen är öppen, kör följande kommando:
