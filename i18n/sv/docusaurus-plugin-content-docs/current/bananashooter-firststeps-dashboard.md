...
title: "Banana Shooter: Översikt över kontrollpanelen"
description: "Upptäck hur du effektivt hanterar din Banana Shooter-server och optimerar dess funktioner efter dina behov → Lär dig mer nu"
...
Om du känner dig mer säker och vill göra mer precisa ändringar rekommenderar vi att du använder Config Editor istället. Mer info om detta finns i kategorin **Configs**.
...
Med **FTP Browser** får du all nödvändig info för att ansluta till FTP-accessen. FTP-accessen ger dig direkt tillgång till filerna på din spelserver. Vi rekommenderar att du använder ett externt FTP-program som **FileZilla** eller **WinSCP** för bästa användarupplevelse. Om du är osäker på hur FTP fungerar, kolla gärna in vår guide [FTP Access](gameserver-ftpaccess.md) som kan hjälpa dig.

![img](https://screensaver01.zap-hosting.com/index.php/s/sX85i9HyzR9wmAM/preview)

**FileZilla:** FileZilla är troligen den enklaste och mest kända FTP-klienten. Installera, starta och fyll i dina inloggningsuppgifter i den övre raden som du hittar lite längre upp på sidan. Med ett snabbt klick på "Anslut" är du direkt inloggad på servern och kan hantera filerna.
...
### Nyheter
**Nyheter** ger dig en komplett översikt över alla meddelanden och nyheter som rör din tjänst. Här hittar du viktig info om olika saker som:
