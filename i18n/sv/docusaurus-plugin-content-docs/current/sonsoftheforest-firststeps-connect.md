...
<Tabs>
    <TabItem value="connect_solution_server_browser_ingame" label="Server Browser Direktanslutning (I spelet)" default>

För att ansluta till din server, öppna spelet. När du är inne i spelet, klicka på **Multiplayer** och välj **Join**. Klicka på **Direct** i serverlistan och skriv in IP-adressen och porten till din server i fältet. Bekräfta inmatningen för att etablera anslutningen.
