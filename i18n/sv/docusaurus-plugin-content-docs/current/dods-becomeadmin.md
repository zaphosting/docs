---
id: dods-becomeadmin
title: "Day of Defeat: Source: Bli admin"
description: "Upptäck hur du ger adminrättigheter för full kontroll över din server och effektiv hantering av spelets funktioner → Läs mer nu"
...
|------------|:------:|-------------|
| reservation | a      | Platser reserverade |
...
Flera flaggor kan kombineras (t.ex. `bc` för kick-rättigheter). För full tillgång använder du bara `z`. Du öppnar adminmenyn genom att skriva `admin` i chatten eller `sm_admin` i konsolen. Med kommandot `admin` i chatten eller `sm_admin` i konsolen kan menyn öppnas.
