...
title: "Myth of Empires: Översikt Dashboard"
description: "Upptäck hur du effektivt hanterar din Myth of Empires-server och optimerar dess inställningar för bästa spelupplevelse → Lär dig mer nu"
...
Var din server offline en stund och du kan inte förklara varför? En titt i händelseloggen och loggfilerna gav inga svar? Det kan vara så att problemet inte ligger direkt hos din server, utan hos värdsystemet där din server körs.
...
I detta avsnitt hittar du en översikt över driftstörningar för värdsystemet där din spelserver körs. Mer info och senaste status för våra tjänster hittar du på vår nya [statussida](https://status.zap-hosting.com/).
