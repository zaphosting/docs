...
title: "Cryofall: Anslut till servern"
description: "Upptäck hur du smidigt ansluter till din Cryofall-server och felsöker vanliga problem för en sömlös spelupplevelse → Läs mer nu"
...
Du behöver all relevant info för att kunna ansluta till din server. Informationen om din server hittar du på dashboarden i ditt spelservers webbpanel. Viktig info inkluderar bland annat:
...
För att ansluta till din server via den inbyggda serverbläddraren i spelet, öppna spelet. När du är inne, klicka på **Play** och sedan **Multiplayer** för att öppna serverlistan. Välj fliken Community och sök efter din server med servernamnet. 
