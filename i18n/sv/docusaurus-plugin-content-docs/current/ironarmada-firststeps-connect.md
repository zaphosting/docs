...
title: "Iron Armada: Anslut till servern"
description: "Upptäck hur du smidigt ansluter till din Iron Armada-server och felsöker vanliga problem för en sömlös spelupplevelse → Lär dig mer nu"
...
För att ansluta till din server via den inbyggda serverbläddraren, öppna serverbläddraren genom att klicka på **Multiplayer** i huvudmenyn. Du kan ansluta i serverlistan antingen via servernamnet eller via **direktanslutning** med IP-adressen och porten till din server. 
...
Att servern inte syns kan bero på att initieringen inte slutfördes korrekt. Det kan till exempel bero på en felaktig konfiguration eller korrupta filer. Mer info hittar du oftast i serverkonsolen eller loggfilerna.
