...
:::info
Hjälper inte informationen där eller förstår du den inte? Ingen fara! I så fall finns vi tillgängliga dagligen i supporten. Skapa bara en **[Ticket](https://zap-hosting.com/en/customer/support/)** och förklara ditt problem för oss. Vi kollar på det så snabbt som möjligt och hjälper dig att lösa problemet! :)
:::
...
I detta avsnitt hittar du en översikt över driftstörningshistoriken för värdsystemet där din spelserver körs. Mer information och den senaste versionen av vår tjänstestatus hittar du på vår nya [statussida](https://status.zap-hosting.com/).
...
Utöver våra spelserverprodukter erbjuder vi även 10 inkluderade databaser. Dessa databaser behövs till exempel när data ska sparas i en databas. Under **Databaser** kan du skapa en databas och se inloggningsuppgifterna. Du har även möjlighet att aktivera backup-alternativet och importera befintliga databasbackuper.
