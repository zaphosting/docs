...
title: "Portal Knights: Översikt över kontrollpanelen"
description: "Upptäck hur du effektivt hanterar din Portal Knights-server med en tydlig översikt över funktioner och alternativ → Lär dig mer nu"
...
Med **FTP Browser** får du all nödvändig information för att upprätta en anslutning till FTP-accessen. FTP-accessen ger dig direkt åtkomst till filerna på din spelserver. Vi rekommenderar att använda ett externt FTP-program som **Filezilla** eller **WinSCP** för bästa användarupplevelse. Om du inte är bekant med FTP rekommenderar vi att du kollar in vår guide [FTP Access](gameserver-ftpaccess.md) som kan hjälpa dig.
