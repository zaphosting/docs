...
title: "No More Room In Hell: Bli admin"
...
För att registrera dig som admin krävs installation av SourceMod eller MetaMod. Dessutom behöver du Steam ID för ditt Steam-konto. Det finns flera sätt att få tag på det: du kan antingen använda en extern webbplats som tillhandahåller denna tjänst eller hämta det direkt via spelets konsol.
...
Detta visar dina anslutningsuppgifter, inklusive ditt SteamID. Anslut sedan till servern via FTP och öppna filen `admins.cfg` som finns i:
...
Här nedan hittar du en lista på vanliga adminkommandon som du kan använda som admin på din server.
...
Grattis! Om du följt allt korrekt borde du nu ha konfigurerat adminrättigheterna för din server. Har du fler frågor eller behöver hjälp, tveka inte att kontakta vår support som finns tillgänglig varje dag för att hjälpa dig! 🙂
