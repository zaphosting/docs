...
title: "Sunkenland: Automatiska Servermeddelanden - Håll dina spelare uppdaterade om nyheter, sociala länkar och mer!"
...
Med **Schemalagda Uppgifter** kan servermeddelanden skickas automatiskt i **Sunkenland**-chatten genom att köra fördefinierade kommandon på återkommande tider.
...
För att skapa automatiska servermeddelanden, öppna din game server dashboard och gå till sektionen **Schemalagda Uppgifter**. Skapa en ny schemalagd uppgift och välj att köra ett **kommando**. I kommandofältet skriver du in meddelandekommandot som din game server stödjer.
...
När det väl är uppsatt körs meddelandena självständigt och kan enkelt återanvändas genom att bara justera det spel-specifika meddelandekommandot och texten.
