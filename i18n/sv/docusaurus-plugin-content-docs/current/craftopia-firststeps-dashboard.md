...
title: "Craftopia: Översikt över kontrollpanelen"
description: "Upptäck hur du effektivt hanterar och optimerar din Craftopia-server med en tydlig översikt över viktiga funktioner och kontroller → Lär dig mer nu"
...
Med **FTP Browser** får du all nödvändig info för att ansluta till FTP-accessen. FTP-accessen ger dig direkt tillgång till filerna på din spelserver. Vi rekommenderar att använda ett externt FTP-program som **FileZilla** eller **WinSCP** för bästa användarupplevelse. Om du är ovan vid FTP kan du kika på vår guide [FTP Access](gameserver-ftpaccess.md) som kan hjälpa dig.
