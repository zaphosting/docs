...
För att ansluta till din server via den inbyggda serverbläddraren, öppna serverbläddraren i huvudmenyn. När du är i serverlistan klickar du på **Custom Browser**. Använd **Sökfältet** för att söka efter din server med serverns namn. Välj den och klicka på **Join Server**.
