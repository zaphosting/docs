...
title: "Miscreated: Anslut till servern"
description: "Upptäck hur du smidigt ansluter till din Miscreated-server och felsöker vanliga problem för en sömlös spelupplevelse → Lär dig mer nu"
...
Du behöver all relevant information för att kunna ansluta till din server. Informationen om din server hittar du på kontrollpanelen i webgränssnittet för din gameserver. Viktig info inkluderar följande:
...
För att ansluta till din server via den inbyggda serverbläddraren i spelet, öppna serverbläddraren i huvudmenyn. Klicka på **Join Server**. När du är där, sök efter din server med ditt servernamn och klicka sedan på **Join Server**.
