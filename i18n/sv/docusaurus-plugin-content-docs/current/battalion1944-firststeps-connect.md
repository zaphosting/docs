...
title: "Battalion 1944: Anslut till servern"
description: "Upptäck hur du smidigt ansluter till din Battalion 1944-server och njuter av oavbrutet spelande → Lär dig mer nu"
...
Sök eller lägg till din server via Steam-bläddraren genom att använda `IP-adress` och `Port` för din gameserver. För att göra detta, välj fliken `Favoriter` i serverlistan och klicka på plustecknet längst ner. Ett popup-fönster öppnas där du anger din serverinfo. 
