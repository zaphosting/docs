...
title: "Citadel Forged With Fire: Anslut till servern"
description: "Upptäck hur du smidigt ansluter till din Citadel Forged With Fire-server och felsöker vanliga problem för en sömlös spelupplevelse → Läs mer nu"
...
För att ansluta till din server, öppna spelet och gå till **Join Game**. När du är där, sök efter din server med servernamnet i serverlistan. Klicka på **Join** för att etablera anslutningen.
