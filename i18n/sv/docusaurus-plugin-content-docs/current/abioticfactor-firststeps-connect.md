...
title: "Abiotic Factor: Anslut till servern"
description: "Upptäck hur du smidigt ansluter till din Abiotic Factor-server och njuter av oavbrutet spelande → Lär dig mer nu"
...
För att ansluta till din server, starta spelet och gå till **Enter the Facility** från huvudmenyn. Klicka sedan på **Join a Server** för att öppna serverlistan. Använd sökfältet för att skriva in ditt servers namn, och när den dyker upp klickar du på **Join** för att ansluta.

![img](https://screensaver01.zap-hosting.com/index.php/s/AScDLr65YwcAwBn/download)

</TabItem>

<TabItem value="connect_solution_server_direct" label="Direktanslutning (I spelet)">

För att ansluta till din server, starta spelet och gå till **Enter the Facility** från huvudmenyn. Klicka sedan på **Join a Server** för att öppna serverlistan. Välj **Direct Connect**, skriv in din servers IP-adress och port, och klicka på **Join** för att ansluta.
