...
:::warning
Hjälper informationen inte eller förstår du den inte? Ingen fara! Vi finns dagligen tillgängliga i supporten. Skapa bara ett **[Ticket](https://zap-hosting.com/en/customer/support/)** och förklara ditt problem för oss. Vi tittar på det så snabbt som möjligt och hjälper dig att lösa problemet! :)
:::
...
Om vårt övervakningssystem upptäcker ett generellt avbrott, meddelas våra tekniker automatiskt som tar hand om problemet så snart som möjligt.
...
Utöver våra spelserverprodukter erbjuder vi även 10 inkluderade databaser. Dessa databaser behövs till exempel när data ska sparas i en databas. Under **Databaser** kan du skapa en databas och se inloggningsuppgifterna. Du har även möjlighet att aktivera backup-alternativet och importera befintliga databas-backuper.
