...
description: "Upptäck hur du smidigt ansluter till din Minecraft-server och vilka verktyg du behöver för en sömlös spelupplevelse → Lär dig mer nu"
...
| Minecraft: Forge                        | ✓                            |
| Minecraft: Fabric                       | ✓                            |
| Minecraft med Mods/Modpacks generellt  | ✓                            |




#### Mods
Vill du använda mods behöver du också rätt mod loader. Beroende på om du vill använda mods från Forge eller Fabric behöver du en av dessa.
...
:::danger Blanda inte Fabric/Forge mods
Fabric och Forge är inte kompatibla med varandra. Forge-mods måste köras på Forge, och Fabric-mods måste köras på Fabric. Att blanda kan leda till krascher både på klient och server.
:::
...
Du behöver all relevant information för att ansluta till din server. Information om din server hittar du i kontrollpanelen för din spelservers webbgränssnitt. Viktig information inkluderar följande:

- IP-adress och port

Med informationen ovan ska du kunna hitta din server och säkerställa att du ansluter till rätt server.
...
Starta spelet via Minecraft- eller Modpack-launchern och gå till menyn **Multiplayer**. Klicka sedan på **Add Server**. Där kan du ange ett namn som platsförvaring och IP-adress/port.
...
#### Anslutning misslyckades, Anslutning timeout.
Detta felmeddelande betyder att en anslutning till servern inte kunde upprättas inom den angivna tidsramen. Orsakerna kan vara flera. Mer information finns oftast i loggar eller livekonsol.

#### Mismatch i mod-kanal-lista
Detta felmeddelande uppstår när det finns skillnader i mods mellan klient och server. Det kan till exempel hända om vissa mods saknas eller är installerade för en annan version. I så fall bör mods helst installeras om och kontrolleras både på klient och server.



#### Saknas lösning eller inget hjälpsamt svar
...
Grattis! Om du följt allt korrekt borde du nu ha lyckats ansluta till servern. Har du fler frågor eller behöver hjälp, tveka inte att kontakta vårt supportteam som finns tillgängligt varje dag för att hjälpa dig! 🙂
