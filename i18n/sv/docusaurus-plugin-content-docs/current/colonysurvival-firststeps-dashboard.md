...
title: "Colony Survival: Översikt över kontrollpanelen"
description: "Upptäck hur du effektivt hanterar och optimerar din Colony Survival-server med en tydlig översikt över alla viktiga funktioner och alternativ → Lär dig mer nu"
...
Vill du schemalägga serveromstarter vid specifika tider? Omstartsplaneraren låter dig ställa in schemalagda automatiska omstarter av din spelserver. Med denna funktion kan du planera omstarter vid specifika tider eller med jämna mellanrum.
...
Med **FTP Browser** får du all nödvändig information för att upprätta en anslutning till FTP-accessen. FTP-accessen ger dig direkt tillgång till filerna på din spelserver. Vi rekommenderar att använda ett externt FTP-program som **FileZilla** eller **WinSCP** för bästa användarupplevelse. Om du inte är bekant med hur man använder FTP rekommenderar vi att du kollar in vår guide [FTP Access](gameserver-ftpaccess.md) som kan hjälpa dig.
...
I inställningarna kan du ange om säkerhetskopior ska skapas automatiskt och om detta ska ske dagligen eller veckovis. Dessutom kan du bestämma om de äldsta säkerhetskopiorna ska tas bort vid behov, till exempel när lagringsutrymmet börjar bli begränsat.
