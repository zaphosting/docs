...
title: "Operation: Harsh Doorstop: Automatiska Servermeddelanden – Håll dina spelare uppdaterade om nyheter, sociala länkar och mer!"
...
Med hjälp av **Schemalagda Uppgifter** kan servermeddelanden skickas automatiskt till **Operation: Harsh Doorstop**-chatten genom att köra fördefinierade kommandon på ett återkommande schema.
...
När det väl är uppsatt körs meddelandena automatiskt och kan enkelt återanvändas genom att bara justera spelets meddelandekommando och text.
