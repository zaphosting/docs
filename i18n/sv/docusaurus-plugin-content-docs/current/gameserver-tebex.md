...
description: "Upptäck hur du kan tjäna pengar på din gameserver med Tebex och öka intäkterna från försäljning av in-game-prylar och ranks → Läs mer nu"
...
Tebex är en plattform som låter dig tjäna pengar på din gameserver och göra riktiga cash 
på in-game items, ranks och mycket mer. Plattformen ger dig en proffsig webbutik där du kan sälja grejer och följa hur din butik går. Kolla in [tebex.io](https://affiliate.tebex.io/r/690a6731-fee1-4054-84e1-30c26729403a) för
...
Följande spel som vi också erbjuder som en del av vårt gameserver-paket stöds av Tebex. För mer info och andra spel som finns, rekommenderar vi att du kikar på den officiella [webbplatsen](https://www.tebex.io/game-servers). 
...
Att sätta upp Tebex med ZAP är superenkelt. Installationen och konfigurationen kräver bara några få steg, som vi förklarar mer i detalj här nedan. 
...
Tebex skickar nu en inbjudan till den e-postadress som är kopplad till ditt ZAP-Hosting-kundkonto. Följ instruktionerna i mailet för att aktivera ditt Tebex-konto. Du kommer att guidas genom den grundläggande konfigurationen av din butik.

### Installera Tebex-plugin

Den här processen är oftast automatiserad. Om vi inte har en plugin för automatisk setup på våra servrar eller om vi saknar pingback från Tebex måste du göra en manuell setup.

### Konfigurera Tebex-plugin

Installera rätt gameserver-plugin för ditt spel manuellt. Setup-processen skiljer sig från spel till spel. Grundläggande instruktioner för hur du installerar plugins hittar du [här](https://docs.tebex.io/store/integrating-with-your-game-server-or-website/minecraft-java-edition).
...
Du har nu kopplat Tebex till din gameserver-tjänst. Har du fler frågor eller behöver hjälp, tveka inte att kontakta vår support som finns tillgänglig varje dag för att hjälpa dig! 🙂
