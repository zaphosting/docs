...
title: "Myth of Empires: Vanliga problem"
description: "Upptäck hur du felsöker och löser vanliga Myth of Empires-serverproblem för en smidig spelupplevelse → Läs mer nu"
...
För att din spelserver ska fungera smidigt och pålitligt är det viktigt att välja en konfiguration som matchar behoven för ditt projekt. Kraven kan variera mycket beroende på spelet, användningen av tillägg som mods, plugins eller resurser och det förväntade antalet spelare.
...
Regelbundna backuper sparar dig mycket stress och oro. Skapa regelbundna backuper så att du vid problem alltid har en äldre version sparad när allt fungerade. Vi erbjuder en [backup-lösning](gameserver-backups.md) för våra Myth of Empires-spelservrar, där du kan skapa manuella eller schemalagda automatiska backuper.
