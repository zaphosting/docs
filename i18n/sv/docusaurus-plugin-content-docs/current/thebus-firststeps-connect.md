...
title: "The Bus: Anslut till servern"
description: "Upptäck hur du smidigt ansluter till din The Bus-server och felsöker vanliga problem för en sömlös spelupplevelse → Lär dig mer nu"
...
Du behöver all relevant information för att ansluta till din server. Informationen om din server hittar du på kontrollpanelen i ditt spelservers webbgränssnitt. Viktig info inkluderar:
...
För att ansluta till din server, öppna **Multiplayer**-menyn i spelet. Tryck sedan på `Alt`-tangenten för att lägga till en ny server i din lista. Skriv in serverns IP-adress och port, och anslut.
