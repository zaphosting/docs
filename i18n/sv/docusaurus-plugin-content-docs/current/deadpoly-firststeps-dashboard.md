...
title: "DeadPoly: Översikt Dashboard"
description: "Upptäck hur du effektivt hanterar och optimerar din DeadPoly-server med en tydlig översikt över viktiga funktioner och kontroller → Lär dig mer nu"
...
Din server var tillfälligt offline och du kan inte förklara varför? En titt i händelseloggen och loggfilerna gav inte heller någon info? Det kan vara så att problemet inte ligger direkt hos din server, utan hos värdsystemet där din server körs.
...
**WinSCP:**  WinSCP är egentligen tänkt för SCP och SFTP (de krypterade varianterna av FTP), men kan lika bra hantera vanlig FTP. Programmet är lite mer avancerat än FileZilla och passar bättre för erfarna användare.
