...
title: "Sons of the Forest: Automatiska Servermeddelanden – Håll dina spelare uppdaterade om nyheter, sociala länkar och mer!"
...
Med hjälp av **Schemalagda Uppgifter** kan servermeddelanden skickas automatiskt till **Sons of the Forest** in-game chat genom att köra fördefinierade kommandon på ett återkommande schema.
