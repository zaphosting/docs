...
title: "Starmade: Vanliga problem"
description: "Lär dig hur du felsöker vanliga Starmade-serverproblem och håller spelet flytande för din community → Läs mer nu"
...
Inget sabbar en grym spelstund snabbare än en oväntad krasch. Krasch kan orsakas av fel i serversoftwaren, trasiga eller inkompatibla tillägg (som plugins, mods, resurser eller frameworks), systemöverbelastning eller felkonfigurationer.
...
Krascher orsakas ofta av felaktiga eller gamla tillägg. Oavsett om det är ett framework, plugin, mod eller resurs kan problem uppstå om tillägget inte är kompatibelt med senaste spelversionen eller innehåller buggar.
...
De kan också uppstå när servern är överbelastad av många spelare eller resurskrävande skript och plugins. Nätverksrelaterade problem som dålig routing, extern överbelastning eller att servern ligger långt från spelarna kan öka latensen ännu mer.
...
Spelservrar kan ibland bli mål för illasinnad nätverksaktivitet, främst DDoS-attacker (Distributed Denial of Service). Såna attacker överöser servern med trafik, vilket ger lagg, tappade anslutningar eller total driftstopp. I andra fall försöker angripare utnyttja nätverkssårbarheter eller störa serverns stabilitet med upprepade anslutningsförsök eller ovanliga datapaket.
...
Regelbundna backups sparar dig mycket stress och oro. Skapa regelbundna backups så att du alltid har en äldre version sparad om något skulle gå fel. Vi erbjuder en [backup-lösning](gameserver-backups.md) för våra Starmade-spelservrar, där du kan göra manuella eller schemalagda automatiska backups.
