...
title: "VEIN: Översikt Dashboard"
description: "Upptäck hur du effektivt hanterar din Vein-server med en tydlig översikt över funktioner och alternativ → Lär dig mer nu"
...
**Livekonsolen** ger dig en realtidsvy över alla aktuella händelser på din server. Här kan du se information om spelarnas aktiviteter samt eventuella fel- och systemmeddelanden. Denna översikt ger dig en helhetsbild av vad som händer på din server och hjälper dig att upptäcka problem i ett tidigt skede.
...
I detta avsnitt hittar du en översikt över driftstörningshistoriken för värdsystemet där din spelserver körs. Mer info och senaste status hittar du på vår nya [statussida](https://status.zap-hosting.com/).
...
:::warning
Har du märkt att vissa ändringar delvis skrivs över? Var medveten om att vissa värden hämtas från inställningssidan. Vill du ändra dessa direkt i config-filen måste du först avaktivera motsvarande alternativ på inställningssidan.
:::
...
Vill du schemalägga serveromstarter vid specifika tider? Restartplaneraren låter dig ställa in automatiska omstarter av din spelserver vid bestämda tidpunkter eller med jämna mellanrum.

![](https://screensaver01.zap-hosting.com/index.php/s/Y6WciDS7YP98P4m/preview)

### DNS-inställningar

Med ZAP DNS-inställningar kan du skapa lättare adresser för din tjänst. Du kan använda en subdomän från någon av våra domäner eller skapa en DNS-post på dina egna domäner för en adress som är bättre kopplad till dig personligen.
...
Utöver våra spelserverprodukter erbjuder vi även 10 inkluderade databaser. Dessa behövs till exempel när data ska sparas i en databas. Under **Databaser** kan du skapa en databas och se inloggningsuppgifter. Du kan också aktivera backup-alternativet och importera befintliga databasbackuper.
