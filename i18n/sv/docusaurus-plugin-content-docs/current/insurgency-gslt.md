---
id: insurgency-gslt
title: "Insurgency: Skapa en GSLT (Steam Game Server Login Token)"
description: "Lär dig hur du säkrar och autentiserar din dedikerade spelserver med en Steam Game Server Login Token för bättre synlighet och skydd → Läs mer nu"
...
När du är inloggad kan du skapa en ny token via formuläret på sidan. I fältet **App ID** anger du App ID `17700` som tillhör **Insurgency**. Se till att ange rätt ID, eftersom token inte fungerar med fel värde.
...
:::info Flera Insurgency-servrar
Om du kör flera **Insurgency**-servrar behöver du en GSLT för varje server. Det är <u>**inte**</u> möjligt att driva flera servrar med en och samma GSLT.
:::
