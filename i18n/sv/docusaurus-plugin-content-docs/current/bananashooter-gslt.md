...
title: "Banana Shooter: Skapa en GSLT (Steam Game Server Login Token)"
description: "Upptäck hur du autentiserar din spelserver med en Steam Game Server Login Token för korrekt listning och VAC-skydd → Lär dig mer nu"
...
När du är inloggad kan du skapa en ny token via formuläret på sidan. I fältet **App ID** anger du App ID `1949740` som tillhör **Banana Shooter**. Se till att ange rätt ID, eftersom token inte fungerar med fel värde.
...
Inloggningstoken måste nu läggas till i din serverkonfiguration. Öppna din spelservers administrationsgränssnitt och gå till sektionen **Settings**. Klistra in token i fältet märkt **GSL Token** och spara.

![img](https://screensaver01.zap-hosting.com/index.php/s/tzJiT4nTZo2nWMz/preview)

:::info Flera Banana Shooter-servrar
När du kör flera **Banana Shooter**-servrar behöver du en GSLT för varje server. Det är <u>**inte**</u> möjligt att köra flera servrar med en och samma GSLT.
:::
