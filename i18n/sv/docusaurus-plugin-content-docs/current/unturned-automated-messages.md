...
title: "Unturned: Automatiska Servermeddelanden – Håll dina spelare uppdaterade om nyheter, sociala länkar och mer!"
...
Automatiska servermeddelanden är ett enkelt men effektivt sätt att kommunicera viktig info direkt i spelet till spelarna. De kan användas för att visa serverregler, annonsera event, dela tips eller påminnelser med jämna mellanrum utan att admins behöver göra något manuellt.

Med **Schemalagda Uppgifter** kan servermeddelanden skickas automatiskt i **Unturned**-chatten genom att köra fördefinierade kommandon på ett återkommande schema.
