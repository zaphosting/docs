...
title: "ASTRONEER: Vanliga problem"
description: "Upptäck hur du felsöker och löser vanliga ASTRONEER-serverproblem för en smidig spelupplevelse → Lär dig mer nu"
...
Att servern inte syns kan hända om uppstarten inte slutfördes korrekt. Det kan till exempel bero på en felaktig konfiguration eller korrupta filer. Mer info hittar du oftast i serverkonsolen eller loggfilerna. Utöver det, kolla så att inga felaktiga filterinställningar används i serverlistan som gör att servern inte visas.
...
Det kan leda till oväntade krascher, frysningar eller fel, särskilt när flera problematiska tillägg samspelar. Om du misstänker att ett tillägg är boven, testa att stänga av det temporärt och se om servern håller sig stabil utan det. Det är ett enkelt sätt att lista ut vilket tillägg som ställer till det.
...
Regelbundna backuper sparar dig mycket stress och oro. Skapa regelbundna backuper så att du alltid har en äldre version sparad om något skulle gå snett. Vi erbjuder en [backup-lösning](gameserver-backups.md) för våra ASTRONEER-spelservrar, där du kan göra manuella eller schemalagda automatiska backuper.
