...
title: "OpenTTD: Översikt över kontrollpanelen"
description: "Upptäck hur du effektivt hanterar din OpenTTD-server och optimerar dess inställningar för bästa prestanda → Lär dig mer nu"
...
Under **Spel** kan du alltid byta spelvariant för ditt befintliga spel eller installera ett annat spel. Spel med samma slotpris kan väljas direkt under **Tillgängliga spel**. För alla andra spel krävs först en justering av slotpriset. Mer info om detta finns i guiden [Spelbyte](gameserver-gameswitch.md).
...
Med **FTP Browser** får du all nödvändig info för att ansluta till FTP-accessen. FTP-accessen ger dig direkt tillgång till filerna på din spelserver. Vi rekommenderar att använda ett externt FTP-program som **Filezilla** eller **WinSCP** för bästa användarupplevelse. Om du är ny på FTP, kolla gärna vår guide [FTP Access](gameserver-ftpaccess.md) som kan hjälpa dig.
