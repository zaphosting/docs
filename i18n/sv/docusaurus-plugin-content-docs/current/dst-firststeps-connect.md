...
För att ansluta till din server via den inbyggda serverbläddraren, öppna serverbläddraren i huvudmenyn. Klicka på **Browse Games**. När du är där, sök efter din server med hjälp av **sökfältet** och ditt servernamn, och klicka sedan på **Join**.
