...
title: "Sanctuary Island: Vanliga problem"
description: "Upptäck hur du felsöker och löser vanliga problem med Sanctuary Island-servrar för att hålla ditt spel igång smidigt och njuta av oavbruten spelupplevelse → Läs mer nu"
...
För att isolera orsaken till krascher är det ofta hjälpsamt att tillfälligt stänga av extra innehåll. Börja med en minimal setup och kolla om problemet kvarstår. Om det försvinner, lägg till tillägg, mods eller resurser en och en och testa efter varje steg. Den här metoden hjälper dig att pinpointa exakt vad som krånglar. Det är ett smart sätt att felsöka baserat på fakta istället för gissningar.
...
Det här sättet smalnar effektivt ner misstänkta orsaker och säkerställer att din felsökning bygger på fakta, inte gissningar.
...
Regelbundna backuper sparar dig mycket stress och oro. Skapa regelbundna backuper så att du vid problem alltid har en äldre version sparad när allt fungerade. Vi erbjuder en [backup-lösning](gameserver-backups.md) för våra Sanctuary Island-servrar, där du kan göra manuella eller schemalagda automatiska backuper.
...
De här stegen borde hjälpa dig att lösa problemet. Om du hittar ditt problem här, pekar lösningen dig oftast i rätt riktning och hjälper dig att få igång servern igen.
