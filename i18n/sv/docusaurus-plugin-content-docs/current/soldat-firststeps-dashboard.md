...
title: "Soldat: Översikt över Dashboard"
description: "Upptäck hur du effektivt hanterar och optimerar din Soldat-server med en tydlig översikt över alla viktiga funktioner och alternativ → Lär dig mer nu"
...
:::warning
Användning av DDoS Manager är endast möjlig om antingen en egen IP-adress eller optionen "DDoS Manager Overview" är bokad som tillägg. Om dessa komponenter saknas i ditt nuvarande paket kan du när som helst lägga till dem genom att uppgradera.
:::
...
:::warning
Hittar du ingen hjälp i informationen eller förstår du den inte? Oroa dig inte! Vi finns dagligen tillgängliga i supporten. Skapa bara ett **[Ticket](https://zap-hosting.com/en/customer/support/)** och förklara ditt problem för oss. Vi tittar på det så snabbt som möjligt och hjälper dig att lösa problemet! :)
:::
