...
title: "RimWorld Together: Automatiska Servermeddelanden – Håll dina spelare uppdaterade med nyheter, sociala länkar och mer!"
...
Med hjälp av **Schemalagda Uppgifter** kan servermeddelanden skickas automatiskt in i **RimWorld Together**-chatten genom att köra fördefinierade kommandon på ett återkommande schema.
