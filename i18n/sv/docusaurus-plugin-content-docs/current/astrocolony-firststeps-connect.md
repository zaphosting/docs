...
title: "Astro Colony: Anslut till servern"
description: "Upptäck hur du smidigt ansluter till din Astro Colony-server och kommer igång med spelet utan krångel → Läs mer nu"
...
Starta spelet och gå till **Multiplayer** för att öppna serverlistan. Använd sökfältet för att hitta din server via servernamnet. Anslut genom att klicka på **Join**-knappen.
...
Sök eller lägg till din server via Steam-listan genom att använda `IP-adress` och `Port` för din gameserver. Gör så här: välj fliken `Favorites` i serverlistan och klicka på plustecknet längst ner. Ett popup-fönster öppnas där du anger din serverinfo. 
...
Grattis! Om du följt allt rätt borde du nu ha lyckats ansluta till servern. Har du fler frågor eller behöver hjälp, tveka inte att kontakta vårt supportteam som finns tillgängligt varje dag för att hjälpa dig! 🙂
