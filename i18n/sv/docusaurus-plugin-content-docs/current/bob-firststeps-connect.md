...
title: "Beasts of Bermuda: Anslut till servern"
description: "Upptäck hur du smidigt ansluter till din Beasts of Bermuda-server och felsöker vanliga problem för oavbrutet spelande → Lär dig mer nu"
...
Du behöver all relevant info för att kunna ansluta till din server. Informationen om din server hittar du på kontrollpanelen i ditt spelserver-webbgränssnitt. Viktig info inkluderar bland annat:
...
För att ansluta till din server via den inbyggda serverbläddraren i spelet, öppna serverbläddraren i huvudmenyn. Klicka på **Multiplayer** och sök efter din server med servernamnet i serverlistan.
...
#### Ingen lösning eller inte hjälpsam
