...
title: "Motor Town: Behind The Wheel: Översikt Dashboard"
description: "Upptäck hur du effektivt hanterar och optimerar din Motor Town-server för maximal prestanda och kontroll → Lär dig mer nu"
...
Vill du schemalägga serveromstarter vid specifika tider? Restart-planeraren låter dig ställa in schemalagda automatiska omstarter av din spelserver. Med denna funktion kan du ställa in omstarter vid specifika tider eller med jämna mellanrum.
...
Med **FTP Browser** får du all nödvändig information för att upprätta en anslutning till FTP-accessen. FTP-accessen ger dig direkt tillgång till filerna på din spelserver. Vi rekommenderar att använda ett externt FTP-program som **Filezilla** eller **WinSCP** för bästa användarupplevelse. Om du inte är bekant med hur FTP används kan guiden [Access via FTP](gameserver-ftpaccess.md) vara till hjälp.
