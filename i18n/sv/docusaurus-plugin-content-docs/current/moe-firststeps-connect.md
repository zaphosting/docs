...
title: "Myth of Empires: Anslut till servern"
description: "Upptäck hur du smidigt ansluter till din Myth of Empires-server och njuter av oavbrutet spelande → Läs mer nu"
...
För att ansluta till din server via den inbyggda serverbläddraren, öppna serverbläddraren i huvudmenyn. Klicka på **Custom Server** för detta. Sök efter din server med servernamnet i sökfältet. Välj sedan din server och klicka på **Connect** för att etablera anslutningen.
