...
## Introduktion
Har du en Windows VPS och vill köra din egen Hytale-server på den? I den här guiden går vi igenom steg för steg hur du installerar och kör Hytale dedikerad server på ett Windows-system.
