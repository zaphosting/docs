---
id: domain-profidns
title: "Domän: ProfiDNS"
description: "Utforska avancerade DNS-konfigurationsmöjligheter med ProfiDNS för att koppla tjänster och optimera dina domäninställningar → Lär dig mer nu"
...
**EasyDNS** är förvalt valt, så du måste först välja och aktivera **ProfiDNS**-alternativet.
...
Grattis, du har nu framgångsrikt konfigurerat DNS-inställningarna för din domän. Har du fler frågor eller behöver hjälp är du varmt välkommen att kontakta vårt supportteam som finns tillgängligt varje dag för att hjälpa dig! 🙂
