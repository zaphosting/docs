...
Även om plugins kan laddas ner från olika källor rekommenderar vi att du håller dig till pålitliga plattformar som det officiella GitHub-repot, eftersom dessa generellt anses vara säkrast. Var alltid försiktig när du lägger till plugins på din server – verifiera källan, kolla upp utvecklarna och förstå helt vad pluginen gör innan du installerar.

För att ladda ner en plugin från GitHub, börja med att besöka den officiella [EXILED GitHub-sidan](https://github.com/Exiled-Team) och välj det plugin-repo du vill använda.  
...
Klart! När du laddat ner kan du gå vidare till installationsstegen längre ner i guiden för att lära dig hur du installerar **.dll**-filen på din server.


## Installation

När du laddat ner de plugins du vill ha kan du börja installera dem. Det gör du via **FTP**, så du behöver en FTP-klient för att ladda upp filerna till din server. Om du inte är bekant med FTP och hur det funkar, kolla in vår guide: [Access via FTP](gameserver-ftpaccess.md).

![](https://screensaver01.zap-hosting.com/index.php/s/pr5s8ySnpBN7qjC/preview)

Rätt plugin-mapp hittar du under: ```/gXXXXXX/.config/EXILED/Plugins```. Ladda bara upp de nedladdade **.dll**-pluginfilerna till den här mappen. Det bör se ut ungefär så här efter uppladdning:  

![](https://screensaver01.zap-hosting.com/index.php/s/MRJHcdGpwSb2agK/preview)

När det är klart är plugin-installationen färdig. Kolla sedan i **live-konsolen** för att bekräfta att pluginen har kompilerats och laddats in utan problem. Bekräftelsen i konsolen ser ut så här:  
...
Om du följt alla steg ska du nu ha installerat din plugin utan problem. Har du fler frågor eller behöver hjälp, tveka inte att kontakta vår support som finns tillgänglig varje dag för att hjälpa dig! 🙂
