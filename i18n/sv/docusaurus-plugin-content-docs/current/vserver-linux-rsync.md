...
title: "VPS: Säkerhetskopiera Linux-servrar med Rsync"
description: "Lär dig skapa effektiva inkrementella säkerhetskopior med Rsync för lokal eller fjärrsynkronisering av data → Läs mer nu"
...
-z=Komprimering, beroende på datamängd/datastorlek komprimeras datan
<br/>
-e=Specificerar SSH-port (standard 22)
<br/>
