...
title: "Risk of Rain 2: Översikt över Dashboard"
description: "Upptäck hur du effektivt hanterar och optimerar din Risk of Rain 2-server med en tydlig översikt över nyckelfunktioner och kontroller → Lär dig mer nu"
...
I dashboarden har du också möjlighet att starta, stoppa eller starta om din tjänst för att ha full kontroll över dess drift. Dessutom kan du komma åt live-konsolen för att få realtidsinformation om serverns status och agera direkt vid behov.
...
:::warning
Hittar du ingen hjälp i informationen eller förstår du den inte? Ingen fara! Vi finns tillgängliga dagligen i supporten. Skapa bara en **[Ticket](https://zap-hosting.com/en/customer/support/)** och förklara ditt problem för oss. Vi tittar på det så snabbt vi kan och hjälper dig att lösa problemet! :)
:::
