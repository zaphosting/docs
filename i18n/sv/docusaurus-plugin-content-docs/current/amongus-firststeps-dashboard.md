...
Med editorn får du direkt tillgång till alla tillgängliga alternativ och kan finjustera dem exakt. Detta är särskilt användbart för avancerade användare som vill ha full kontroll över sina serverinställningar och vet exakt vilka ändringar de vill göra.
...
Med ZAP DNS-inställningar kan du skapa lättare adresser för din tjänst. Du kan antingen använda en subdomän av någon av våra domäner eller skapa en DNS-post på din egen domän och därmed få en adress som är bättre kopplad till dig som person.
