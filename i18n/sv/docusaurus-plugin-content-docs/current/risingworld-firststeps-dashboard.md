...
title: "Rising World: Översikt över Kontrollpanelen"
description: "Upptäck hur du effektivt hanterar din Rising World-server och optimerar dess inställningar för bästa prestanda → Lär dig mer nu"
...
Med ZAP DNS-inställningar kan du skapa lättare adresser för din tjänst. Du kan använda en subdomän från någon av våra domäner eller skapa en DNS-post på dina egna domäner och därmed få en adress som är lättare att koppla till dig som person.
...
Med **FTP Browser** får du all nödvändig information för att ansluta till FTP-accessen. FTP-accessen ger dig direkt tillgång till filerna på din spelserver. Vi rekommenderar att använda ett externt FTP-program som **Filezilla** eller **WinSCP** för bästa användarupplevelse. Om du är osäker på hur FTP fungerar kan guiden [Access via FTP](gameserver-ftpaccess.md) vara till hjälp.
...
I inställningarna kan du ange om backuper ska skapas automatiskt och om det ska ske dagligen eller veckovis. Dessutom kan du bestämma om de äldsta backuperna ska tas bort vid behov, till exempel när lagringsutrymmet börjar ta slut.
