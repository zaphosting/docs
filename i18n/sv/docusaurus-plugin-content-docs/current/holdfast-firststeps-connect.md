...
title: "Holdfast: Nations At War: Anslut till servern"
description: "Upptäck hur du smidigt ansluter till din Holdfast: Nations At War-server och felsöker vanliga problem → Lär dig mer nu"
...
För att ansluta till din server via den inbyggda serverbläddraren, öppna serverbläddraren i huvudmenyn. Använd **sökfältet** i serverlistan för att söka efter din server med serverns namn. 
