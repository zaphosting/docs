...
title: "DDraceNetwork: Anslut till servern"
description: "Upptäck hur du smidigt ansluter till din DDraceNetwork-server och felsöker vanliga problem för en grym spelupplevelse → Läs mer nu"
...
Du behöver all relevant info för att kunna ansluta till din server. Informationen om din server hittar du i kontrollpanelen på din gameservers webbgränssnitt. Viktig info inkluderar:
...
För att ansluta till din server via den inbyggda serverbläddraren, öppna serverbläddraren genom att klicka på **Spela** i huvudmenyn. Du kan ansluta i serverlistan antingen via servernamnet (sökterm) eller via IP-adressen och porten till din server. 
