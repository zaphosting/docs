...
title: "Argo: Översikt Dashboard"
description: "Upptäck hur du effektivt hanterar och optimerar din Argo-server med en tydlig översikt över nyckelfunktioner och administrationstips → Lär dig mer nu"
...
Din server var offline en stund och du kan inte förklara varför? En titt i händelseloggen och loggfilerna gav heller ingen ledtråd? Det kan vara så att problemet inte ligger direkt hos din server, utan hos värdsystemet där din server körs.
...
I det här avsnittet hittar du en översikt över driftstörningshistoriken för värdsystemet där din spelserver körs. Mer info och senaste statusen hittar du på vår nya [statussida](https://status.zap-hosting.com/).
...
Config-filredigeraren låter dig redigera konfigurationsfilerna direkt på webbplatsen i klassisk vy, utan förenklad vy. Den här funktionen gör att du kan anpassa serverns inställningar efter dina personliga preferenser.
