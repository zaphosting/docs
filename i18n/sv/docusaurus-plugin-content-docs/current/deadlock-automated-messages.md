...
title: "Deadlock: Automatiska Servermeddelanden – Håll dina spelare uppdaterade om nyheter, sociala länkar och mer!"
...
Med hjälp av **Schemalagda Uppgifter** kan servermeddelanden skickas automatiskt till **Deadlock**-chatten i spelet genom att köra fördefinierade kommandon på återkommande tider.
