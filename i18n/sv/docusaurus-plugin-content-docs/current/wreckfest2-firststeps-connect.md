...
title: "Wreckfest 2: Anslut till servern"
description: "Upptäck hur du smidigt ansluter till din Wreckfest 2-server och felsöker vanliga problem för en sömlös spelupplevelse → Lär dig mer nu"
...
<Tabs>
    <TabItem value="connect_solution_direct_ingame" label="Direktanslutning (I spelet)" default>

För att ansluta till din server via spelets inbyggda serverbrowser, öppna serverbrowsern i huvudmenyn. Klicka sedan på **Anslut till adress** till vänster. Fyll i IP-adressen och porten till din server och klicka på **Ok** för att etablera anslutningen. 
