...
title: "DayZ: Anslut till servern"
description: "Upptäck hur du smidigt ansluter till din DayZ-server och få alla viktiga tips för en problemfri spelupplevelse → Lär dig mer nu"
...
Ingen extra mjukvara används för spelet som standard. Men om du vill använda mods på din server är det värt att använda [DZSA Launcher](https://dayzsalauncher.com/). 
...
För att ansluta till din server via den inbyggda serverbläddraren, öppna serverbläddraren i huvudmenyn. När du är i serverlistan, klicka på **Community**. Använd filteralternativen för att söka efter din server via servernamnet. 

![img](https://screensaver01.zap-hosting.com/index.php/s/Mbb4DFjeEKrZK8M/download)



:::warning DayZ-servern syns inte
Serverlistan i spelet är känd för att inte alltid vara helt pålitlig. Det kan hända att din server inte visas tillfälligt. I så fall, använd en alternativ anslutningsmetod.
:::
