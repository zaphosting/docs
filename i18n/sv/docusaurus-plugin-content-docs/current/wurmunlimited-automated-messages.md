...
title: "Wurm Unlimited: Automatiska Servermeddelanden - Håll dina spelare uppdaterade om nyheter, sociala länkar och mer!"
...
Med **Schemalagda Uppgifter** kan servermeddelanden skickas automatiskt in i **Wurm Unlimited**-chatten genom att köra fördefinierade kommandon på ett återkommande schema.

<InlineVoucher />



## Hur automatiska meddelanden funkar
...
Du kan sedan definiera hur ofta meddelandet ska skickas, t.ex. var några minuter, varje timme eller vid specifika tider på dagen. För detaljerade instruktioner om schemalagda uppgifter, kolla in guiden [Schemalagda uppgifter](gameserver-scheduled-tasks.md).
...
Funktionen för automatiska servermeddelanden beror på spelets möjligheter och tillgängliga kommandon. Medan grundläggande schemalagda meddelanden kan implementeras med standardserverkommandon, kan detta vara begränsat när det gäller formatering, villkor eller avancerad anpassning.

Om spelet stödjer extra plugins, mods eller extensions som ger mer flexibilitet och anpassningsmöjligheter kan det vara värt att använda dem. I sådana fall kan specialiserade meddelandesystem erbjuda fler funktioner än standardkommandon och passa bättre för komplexa eller väldigt anpassade serveruppsättningar.
