...
title: "Day of Defeat: Source: Automatiska Servermeddelanden – Håll dina spelare uppdaterade om nyheter, sociala länkar och mer!"
...
Automatiska servermeddelanden är ett enkelt men grymt sätt att kommunicera viktig info direkt till spelarna i spelet. De kan användas för att visa serverregler, annonsera events, dela tips eller påminnelser med jämna mellanrum – helt utan att admins behöver göra något manuellt.

Med hjälp av **Schemalagda Uppgifter** kan servermeddelanden skickas automatiskt till **Day of Defeat: Source** chatt genom att köra fördefinierade kommandon på ett återkommande schema.
