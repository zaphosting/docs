...
title: "Rising World: Automatiska Servermeddelanden – Håll dina spelare uppdaterade om nyheter, sociala länkar och mer!"
...
Med **Schemalagda Uppgifter** kan servermeddelanden skickas automatiskt in i **Rising World**-chatten genom att köra fördefinierade kommandon på ett återkommande schema.
...
När det är upprättat körs meddelandena självständigt och kan enkelt återanvändas genom att bara justera spelets meddelandekommando och text.
