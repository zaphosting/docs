...
title: "Broke Protocol: Anslut till servern"
description: "Upptäck hur du smidigt ansluter till din Broke Protocol-server och är redo att spela utan krångel → Läs mer nu"
...
För att ansluta till din server, öppna spelet och gå till **Play Online**. När du är där, sök efter din server med servernamnet i serverlistan. Klicka på Join för att ansluta.

![img](https://screensaver01.zap-hosting.com/index.php/s/aJJx7Kq25SPzgrC/download)

</TabItem>

<TabItem value="connect_solution_direct_ingame" label="Direktanslutning (I spelet)">

För att ansluta till din server, öppna spelet och gå till **Play Online**. Klicka sedan på **Direct**. Skriv in din servers IP-adress och port och klicka på **Connect**.
