...
För att ansluta till din server, öppna spelet och gå till **Play Online**. Klicka sedan på **Direct**. Fyll i din servers IP-adress och port och klicka på **Connect**.
