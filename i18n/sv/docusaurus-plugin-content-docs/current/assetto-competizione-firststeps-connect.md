...
title: "Assetto Corsa Competizione: Anslut till servern"
description: "Upptäck hur du smidigt ansluter till din Assetto Corsa Competizione-server och felsöker vanliga problem → Lär dig mer nu"
...
För att ansluta till din server via den inbyggda serverbläddraren, öppna spelet och klicka på **Multiplayer**. Du kan söka efter din server i serverlistan med servernamnet. 
