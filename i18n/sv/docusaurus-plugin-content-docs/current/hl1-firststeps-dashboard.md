...
**Kontrollpanelen** för din server är hjärtat i administrationen. Här presenteras all grundläggande och viktig information om din tjänst på ett tydligt sätt. Det inkluderar till exempel information om plats, status, IP:Port, använd minne, pågående spel, servernamn, karta och antalet tillgängliga slots. Dessutom visas även belastningen på CPU, minne och RAM.
...
I det här avsnittet hittar du en översikt över driftstörningshistoriken för värdsystemet där din spelserver körs. Du kan hitta mer information och den senaste versionen av vår servicestatus på vår nya [statussida](https://status.zap-hosting.com/).
