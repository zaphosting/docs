...
title: "Half-Life 1: Översikt över Kontrollpanelen"
description: "Upptäck hur du effektivt hanterar och optimerar din Half-Life 1-server med en tydlig översikt över viktiga funktioner och kontroller → Lär dig mer nu"
...
Utöver våra spelserverprodukter erbjuder vi även 10 inkluderade databaser. Dessa databaser behövs till exempel när data ska sparas i en databas. Under **Databaser** kan du skapa en databas och se inloggningsuppgifterna. Du har också möjlighet att aktivera backupfunktionen och importera befintliga databasbackuper.
