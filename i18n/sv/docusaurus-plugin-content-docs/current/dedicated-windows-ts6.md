...
title: "Dedikerad Server: Sätt upp Teamspeak 6 Server på din Windows Dedikerade Server"
description: "Upptäck hur du sätter upp och optimerar din TeamSpeak 6 Server för bästa prestanda och säkerhet → Lär dig mer nu"
...
## Installation
Nu när alla krav är uppfyllda och förberedelserna klara kan du köra igång med installationen av Teamspeak 6 Server-appen. För att installera TeamSpeak 6 Server, ladda först ner senaste releasen `http://teamspeak-server_win64-v6.0.0-beta6.zip/` från GitHub: [TeamSpeak 6 Server (Windows 64-bit)](https://github.com/teamspeak/teamspeak6-server/releases/download/v6.0.0%2Fbeta6/teamspeak-server_win64-v6.0.0-beta6.zip)
...
Du kan också justera fler inställningar för **TeamSpeak 6 Server** via **kommandoradsargument**. Alternativ skickas direkt när du startar servern. En komplett lista över tillgängliga alternativ finns i den officiella [TeamSpeak 6 Server](https://github.com/teamspeak/teamspeak6-server/blob/main/CONFIG.md) dokumentationen. Exempel:
...
Grattis! Du har nu installerat och konfigurerat Teamspeak 6 Server på din Dedikerade Server. Vi rekommenderar även att kolla in följande resurser som kan ge dig extra hjälp och tips under din serverkonfiguration:
