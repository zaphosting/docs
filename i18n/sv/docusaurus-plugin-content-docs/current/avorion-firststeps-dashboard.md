...
title: "Avorion: Översikt över Dashboard"
description: "Upptäck hur du effektivt hanterar och optimerar din Avorion-server med en tydlig översikt över alla viktiga funktioner → Lär dig mer nu"
...
Med **FTP Browser** får du all nödvändig information för att ansluta till FTP-accessen. FTP-accessen ger dig direkt tillgång till filerna på din spelserver. Vi rekommenderar att använda ett externt FTP-program som **Filezilla** eller **WinSCP** för bästa användarupplevelse. Om du är osäker på hur FTP fungerar rekommenderar vi att du kollar vår guide [FTP Access](gameserver-ftpaccess.md) som kan hjälpa dig.
...
Utöver våra spelserverprodukter erbjuder vi även 10 inkluderade databaser. Dessa databaser behövs till exempel när data ska sparas i en databas. Under **Databaser** kan du skapa en databas och se åtkomstuppgifterna. Du kan även aktivera backup-alternativet och importera befintliga databasbackuper.
