...
description: "Upptäck hur du effektivt hanterar din Minecraft-server med en tydlig översikt över funktioner och inställningar → Lär dig mer nu"
...
Med Tebex kan du förvandla din spelserver till cash genom att sälja virtuella varor och ranks för riktiga pengar. Det är ett kraftfullt och pålitligt verktyg speciellt designat för spelserveradministratörer som vill erbjuda en bättre spelupplevelse för sina spelare.
...
Klicka på bilden för att skapa din egen spelserverbutik med Tebex. Uppstarten är snabb och enkel, så du är redo att börja sälja dina virtuella varor på nolltid.
...
**Live Console** ger dig en realtidsvy över alla aktuella händelser på din server. Här ser du information om spelarnas aktiviteter samt eventuella fel- och systemmeddelanden. Denna översikt låter dig få en helhetsbild av vad som händer på din server och upptäcka problem i ett tidigt skede.
...
I detta avsnitt hittar du en översikt över driftstörningshistoriken för värdsystemet där din spelservertjänst körs. Mer information och den senaste statusen för våra tjänster hittar du på vår nya [statussida](https://status.zap-hosting.com/).
...
Under **Spel** kan du alltid byta spelvariant på ditt befintliga spel eller installera ett annat spel. Spel med samma slotpris kan väljas direkt under **Tillgängliga spel**. För alla andra spel krävs först en justering av slotpriset. Mer information om detta finns i guiden [Spelbyte](gameserver-gameswitch.md).
...
Du kan även aktivera e-postnotiser för automatiska uppdateringar för att hålla dig informerad om uppdateringar och säkerställa att du alltid är uppdaterad.
...
Spelarhanteringen låter dig snabbt och enkelt hantera dina spelare. Lägg till spelare som operatörer eller banna spelare som inte är välkomna med bara några klick.
...
Med **FTP Browser** får du all nödvändig information för att upprätta en anslutning till FTP-accessen. FTP-accessen ger dig direkt tillgång till filerna på din spelserver. Vi rekommenderar att använda ett externt FTP-program som **FileZilla** eller **WinSCP** för bästa användarupplevelse. Om du är osäker på hur FTP används kan guiden [Access via FTP](gameserver-ftpaccess.md) vara till hjälp.
...
Utöver våra spelserverprodukter erbjuder vi även 10 inkluderade databaser. Dessa behövs till exempel när data ska sparas i en databas. Under **Databaser** kan du skapa en databas och se inloggningsuppgifterna. Du kan även aktivera backup-funktionen och importera befintliga databasbackuper.
