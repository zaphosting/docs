...
title: "Core Keeper: Anslut till servern"
description: "Upptäck hur du smidigt ansluter till din Core Keeper-server och felsöker vanliga problem för en sömlös spelupplevelse → Lär dig mer nu"
...
<Tabs>
    <TabItem value="connect_solution_server_joine" label="Gå med i spelet" default>

Klicka på **Gå med i spelet** i spelet och klistra in det kopierade **Game ID** från `Game ID`-konfigurationsfilen i fältet. 
