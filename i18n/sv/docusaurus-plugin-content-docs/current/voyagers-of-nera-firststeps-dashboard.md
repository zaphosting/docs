...
title: "Voyagers of Nera: Översikt över Kontrollpanelen"
description: "Upptäck hur du effektivt hanterar och optimerar din Voyagers of Nera-server för bästa prestanda och kontroll → Lär dig mer nu"
...
**Livekonsolen** ger dig en realtidsvy över alla aktuella händelser på din server. Här kan du se information om spelarnas aktiviteter samt eventuella fel- och systemmeddelanden. Denna översikt låter dig få en komplett bild av vad som händer på din server och upptäcka eventuella problem i ett tidigt skede.
...
I detta avsnitt hittar du en översikt över driftstörningshistoriken för värdsystemet där din spelservers tjänst körs. Mer information och den senaste versionen av vår tjänstestatus hittar du på vår nya [statussida](https://status.zap-hosting.com/).
