...
title: "Unturned: Anslut till servern"
description: "Upptäck hur du smidigt ansluter till din Unturned-server och njut av sömlöst spelande med vår kompletta guide → Läs mer nu"
...
## Introduktion
Osäker på hur du ansluter till din **Unturned**-server eller vad du behöver för att komma igång? Ingen fara, vi har dig täckt! Vi går igenom allt du behöver – från nödvändiga verktyg och information till själva anslutningsprocessen, plus viktiga saker att tänka på för att säkerställa en smidig och problemfri anslutning. Följ vår guide så är du igång på nolltid!
...
Öppna spelet för att ansluta till din server via den inbyggda serverbläddraren. När du är inne i spelet, klicka på **Play** och gå till **Multiplayer**. Klicka sedan på filteralternativen i serverlistan och använd namn-fältet för att söka efter din server med serverns namn. ![img](https://screensaver01.zap-hosting.com/index.php/s/6cbF7Gp3kyfMc4E/download)

</TabItem>

<TabItem value="connect_solutiion_direct" label="Direktanslutning (I spelet)">

Öppna spelet för att ansluta via direktanslutning. När du är inne i spelet, klicka på **Play** och gå till **Connect directly**. Skriv in serverns IP-adress och port där och klicka sedan på **Connect**. 
...
Grattis! Om du följt allt korrekt borde du nu ha en fungerande anslutning till servern. Har du fler frågor eller behöver hjälp, tveka inte att kontakta vårt supportteam som finns tillgängligt varje dag för att hjälpa dig! 🙂
