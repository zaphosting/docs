...
title: "Battle Grounds III: Anslut till servern"
description: "Upptäck hur du smidigt ansluter till din Battle Grounds III-server och njuter av oavbrutet spel → Läs mer nu"
...
Du behöver all relevant info för att kunna ansluta till din server. Informationen om din server hittar du på kontrollpanelen för din gameserver. Viktig info inkluderar:
...
För att ansluta till din server via den inbyggda serverbläddraren i spelet, öppna serverbläddraren i huvudmenyn. Klicka på **Hitta server** och sök efter din server i serverlistan med hjälp av ditt servernamn.
...
Sök eller lägg till din server via Steam-bläddraren genom att använda `IP-adress` och `Port` för din gameserver. Gör så här: välj fliken `Favoriter` i serverlistan och klicka på plustecknet längst ner. Ett popup-fönster öppnas där du anger din serverinfo.
