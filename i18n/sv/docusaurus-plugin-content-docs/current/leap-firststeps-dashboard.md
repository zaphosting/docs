...
title: "Leap: Översikt över kontrollpanelen"
description: "Upptäck hur du effektivt hanterar din Leap-server med en tydlig översikt över funktioner och alternativ för optimal prestanda → Lär dig mer nu"
...
Med **FTP Browser** får du all nödvändig info för att koppla upp dig mot FTP-accessen. FTP-accessen ger dig direkt tillgång till filerna på din spelserver. Vi rekommenderar att du använder ett externt FTP-program som **FileZilla** eller **WinSCP** för bästa användarupplevelse. Om du är ny på FTP rekommenderar vi att du kollar in vår guide [FTP Access](gameserver-ftpaccess.md) som kan hjälpa dig.
