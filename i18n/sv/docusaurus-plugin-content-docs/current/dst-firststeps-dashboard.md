...
title: "Don't Starve Together: Översikt Dashboard"
description: "Upptäck hur du effektivt hanterar din Don't Starve Together-server och optimerar inställningarna för bästa spelupplevelse → Lär dig mer nu"
...
Med ZAP DNS-inställningar kan du skapa lättare adresser för din tjänst. Du kan använda en subdomän från någon av våra domäner eller skapa en DNS-post på dina egna domäner för en adress som är mer personlig och lättare att koppla till dig.
...
Vi erbjuder som standard 10 GB lagringsutrymme för backuper på lagringsservern för våra spelserverprodukter. Behöver du mer utrymme kan det uppgraderas mot en avgift. På så sätt säkerställer du att du alltid har tillräckligt med plats för dina backuper och kan komma åt äldre backuper vid behov.
