...
title: "Nienix: Automatiska Servermeddelanden – Håll dina spelare uppdaterade om nyheter, sociala länkar och mer!"
...
Med **Schemalagda Uppgifter** kan servermeddelanden skickas automatiskt in i **Nienix**-chatten genom att köra fördefinierade kommandon på ett återkommande schema.
