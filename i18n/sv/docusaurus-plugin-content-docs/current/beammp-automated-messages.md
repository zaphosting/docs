...
title: "BeamMP: Automatiska Servermeddelanden – Håll dina spelare uppdaterade om nyheter, sociala länkar och mer!"
...
Med **Schemalagda Uppgifter** kan servermeddelanden skickas automatiskt till **BeamMP**-chatten genom att köra fördefinierade kommandon på ett återkommande schema.
...
Du kan sedan bestämma hur ofta meddelandet ska skickas, till exempel var några minuter, varje timme eller vid specifika tider på dagen. För detaljerade instruktioner om schemalagda uppgifter, kolla in guiden [Schemalagda uppgifter](gameserver-scheduled-tasks.md).
