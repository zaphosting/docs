...
title: "Astro Colony: Översikt Dashboard"
description: "Upptäck hur du effektivt hanterar din Astro Colony-server med en tydlig översikt över funktioner och alternativ → Lär dig mer nu"
...
Var din server tillfälligt offline och du kan inte förklara varför? En titt i händelseloggen och loggfilerna gav ingen ledtråd? Det kan vara så att problemet inte ligger direkt hos din server, utan hos värdsystemet där din server körs.
...
Under inställningar hittar du en översikt över de vanligaste inställningsalternativen för din server. Dessa inkluderar även korta förklaringar. Inställningssidan rekommenderas särskilt för nybörjare inom serveradministration.
...
Vill du schemalägga serveromstarter vid specifika tider? Restart-planeraren låter dig ställa in automatiska omstarter av din spelserver vid bestämda tidpunkter eller regelbundet.
