...
title: "Nienix: Översikt Dashboard"
description: "Utforska hur du effektivt hanterar och optimerar din Nienix-server med en tydlig översikt över funktioner och alternativ → Lär dig mer nu"
...
Vill du schemalägga serveromstarter vid specifika tider? Restart-planeraren låter dig ställa in automatiska omstarter av din spelserver vid bestämda tidpunkter eller med jämna mellanrum.
...
Med **FTP Browser** får du all nödvändig info för att ansluta till FTP-accessen. FTP-accessen ger dig direkt tillgång till filerna på din spelserver. Vi rekommenderar att använda ett externt FTP-program som **FileZilla** eller **WinSCP** för bästa upplevelse. Om du är osäker på hur FTP fungerar, kolla gärna vår guide [FTP Access](gameserver-ftpaccess.md).
