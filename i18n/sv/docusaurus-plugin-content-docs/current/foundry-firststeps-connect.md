...
title: "Foundry: Anslut till servern"
description: "Upptäck hur du smidigt ansluter till din Foundry-server och felsöker vanliga problem för en sömlös spelupplevelse → Lär dig mer nu"
...
Du behöver all relevant information som krävs för att ansluta till din server. Information om din server hittar du på kontrollpanelen i webbgränssnittet för din spelserver. Viktig info inkluderar följande:
...
Öppna spelet och gå till multiplayer. Klicka på **IP Direktanslutning** och skriv in IP-adressen och porten till din server. 
