...
title: "Assetto Corsa Competizione: Översikt Dashboard"
description: "Upptäck hur du effektivt hanterar din Assetto Corsa Competizione-server med en tydlig översikt över funktioner och alternativ → Lär dig mer nu"
...
**Dashboarden** för din server är hjärtat i administrationen. All grundläggande och viktig information om din tjänst presenteras tydligt här. Det inkluderar till exempel information om plats, status, IP: Port, använd minne, pågående spel, servernamn, bana och antal tillgängliga slots. Dessutom visas även belastningen på CPU, minne och RAM.
...
:::warning
Användning av DDoS Manager är endast möjlig om antingen en egen IP-adress eller tillägget "DDoS Manager Översikt" har bokats som tilläggsalternativ. Om dessa komponenter saknas i ditt nuvarande paket kan du lägga till dem när som helst genom att uppgradera.
:::
...
Om vårt övervakningssystem upptäcker ett generellt avbrott, meddelas våra tekniker automatiskt som tar hand om problemet så snabbt som möjligt.

I detta avsnitt hittar du en översikt över driftstörningar på värdsystemet där din spelservers tjänst körs. Mer information och den senaste statusen för våra tjänster hittar du på vår nya [statussida](https://status.zap-hosting.com/).
...
Config-filredigeraren låter dig redigera konfigurationsfilerna direkt på webbplatsen i klassisk vy, utan förenklad vy. Detta alternativ låter dig anpassa serverns inställningar efter dina personliga preferenser.
...
Du kan även aktivera e-postnotiser för automatiska uppdateringar för att hålla dig informerad och alltid vara uppdaterad.
...
Vill du schemalägga serveromstarter vid specifika tider? Restartplaneraren låter dig ställa in automatiska omstarter av din spelserver. Med denna funktion kan du planera omstarter vid specifika tidpunkter eller med jämna mellanrum.
...
**Nyheter** ger dig en komplett översikt över alla meddelanden och nyheter kopplade till din tjänst. Här hittar du viktig information om olika aspekter som:
