...
Du kan även aktivera e-postnotiser för automatiska uppdateringar så att du hålls informerad om uppdateringar och alltid är uppdaterad.
...
Vill du schemalägga serveromstarter vid specifika tider? Restartplaneraren låter dig ställa in automatiska omstarter av din spelserver. Med denna funktion kan du planera omstarter vid bestämda tider eller med jämna mellanrum.
