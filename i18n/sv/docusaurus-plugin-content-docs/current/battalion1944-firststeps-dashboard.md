...
title: "Battalion 1944: Översikt över kontrollpanelen"
description: "Upptäck hur du effektivt hanterar din Battalion 1944-server och optimerar dess inställningar för bästa prestanda → Lär dig mer nu"
...
Med **FTP Browser** får du all nödvändig info för att ansluta till FTP-accessen. FTP-accessen ger dig direkt tillgång till filerna på din spelserver. Vi rekommenderar att använda ett externt FTP-program som **FileZilla** eller **WinSCP** för bästa upplevelse. Om du är ny på FTP, kolla gärna in vår guide [FTP Access](gameserver-ftpaccess.md) som kan hjälpa dig.
