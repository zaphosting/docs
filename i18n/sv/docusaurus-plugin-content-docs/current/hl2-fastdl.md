---
id: hl2-fastdl
title: "Half-Life 2: Ställ in FastDL"
...
FastDL (Fast Download) är en metod för att leverera custom content som kartor, ljud eller modeller via en extern webbserver istället för själva spelservern. Det gör att spelare får snabbare nedladdningar och minskar belastningen på servern.
...
Du behöver en aktiv Half-Life 2-server hos ZAP-Hosting och ett extra webspace-paket. FTP-åtkomst eller tillgång till Filhanteraren måste finnas både för spelservern och webspace.
...
I root-mappen på ditt webspace skapar du en mapp som heter `fastdl`. Inuti den skapar du undermappar som `maps`, `sound` eller `models` beroende på vad du ska leverera. Mappstrukturen måste exakt spegla den som används på din Half-Life 2-server.
...
När filerna är uppladdade och rättigheterna är kollade, kommer FastDL-innehållet vara tillgängligt via följande publika URL:
...
FastDL går snabbt och smidigt att sätta upp med ditt egna ZAP webspace. Det ger snabb och effektiv leverans av custom content och förbättrar upplevelsen för alla som spelar på din Half-Life 2-server.
