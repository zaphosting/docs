...
title: "Half-Life 2: Automatiska Servermeddelanden - Håll dina spelare uppdaterade om nyheter, sociala länkar och mer!"
...
Med **Schemalagda Uppgifter** kan servermeddelanden skickas automatiskt i **Half-Life 2**-chatten genom att köra fördefinierade kommandon på ett återkommande schema.
...
När det är uppsatt körs meddelandena självständigt och kan enkelt återanvändas genom att bara justera spelets meddelandekommando och text.
