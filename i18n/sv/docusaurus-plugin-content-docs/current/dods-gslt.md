---
id: dods-gslt
title: "Day of Defeat: Source: Skapa en GSLT (Steam Game Server Login Token)"
description: "Lär dig hur du autentiserar och säkrar dina dedikerade spelservrar med Steams Game Server Login Token för bättre synlighet och skydd → Läs mer nu"
...
När du är inloggad kan du skapa en ny token via formuläret på sidan. I fältet **App ID** anger du App ID `300` som tillhör **Day of Defeat: Source**. Se till att ange rätt ID, eftersom token inte fungerar med fel värde.
...
Login-token måste nu läggas till i din serverkonfiguration. Öppna din spelservers administrationsgränssnitt och gå till avsnittet **Settings**. Klistra in token i fältet märkt **GSL Token** och spara.

![img](https://screensaver01.zap-hosting.com/index.php/s/tzJiT4nTZo2nWMz/preview)

:::info Flera Day of Defeat: Source-servrar
Om du kör flera **Day of Defeat: Source**-servrar behöver du en GSLT för varje server. Det är <u>**inte**</u> möjligt att köra flera servrar med en och samma GSLT.
:::
