---
id: l4d2-plugins
title: "Left 4 Dead 2: Installera plugins på din egen server"
description: "Upptäck hur du anpassar din spelserver med Sourcemod och Metamod för att förbättra funktioner och hantering → Lär dig mer nu"
...
När ovanstående steg är klara kan du fortsätta med installationen. Ladda upp filerna till din server via FTP med en FTP-klient. Om du är osäker på hur FTP fungerar, kolla in guiden: [Åtkomst via FTP](gameserver-ftpaccess.md)
