...
title: "Hytale: Automatiska Servermeddelanden – Håll dina spelare uppdaterade om nyheter, sociala länkar och mer!"
...
Med **Schemalagda Uppgifter** kan servermeddelanden skickas automatiskt i **Hytale**-chatten genom att köra fördefinierade kommandon på ett återkommande schema.
