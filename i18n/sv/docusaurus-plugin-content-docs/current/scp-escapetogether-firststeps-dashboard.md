...
title: "SCP: Escape Together: Översikt Dashboard"
description: "Upptäck hur du effektivt hanterar och optimerar din SCP: Escape Together-server för bästa prestanda och kontroll → Lär dig mer nu"
...
:::warning
Hittar du ingen hjälp i informationen eller förstår du den inte? Oroa dig inte! Vi finns tillgängliga i supporten varje dag. Skapa bara en **[Ticket](https://zap-hosting.com/en/customer/support/)** och förklara ditt problem för oss. Vi kollar på det så snabbt som möjligt och hjälper dig att lösa problemet! :)
:::
...
Med **FTP Browser** får du all nödvändig information för att upprätta en anslutning till FTP-accessen. FTP-accessen ger dig direkt tillgång till filerna på din spelserver. Vi rekommenderar att använda ett externt FTP-program som **Filezilla** eller **WinSCP** för bästa användarupplevelse. Om du inte är bekant med hur man använder FTP kan du ta en titt på guiden [Åtkomst via FTP](gameserver-ftpaccess.md).
