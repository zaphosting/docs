...
title: "Icarus: Översikt över kontrollpanelen"
description: "Upptäck hur du effektivt hanterar din Icarus-server med en tydlig översikt över funktioner och alternativ → Lär dig mer nu"
...
**Kontrollpanelen** för din server är hjärtat i administrationen. Här presenteras all grundläggande och viktig information om din tjänst på ett tydligt sätt. Det inkluderar till exempel information om plats, status, IP: Port, använd minne, pågående spel, servernamn, karta och antalet tillgängliga platser. Dessutom visas även belastningen på CPU, minne och RAM.
