...
title: "Hurtworld: Översikt över kontrollpanelen"
description: "Upptäck hur du effektivt hanterar din Hurtworld-server med en tydlig översikt över funktioner och alternativ → Lär dig mer nu"
...
Här hittar du en översikt över driftstörningshistoriken för värdsystemet där din spelserver körs. Mer info och den senaste statusen för våra tjänster hittar du på vår nya [statussida](https://status.zap-hosting.com/).
...
Med editorn får du direkt tillgång till alla tillgängliga alternativ och kan finjustera dem. Perfekt för avancerade användare som vill ha full kontroll över serverinställningarna och vet exakt vilka ändringar de vill göra.
