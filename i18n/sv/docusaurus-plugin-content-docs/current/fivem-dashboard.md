---
id: fivem-dashboard
title: "FiveM: Översikt Dashboard"
description: "Upptäck hur du effektivt hanterar och optimerar din FIVE: FiveM-server med en tydlig, steg-för-steg administrationsöversikt → Lär dig mer nu"
...
:::info
Hjälper informationen inte eller förstår du den inte? Ingen fara! I så fall finns vi tillgängliga i supporten varje dag. Skapa bara en **[Ticket](https://zap-hosting.com/en/customer/support/)** och förklara ditt problem för oss. Vi kollar på det så snabbt som möjligt och hjälper dig att lösa problemet! :)
:::
...
Vill du schemalägga serveromstarter vid specifika tider? Restart-planeraren låter dig ställa in schemalagda automatiska omstarter av din spelserver. Med denna funktion kan du planera omstarter vid specifika tider eller med jämna mellanrum.
...
I avsnittet **Verktyg** i din navigationspanel hittar du flera underkategorier som hjälper dig att hantera din server. Dessa inkluderar **FTP Browser**, **Databaser** och **Backuper**. Nedan får du en detaljerad introduktion till dessa olika områden.
