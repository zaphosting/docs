...
title: "Colony Survival: Anslut till servern"
description: "Upptäck hur du smidigt ansluter till din Colony Survival-server och felsöker vanliga problem för en sömlös spelupplevelse → Läs mer nu"
...
För att ansluta till din server, öppna spelet och gå till **Multiplayer**. Där kan du söka efter din server med servernamnet. Välj din server och klicka på **Join**.
