...
title: "Empyrion: Vanliga problem"
description: "Upptäck hur du felsöker och löser vanliga problem med Empyrion-servrar för en smidig spelupplevelse → Läs mer nu"
...
Att servern inte syns kan bero på att initieringen inte slutfördes korrekt. Det kan till exempel bero på felaktig konfiguration eller korrupta filer. Mer info hittar du ofta i serverkonsolen eller loggfilerna. Utöver detta bör du kolla att inga felaktiga filterinställningar används i serverlistan som gör att servern inte visas.
...
Regelbundna backuper sparar dig mycket stress och oro. Skapa regelbundna backuper så att du alltid har en äldre version sparad om något skulle gå snett. Vi erbjuder en [backup-lösning](gameserver-backups.md) för våra Empyrion-servrar, där du kan göra manuella eller schemalagda automatiska backuper.
