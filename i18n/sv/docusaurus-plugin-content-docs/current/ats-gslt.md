---
id: ats-gslt
title: "American Truck Simulator: Skapa en GSLT (Steam Game Server Login Token)"
description: "Upptäck hur du säkrar och autentiserar dina dedikerade spelservrar med Steams Game Server Login Token för pålitlig offentlig listning och skydd → Läs mer"
...
När du är inloggad kan du skapa en ny token via formuläret på sidan. I fältet **App ID** anger du App ID `270880` som tillhör **American Truck Simulator**. Se till att ange rätt ID, eftersom token inte fungerar med fel värde.
...
Login-token behöver nu läggas till i din serverkonfiguration. Öppna din spelservers administrationsgränssnitt och gå till sektionen **Settings**. Klistra in token i fältet märkt **GSL Token** och spara.

![img](https://screensaver01.zap-hosting.com/index.php/s/tzJiT4nTZo2nWMz/preview)

:::info Driva flera American Truck Simulator-servrar
När du driver flera **American Truck Simulator**-servrar behöver du en GSLT för varje server. Det är <u>**inte**</u> möjligt att driva flera servrar med en och samma GSLT.
:::
