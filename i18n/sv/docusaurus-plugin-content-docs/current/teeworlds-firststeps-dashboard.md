...
title: "Teeworlds: Översikt över kontrollpanelen"
description: "Upptäck hur du effektivt hanterar och optimerar din Teeworlds-server med en tydlig, steg-för-steg administrationsguide → Lär dig mer nu"
...
Om vårt övervakningssystem upptäcker en generell driftstörning, meddelas våra tekniker automatiskt som tar hand om problemet så snart som möjligt.
...
Config-filredigeraren låter dig redigera konfigurationsfilerna direkt på webbplatsen på det klassiska sättet, utan förenklad vy. Detta ger dig möjlighet att anpassa serverinställningarna efter dina personliga preferenser.
...
Med **FTP Browser** får du all nödvändig info för att ansluta till FTP-accessen. FTP-accessen ger dig direkt tillgång till filerna på din spelserver. Vi rekommenderar att använda ett externt FTP-program som **FileZilla** eller **WinSCP** för bästa användarupplevelse. Om du är osäker på hur FTP fungerar, kolla gärna vår guide [FTP Access](gameserver-ftpaccess.md) som kan hjälpa dig.
