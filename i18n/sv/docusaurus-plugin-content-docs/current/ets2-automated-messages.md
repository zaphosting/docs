...
title: "Euro Truck Simulator 2: Automatiska Servermeddelanden – Håll dina spelare uppdaterade om nyheter, sociala länkar och mer!"
...
Med hjälp av **Schemalagda Uppgifter** kan servermeddelanden skickas automatiskt in i **Euro Truck Simulator 2** chatt genom att köra fördefinierade kommandon på ett återkommande schema.
