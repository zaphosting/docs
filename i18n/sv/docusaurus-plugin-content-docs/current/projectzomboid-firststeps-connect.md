...
title: "Project Zomboid: Anslut till servern"
description: "Upptäck hur du smidigt och säkert ansluter till din Project Zomboid-server med viktiga tips och steg → Lär dig mer nu"
...
Du behöver all relevant information för att ansluta till din server. Information om din server hittar du på kontrollpanelen för din spelserver. Viktig info inkluderar:
...
För att ansluta till din server via den inbyggda serverbläddraren i spelet, öppna spelet och gå till **Join**. När du är i serverlistan, fyll i din serverinformation i fälten Favoritnamn, IP-adress och Port. Du måste även ange ditt kontonamn och lösenord. Klicka på **Add** för att lägga till servern. 
