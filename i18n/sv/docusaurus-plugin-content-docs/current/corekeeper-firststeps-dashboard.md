...
title: "Core Keeper: Översikt av Kontrollpanelen"
...
Efter att ha gått igenom den här guiden kommer du enkelt kunna hantera din server effektivt och snabbt hitta alla nödvändiga inställningar och funktioner. Här får du en strukturerad översikt som hjälper dig steg för steg att bekanta dig med serveradministrationen och utöka din kunskap på ett målmedvetet sätt. På så vis kan du säkerställa att din **Core Keeper-server** är optimalt anpassad efter dina behov och att du får ut maximalt av de tillgängliga möjligheterna.

<YouTube videoId="h1PJVBtIbnw" imageSrc="https://screensaver01.zap-hosting.com/index.php/s/WCMiqBedR6tiAWR/preview" title="Sätt upp Core Keeper-server på bara EN MINUT!" description="Känns det lättare att förstå när du ser saker i praktiken? Vi fixar det! Kolla in vår video som bryter ner allt för dig. Oavsett om du har bråttom eller bara föredrar att ta in info på det mest engagerande sättet!"/>
...
Var din server tillfälligt offline och du vet inte varför? Kollade du i händelseloggen och loggfilerna utan resultat? Orsaken kan ligga i värdsystemet där din server körs, inte direkt i din server.
...
Här hittar du en översikt över driftstörningar i värdsystemet där din spelserver körs. Mer info och senaste status hittar du på vår nya [statussida](https://status.zap-hosting.com/).

## Inställningar

I avsnittet **Inställningar** hittar du alla sidor för att konfigurera din server. De tillgängliga inställningarna listas i detalj nedan.

### Inställningar

Under inställningar finns en översikt över de vanligaste inställningsalternativen för din server, inklusive korta förklaringar. Den här sidan rekommenderas särskilt för nybörjare inom serveradministration.
...
Config Editor låter dig redigera konfigurationsfiler direkt på webbplatsen i klassisk vy, utan förenklingar. Här kan du anpassa serverns inställningar efter dina personliga preferenser.
...
Under **Spel** kan du alltid byta spelvariant på ditt befintliga spel eller installera ett annat spel. Spel med samma slotpris kan väljas direkt under **Tillgängliga Spel**. För andra spel krävs först en justering av slotpriset. Mer info finns i guiden [Spelbyte](  - gameserver-corekeeper-gameswitch.md).
...
Med **FTP Browser** får du all info du behöver för att ansluta till FTP. FTP-åtkomst ger dig direkt tillgång till filerna på din spelserver. Vi rekommenderar att använda ett externt FTP-program som **FileZilla** eller **WinSCP** för bästa användarupplevelse. Om du är ny på FTP kan guiden [Åtkomst via FTP](  - gameserver-corekeeper-ftpaccess.md) vara till hjälp.
