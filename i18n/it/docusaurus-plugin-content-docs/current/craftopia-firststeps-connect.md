...
title: "Craftopia: Connettiti al server"
description: "Scopri come connetterti al tuo server Craftopia senza intoppi e risolvi i problemi comuni per un'esperienza di gioco fluida → Scopri di più ora"
...
Per connetterti al tuo server, apri il gioco e vai su **Multiplayer** nel menu principale. Da lì, clicca su **Join via IP**. Inserisci l’indirizzo IP e la porta del tuo server e clicca su **Start**.
