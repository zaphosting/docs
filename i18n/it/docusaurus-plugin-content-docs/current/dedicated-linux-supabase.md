...
title: "Server Dedicato: Configura Supabase su Linux"
description: "Scopri come installare e configurare Supabase in self-hosting per creare una potente piattaforma Postgres open-source → Scopri di più ora"
...
Stai pensando di ospitare questo servizio in autonomia? Ti guideremo passo passo su come configurarlo e installarlo, con tutto quello che devi sapere.
...
**Sistema Operativo:** Ultima versione di Ubuntu/Debian che supporti Docker 2
...
Supabase verrà eseguito tramite container Docker, quindi Docker deve essere installato. Usa questi comandi:
...
Clona il repository Supabase, crea una cartella dedicata al progetto e copia dentro i file Docker e il file di esempio per l’ambiente.
...
Hai domande specifiche non trattate qui? Per qualsiasi dubbio o supporto, il nostro team è sempre disponibile ogni giorno per darti una mano! 🙂