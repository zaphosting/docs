---
id: csgo-gslt
title: "CS:GO: Crea un GSLT (Steam Game Server Login Token)"
...
Una volta loggato, puoi creare un nuovo token usando il modulo sulla pagina. Nel campo **App ID**, inserisci l’App ID `4465480` che corrisponde a **CS:GO**. Assicurati di inserire l’ID corretto, altrimenti il token non funzionerà.
...
Ora devi aggiungere il token alla configurazione del tuo server. Per farlo, apri l’interfaccia di gestione del tuo game server e vai alla sezione **Settings**. Inserisci il token nel campo chiamato **GSL Token** e salva.

![img](https://screensaver01.zap-hosting.com/index.php/s/tzJiT4nTZo2nWMz/preview)

:::info Gestire più server CS:GO
Se gestisci più server **CS:GO**, ti serve un GSLT per ciascun server. <u>**Non**</u> è possibile usare un singolo GSLT per più server contemporaneamente.
:::
