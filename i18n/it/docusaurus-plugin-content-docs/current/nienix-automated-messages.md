...
title: "Nienix: Messaggi automatici del server - Tieni i tuoi giocatori aggiornati su news, link social e altro!"
...
Usando le **Attività Programmate**, i messaggi del server possono essere inviati automaticamente nella chat in-game di **Nienix** eseguendo comandi predefiniti a intervalli ricorrenti.
...
Poi puoi definire ogni quanto inviare il messaggio, ad esempio ogni pochi minuti, ogni ora o a orari specifici della giornata. Per istruzioni dettagliate sulle attività programmate, dai un’occhiata alla guida [Attività programmate](gameserver-scheduled-tasks.md).
