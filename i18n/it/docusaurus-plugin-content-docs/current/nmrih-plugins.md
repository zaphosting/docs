---
id: nmrih-plugins
title: "No More Room In Hell: Installa plugin sul tuo server"
...
Una volta che Sourcemod e Metamod sono installati e funzionano correttamente, puoi iniziare ad aggiungere plugin. Scarica i plugin che vuoi installare sul tuo server da [Sourcemod](https://sourcemod.net/), dove trovi una vasta e sempre aggiornata collezione pubblicata nel tempo. Per ogni plugin, assicurati di prendere il file .smx corrispondente.

### Installazione

Dopo aver scaricato i plugin desiderati, puoi procedere con l’installazione. Carica i file via FTP nella cartella:
