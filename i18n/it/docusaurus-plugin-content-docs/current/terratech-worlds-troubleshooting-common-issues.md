...
title: "Terratech Worlds: Problemi comuni"
description: "Scopri come risolvere i problemi più comuni del server Terratech Worlds per un’esperienza di gioco senza intoppi → Scopri di più ora"
...
Impostazioni errate o mal regolate possono far usare troppe risorse e causare lag o stuttering. Assicurati che i valori di configurazione siano quelli consigliati per il tuo gioco e la dimensione del server. Controlla e aggiusta se serve per mantenere il server il più efficiente possibile.
...
Backup regolari evitano un sacco di stress e preoccupazioni. Crea backup frequenti per essere sicuro che in caso di problemi tu abbia sempre una versione precedente funzionante. Offriamo una [soluzione di backup](gameserver-backups.md) per i server Terratech Worlds, che puoi usare per creare backup manuali o automatici programmati.
