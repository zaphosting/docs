...
Qui trovi una panoramica delle opzioni di configurazione più comuni per il tuo server, con una breve spiegazione. La pagina impostazioni è consigliata soprattutto ai nuovi arrivati nell’amministrazione server.
...
Con le impostazioni DNS di ZAP puoi creare indirizzi facili da ricordare per il tuo servizio. Puoi usare un sottodominio di uno dei nostri domini o creare una voce DNS sui tuoi domini per avere un indirizzo più personale e riconoscibile.
...
Oltre ai nostri server di gioco, offriamo anche 10 database inclusi. Questi sono necessari, ad esempio, quando devi salvare dati in un database. In **Database** puoi creare un database e vedere le credenziali di accesso. Puoi anche attivare i backup e importare backup esistenti.
...
Nelle impostazioni puoi scegliere se creare backup automatici, con frequenza giornaliera o settimanale. Puoi anche decidere se eliminare i backup più vecchi quando lo spazio di archiviazione si riduce.
