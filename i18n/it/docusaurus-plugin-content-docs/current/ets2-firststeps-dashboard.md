...
title: "Euro Truck Simulator 2: Panoramica del Dashboard"
description: "Scopri come gestire e ottimizzare al meglio il tuo server Euro Truck Simulator 2 per massime prestazioni e controllo → Scopri di più ora"
...
Sotto **Giochi** puoi sempre cambiare la variante di gioco del tuo gioco esistente o installarne un altro. I giochi con lo stesso prezzo per slot si possono selezionare direttamente sotto **Giochi Disponibili**. Per tutti gli altri giochi serve prima un adeguamento del prezzo per slot. Maggiori info nel tutorial [Cambio Gioco](gameserver-gameswitch.md).
...
Nelle impostazioni puoi scegliere se creare backup automatici e se farli giornalieri o settimanali. Puoi anche decidere se eliminare i backup più vecchi quando lo spazio disponibile si riduce.
