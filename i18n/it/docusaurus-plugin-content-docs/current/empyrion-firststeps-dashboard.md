...
description: "Scopri come gestire al meglio il tuo server Empyrion e ottimizzare le impostazioni per le migliori prestazioni → Scopri di più ora"
...
Vuoi programmare riavvii del server a orari specifici? Il Pianificatore Riavvii ti permette di impostare riavvii automatici programmati del server di gioco. Puoi scegliere orari specifici o intervalli regolari.
...
Oltre ai server di gioco, offriamo anche 10 database inclusi. Questi sono necessari, per esempio, quando i dati devono essere salvati in un database. In **Database** puoi creare un database e vedere le credenziali di accesso. Puoi anche attivare i backup e importare backup di database esistenti.
...
Nelle impostazioni puoi scegliere se i backup devono essere automatici e se farli giornalieri o settimanali. Puoi anche decidere se eliminare i backup più vecchi quando lo spazio di archiviazione è limitato.

![](https://screensaver01.zap-hosting.com/index.php/s/nm9za5LTMEcNsga/preview)

Per i nostri server di gioco offriamo di default 10 GB di spazio per i backup sul server di archiviazione. Se ti serve più spazio, puoi fare un upgrade a pagamento. Così hai sempre abbastanza spazio per i backup e puoi accedere anche a quelli più vecchi.
