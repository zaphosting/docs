...
title: "Empyrion: Panoramica del Dashboard"
description: "Scopri come gestire al meglio il tuo server Empyrion e ottimizzare le sue impostazioni per le migliori prestazioni → Scopri di più ora"
...
La **Console Live** ti offre una vista in tempo reale di tutti gli eventi attuali sul tuo server. Qui puoi vedere info sulle attività dei giocatori, messaggi di errore o di sistema. Questa panoramica ti permette di capire cosa succede sul server e di individuare problemi in anticipo.
...
Con l’editor hai accesso diretto a tutte le opzioni e puoi personalizzarle al dettaglio. Utile soprattutto per utenti avanzati che vogliono il pieno controllo sulle impostazioni e sanno esattamente cosa modificare.
...
Con le impostazioni DNS di ZAP puoi creare indirizzi facili da ricordare per il tuo servizio. Puoi usare un sottodominio di uno dei nostri domini oppure creare una voce DNS sul tuo dominio, così hai un indirizzo più personale e riconoscibile.
...
Con l’**FTP Browser** trovi tutte le info per connetterti via FTP. L’accesso FTP ti dà accesso diretto ai file del tuo server di gioco. Consigliamo di usare un client FTP esterno come **Filezilla** o **WinSCP** per un’esperienza ottimale. Se non sai come usare FTP, dai un’occhiata alla guida [Accesso via FTP](gameserver-ftpaccess.md).

![](https://screensaver01.zap-hosting.com/index.php/s/sX85i9HyzR9wmAM/preview)

**FileZilla:** FileZilla è probabilmente il client FTP più semplice e conosciuto. Basta installarlo, avviarlo e inserire in alto i dati di accesso che trovi qui sopra. Con un clic su "Connetti" sei subito dentro al server e puoi gestire i file.
