...
title: "[Game]: Messaggi automatici del server - Tieni i tuoi giocatori aggiornati su news, link social e altro!"
...
Usando le **Attività Programmate**, i messaggi del server possono essere inviati automaticamente nella chat in-game di **[Game]** eseguendo comandi predefiniti a intervalli ricorrenti.
...
Poi puoi definire ogni quanto inviare il messaggio, ad esempio ogni pochi minuti, ogni ora o in orari specifici della giornata. Per istruzioni dettagliate su come creare attività programmate, dai un’occhiata alla guida [Attività programmate](gameserver-scheduled-tasks.md).
