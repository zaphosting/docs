...
Ti serviranno tutte le informazioni rilevanti per connetterti al tuo server. Puoi trovare i dati del tuo server nel pannello web del tuo game server, nella dashboard. Le info importanti includono:
...
Per connetterti al tuo server, apri il gioco e vai su **Multiplayer** nel menu principale. Poi clicca su **Aggiungi Server** e inserisci un nome, l’indirizzo IP e la porta del tuo server. Conferma con il pulsante **Aggiungi**. 
