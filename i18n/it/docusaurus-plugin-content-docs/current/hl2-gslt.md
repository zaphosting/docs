---
id: hl2-gslt
title: "Half-Life 2: Crea un GSLT (Steam Game Server Login Token)"
...
Una volta loggato, puoi creare un nuovo token usando il modulo sulla pagina. Nel campo **App ID**, inserisci l’App ID `320` che corrisponde a **Half-Life 2**. Assicurati di inserire l’ID corretto, altrimenti il token non funzionerà.
...
:::info Gestire più server Half-Life 2
Se gestisci più server **Half-Life 2**, ti serve un GSLT per ciascun server. <u>**Non**</u> è possibile usare un singolo GSLT per più server contemporaneamente.
:::
