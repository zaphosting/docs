...
description: "Scopri come gestire e ottimizzare il tuo server SCUM in modo efficiente con una panoramica chiara delle funzionalità e dei controlli chiave → Scopri di più ora"
...
Qui trovi una panoramica delle opzioni di configurazione più comuni per il tuo server, con una breve spiegazione. La pagina impostazioni è particolarmente consigliata ai nuovi utenti nell’amministrazione server.
...
Nelle impostazioni puoi decidere se fare backup automatici e se farli giornalmente o settimanalmente. Puoi anche scegliere se eliminare i backup più vecchi quando lo spazio disponibile si riduce.
