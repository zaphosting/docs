...
title: "The Bus: Messaggi automatici del server - Tieni i tuoi giocatori aggiornati su news, link social e altro!"
...
Usando le **Attività Programmate**, i messaggi del server possono essere inviati automaticamente nella chat in-game di **The Bus** eseguendo comandi predefiniti a intervalli ricorrenti.
...
Una volta configurata, l’attività gira automaticamente in background e mostra il messaggio a tutti i giocatori connessi. Così si garantisce una comunicazione costante senza dover avere lo staff sempre online.
...
Poi puoi definire ogni quanto inviare il messaggio, ad esempio ogni pochi minuti, ogni ora o a orari specifici della giornata. Per istruzioni dettagliate sulla creazione di attività programmate, dai un’occhiata alla guida [Attività programmate](gameserver-scheduled-tasks.md).
...
I messaggi automatici sono un modo affidabile per tenere i giocatori informati e coinvolti senza fatica manuale. Usando le attività programmate per eseguire comandi messaggio, gli admin possono garantire comunicazioni costanti su tutto il server.
