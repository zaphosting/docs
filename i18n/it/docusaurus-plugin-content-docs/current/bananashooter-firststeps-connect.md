...
Per connetterti al tuo server, apri il gioco e vai su **Multiplayer**. Da lì, scegli il **Community Server Browser** e cerca il tuo server usando il nome del server.
