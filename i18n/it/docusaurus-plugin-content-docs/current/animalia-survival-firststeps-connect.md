...
Per connetterti al tuo server tramite il server browser in gioco, apri il server browser dal menu principale. Clicca su **Multiplayer**, cerca il tuo server usando il nome nella lista. Seleziona il server e clicca su **Connetti**. Poi scegli uno slot e seleziona un animale per iniziare.
