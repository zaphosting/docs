...
title: "Don't Starve Together: Panoramica del Dashboard"
description: "Scopri come gestire al meglio il tuo server Don't Starve Together e ottimizzare le impostazioni per la migliore esperienza di gioco → Scopri di più ora"
...
Qui trovi una panoramica delle impostazioni più comuni per il tuo server, con una breve spiegazione. La pagina impostazioni è particolarmente consigliata ai nuovi arrivati nell’amministrazione server.
...
Con l’editor hai accesso diretto a tutte le opzioni disponibili e puoi modificarle con precisione. Perfetto per utenti avanzati che vogliono il controllo totale sulle impostazioni e sanno esattamente cosa cambiare.
...
Crea attività programmate che si eseguono automaticamente a orari definiti per automatizzare processi sul server. Puoi scegliere se farle eseguire una volta o ripetutamente. Le attività supportate includono avviare, fermare o riavviare servizi, riavviare il server se online, creare backup o eseguire comandi personalizzati.

![](https://screensaver01.zap-hosting.com/index.php/s/P6DeWiRC3tDqG2z/preview)

### Pianificatore Riavvii

Vuoi programmare riavvii del server a orari specifici? Il Pianificatore Riavvii ti permette di impostare riavvii automatici programmati. Puoi scegliere orari precisi o intervalli regolari.
...
Con l’**FTP Browser** ottieni tutte le info necessarie per connetterti via FTP. L’accesso FTP ti dà accesso diretto ai file del tuo server di gioco. Ti consigliamo di usare un programma FTP esterno come **Filezilla** o **WinSCP** per un’esperienza ottimale. Se non sai come usare FTP, dai un’occhiata alla guida [Accesso via FTP](gameserver-ftpaccess.md).
...
Oltre ai nostri server di gioco, offriamo anche 10 database inclusi. Questi sono necessari, ad esempio, quando devi salvare dati in un database. In **Database** puoi crearne uno e vedere le credenziali di accesso. Puoi anche attivare i backup e importare backup di database esistenti.
