---
id: dods-gslt
title: "Day of Defeat: Source: Crea un GSLT (Steam Game Server Login Token)"
description: "Scopri come autenticare e proteggere i tuoi server di gioco dedicati con il Game Server Login Token di Steam per maggiore visibilità e sicurezza → Scopri di più ora"
...
Una volta loggato, puoi creare un nuovo token usando il modulo sulla pagina. Nel campo **App ID**, inserisci l’ID `300` che corrisponde a **Day of Defeat: Source**. Assicurati di inserire l’ID corretto, altrimenti il token non funzionerà.
...
Ora devi aggiungere il token di login alla configurazione del server. Apri l’interfaccia di gestione del tuo game server e vai alla sezione **Settings**. Inserisci il token nel campo chiamato **GSL Token** e salva.

![img](https://screensaver01.zap-hosting.com/index.php/s/tzJiT4nTZo2nWMz/preview)

:::info Gestire più server Day of Defeat: Source
Se gestisci più server **Day of Defeat: Source**, ti serve un GSLT per ciascun server. <u>**Non**</u> è possibile usare un singolo GSLT per più server contemporaneamente.
:::
