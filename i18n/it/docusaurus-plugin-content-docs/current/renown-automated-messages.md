...
title: "Renown: Messaggi automatici del server - Tieni i tuoi giocatori aggiornati su news, link social e altro!"
...
Usando le **Attività Programmate**, i messaggi del server possono essere inviati automaticamente nella chat in-game di **Renown** eseguendo comandi predefiniti a intervalli ricorrenti.
...
Poi definisci ogni quanto vuoi che il messaggio venga inviato, ad esempio ogni pochi minuti, ogni ora o a orari specifici. Per istruzioni dettagliate sulla creazione di attività programmate, dai un’occhiata alla guida [Attività programmate](gameserver-scheduled-tasks.md).
...
I messaggi automatici del server sono un modo affidabile per tenere i giocatori informati e coinvolti senza sforzo manuale. Usando attività programmate per eseguire comandi messaggio, gli admin possono garantire comunicazioni costanti su tutto il server.
