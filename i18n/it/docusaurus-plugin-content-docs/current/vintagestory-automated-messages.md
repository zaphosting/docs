...
title: "Vintage Story: Messaggi automatici del server - Tieni i tuoi giocatori aggiornati su news, link social e altro!"
...
Usando le **Attività Programmate**, i messaggi del server possono essere inviati automaticamente nella chat in-game di **Vintage Story** eseguendo comandi predefiniti a intervalli ricorrenti.
...
Una volta configurata, l’attività gira automaticamente in background e mostra il messaggio a tutti i giocatori connessi. Così la comunicazione resta costante senza che lo staff debba essere online.
...
Poi puoi definire ogni quanto inviare il messaggio, ad esempio ogni pochi minuti, ogni ora o a orari specifici. Per istruzioni dettagliate sulla creazione di attività programmate, dai un’occhiata alla guida [Attività programmate](gameserver-scheduled-tasks.md).
...
Le attività programmate ti danno pieno controllo su quando e quanto spesso i messaggi appaiono. Alcuni casi d’uso comuni sono:
...
L’intervallo si può modificare in qualsiasi momento senza riavviare il server, così puoi adattarti facilmente man mano che il tuo server cresce.
...
I messaggi automatici del server sono un modo affidabile per tenere i giocatori informati e coinvolti senza sforzo manuale. Usando attività programmate per eseguire comandi messaggio, gli admin possono garantire una comunicazione costante su tutto il server.
