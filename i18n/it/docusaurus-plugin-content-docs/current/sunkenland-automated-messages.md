...
title: "Sunkenland: Messaggi automatici del server - Tieni i tuoi giocatori aggiornati su news, link social e altro!"
...
Usando le **Attività Programmate**, i messaggi del server possono essere inviati automaticamente nella chat in-game di **Sunkenland** eseguendo comandi predefiniti a intervalli ricorrenti.
...
Poi puoi definire ogni quanto il messaggio deve essere inviato, ad esempio ogni pochi minuti, ogni ora o in orari specifici della giornata. Per istruzioni dettagliate sulla creazione di attività programmate, consulta la guida [Attività programmate](gameserver-scheduled-tasks.md).
...
- Ricordare ai giocatori i link di Discord o del sito

L’intervallo può essere modificato in qualsiasi momento senza riavviare il server, così puoi adattarti facilmente man mano che il tuo server cresce.
...
Una volta configurati, i messaggi automatici girano in modo indipendente e si possono riutilizzare facilmente modificando solo il comando e il testo specifico del gioco.
