---
id: l4d2-becomeadmin
title: "Left 4 Dead 2: Diventa admin"
...
Per ottenere il tuo SteamID tramite un sito, apri prima il tuo profilo Steam e clicca col tasto destro in qualsiasi punto della pagina per copiare l’URL del profilo. Poi incolla questo URL in uno dei seguenti siti:
...
In alternativa, puoi recuperare il tuo SteamID direttamente in gioco tramite la console. Avvia il gioco, connettiti al server, apri la console e digita il comando:
