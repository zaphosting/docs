...
title: "Server Dedicato: Configura Standard Notes su Linux"
...
Una guida completa sull’installazione e l’uso di Docker è disponibile nel nostro tutorial [Docker](vserver-linux-docker.md).
...
Questo file contiene solo le variabili minime necessarie per una configurazione funzionante. La lista completa delle variabili attualmente usate la trovi qui: [docker-entrypoint.sh](https://github.com/standardnotes/server/blob/main/docker/docker-entrypoint.sh)
