...
description: "Entdecke, wie du deinen Server mit trusted Plugins erweiterst und personalisierst für mehr Features und Customizing → Jetzt mehr erfahren"
...
Plugins ermöglichen es dir, deinen Server noch mehr zu erweitern und individuell anzupassen. Im Folgenden zeigen wir dir, wo du die beliebtesten Plugins findest und wie du sie einrichtest.
...
Plugins können zwar von verschiedenen Quellen geladen werden, wir empfehlen dir aber, bei trusted Plattformen wie dem offiziellen GitHub-Repo zu bleiben, da diese in der Regel am sichersten sind. Sei immer vorsichtig beim Hinzufügen von Plugins zu deinem Server – überprüfe die Quelle, check die Entwickler und verstehe genau, was das Plugin macht, bevor du es installierst.
...
Das war’s! Sobald du die Datei hast, kannst du mit den Installationsschritten weiter unten lernen, wie du die **.dll** auf deinem Server installierst.
...
Wenn du alle Schritte befolgt hast, solltest du dein Plugin erfolgreich installiert haben. Bei weiteren Fragen oder wenn du Hilfe brauchst, zögere nicht, unseren Support zu kontaktieren – wir sind täglich für dich da! 🙂
