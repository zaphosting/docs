...
title: "Outlaws of the Old West: Panoramica del Dashboard"
description: "Scopri come gestire e ottimizzare al meglio il tuo server Outlaws of the Old West per massime prestazioni e controllo → Scopri di più ora"
...
Oltre ai nostri prodotti game server, offriamo anche 10 database inclusi. Questi database servono, ad esempio, quando i dati devono essere salvati in un database. Sotto **Database** puoi crearne uno e vedere le credenziali di accesso. Hai anche l’opzione di attivare i backup e importare backup esistenti.

![img](https://screensaver01.zap-hosting.com/index.php/s/WFLwCbZSQfYjrmD/preview)

### Backup

Sotto **Backup** puoi creare backup manuali e automatici per il tuo server e il database associato. Così è più facile recuperare i dati in caso di problemi o perdita dati.

Nelle impostazioni puoi scegliere se creare backup automatici e se farlo giornalmente o settimanalmente. Inoltre, puoi decidere se eliminare i backup più vecchi quando lo spazio di archiviazione diventa limitato.
