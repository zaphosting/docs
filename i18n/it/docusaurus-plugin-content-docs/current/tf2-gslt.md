---
id: tf2-gslt
title: "Team Fortress 2: Crea un GSLT (Steam Game Server Login Token)"
description: "Scopri come autenticare il tuo server di gioco dedicato con un valido Steam Game Server Login Token per una corretta visualizzazione e protezione VAC → Scopri di più ora"
...
Una volta loggato, puoi creare un nuovo token usando il modulo sulla pagina. Nel campo **App ID**, inserisci l’App ID `440` che corrisponde a **Team Fortress 2**. Assicurati di inserire l’ID corretto, altrimenti il token non funzionerà.
...
Ora devi aggiungere il token di login alla configurazione del tuo server. Per farlo, apri l’interfaccia di gestione del tuo game server e vai nella sezione **Settings**. Inserisci il token nel campo chiamato **GSL Token** e salva.

![img](https://screensaver01.zap-hosting.com/index.php/s/tzJiT4nTZo2nWMz/preview)

:::info Gestire più server Team Fortress 2
Se gestisci più server **Team Fortress 2**, ti serve un GSLT per ciascun server. <u>**Non**</u> è possibile usare un singolo GSLT per più server contemporaneamente.
:::
