...
title: "Enshrouded: Panoramica del Dashboard"
description: "Scopri come gestire al meglio il tuo server Enshrouded con una panoramica chiara di funzioni e opzioni → Scopri di più ora"
...
Sei interessato a un **server Enshrouded** o ne possiedi già uno, ma ti manca ancora una panoramica completa dell’amministrazione e di dove trovare tutte le opzioni necessarie? Soprattutto all’inizio, può essere una sfida. Ma niente panico, qui sotto ti diamo una guida dettagliata all’amministrazione del tuo servizio, così avrai la miglior panoramica possibile. Dopo aver seguito questa guida, potrai gestire il tuo server in modo efficiente e trovare tutte le opzioni e funzioni necessarie in modo rapido e semplice. Qui avrai una panoramica strutturata che ti aiuterà passo dopo passo a familiarizzare con l’amministrazione del server e ad ampliare le tue conoscenze in modo mirato. Così potrai assicurarti che il tuo **server Enshrouded** sia ottimizzato per le tue esigenze e sfruttare al massimo tutte le opzioni disponibili.

<YouTube videoId="wgvfvQdtwN4" imageSrc="https://screensaver01.zap-hosting.com/index.php/s/tHLf63nL2FcGTFm/preview" title="Configura il server Enshrouded in un MINUTO!" description="Ti è più facile capire vedendo le cose in azione? Ci pensiamo noi! Immergiti nel nostro video che ti spiega tutto. Che tu sia di fretta o preferisca imparare nel modo più coinvolgente possibile!"/>

<InlineVoucher />

## Amministrazione Prodotto

Nella sezione **Amministrazione Prodotto** trovi tutte le pagine necessarie per gestire il tuo server. Qui sotto elenchiamo nel dettaglio le opzioni per la gestione del tuo server.
...
I messaggi di errore in particolare aiutano a identificare e capire meglio la causa di un problema. Spesso si riesce a scovare e risolvere la difficoltà dando un’occhiata mirata ai file di log.
...
La **Console Live** ti offre una vista in tempo reale di tutti gli eventi attuali sul tuo server. Qui puoi vedere informazioni sulle attività dei giocatori, messaggi di errore o di sistema. Questa panoramica ti permette di avere un quadro completo di cosa succede sul server e di individuare problemi in anticipo.
...
Per i nostri server di gioco forniamo di default 10 GB di spazio per backup sul server di storage. Se ti serve più spazio, puoi fare un upgrade a pagamento. Così hai sempre spazio a sufficienza per i backup e puoi accedere anche ai backup più vecchi.
