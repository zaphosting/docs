...
title: "Afterinfection: Connessione al server"
description: "Scopri come connetterti al tuo server Afterinfection in modo semplice e sicuro con consigli e indicazioni essenziali → Scopri di più ora"
...
## Introduzione
Non sai come connetterti al tuo server **Afterinfection** o cosa ti serve per iniziare? Nessun problema, ci pensiamo noi! Ti guideremo passo passo su tutto ciò che ti serve – dagli strumenti e informazioni necessarie fino al processo di connessione vero e proprio, con consigli chiave per garantirti un’esperienza fluida e senza intoppi. Segui la nostra guida e sarai connesso in un attimo!
...
Per connetterti al tuo server tramite il server browser in game, apri il gioco e vai su **Multiplayer**. Ora puoi cercare il tuo server nella lista server usando il nome del server.

![img](https://screensaver01.zap-hosting.com/index.php/s/yJpWzbfzD8jTSpc/download)

</TabItem>

<TabItem value="connect_solution_direct" label="Connessione Diretta (In game)">

Invece di cercare il server nella lista, puoi usare la connessione diretta sotto **Multiplayer** in basso a sinistra. Inserisci semplicemente l’indirizzo IP e la porta del tuo server e clicca su **Join**.
