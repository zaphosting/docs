...
Dai un’occhiata alla nostra guida [Installare Certbot](vserver-linux-certbot.md), che spiega come richiedere e rinnovare automaticamente i certificati SSL per i tuoi domini.
