...
title: "Terratech Worlds: Panoramica del Dashboard"
description: "Scopri come gestire e ottimizzare al meglio il tuo server TerraTech Worlds con una guida chiara e passo dopo passo → Scopri di più ora"
...
:::warning
L’uso del DDoS Manager è possibile solo se è stato prenotato un IP proprio o l’opzione "Panoramica DDoS Manager" come extra. Se questi componenti mancano nel tuo pacchetto attuale, puoi aggiungerli in qualsiasi momento con un upgrade.
:::
...
Con l’editor hai accesso diretto a tutte le opzioni disponibili e puoi modificarle con precisione. Utile soprattutto per utenti avanzati che vogliono il pieno controllo e sanno esattamente cosa cambiare.
...
Per i nostri prodotti server di gioco forniamo di default 10 GB di spazio per backup sul server di storage. Se ti serve più spazio, puoi fare un upgrade a pagamento. Così hai sempre spazio a sufficienza per i backup e puoi accedere anche ai backup più vecchi.
