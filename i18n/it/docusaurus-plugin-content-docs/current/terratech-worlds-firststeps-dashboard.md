...
In questa sezione trovi una panoramica della storia delle interruzioni del sistema host su cui gira il tuo server di gioco. Maggiori info e lo stato aggiornato del servizio sono disponibili sulla nostra nuova [pagina di status](https://status.zap-hosting.com/).
...
Qui trovi una panoramica delle opzioni di configurazione più comuni per il tuo server, con una breve spiegazione. La pagina impostazioni è consigliata soprattutto ai principianti nell’amministrazione server.
...
### Impostazioni DNS
Con le impostazioni DNS di ZAP puoi creare indirizzi facili da ricordare per il tuo servizio. Puoi usare un sottodominio di uno dei nostri domini oppure creare una voce DNS sui tuoi domini, così avrai un indirizzo più personale e riconoscibile.
![](https://screensaver01.zap-hosting.com/index.php/s/tM5FGTHRSbZA5rN/preview)

## Strumenti

Nella sezione **Strumenti** del pannello di navigazione trovi vari sottomenu che ti aiutano a gestire il server. Tra questi ci sono **FTP Browser**, **Database** e **Backup**. Qui sotto ti diamo una guida dettagliata su queste aree.
...
Oltre ai server di gioco, offriamo anche 10 database inclusi. Questi sono necessari, ad esempio, quando devi salvare dati in un database. Sotto **Database** puoi crearne uno e vedere le credenziali di accesso. Puoi anche attivare il backup e importare backup esistenti.
...
Nelle impostazioni puoi decidere se creare backup automatici e se farli giornalieri o settimanali. Puoi anche scegliere se eliminare i backup più vecchi quando lo spazio di archiviazione si riduce.

![](https://screensaver01.zap-hosting.com/index.php/s/nm9za5LTMEcNsga/preview)

Per i nostri server di gioco forniamo di default 10 GB di spazio per backup sul server di storage. Se ti serve più spazio, puoi fare un upgrade a pagamento. Così hai sempre spazio a sufficienza per i backup e puoi accedere anche a quelli più vecchi se serve.
