...
const siteConfig = {
    ...
    */
    ...
    copyright: `Copyright © ${new Date().getFullYear()} ZAP-Hosting.com. All Rights Reserved.`,
    ...
    scripts: [
        ...
        '/guides/js/code-block-buttons.js',
        '/guides/js/analytics.js',
    ],
