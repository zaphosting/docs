...
title: "Animalia Survival: Connect to the server"
description: Information about various ways on how to connect to your Animalia Survival server from ZAP-Hosting - ZAP-Hosting.com Documentation
...
To connect to your server via the in game server browser, open the server browser in the main menu. To do this click on **Multiplayer**, search for your server by using the server name in the list. Select the server and click on **Connect**. Then select a slot and choose an animal to start. 
