...
title: "Portal Knights: Connect to the server"
description: Information about various ways on how to connect to your Portal Knights server from ZAP-Hosting - ZAP-Hosting.com Documentation
...
![img](https://screensaver01.zap-hosting.com/index.php/s/E9ZydKWz73Bqx6f/preview)
...
Start the game to connect to your server. Navigate to **Join** and select the **Find Games** tab. Now click on **Add Server** and enter the IP address and port of your server. 
