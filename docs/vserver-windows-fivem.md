...
description: "Discover how to install and configure your own FiveM Dedicated Server on a VPS for seamless multiplayer gaming → Learn more now"
sidebar_label: FiveM
services:
  - vserver
---
...
If you want to use and install resources that require a database, you need an additional **database server**. There are various ways to set up such a server. In our [Install MySQL](vserver-windows-installmysql.md) guide, we show you how to install your own **database server** on your **VPS**.
