...
title: "ASTRONEER: Connect to the server"
description: "Discover how to connect to your ASTRONEER server smoothly and troubleshoot common issues for uninterrupted gameplay → Learn more now"
...
To connect to your server via the in game server browser, open the **server browser** in the main menu. Click on **Add Dedicated Server** in the server list to add your server. Enter the IP address and port of your server and add a name. Then click on **Add server**, select the added server and establish the connection. 
