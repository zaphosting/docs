...
description: Information about various ways on how to connect to your Empyrion server from ZAP-Hosting - ZAP-Hosting.com Documentation
...
Open the game to connect to your server. Call up the **server list** in the game and enter the IP address and port of the server in the **Direct IP and Port** field. Then click on the **Connect** button to establish the connection. 
