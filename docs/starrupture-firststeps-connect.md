...
title: "StarRupture: Connect to the server"
description: "Discover how to connect smoothly to your StarRupture server and troubleshoot common issues for a seamless gaming experience → Learn more now"
...
The connection to the server is established using the server **IP address** and **Port**. An optional password may also be required. To do this, click on **Join Game** in the main menu and click **Dedicated Server** in the bottom left. 

Enter the IP address and port of your server, as well as the password, provided one has been defined. To confirm and to establish the connection complete the process by pressing the **Confirm** button. 
