...
<YouTube videoId="9v3kF-ky6Ho" imageSrc="https://screensaver01.zap-hosting.com/index.php/s/MQdLKPJfwmABzZ6/preview" title="Setup Factorio server in just a MINUTE!" description="Feel like you understand better when you see things in action? We’ve got you! Dive into our video that breaks it all down for you. Whether you're in a rush or just prefer to soak up information in the most engaging way possible!"/>
...
![img](https://screensaver01.zap-hosting.com/index.php/s/KrWLzqE6D5qS925/preview)
...
![img](https://screensaver01.zap-hosting.com/index.php/s/Twnm4g7kK2YTxCL/preview)
...
In the **Settings** section of your navigation panel, you will find a number of sub-items that will help you manage your server. These include the **Settings**, **Configs**, **Games**, **Versions**, **Plugins** and the **Restart planner**. In the following you will get a detailed introduction to these different areas.
...
![img](https://screensaver01.zap-hosting.com/index.php/s/J8WCP2Xfwnb2JSY/preview)

Here you can make for example the following adjustments: 

- Basic settings: Create Savegame, Savegame, Rcon password
...
![img](https://screensaver01.zap-hosting.com/index.php/s/9yqLpLQ6FD6QdwK/preview)
...
![img](https://screensaver01.zap-hosting.com/index.php/s/g3f5ZkcqBgSpCzj/preview)
