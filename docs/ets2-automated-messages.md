...
title: "Euro Truck Simulator 2: Automated Server Messages - Keep your players informed about news, social links and more!"
...
Using **Scheduled Tasks**, server messages can be sent automatically into the **Euro Truck Simulator 2** in-game chat by executing predefined commands on a recurring schedule. 
