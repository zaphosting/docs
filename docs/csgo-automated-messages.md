...
title: "CS:GO: Automated Server Messages - Keep your players informed about news, social links and more!"
...
Using **Scheduled Tasks**, server messages can be sent automatically into the **CS:GO** in-game chat by executing predefined commands on a recurring schedule. 
