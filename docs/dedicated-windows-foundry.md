...
description: Information about setting up a Foundry Dedicated Server on a Windows Dedicated Server from ZAP-Hosting 
...
Do you have a Windows VPS or dedicated server and you want to install the Foundry Dedicated server service on it? You are in the right place. In this guide, we will explain the step by step process of installing this service on your server.
