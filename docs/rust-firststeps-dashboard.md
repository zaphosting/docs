...
![img](https://screensaver01.zap-hosting.com/index.php/s/qA8a4KYbeJaTcQD/preview)
...
| Guide            | Page                                                         |
| ---------------- | ------------------------------------------------------------ |
| Become Admin     | [View guide](rust-becomeadmin.md) |
| Connect via Rcon | [View guide](rust-connectrcon.md) |
| Admin commands   | [View guide](rust-commands.md) |
| Plugins install  | [View guide](rust-plugins.md) |
| Decay            | [View guide](rust-decay.md) |
...
![img](https://screensaver01.zap-hosting.com/index.php/s/Ymijoa34iNWEwLb/preview)

Here you can make for example the following adjustments: 

- Basic settings:Servername, Server Description, Server URL, Header Image, Map, Worldsize, Save Intervall, Companion, Rcon Password, Server tags, Web RCON, EAC anticheat, Hardcore
...
![img](https://screensaver01.zap-hosting.com/index.php/s/oxYF3tLpaa4Kz3W/preview)
