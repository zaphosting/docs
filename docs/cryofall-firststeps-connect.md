...
description: "Discover how to connect to your Cryofall server smoothly and troubleshoot common issues for a seamless gaming experience → Learn more now"
...
To connect to your server via the in game server browser, open the game. Once in game, click on **Play** and then **Multiplayer** top open the server list. Choose the community tab and search for your server using the server name. 
