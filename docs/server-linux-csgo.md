...
description: "Discover how to set up a CS:GO dedicated server on your Linux server for seamless gameplay hosting → Learn more now"
sidebar_label: "CS:GO"
services:
  - vserver
  - dedicated
...
By this stage, you have finished the setup for your CS:GO server. You can perform further server configuration by directing editing the launch file.
