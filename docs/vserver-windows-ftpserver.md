...
Once the setup file has been downloaded, you have to execute it. To do this, click on the previously downloaded file. The following window should open: ![](https://screensaver01.zap-hosting.com/index.php/s/Qi97fYbyoKDdsi3/preview)
