...
To connect to your server via the in game server browser, open the server browser by clicking on **Multiplayer** in the main menu. You can establish a connection in the server list either via the server name or through **direct connect** via the IP address and port of your server. 
