...
description: "Discover how to set up an Enshrouded Dedicated Server on your Windows VPS for seamless gameplay and control → Learn more now"
...
## Introduction
Do you have a Windows VPS and you want to install the Enshrouded Dedicated server service on it? You are in the right place. In this guide, we will explain the step by step process of installing this service on your server.
