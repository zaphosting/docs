...
To connect to your server via the in game server browser, open the server browser in the main menu. Once in the server list, click on **Custom Browser**. Use the **Search field** to search for your server using the name of your server. Select it and click on **Join Server**.
