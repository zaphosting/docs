...
description: "Discover how to connect seamlessly to your Motor Town server and enjoy uninterrupted gameplay → Learn more now"
...
Start the game and navigate to **Join** to open the server list. Use the search field to search for your server by the server name. Establish the connection by clicking on the **Connect** button.
