...
The latest version of Ubuntu is the [22.04](http://localhost:3000/guides/docs/dedicated-ubuntu) version. We recommend using the latest version for long-term projects.
