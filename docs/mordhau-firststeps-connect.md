...
title: "Mordhau: Connect to the server"
description: "Discover how to connect seamlessly to your Mordhau server and ensure a smooth gaming experience → Learn more now"
...
Start your game and select **Fight** from the main menu. Open the server browser and enter your server’s name in the search field on the right to find it quickly.
