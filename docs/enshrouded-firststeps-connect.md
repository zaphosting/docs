...
To connect to your server via the in game server browser, open the game. From there, click on **Play**, select **Join** in the play selection and then click on **Search for servername** on the right. A pop-up window will open where you have to type in the name of your server and then click on search. Your server should be displayed afterwards. 
