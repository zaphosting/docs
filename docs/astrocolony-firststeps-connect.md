...
description: "Information about various ways on how to connect to your Astro Colony server from ZAP-Hosting - ZAP-Hosting.com Documentation"
...
Start the game and navigate to **Multiplayer** to open the server list. Use the search field to search for your server by the server name. Establish the connection by clicking on the **Join** button.
