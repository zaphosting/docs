...
![img](https://screensaver01.zap-hosting.com/index.php/s/QnTA9xN2pMZ8gy8/preview)
...
| Guide                      | Page                                                         |
| -------------------------- | ------------------------------------------------------------ |
| Connect to the server      | [View guide](https://zap-hosting.com/guides/docs/en/scp_firststeps_connect/) |
| Become Admin               | [View guide](https://zap-hosting.com/guides/docs/en/scp_becomeadmin) |
| Add new roles              | [View guide](https://zap-hosting.com/guides/docs/en/scp_newroles) |
| Colored servername         | [View guide](https://zap-hosting.com/guides/docs/en/scp_colored_servername) |
...
![img](https://screensaver01.zap-hosting.com/index.php/s/ppexPoftgatx9TF/preview)

Here you can make for example the following adjustments: 

- Basic settings: Contact E-Mail, Server list, servername, server info
...
![img](https://screensaver01.zap-hosting.com/index.php/s/wfYPFfANbZC2Rc5/preview)
