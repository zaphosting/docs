...
description: "Discover how to connect seamlessly to your Assetto Corsa server and ensure a smooth gaming experience → Learn more now"
...
To connect to your server via the in game server browser, open the server browser in the main menu. Navigate to **Drive** and select **Online**. The server list opens, in which you can search for the server using the server name in the **search field**. 
