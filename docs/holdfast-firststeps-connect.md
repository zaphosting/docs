...
To connect to your server via the in game server browser, open the server browser in the main menu. Use the **search field** in the server list to search for your server using the name of your server. 
