...
title: "Insurgency: Sandstorm: Connect to the server"
description: "Information about various ways on how to connect to your Insurgency: Sandstorm server from ZAP-Hosting - ZAP-Hosting.com Documentation"
...
![img](https://screensaver01.zap-hosting.com/index.php/s/WTMqLnSK3cG9qaf/preview)
...
Start your game to connect to your server. Navigate to **Play** in the main menu and select the **Server browser**. In the server list, you can search for your server using the search field and the name of your server. 

![img](https://screensaver01.zap-hosting.com/index.php/s/pxFqH3fnkBxg7RF/download)

</TabItem>

<TabItem value="connect_solution_direct_ingame" label="Direct connect (In game)">

Start your game to connect to your server. Navigate to **Play** in the main menu and select the **Server browser**. Now click on **Connect to IP** at the bottom left and enter the IP address, port and password of your server.
