...
title: "No More Room In Hell: Automated Server Messages - Keep your players informed about news, social links and more!"
...
Using **Scheduled Tasks**, server messages can be sent automatically into the **No More Room In Hell** in-game chat by executing predefined commands on a recurring schedule. 
