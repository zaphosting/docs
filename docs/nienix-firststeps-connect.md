...
title: "Nienix: Connect to the server"
description: Information about various ways on how to connect to your Nienix server from ZAP-Hosting - ZAP-Hosting.com Documentation
...
![img](https://screensaver01.zap-hosting.com/index.php/s/FFoW7ADsneHrzJb/preview)
...
To connect to your server open the game and navigate to **Join Game**. Once you are there  search for your server using the server name in the server list. Click **Connect** to establish the connection. 

![img](https://screensaver01.zap-hosting.com/index.php/s/9ipNTGpzRwcSjLq/download)

</TabItem>

<TabItem value="connect_solution_direct_ingame" label="Direct connect (In game)" default>

Instead of using the server list, you can also establish a connection via the direct connection. To do this, enter the IP address and port of your server and add the server. 
