...
description: Information about various ways on how to connect to your SCUM server from ZAP-Hosting - ZAP-Hosting.com Documentation
...
To connect to your server, you must open the game. Once in the game, call up the **Multi Play** menu item. Click on the **IP:Port** field at the bottom left and enter the information for your game server. Confirm the entry with the `Enter` key
