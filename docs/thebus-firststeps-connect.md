...
<Tabs>
    <TabItem value="connect_solution_server_browser_ingame" label="Multiplayer (In game)" default>

To connect to your server, start your game and go to the **Multiplayer** section in the main menu. In the server list, click **Add server** and enter your  IP address and port of your server. Confirm your input by clicking the **OK** button.
