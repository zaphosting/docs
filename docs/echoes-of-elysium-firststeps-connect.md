...
title: "Echoes of Elysium: Connect to the server"
description: "Discover how to connect smoothly to your Echoes of Elysium server and troubleshoot common issues for a seamless gaming experience → Learn more now"
...
The connection to the server is established using the server **IP address** and **Port**. An optional password may also be required. To do this, click on **Join** in the main menu and click **Join IP address** at the bottom of the server list. Enter the IP address, port and optionally the password of your server. 
