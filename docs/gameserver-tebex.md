...
Choose a game which is supported by Tebex and add it to your game server. Click on
...
the connection from ZAP to your Tebex store. You can then see that the connection was successfull:
