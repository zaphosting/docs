...
Start the game and navigate to **Play**. Select the **Direct connect** option and fill in the IP address and port of your server. Afterwards, establish the connection by clicking on the **Connect** button.
