...
description: "Information about various ways on how to connect to your Beasts of Bermuda server from ZAP-Hosting"
...
To connect to your server via the in game server browser, open the server browser in the main menu. To do this, click on **Multiplayer** and search for your server using the server name in the server list.
