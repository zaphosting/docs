...
description: Information about various ways on how to connect to your Afterinfection server from ZAP-Hosting - ZAP-Hosting.com Documentation
...
To connect to your server via the in game server browser, open the game and navigate to **Multiplayer**. You can now search for your server in the server list using the server name. 
...
Instead of searching for your server in the server list, you can also use the direct connection under **Multiplayer** at the bottom left. Simply enter the IP address and port of your server and click on **Join**.
