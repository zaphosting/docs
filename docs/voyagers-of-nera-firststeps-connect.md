...
description: "Discover how to connect smoothly to your Voyagers of Nera server and troubleshoot common issues for a seamless gaming experience → Learn more now"
...
To connect to your server, you must open the game. Once in the game, call up the **Browse Game** menu item. In the server list, use the search field to search for your server via the server name. 
