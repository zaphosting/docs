...
title: "Factorio: Connect to the server"
description: "Discover how to connect to your Factorio server smoothly and troubleshoot common issues for a seamless gaming experience → Learn more now"
...
Open the game to connect to your server. In the game, navigate to **Multiplayer** and then to **Connect to address**. Once there, enter the IP address and port of your server in the field. Confirm the input and establish the connection by clicking on the **Connect** button.  
