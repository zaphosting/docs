...
Congratulations, you have successfully installed and configured Plesk! As the next step, we highly recommend setting up a domain and SSL certificate for your Apache web server to ensure that data is transmitted securely and make it easier to access. Please view our [Certbot guide](vserver-linux-certbot.md#webroot-plugin) with a focus on the **Apache Plugin** and follow the interactive setup to setup a certificate for your chosen domain.
