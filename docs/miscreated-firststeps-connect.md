...
title: "Miscreated: Connect to the server"
description: "Discover how to connect to your Miscreated server smoothly and troubleshoot common issues for a seamless gaming experience → Learn more now"
...
To connect to your server via the in game server browser, open the server browser in the main menu. To do this, click on **Join Server** . Once you are there, search for your server using your server name and then click on **Join Server**.
