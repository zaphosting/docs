...
Finally, you can change the language of your server which is displayed on your server's server list page. We have a [guide](fivem-locale.md) for setting localisation. This can be done through your game server's webinterface, or by setting a tag:
