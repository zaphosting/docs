...
description: Information about setting up an Avorion Dedicated Server on a Windows Dedicated Server from ZAP-Hosting - ZAP-Hosting.com documentation
...
Do you have a Windows VPS or root server and you want to install the Avorion Dedicated server service on it? You are in the right place. In this guide, we will explain the step by step process of installing this service on your server.
