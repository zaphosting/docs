...
description: Information about various ways on how to connect to your DeadPoly server from ZAP-Hosting - ZAP-Hosting.com Documentation
...
Start the game to connect to your server. Click on **Play** in the game and then navigate to **Find Game**. You will now see the server list where you can search for your server by its name. Select your server and click on **Connect** to establish the connection.
...
Start the game to connect to your server. Click on **Play** in the game and then navigate to the **IP:Port** field. Enter the IP address and port of your server there and then click on the **Connect** button.
