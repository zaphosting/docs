...
title: "Path of Titans: Dashboard Overview"
description: Information about the dashboard of a Path of Titans server from ZAP-Hosting - ZAP-Hosting.com documentation
...
![img](https://screensaver01.zap-hosting.com/index.php/s/Zt37zeEyxexNQSX/preview)
...
![img](https://screensaver01.zap-hosting.com/index.php/s/k4EZAWfa5gBQEXJ/preview)



Here you can make for example the following adjustments: 

- Basic settings: Auth-Token, Server Name, Server Password, Discord Server Invite, EAC Anticheat
