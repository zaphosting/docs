...
description: Information about installing the Ubuntu 20.04 operating system on your dedicated server from ZAP-Hosting - ZAP-Hosting.com documentation
...
The latest version of Ubuntu is the [20.04](http://localhost:3000/guides/docs/dedicated-ubuntu) version. We recommend using the latest version for long-term projects.
