...
description: "Information about the creation and use of GSLT for American Truck Simulator server from ZAP-Hosting"
...
Once logged in, you have the possibility to create a new token using the form displayed on the page. In the **App ID** field, enter the App ID `270880` which belongs to **American Truck Simulator**. Make sure to enter the correct ID, as the token will not work with an incorrect value.
...
:::info Operating multiple American Truck Simulator servers
When operating multiple **American Truck Simulator** servers, you will need a GSLT for each server. It is <u>**not**</u> possible to operate multiple game servers via one single GSLT.
:::
