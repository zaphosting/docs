...
description: Information about various ways on how to connect to your Citadel Forged With Fire server from ZAP-Hosting - ZAP-Hosting.com Documentation
...
To connect to your server open the game and navigate to **Join Game**. Once you are there  search for your server using the server name in the server list. Click **Join** to establish the connection. 
