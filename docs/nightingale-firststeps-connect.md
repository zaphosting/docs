...
title: "Nightingale: Connect to the server"
description: "Discover how to connect smoothly to your Nightingale server and troubleshoot common issues for a seamless gaming experience → Learn more now"
...
<Tabs>
    <TabItem value="connect_solution_server_browser_ingame" label="In game" default>

To connect to your server, you must open the UI. To do this press `F2` or `RCtrl` and navigate to **Connect**. Once there use the IP:Port of your server to establish the connection. 
