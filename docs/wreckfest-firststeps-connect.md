...
title: "Wreckfest: Connect to the server"
description: "Discover how to connect to your Wreckfest server smoothly and troubleshoot common issues for a seamless gaming experience → Learn more now"
...
To connect to your server , open the server browser in the main menu. To do so, click on **Multiplayer** and navigate to **Server browser**. Once there, search for your server using the server name of your server.
