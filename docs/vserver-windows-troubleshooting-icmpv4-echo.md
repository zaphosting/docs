...
title: "Network Troubleshooting: ICMPv4 Echo missing – Server appears offline"
...
To resolve this issue, a firewall rule must be created that allows ICMPv4 Echo requests. Start by establishing a connection via VNC. To do this, click on **VNC Console** in the VPS management section and log in with your usual login credentials.
...
Congratulations! By creating the ICMPv4 Echo rule in the Windows Firewall, you have successfully ensured that your Windows VPS can respond to ping requests again.
