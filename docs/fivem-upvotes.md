...
FiveM Upvotes are no longer sold through the ZAP-Hosting shop. You can purchase Upvotes and Burst Upvotes directly and officially through the [Cfx.re Portal](https://portal.cfx.re/subscriptions/upvotes). For the exact steps, take a look at Cfx.re's own guide: [How to buy Upvotes for FiveM/RedM servers](https://support.cfx.re/hc/en-us/articles/18675194571420).
...
In case the upvotes should be reassigned to another server or an error occurred while assigning them, they can be reset directly in the [Cfx.re Portal](https://portal.cfx.re/subscriptions/upvotes). The reset of the upvotes will take a few minutes until it has been adopted by Cfx.re.
