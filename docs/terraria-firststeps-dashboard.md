...
description: Information about the dashboard of an Terraria server from ZAP-Hosting 
...
<YouTube videoId="3k7AySyv0S4" imageSrc="https://screensaver01.zap-hosting.com/index.php/s/8eAeraFWCXb5Rpi/preview" title="Setup Terraria server in just a MINUTE!" description="Feel like you understand better when you see things in action? We’ve got you! Dive into our video that breaks it all down for you. Whether you're in a rush or just prefer to soak up information in the most engaging way possible!"/>
...
- Basic settings: Additional cheat protection, World Title, Size of the new world, Create new world?, Server Password
