...
description: Information about various ways on how to connect to your Wreckfest 2 server from ZAP-Hosting - ZAP-Hosting.com Documentation
...
To connect to your server via the in game server browser, open the server browser in the main menu. Once there, click on **Connect to address** on the left. Fill in the IP address and port of your server and then click on **Ok** to establish the connection. 
