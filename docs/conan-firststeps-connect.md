...
description: "Discover how to connect to your Conan Exiles server smoothly and enjoy uninterrupted gameplay → Learn more now"
...
To connect to your server, navigate to **Play Online** in the game. This will open the server list. In the server list, you can search for the name of your server using the **name field**. Select your server and click on **Join**.
...
To connect to your server, navigate to **Play Online** in the game. The server list will open. Instead of searching for your server, you can click on **Direct Connect** at the bottom left and connect using your server's IP address and port. 
