...
description: Information about various ways on how to connect to your No More Room in Hell server from ZAP-Hosting - ZAP-Hosting.com Documentation
...
In No More Room in Hell, the console is disabled by default. To enable it, **visit Options → Keyboard and choose Advanced**. To connect to your server via console, open the console with the `~` key. Once the console is open, execute the following command:
